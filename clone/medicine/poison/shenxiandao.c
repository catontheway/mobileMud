...
void create()
{
	...
	if( clonep() )
		...
		set("long","这是一包五毒教的圣药，吃了它连大罗金仙也要倒下。\n你可以用(pour)命令试试。\n" );
		set("unit", "些");
		set("base_value", 200);
		set("base_unit", "包");
		set("base_weight", 30);
...
//	object *inv;
	...
	if( !ob ) return notify_fail("对方身上没有" + what + "这样东西。\n");
...
{
	F_POISON->poison_attack(ob,this_player(),"slumber_drug",
