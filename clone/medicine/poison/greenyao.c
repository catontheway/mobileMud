...
void create()
{
	set_name(HIG"绿色药粉"NOR, ({ "green yao","yao"}) );
	if( clonep() )
...
{
	F_POISON->poison_attack(ob,this_player(),"zhizhu_poison", (int)this_player()->query_condition("zhizhu_poison") + (int)ob->query("liquid/slumber_effect") );
	return 0;
}
