...
void create()
{
	set_name(BLK"黑色药粉"NOR, ({ "black yao","yao"}) );
	if( clonep() )
...
{
	F_POISON->poison_attack(ob,this_player(),"chanchu_poison", (int)this_player()->query_condition("chanchu_poison") + (int)ob->query("liquid/slumber_effect") );
	return 0;
}
