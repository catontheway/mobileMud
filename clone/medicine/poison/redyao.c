...
void create()
{
	set_name(HIR"红色药粉"NOR, ({ "red yao","yao"}) );
	if( clonep() )
...
{
	F_POISON->poison_attack(ob,this_player(),"snake_poison", (int)this_player()->query_condition("snake_poison") + (int)ob->query("liquid/slumber_effect") );
	return 0;
}
