...
if(!ob) return 1;
        if ( (lev = ob->query_skill("sword", 1)) < 100 )
                ob->set_skill("sword", lev + 10);


if (ob)
{
        tell_object(ob, HIC "你从霍青桐那里学习到了高级的剑法。\n" NOR);
