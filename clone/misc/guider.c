  ...
  int do_travel(string arg)
{
        ...
        str += "扬州:travel yz"+ZJSEP;
		str += "少林:travel sl"+ZJSEP;
	    str += "武当:travel wd"+ZJSEP;
		str += "星宿:travel xx"+ZJSEP;
		str += "全真:travel qz"+ZJSEP;
		str += "华山:travel hs"+ZJSEP;
		str += "灵鹫:travel lj"+ZJSEP;
		str += "桃花岛:travel thd"+ZJSEP;
		str += "明教:travel mj"+ZJSEP;
		str += "天龙:travel tls"+ZJSEP;
		str += "峨嵋:travel em"+ZJSEP;
		str += "古墓:travel gm"+ZJSEP;
		str += "白驼山:travel bt"+ZJSEP;  
		str += "嘉兴:travel jx"+ZJSEP;
		str += "泉州:travel quan"+ZJSEP;
		str += "临安府:travel laf"+ZJSEP;
		str += "苏州:travel sz"+ZJSEP;
		str += "北京:travel bj"+ZJSEP;
		str += "平西王府:travel px"+ZJSEP;
		str += "襄阳:travel xy"+ZJSEP;
		str += "泰山:travel ts"+ZJSEP;
		str += "镇江:travel zj"+ZJSEP;
		str += "江州:travel jz"+ZJSEP;
		str += "岳阳:travel yy"+ZJSEP;
		str += "晋阳:travel jy"+ZJSEP;
		str += "长安:travel ca"+ZJSEP;
		str += "昆明:travel km"+ZJSEP;
		str += "神龙岛:travel sld"+ZJSEP;
		str += "钓鱼岛:travel dyd"+ZJSEP;
		str += "凌霄城:travel lxc"+ZJSEP;
		str += "灵州:travel lz"+ZJSEP;
		str += "归云庄:travel gy"+ZJSEP;
		str += "丐帮:travel gb"+ZJSEP;
		str += "侠客岛:travel xkd"+ZJSEP;
		str += "慕容:travel mr"+ZJSEP;
		str += "洛阳:travel ly"+ZJSEP;
		str += "成都:travel cd"+ZJSEP;
		str += "信阳:travel xin"+ZJSEP;
		str += "张家口:travel zjk"+ZJSEP;
		str += "应天府:travel ytf"+ZJSEP;
		str += "大理城:travel dl"+ZJSEP;
		str += "大轮寺:travel dls"+ZJSEP;
		str += "杀手帮:travel pker"+ZJSEP;
		str += "日月:travel ry"+ZJSEP;
