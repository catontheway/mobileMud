...
if (txs2<=txs3 && yushi>=5 )
{
	txs2=txs2+1;	
fhtest=basefhtest+random(5+lev);
my_file= replace_string(my_file,"magictest",	fhtest+"");
//strnf +=TYPE3[6]["TYPE1"]+":"+ w_power(fhtest) + " ";
}
else
{
...
{ 
	txs=txs+1;	
sztest=basesztest+random(lev*10);
my_file= replace_string(my_file,"aatext",	sztest+"");  
strn +="周天:"+w_power2(sztest)+" ";
}
else
{
...
{ 
	txs=txs+1;	
sztest=basesztest+random(lev*10);
my_file= replace_string(my_file,"bbbtext",	sztest+"");  
my_file= replace_string(my_file,"ddtext",	sztest+"");  
strn +="不老:"+w_power2(sztest)+" ";
}
else
{
...
txs=txs+1;
sztest=basesztest+random(lev*10);
  my_file= replace_string(my_file,"cctext",	sztest+"");
//strn +="悟  性:"+w_power2(gifttext)+" ";
}
else
{
...
txs=txs+1;
sztest=basesztest+random(lev*10);
  my_file= replace_string(my_file,"eetext",	sztest+"");
//strn +="悟  性:"+w_power2(gifttext)+" ";
}
else
{
...
txs=txs+1;
sztest=basesztest+random(lev*10);
  my_file= replace_string(my_file,"fftext",	sztest+"");
//strn +="悟  性:"+w_power2(gifttext)+" ";
}
else
{
...
txs=txs+1;
sztest=basesztest+random(lev*10);
  my_file= replace_string(my_file,"forcetest",	sztest+"");
//strn +="悟  性:"+w_power2(gifttext)+" ";
}
else
{
...
txs=txs+1;
sztest=basesztest+random(lev*10);
  my_file= replace_string(my_file,"magictest",	sztest+"");
//strn +="悟  性:"+w_power2(gifttext)+" ";
}
else
{
