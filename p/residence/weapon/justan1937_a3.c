...
void create()
{
	      set_name("[1;31m西川红锦百花袍[2;37;0m", ({ "ganjiang armor", "armor" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一件由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重二斤三两八钱的[31m干将之披风[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比坚固，具有[1;34m倚天屠龙[2;37;0m的防护力！
上面刻了几个古符号：
[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;31m毁天[2;37;0m 

上面还刻了一些符字：
坚硬:[1;33m灭世[2;37;0m 绝代:[32m粗糙[2;37;0m 巧制:[35m标准[2;37;0m 
白石:[1;36m完美[2;37;0m 闪电:[32m粗糙[2;37;0m 
周天:[1;36m完美[2;37;0m 不老:[33m很高[2;37;0m 
以及一排古篆字【 [1;32m曹青帝[2;37;0m 】。和一些【 [1;32m斧法[2;37;0m 】的技巧。
...
//特效数值
 ...
 //   set("armor_prop/weapon_effect_jing", 0);
   ...
   // set("armor_prop/max_busy_dianxue", 15);
...
//气血恢复治疗类
    set("armor_prop/max_qi", 73);
    set("armor_prop/max_jing", 45);
    set("armor_prop/neili_recover", 73);
    set("armor_prop/qi_recover", 73);
    set("armor_prop/jing_recover", 86);
    set("armor_prop/jingli_recover", 45);
