...
void create()
{
	      set_name("[1;36m一片冰心在玉壶[2;37;0m", ({ "yuchang neck", "neck" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一串由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重二斤一两八钱的[31m鱼肠之项链[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比坚固，具有[1;34m倚天屠龙[2;37;0m的防护力！
上面刻了几个古符号：
[1;31m魔[2;37;0m:[1;35m绝世[2;37;0m [1;33m金[2;37;0m:[1;31m毁天[2;37;0m [33m土[2;37;0m:[1;31m创世[2;37;0m 
上面还刻了一些符字：
坚硬:[1;33m灭世[2;37;0m 巧制:[1;32m魔王[2;37;0m 
紫石:[1;34m举世[2;37;0m 不老:[1;32m魔王[2;37;0m 
...
//特效数值
      set("armor_prop/kf_def_wound", 15);
    set("armor_prop/kf_wound", 0);
    set("armor_prop/cant_all_busy", 9);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 61);
    set("armor_prop/jingli_recover", 94);
    set("armor_prop/qi_cure", 63);
    set("armor_prop/jing_cure", 39);
