...
void create()
{
	      set_name("[1;31m天子手套[2;37;0m", ({ "chungou hands", "hands" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一副由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重六斤一两三钱的[31m纯钩之手套[2;37;0m。
...
体灵:[1;36m完美[2;37;0m 白石:[35m标准[2;37;0m 周天:[35m标准[2;37;0m 不老:[1;36m完美[2;37;0m 威力:[33m很高[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/armor_effect_poison", 6);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     ...
     set("armor_prop/dodge_factor", 15);
//气血恢复治疗类
    set("armor_prop/max_qi", 59);
    set("armor_prop/max_jing", 77);
    set("armor_prop/neili_recover", 59);
    set("armor_prop/qi_recover", 59);
    set("armor_prop/jing_recover", 46);
    set("armor_prop/jingli_recover", 77);
    set("armor_prop/qi_cure", 59);
