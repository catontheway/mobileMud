...
void create()
{
	      set_name("[1;31m云纹金缕百战靴[2;37;0m", ({ "yuchang boots", "boots" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一双由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重五斤一两一钱的[31m鱼肠之靴[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比坚固，具有[1;34m倚天屠龙[2;37;0m的防护力！
上面刻了几个古符号：
[1;31m魔[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;33m天圣[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
上面还刻了一些符字：
坚硬:[1;33m灭世[2;37;0m 天渊:[33m很高[2;37;0m 巧制:[1;32m魔王[2;37;0m 
闪电:[35m标准[2;37;0m 
周天:[33m很高[2;37;0m 不老:[31m精致[2;37;0m 
以及一排古篆字【 [1;32m曹青帝[2;37;0m 】。和一些【 [1;32m棍法[2;37;0m 】的技巧。
...
//伤害防御类
    ...
    set("armor_prop/defense_attack", 12);
    set("armor_prop/armor_vs_force", 15);
    set("armor_prop/armor_effect_armor_vs_force", 16);
    set("armor_prop/attack_speed", 7);
     set("armor_prop/attack_factor", 9);
     set("armor_prop/parry_factor", 0);
     set("armor_prop/dodge_factor", 8);
//气血恢复治疗类
    set("armor_prop/max_qi", 40);
    set("armor_prop/max_jing", 63);
    set("armor_prop/neili_recover", 40);
    set("armor_prop/qi_recover", 40);
    set("armor_prop/jing_recover", 49);
    set("armor_prop/jingli_recover", 63);
