...
void create()
{
	      set_name("[1;37m白玉带[2;37;0m", ({ "moye surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一条由绝对坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重五斤九两八钱的[31m莫邪之肚带[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来绝对坚固，具有[1;34m倚天屠龙[2;37;0m的防护力！
上面刻了几个古符号：
[1;33m金[2;37;0m:[1;31m创世[2;37;0m 
上面还刻了一些符字：
坚硬:[1;33m灭世[2;37;0m 天灵:[35m标准[2;37;0m 天宇:[33m很高[2;37;0m 绝代:[33m很高[2;37;0m 巧制:[1;32m魔王[2;37;0m 
白石:[35m标准[2;37;0m 不老:[32m粗糙[2;37;0m 
以及一排古篆字【 [1;32m风逍遥[2;37;0m 】。和一些【 [1;32m腿法[2;37;0m 】的技巧。
...
//特效数值
    ...
    set("armor_prop/armor_effect_rebound", 10);
 //   set("armor_prop/weapon_effect_jing", 8);
    set("armor_prop/max_all_busy", 8);
