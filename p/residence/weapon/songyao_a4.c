...
void create()
{
	      set_name("[33m春风得意马蹄疾[2;37;0m", ({ "zhanlu surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一条由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重三斤七两零钱的[31m湛卢之肚带[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比坚固，具有[1;34m倚天屠龙[2;37;0m的防护力！
上面刻了几个古符号：
[33m土[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;31m毁天[2;37;0m 

上面还刻了一些符字：
坚硬:[1;33m灭世[2;37;0m 天玄:[32m粗糙[2;37;0m 巧制:[1;34m举世[2;37;0m 
体灵:[32m粗糙[2;37;0m 白石:[1;34m举世[2;37;0m 紫石:[35m标准[2;37;0m 闪电:[1;34m举世[2;37;0m 
周天:[31m精致[2;37;0m 不老:[1;36m完美[2;37;0m 
以及一排古篆字【 [1;32m宋珧[2;37;0m 】。和一些【 [1;32m内功[2;37;0m 】的技巧。
...
//特效数值
    ...
    set("armor_prop/armor_effect_armor_vs_force", 11);
    set("armor_prop/armor_effect_healup", 12);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     set("armor_prop/attack_factor", 10);
     set("armor_prop/parry_factor", 0);
     set("armor_prop/dodge_factor", 0);
//气血恢复治疗类
    set("armor_prop/max_qi", 62);
    set("armor_prop/max_jing", 76);
    set("armor_prop/neili_recover", 62);
    set("armor_prop/qi_recover", 62);
    set("armor_prop/jing_recover", 0);
    set("armor_prop/jingli_recover", 76);
