...
void create()
{
	      set_name("[1;31m因果循环有定数[2;37;0m", ({ "juque waist", "waist" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一条由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重六斤零两八钱的[31m巨阙之腰带[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比坚固，具有[1;34m倚天屠龙[2;37;0m的防护力！
上面刻了几个古符号：
[37m天[2;37;0m:[1;31m创世[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m 

上面还刻了一些符字：
坚硬:[1;33m灭世[2;37;0m 福源:[33m很高[2;37;0m 
天玄:[32m粗糙[2;37;0m 巧制:[35m标准[2;37;0m 
紫石:[1;34m举世[2;37;0m 不老:[33m很高[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spirituality", 41);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 64);
