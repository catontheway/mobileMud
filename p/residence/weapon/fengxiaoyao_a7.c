...
void create()
{
	      set_name("[1;37m诗赋[2;37;0m", ({ "juque neck", "neck" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一串由绝对坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重三斤五两四钱的[31m巨阙之项链[2;37;0m。
...
白石:[31m精致[2;37;0m 紫石:[35m标准[2;37;0m 闪电:[35m标准[2;37;0m 
不老:[1;34m举世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/armor_effect_poison", 16);
    set("armor_prop/armor_effect_rebound", 7);
