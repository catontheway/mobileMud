...
void create()
{
	      set_name("[1;36m阿松大[2;37;0m", ({ "chungou boots", "boots" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一双由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重五斤二两五钱的[31m纯钩之靴[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比坚固，具有[1;34m倚天屠龙[2;37;0m的防护力！
上面刻了几个古符号：
[33m土[2;37;0m:[1;31m创世[2;37;0m [1;35m风[2;37;0m:[1;31m创世[2;37;0m 
[1;34m电[2;37;0m:[1;35m绝世[2;37;0m 
上面还刻了一些符字：
坚硬:[1;33m灭世[2;37;0m 巧制:[35m标准[2;37;0m 
白石:[35m标准[2;37;0m 闪电:[1;36m完美[2;37;0m 
不老:[33m很高[2;37;0m 
以及一排古篆字【 [1;32m幕后黑手[2;37;0m 】。和一些【 [1;32m手法[2;37;0m 】的技巧。
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     ...
     set("armor_prop/parry_factor", 15);
     set("armor_prop/dodge_factor", 0);
//气血恢复治疗类
    set("armor_prop/max_qi", 0);
    set("armor_prop/max_jing", 47);
    set("armor_prop/neili_recover", 0);
    set("armor_prop/qi_recover", 0);
    set("armor_prop/jing_recover", 72);
    set("armor_prop/jingli_recover", 47);
    set("armor_prop/qi_cure", 77);
