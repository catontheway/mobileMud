...
void create()
{
	      set_name("[1;37m测试[2;37;0m", ({ "yuchang hands", "hands" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一副由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重二斤二两九钱的[31m鱼肠之手套[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比坚固，具有[1;34m倚天屠龙[2;37;0m的防护力！
上面刻了几个古符号：
[37m天[2;37;0m:[1;31m创世[2;37;0m [1;33m金[2;37;0m:[1;31m创世[2;37;0m [36m木[2;37;0m:[1;31m毁天[2;37;0m [1;35m风[2;37;0m:[1;31m毁天[2;37;0m 

上面还刻了一些符字：
坚硬:[1;33m灭世[2;37;0m 天玄:[32m粗糙[2;37;0m 巧制:[35m标准[2;37;0m 
体灵:[31m精致[2;37;0m 闪电:[33m很高[2;37;0m 
周天:[33m很高[2;37;0m 不老:[35m标准[2;37;0m 威力:[33m很高[2;37;0m 
以及一排古篆字【 [1;32m眼[2;37;0m 】。和一些【 [1;32m拳法[2;37;0m 】的技巧。
...
//特效数值
    ...
    set("armor_prop/armor_effect_healup", 8);
...
//伤害防御类
    ...
    set("armor_prop/armor_effect_armor_vs_force", 12);
    set("armor_prop/attack_speed", 0);
     set("armor_prop/attack_factor", 0);
     set("armor_prop/parry_factor", 0);
     set("armor_prop/dodge_factor", 0);
//气血恢复治疗类
    set("armor_prop/max_qi", 44);
    set("armor_prop/max_jing", 57);
    set("armor_prop/neili_recover", 44);
    set("armor_prop/qi_recover", 44);
    set("armor_prop/jing_recover", 0);
    set("armor_prop/jingli_recover", 57);
