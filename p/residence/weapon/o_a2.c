...
void create()
{
	      set_name("[33m看看[2;37;0m", ({ "longquan surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
		...
		set("long", @LONG
[31m龙泉人间极品，武林至宝！
[2;37;0m这是一条由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重六斤一两零钱的[31m龙泉之肚带[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比坚固，具有[32m水准以上[2;37;0m的防护力！
上面刻了几个古符号：
[36m木[2;37;0m:[1;31m创世[2;37;0m [33m土[2;37;0m:[1;31m创世[2;37;0m 
上面还刻了一些符字：
坚硬:[1;33m灭世[2;37;0m 绝代:[33m很高[2;37;0m 巧制:[31m精致[2;37;0m 
白石:[1;34m举世[2;37;0m 紫石:[1;36m完美[2;37;0m 长生:[32m粗糙[2;37;0m 不老:[32m粗糙[2;37;0m 威力:[1;36m完美[2;37;0m 
以及一排古篆字【 [1;32m幕后黑手[2;37;0m 】。和一些【 [1;32m轻功[2;37;0m 】的技巧。
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/staff", 47);
    set("armor_prop/force", 0);
    set("armor_prop/dagge", 0);
    set("armor_prop/hammer", 47);
    set("armor_prop/spear", 47);
...
//特效数值
    ...
    set("armor_prop/PoisonAttack", 7);
    set("armor_prop/kf_hit_rate", 0);
    set("armor_prop/kf_anti_hr", 0);
//伤害防御类
    set("armor_prop/deep_injure", 16);
