...
void create()
{
	      set_name("[1;34m北龙归心号苍穹[2;37;0m", ({ "chungou cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一件由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重七斤一两二钱的[31m纯钩之服装[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比坚固，具有[1;33m举世无匹[2;37;0m的防护力！
上面刻了几个古符号：
[1;36m人[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[1;31m开元[2;37;0m [32m水[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;31m毁天[2;37;0m [1;37m雷[2;37;0m:[1;33m灭世[2;37;0m 
上面还刻了一些符字：
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 16);
 ...
 //   set("armor_prop/weapon_effect_jing", 11);
    set("armor_prop/max_all_busy", 11);
...
//伤害防御类
    ...
    set("armor_prop/abs_week_injure", 14);
    set("armor_prop/defense_attack", 9);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 63);
