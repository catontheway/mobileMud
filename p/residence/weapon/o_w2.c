...
void create()
{
	set_name("[31m测试二号[2;37;0m", ({ "longquan sword", "sword" }));
	set_weight(14711);
	if (clonep())
		...
		set("long", @LONG
[31m龙泉人间极品，武林至宝！
[2;37;0m这是一把由无比坚硬的[1;36m万年寒冰铁[2;37;0m制成，重二十九斤四两二钱的[31m龙泉之剑[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比锋利，具有[1;36m斩妖伏魔[2;37;0m的威力！
上面刻了几个古符号：
[1;33m金[2;37;0m:[1;31m毁天[2;37;0m [36m木[2;37;0m:[1;32m魔王[2;37;0m [33m土[2;37;0m:[1;31m无双[2;37;0m [1;35m风[2;37;0m:[1;36m完美[2;37;0m 
[1;37m雷[2;37;0m:[1;35m绝世[2;37;0m [1;34m电[2;37;0m:[1;31m开元[2;37;0m 
上面还刻了一些符字：
锋利:[1;33m灭世[2;37;0m 福源:[32m粗糙[2;37;0m 
巧制:[35m标准[2;37;0m 
体灵:[31m精致[2;37;0m 紫石:[33m很高[2;37;0m 周天:[1;34m举世[2;37;0m 
以及一排古篆字【 [1;32m幕后黑手[2;37;0m 】。和一些【 [1;32m棍法[2;37;0m 】的技巧。
...
//特效数值
    ...
    set("weapon_prop/max_busy_fenjin", 8);
    set("weapon_prop/max_busy_confuse", 6);
    set("weapon_prop/max_busy_body", 0);
    set("weapon_prop/AllPoisonsImmune", 11);
...
//伤害防御类
    ...
    set("weapon_prop/defense_attack", 7);
    set("weapon_prop/armor_vs_force", 10);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 37);
