...
void create()
{
	      set_name("[1;31m测试[2;37;0m", ({ "moye hands", "hands" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一副由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上布料制成，重二斤八两七钱的[31m莫邪之手套[2;37;0m。
综合评价[35m毁天灭地[2;37;0m 看起来无比坚固，具有[35m极其可怕[2;37;0m的防护力！
上面刻了几个古符号：
[40m地[2;37;0m:[1;34m举世[2;37;0m [36m木[2;37;0m:[1;31m开元[2;37;0m [32m水[2;37;0m:[1;31m毁天[2;37;0m [1;35m风[2;37;0m:[1;31m开元[2;37;0m 
[1;34m电[2;37;0m:[1;32m魔王[2;37;0m 
上面还刻了一些符字：
坚硬:[1;33m灭世[2;37;0m 绝代:[32m粗糙[2;37;0m 巧制:[1;32m魔王[2;37;0m 
体灵:[33m很高[2;37;0m 白石:[1;34m举世[2;37;0m 周天:[33m很高[2;37;0m 不老:[1;34m举世[2;37;0m 威力:[33m很高[2;37;0m 
以及一排古篆字【 [1;32m眼[2;37;0m 】。和一些【 [1;32m手法[2;37;0m 】的技巧。
...
LONG
	...
	set("ownmake",1);
		...
		set("value", 36000);
		  set("forge/max", 746);
  set("forge/times_max", 746);
  set("level", 746);

     set("armor_prop/damage", 746);
...
//特效数值
 ...
 //   set("armor_prop/weapon_effect_jing", 0);
   ...
   // set("armor_prop/max_busy_dianxue", 6);
...
//气血恢复治疗类
    set("armor_prop/max_qi", 43);
    set("armor_prop/max_jing", 81);
    set("armor_prop/neili_recover", 43);
    set("armor_prop/qi_recover", 43);
    set("armor_prop/jing_recover", 0);
    set("armor_prop/jingli_recover", 81);
