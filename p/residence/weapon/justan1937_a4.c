...
void create()
{
	      set_name("[1;31m三叉束发紫金冠[2;37;0m", ({ "ganjiang head", "head" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一顶由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重四斤一两二钱的[31m干将之头盔[2;37;0m。
...
不老:[32m粗糙[2;37;0m 
以及一排古篆字【 [1;32m曹青帝[2;37;0m 】。和一些【 [1;32m手法[2;37;0m 】的技巧。
...
//特效数值
    ...
    set("armor_prop/armor_effect_healup", 16);
