...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[35m九龙之手套[2;37;0m这是一副由极为坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两八钱的[35m九龙之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m毁天[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 33);
