...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;31m炎龙之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两五钱的[1;31m炎龙之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;35m绝世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/throwing", 16);
    
    
   
//特效数值
    set("armor_prop/kf_def_wound", 5);
    ...
    set("armor_prop/cant_busy_fenjin", 13);
