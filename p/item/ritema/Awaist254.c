...
void create()
{
	      set_name("[33m春兰之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
春兰之腰带[2;37;0m这是一条由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两三钱的[33m春兰之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
