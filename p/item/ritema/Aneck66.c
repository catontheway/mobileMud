...
void create()
{
	      set_name("[1;32m宾之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
宾之项链[2;37;0m这是一串由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤七两五钱的[1;32m宾之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m 
