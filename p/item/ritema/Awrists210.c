...
void create()
{
	      set_name("[31m鬼雨之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
鬼雨之护腕[2;37;0m这是一双由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两五钱的[31m鬼雨之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[1;36m人[2;37;0m:[1;36m完美[2;37;0m 
