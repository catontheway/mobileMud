...
void create()
{
	      set_name("[1;35m月季之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
月季之头盔[2;37;0m这是一顶由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两一钱的[1;35m月季之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[1;34m举世[2;37;0m 
