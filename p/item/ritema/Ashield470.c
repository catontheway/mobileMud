...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一面由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重二斤四两二钱的[31m莫邪之盾[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 29);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 25);
