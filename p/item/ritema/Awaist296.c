...
void create()
{
	      set_name("[1;34m晦光之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
晦光之腰带[2;37;0m这是一条由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两九钱的[1;34m晦光之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
