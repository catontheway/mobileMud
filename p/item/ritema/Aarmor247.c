...
void create()
{
	      set_name("[1;33m承天之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
承天之披风[2;37;0m这是一件由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两七钱的[1;33m承天之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[1;34m电[2;37;0m:[1;31m开元[2;37;0m 
