...
void create()
{
	      set_name("[34m盘古之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
盘古之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤五两八钱的[34m盘古之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_jiemai", 6);
