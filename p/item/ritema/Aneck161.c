...
void create()
{
	      set_name("[1;37m摘星之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
摘星之项链[2;37;0m这是一串由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两一钱的[1;37m摘星之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;35m绝世[2;37;0m 
