...
void create()
{
	      set_name("[34m冰释之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
冰释之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两七钱的[34m冰释之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
