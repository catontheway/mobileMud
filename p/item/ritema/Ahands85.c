...
void create()
{
	      set_name("[1;36m竹之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
竹之手套[2;37;0m这是一副由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤二两五钱的[1;36m竹之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m [1;36m人[2;37;0m:[32m粗糙[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_body", 1);
