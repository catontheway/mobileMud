...
void create()
{
	      set_name("[35m钢之靴[2;37;0m", ({ "bad boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
钢之靴[2;37;0m这是一双由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤七两三钱的[35m钢之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[34m细碎[2;37;0m 
