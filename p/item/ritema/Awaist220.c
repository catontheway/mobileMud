...
void create()
{
	      set_name("[1;35m夺魂之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
夺魂之腰带[2;37;0m这是一条由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两六钱的[1;35m夺魂之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m无双[2;37;0m 
