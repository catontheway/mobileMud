...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[34m公侯之项链[2;37;0m这是一串由极为坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤零两零钱的[34m公侯之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
