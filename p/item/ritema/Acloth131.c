...
void create()
{
	      set_name("[1;32m杜鹃之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
杜鹃之服装[2;37;0m这是一件由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤零两二钱的[1;32m杜鹃之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [36m木[2;37;0m:[1;36m完美[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
