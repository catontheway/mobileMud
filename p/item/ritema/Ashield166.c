...
void create()
{
	      set_name("[1;34m太陽之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
太陽之盾[2;37;0m这是一面由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤八两六钱的[1;34m太陽之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[35m标准[2;37;0m 
