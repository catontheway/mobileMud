...
void create()
{
	      set_name("[1;34m玉指之靴[2;37;0m", ({ "good boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
玉指之靴[2;37;0m这是一双由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两一钱的[1;34m玉指之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m 
