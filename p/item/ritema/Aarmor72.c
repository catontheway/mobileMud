...
void create()
{
	      set_name("[1;33m怪之披风[2;37;0m", ({ "bad armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
怪之披风[2;37;0m这是一件由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤二两八钱的[1;33m怪之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[33m很高[2;37;0m 
