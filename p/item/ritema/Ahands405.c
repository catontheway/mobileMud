...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[1;35m所谓风云际会，天地变色！仗此行千里，老魔小丑，岂堪一击！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤一两二钱的[1;35m风云之手套[2;37;0m。$br#
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 25000);
                  //  基础类
  set("forge/max", 228);
  set("forge/times_max", 228);
  set("level", 228);

     set("armor_prop/damage", 228);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 31);
