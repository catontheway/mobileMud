...
void create()
{
	      set_name("[37m阖之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
阖之服装[2;37;0m这是一件由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重三斤零两九钱的[37m阖之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[32m粗糙[2;37;0m 
