...
void create()
{
	      set_name("[1;35m皓齿之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
皓齿之盾[2;37;0m这是一面由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重三斤零两三钱的[1;35m皓齿之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m 
