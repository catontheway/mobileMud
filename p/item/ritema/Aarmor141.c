...
void create()
{
	      set_name("[36m苍岩之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
苍岩之披风[2;37;0m这是一件由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两零钱的[36m苍岩之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[33m很高[2;37;0m 
