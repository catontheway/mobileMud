...
void create()
{
	      set_name("[37m魂魄之靴[2;37;0m", ({ "good boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
魂魄之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两三钱的[37m魂魄之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m 
