...
void create()
{
	      set_name("[1;34m巨之靴[2;37;0m", ({ "bad boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
巨之靴[2;37;0m这是一双由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两五钱的[1;34m巨之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m [1;36m人[2;37;0m:[34m细碎[2;37;0m [1;31m魔[2;37;0m:[34m细碎[2;37;0m 
