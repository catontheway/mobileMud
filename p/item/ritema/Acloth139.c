...
void create()
{
	      set_name("[1;33m旋风之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
旋风之服装[2;37;0m这是一件由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤七两二钱的[1;33m旋风之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;35m绝世[2;37;0m 
