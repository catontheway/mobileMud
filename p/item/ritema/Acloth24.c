...
void create()
{
	      set_name("[1;37m怪之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
怪之服装[2;37;0m这是一件由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤五两九钱的[1;37m怪之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[36m不错[2;37;0m 
