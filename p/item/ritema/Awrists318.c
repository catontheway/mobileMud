...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[36m天后之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两五钱的[36m天后之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 5);
     set("armor_prop/attack_factor", 5);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 35);
