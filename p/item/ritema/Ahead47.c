...
void create()
{
	      set_name("[1;33m韧之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
韧之头盔[2;37;0m这是一顶由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤三两二钱的[1;33m韧之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[36m不错[2;37;0m 
