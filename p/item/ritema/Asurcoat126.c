...
void create()
{
	      set_name("[36m海棠之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
海棠之肚带[2;37;0m这是一条由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两二钱的[36m海棠之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
