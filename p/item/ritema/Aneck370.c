...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[1;32m破甲之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两五钱的[1;32m破甲之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#[1;31m魔[2;37;0m:[31m精致[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/week_injure", 7);
    set("armor_prop/abs_week_injure", 8);
