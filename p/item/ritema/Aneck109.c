...
void create()
{
	      set_name("[1;34m常青之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
常青之项链[2;37;0m这是一串由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两五钱的[1;34m常青之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[33m很高[2;37;0m 
