...
void create()
{
	      set_name("[31m巧之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
巧之盾[2;37;0m这是一面由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤七两二钱的[31m巧之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[34m细碎[2;37;0m [32m水[2;37;0m:[34m细碎[2;37;0m [1;34m电[2;37;0m:[32m粗糙[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_jiemai", 1);
...
//伤害防御类
    ...
    set("armor_prop/armor_effect_armor_vs_force", 1);
