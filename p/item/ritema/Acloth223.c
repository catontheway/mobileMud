...
void create()
{
	      set_name("[36m啸天之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
啸天之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两七钱的[36m啸天之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [36m木[2;37;0m:[1;35m绝世[2;37;0m 
