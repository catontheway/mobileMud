...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[37m风雷之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两六钱的[37m风雷之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m开元[2;37;0m [1;34m电[2;37;0m:[1;31m毁天[2;37;0m [1;36m人[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 13);
     ...
     set("armor_prop/parry_factor", 18);
