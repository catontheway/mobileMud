...
void create()
{
	      set_name("[33m木樨之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
木樨之头盔[2;37;0m这是一顶由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两九钱的[33m木樨之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[1;34m举世[2;37;0m 
