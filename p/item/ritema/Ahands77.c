...
void create()
{
	      set_name("[1;32m大之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
大之手套[2;37;0m这是一副由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤二两二钱的[1;32m大之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[33m很高[2;37;0m $br#
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 1);
    ...
    set("armor_prop/max_busy_jiemai", 3);
...
//伤害防御类
    ...
    set("armor_prop/week_injure", 5);
    set("armor_prop/abs_week_injure", 4);
