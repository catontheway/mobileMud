...
void create()
{
	      set_name("[31m落雪之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
落雪之盾[2;37;0m这是一面由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤九两九钱的[31m落雪之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m 
