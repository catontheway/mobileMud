...
void create()
{
	      set_name("[34m牛头之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
牛头之手套[2;37;0m这是一副由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两六钱的[34m牛头之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m创世[2;37;0m 
