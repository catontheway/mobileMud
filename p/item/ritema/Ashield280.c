...
void create()
{
	      set_name("[31m阴蛇之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
阴蛇之盾[2;37;0m这是一面由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两六钱的[31m阴蛇之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m [1;37m雷[2;37;0m:[1;33m天圣[2;37;0m 
