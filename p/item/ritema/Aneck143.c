...
void create()
{
	      set_name("[1;35m降魔之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
降魔之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两六钱的[1;35m降魔之项链[2;37;0m。$br#
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 11);
