...
void create()
{
	      set_name("[34m五步之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
五步之服装[2;37;0m这是一件由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤六两五钱的[34m五步之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m [1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#[1;36m人[2;37;0m:[33m很高[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 4);
    set("armor_prop/cant_busy_jiemai", 7);
    set("armor_prop/cant_busy_fenjin", 0);
    set("armor_prop/cant_busy_confuse", 0);
    set("armor_prop/cant_busy_body", 4);
