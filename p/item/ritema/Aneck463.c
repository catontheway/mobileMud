...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一串由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤一两五钱的[31m工布之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    set("armor_prop/kf_def_wound", 30);
