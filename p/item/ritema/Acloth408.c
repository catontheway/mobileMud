...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;33m太极者，无极而生，阴阳之母也。动之则分，静之则合。无过不及，随曲就伸。人刚我柔谓之走，我顺人背谓之粘。动急则急应，动缓则缓随。虽变化万端，而理为一贯！$br#[2;37;0m这是一件由极为坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重二斤三两七钱的[1;33m太极之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;31m开元[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_body", 14);
