...
void create()
{
	      set_name("[1;35m盘古之靴[2;37;0m", ({ "good boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
盘古之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两零钱的[1;35m盘古之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m 
