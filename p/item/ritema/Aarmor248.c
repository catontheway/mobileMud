...
void create()
{
	      set_name("[1;36m曙光之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
曙光之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两零钱的[1;36m曙光之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m开元[2;37;0m 
