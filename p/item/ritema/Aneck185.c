...
void create()
{
	      set_name("[35m白鶴之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
白鶴之项链[2;37;0m这是一串由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两三钱的[35m白鶴之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m 
