...
void create()
{
	      set_name("[1;37m清水之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
清水之腰带[2;37;0m这是一条由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤四两五钱的[1;37m清水之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;34m举世[2;37;0m [1;36m人[2;37;0m:[1;31m开元[2;37;0m 
