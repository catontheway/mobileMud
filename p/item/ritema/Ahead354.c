...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[36m帝王之头盔[2;37;0m这是一顶由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两一钱的[36m帝王之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [1;37m雷[2;37;0m:[33m很高[2;37;0m [40m地[2;37;0m:[33m很高[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_fenjin", 6);
