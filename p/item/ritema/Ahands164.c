...
void create()
{
	      set_name("[35m富貴之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
富貴之手套[2;37;0m这是一副由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两四钱的[35m富貴之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;34m举世[2;37;0m 
