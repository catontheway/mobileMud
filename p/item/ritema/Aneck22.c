...
void create()
{
	      set_name("[33m小之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
小之项链[2;37;0m这是一串由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤六两九钱的[33m小之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[33m很高[2;37;0m 
