...
void create()
{
	      set_name("[1;35m宾之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
宾之头盔[2;37;0m这是一顶由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤八两四钱的[1;35m宾之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[35m标准[2;37;0m 
