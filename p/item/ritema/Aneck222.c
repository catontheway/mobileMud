...
void create()
{
	      set_name("[33m仙水之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
仙水之项链[2;37;0m这是一串由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤一两二钱的[33m仙水之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
