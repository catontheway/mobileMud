...
void create()
{
	      set_name("[1;31m文昌之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
文昌之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两三钱的[1;31m文昌之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m [37m天[2;37;0m:[34m细碎[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 3);
