...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[1;36m大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”$br#[2;37;0m这是一面由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重二斤七两六钱的[1;36m三清之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_confuse", 5);
    ...
    set("armor_prop/AllPoisonsImmune", 6);
