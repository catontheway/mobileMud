...
void create()
{
	      set_name("[33m巧之护腕[2;37;0m", ({ "bad wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
巧之护腕[2;37;0m这是一双由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤六两四钱的[33m巧之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m [1;37m雷[2;37;0m:[31m精致[2;37;0m 
