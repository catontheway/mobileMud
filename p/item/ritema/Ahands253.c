...
void create()
{
	      set_name("[35m吴钩之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
吴钩之手套[2;37;0m这是一副由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两九钱的[35m吴钩之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
