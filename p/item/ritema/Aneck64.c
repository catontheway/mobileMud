...
void create()
{
	      set_name("[1;34m大之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
大之项链[2;37;0m这是一串由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤零两九钱的[1;34m大之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[31m精致[2;37;0m 
