...
void create()
{
	      set_name("[35m宾之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
宾之手套[2;37;0m这是一副由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤八两五钱的[35m宾之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m 
