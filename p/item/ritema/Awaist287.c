...
void create()
{
	      set_name("[35m承天之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
承天之腰带[2;37;0m这是一条由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两一钱的[35m承天之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[1;36m人[2;37;0m:[1;31m创世[2;37;0m 
