...
void create()
{
	      set_name("[37m青羊之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
青羊之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤九两三钱的[37m青羊之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_confuse", 3);
