...
void create()
{
	      set_name("[31m金铃之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
金铃之头盔[2;37;0m这是一顶由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两二钱的[31m金铃之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m 
