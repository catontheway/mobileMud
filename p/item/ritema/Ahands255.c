...
void create()
{
	      set_name("[1;33m夏雨之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
夏雨之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两二钱的[1;33m夏雨之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[32m粗糙[2;37;0m 
