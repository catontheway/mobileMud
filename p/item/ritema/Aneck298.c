...
void create()
{
	      set_name("[1;31m明光之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
明光之项链[2;37;0m这是一串由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两零钱的[1;31m明光之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#[37m天[2;37;0m:[1;34m举世[2;37;0m [40m地[2;37;0m:[1;35m绝世[2;37;0m 
