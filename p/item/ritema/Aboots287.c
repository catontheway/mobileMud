...
void create()
{
	      set_name("[1;36m天女之靴[2;37;0m", ({ "good boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
天女之靴[2;37;0m这是一双由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两三钱的[1;36m天女之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m [1;37m雷[2;37;0m:[1;34m举世[2;37;0m 
