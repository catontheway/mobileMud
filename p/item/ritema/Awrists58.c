...
void create()
{
	      set_name("[36m铁之护腕[2;37;0m", ({ "bad wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
铁之护腕[2;37;0m这是一双由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤七两九钱的[36m铁之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[35m标准[2;37;0m [1;31m魔[2;37;0m:[32m粗糙[2;37;0m 
