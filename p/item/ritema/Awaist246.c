...
void create()
{
	      set_name("[33m寒光之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
寒光之腰带[2;37;0m这是一条由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤四两零钱的[33m寒光之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;34m举世[2;37;0m 
