...
void create()
{
	      set_name("[36m黑魅之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
黑魅之服装[2;37;0m这是一件由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤六两三钱的[36m黑魅之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m无双[2;37;0m 
