...
void create()
{
	      set_name("[1;33m天师之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
天师之腰带[2;37;0m这是一条由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两八钱的[1;33m天师之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;34m举世[2;37;0m 
