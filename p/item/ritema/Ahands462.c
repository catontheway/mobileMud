...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤一两八钱的[31m工布之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
...
LONG
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 36000);
                  //  基础类
  set("forge/max", 256);
  set("forge/times_max", 256);
  set("level", 256);

     set("armor_prop/damage", 256);
 ...
 //先天类    
    ...
    set("armor_prop/finger", 31);
    set("armor_prop/hand", 40);
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 21);
    ...
    set("armor_prop/max_busy_jiemai", 26);
    set("armor_prop/max_busy_fenjin", 0);
    set("armor_prop/max_busy_confuse", 17);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 20);
