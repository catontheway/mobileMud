...
void create()
{
	      set_name("[1;31m常青之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
常青之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两五钱的[1;31m常青之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[33m很高[2;37;0m $br#[1;31m魔[2;37;0m:[35m标准[2;37;0m 
