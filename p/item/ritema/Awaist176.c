...
void create()
{
	      set_name("[36m南天之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
南天之腰带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两五钱的[36m南天之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m [1;36m人[2;37;0m:[34m细碎[2;37;0m 
