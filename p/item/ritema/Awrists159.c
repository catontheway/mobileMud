...
void create()
{
	      set_name("[37m丹陽之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
丹陽之护腕[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两七钱的[37m丹陽之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [31m火[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
