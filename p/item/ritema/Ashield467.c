...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一面由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重二斤九两二钱的[31m纯钩之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m [1;34m电[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spear", 40);
    set("armor_prop/throwing", 0);
    
    
   
//特效数值
    set("armor_prop/kf_def_wound", 20);
    ...
    set("armor_prop/cant_busy_confuse", 10);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 15);
     set("armor_prop/attack_factor", 19);
     set("armor_prop/parry_factor", 0);
     set("armor_prop/dodge_factor", 0);
//气血恢复治疗类
    set("armor_prop/max_qi", 0);
    set("armor_prop/max_jing", 11);
