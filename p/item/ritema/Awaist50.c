...
void create()
{
	      set_name("[1;34m铜之腰带[2;37;0m", ({ "bad waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
铜之腰带[2;37;0m这是一条由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤八两八钱的[1;34m铜之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[36m不错[2;37;0m 
