...
void create()
{
	      set_name("[1;32m起云之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
起云之服装[2;37;0m这是一件由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重三斤零两零钱的[1;32m起云之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m 
