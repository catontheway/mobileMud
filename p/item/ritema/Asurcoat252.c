...
void create()
{
	      set_name("[35m高山之肚带[2;37;0m", ({ "good surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
高山之肚带[2;37;0m这是一条由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两六钱的[35m高山之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;32m魔王[2;37;0m 
