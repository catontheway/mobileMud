...
void create()
{
	      set_name("[33m明月之头盔[2;37;0m", ({ "good head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
明月之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤四两一钱的[33m明月之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
