...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一面由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤六两八钱的[31m工布之盾[2;37;0m。$br#
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/whip", 33);
    set("armor_prop/staff", 0);
    set("armor_prop/force", 0);
    set("armor_prop/dagge", 28);
...
//特效数值
    set("armor_prop/kf_def_wound", 22);
    ...
    set("armor_prop/max_busy_body", 19);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 20);
