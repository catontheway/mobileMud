...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一条由极为坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤八两二钱的[31m工布之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/armor_vs_force", 26);
    set("armor_prop/armor_effect_armor_vs_force", 24);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 53);
    set("armor_prop/jingli_recover", 18);
    set("armor_prop/qi_cure", 0);
    set("armor_prop/jing_cure", 52);
