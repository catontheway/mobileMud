...
void create()
{
	      set_name("[33m梦雪之靴[2;37;0m", ({ "general boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
梦雪之靴[2;37;0m这是一双由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤零两五钱的[33m梦雪之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;35m绝世[2;37;0m 
