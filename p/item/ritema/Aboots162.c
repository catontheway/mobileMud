...
void create()
{
	      set_name("[33m雪花之靴[2;37;0m", ({ "general boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
雪花之靴[2;37;0m这是一双由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两三钱的[33m雪花之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#[1;36m人[2;37;0m:[1;31m无双[2;37;0m 
