...
void create()
{
	      set_name("[1;36m啼莺之头盔[2;37;0m", ({ "good head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
啼莺之头盔[2;37;0m这是一顶由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两零钱的[1;36m啼莺之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#
