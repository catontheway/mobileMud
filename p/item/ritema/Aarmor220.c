...
void create()
{
	      set_name("[1;37m神水之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
神水之披风[2;37;0m这是一件由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤零两二钱的[1;37m神水之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;31m开元[2;37;0m 
