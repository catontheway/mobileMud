...
void create()
{
	      set_name("[1;37m白薇之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
白薇之肚带[2;37;0m这是一条由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤四两七钱的[1;37m白薇之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[31m精致[2;37;0m 
