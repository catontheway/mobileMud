...
void create()
{
	      set_name("[33m仙雨之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
仙雨之护腕[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两六钱的[33m仙雨之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m 
