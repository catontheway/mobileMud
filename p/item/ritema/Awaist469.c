...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤零两五钱的[31m胜邪之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;33m灭世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/force", 51);
    set("armor_prop/dagge", 38);
...
//特效数值
    ...
    set("armor_prop/PoisonAttack", 26);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     ...
     set("armor_prop/parry_factor", 20);
