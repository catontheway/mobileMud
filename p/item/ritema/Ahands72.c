...
void create()
{
	      set_name("[1;37m铜之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
铜之手套[2;37;0m这是一副由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤六两零钱的[1;37m铜之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m 
