...
void create()
{
	      set_name("[1;34m金铃之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
金铃之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两五钱的[1;34m金铃之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [40m地[2;37;0m:[32m粗糙[2;37;0m 
