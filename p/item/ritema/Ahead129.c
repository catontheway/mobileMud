...
void create()
{
	      set_name("[1;35m戈壁之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
戈壁之头盔[2;37;0m这是一顶由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两六钱的[1;35m戈壁之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#
