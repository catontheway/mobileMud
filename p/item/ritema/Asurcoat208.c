...
void create()
{
	      set_name("[1;34m天锋之肚带[2;37;0m", ({ "good surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
天锋之肚带[2;37;0m这是一条由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两四钱的[1;34m天锋之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[40m地[2;37;0m:[1;36m完美[2;37;0m 
