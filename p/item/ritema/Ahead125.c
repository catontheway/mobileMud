...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
扣骨之头盔[2;37;0m这是一顶由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两一钱的[35m扣骨之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;36m完美[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_body", 7);
    set("armor_prop/max_all_busy", 0);
    set("armor_prop/max_busy_dianxue", 5);
