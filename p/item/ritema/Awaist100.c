...
void create()
{
	      set_name("[1;33m白雪之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
白雪之腰带[2;37;0m这是一条由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两九钱的[1;33m白雪之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m 
