...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;34m在西方查理曼统治的时代，最简朴的剑也能值三头母牛的价钱。而查理大帝自己的那把传奇式的神兵“乔依乌斯”据说是半人半神的“韦兰铁匠”所造，乃当世界神兵！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤七两零钱的[1;34m乔依乌斯之肚带[2;37;0m。$br#
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/whip", 23);
    set("armor_prop/staff", 21);
    set("armor_prop/force", 0);
    set("armor_prop/dagge", 33);
...
//特效数值
    ...
    set("armor_prop/PoisonAttack", 16);
