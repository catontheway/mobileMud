...
void create()
{
	      set_name("[1;31m含翠之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
含翠之腰带[2;37;0m这是一条由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两三钱的[1;31m含翠之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m 
