...
void create()
{
	      set_name("[33m削岩之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
削岩之头盔[2;37;0m这是一顶由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两七钱的[33m削岩之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
