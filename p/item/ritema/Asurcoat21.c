...
void create()
{
	      set_name("[1;36m柔之肚带[2;37;0m", ({ "bad surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
柔之肚带[2;37;0m这是一条由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤九两零钱的[1;36m柔之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[32m粗糙[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
