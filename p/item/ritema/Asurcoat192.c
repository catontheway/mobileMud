...
void create()
{
	      set_name("[33m烟雨之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
烟雨之肚带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤四两八钱的[33m烟雨之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/blade", 5);
    set("armor_prop/whip", 9);
