...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m干将威力无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤四两一钱的[31m干将之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m创世[2;37;0m 
