...
void create()
{
	      set_name("[34m渡心之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
渡心之肚带[2;37;0m这是一条由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两四钱的[34m渡心之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
