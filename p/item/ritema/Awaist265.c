...
void create()
{
	      set_name("[34m神虎之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
神虎之腰带[2;37;0m这是一条由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两一钱的[34m神虎之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m创世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
