...
void create()
{
	      set_name("[31m啸天之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
啸天之腰带[2;37;0m这是一条由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两二钱的[31m啸天之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m毁天[2;37;0m [1;36m人[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;31m创世[2;37;0m 
