...
void create()
{
	      set_name("[31m芙蓉之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
芙蓉之肚带[2;37;0m这是一条由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两四钱的[31m芙蓉之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m 
