...
void create()
{
	      set_name("[36m蝙蝠之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
蝙蝠之披风[2;37;0m这是一件由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤四两零钱的[36m蝙蝠之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[34m细碎[2;37;0m 
