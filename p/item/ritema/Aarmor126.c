...
void create()
{
	      set_name("[31m落雪之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
落雪之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两七钱的[31m落雪之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m 
