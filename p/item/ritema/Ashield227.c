...
void create()
{
	      set_name("[1;33m仙水之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
仙水之盾[2;37;0m这是一面由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤五两一钱的[1;33m仙水之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;31m创世[2;37;0m 
