...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤八两七钱的[31m工布之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m 
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 36000);
                  //  基础类
  set("forge/max", 252);
  set("forge/times_max", 252);
  set("level", 252);

     set("armor_prop/damage", 252);
...
//特效数值
    ...
    set("armor_prop/cant_busy_body", 19);
