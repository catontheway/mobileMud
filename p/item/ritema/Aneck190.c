...
void create()
{
	      set_name("[1;36m武圣之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
武圣之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤零两六钱的[1;36m武圣之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m 
