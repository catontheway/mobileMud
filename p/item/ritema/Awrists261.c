...
void create()
{
	      set_name("[1;34m泪痕之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
泪痕之护腕[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两五钱的[1;34m泪痕之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m 
