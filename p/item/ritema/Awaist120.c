...
void create()
{
	      set_name("[34m黑魅之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
黑魅之腰带[2;37;0m这是一条由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两三钱的[34m黑魅之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[31m精致[2;37;0m 
