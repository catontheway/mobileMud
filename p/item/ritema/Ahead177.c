...
void create()
{
	      set_name("[34m青竹之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
青竹之头盔[2;37;0m这是一顶由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两二钱的[34m青竹之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[32m粗糙[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 3);
...
//气血恢复治疗类
    ...
    set("armor_prop/max_jing", 12);
    set("armor_prop/neili_recover", 0);
    set("armor_prop/qi_recover", 11);
