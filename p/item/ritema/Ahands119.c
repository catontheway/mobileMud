...
void create()
{
	      set_name("[1;35m巨威之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
巨威之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两二钱的[1;35m巨威之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m 
