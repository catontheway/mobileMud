...
void create()
{
	      set_name("[34m飞星之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
飞星之服装[2;37;0m这是一件由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤八两九钱的[34m飞星之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 2);
