...
void create()
{
	      set_name("[1;33m赤霞之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
赤霞之手套[2;37;0m这是一副由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两三钱的[1;33m赤霞之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[35m标准[2;37;0m 
