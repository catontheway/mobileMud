...
void create()
{
	      set_name("[37m怒涛之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
怒涛之服装[2;37;0m这是一件由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤七两六钱的[37m怒涛之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[33m很高[2;37;0m 
