...
void create()
{
	      set_name("[1;32m冰薇之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
冰薇之服装[2;37;0m这是一件由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤二两八钱的[1;32m冰薇之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m开元[2;37;0m 
