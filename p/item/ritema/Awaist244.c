...
void create()
{
	      set_name("[1;34m必胜之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
必胜之腰带[2;37;0m这是一条由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤四两六钱的[1;34m必胜之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;34m举世[2;37;0m [40m地[2;37;0m:[1;36m完美[2;37;0m 
