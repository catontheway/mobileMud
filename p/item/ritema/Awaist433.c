...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;31m天兵神通，走势要平善，气要随行，两眼顾尖，气沉两足稳，身法需自然，身行如飞燕，身落如停风，收如花絮，刺如钢钉！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤三两五钱的[1;31m神通之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m创世[2;37;0m [31m火[2;37;0m:[1;35m绝世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 17);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 12);
