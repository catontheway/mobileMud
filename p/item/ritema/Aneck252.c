...
void create()
{
	      set_name("[1;33m鬼雨之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
鬼雨之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤零两四钱的[1;33m鬼雨之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m [40m地[2;37;0m:[1;35m绝世[2;37;0m 
