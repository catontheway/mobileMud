...
void create()
{
	      set_name("[1;32m金牛之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
金牛之手套[2;37;0m这是一副由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤四两五钱的[1;32m金牛之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m 
