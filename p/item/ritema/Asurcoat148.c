...
void create()
{
	      set_name("[37m含翠之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
含翠之肚带[2;37;0m这是一条由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两二钱的[37m含翠之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [33m土[2;37;0m:[32m粗糙[2;37;0m [1;36m人[2;37;0m:[1;36m完美[2;37;0m 
