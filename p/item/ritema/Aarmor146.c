...
void create()
{
	      set_name("[1;32m东天之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
东天之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两三钱的[1;32m东天之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m 
