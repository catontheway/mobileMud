...
void create()
{
	      set_name("[36m狮枭之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
狮枭之盾[2;37;0m这是一面由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两九钱的[36m狮枭之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;34m举世[2;37;0m 
