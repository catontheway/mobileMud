...
void create()
{
	      set_name("[1;37m巨之披风[2;37;0m", ({ "bad armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
巨之披风[2;37;0m这是一件由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两一钱的[1;37m巨之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[35m标准[2;37;0m 
