...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[35m九龙之肚带[2;37;0m这是一条由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤六两零钱的[35m九龙之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m 
...
//伤害防御类
    set("armor_prop/deep_injure", 12);
    set("armor_prop/week_injure", 0);
    set("armor_prop/abs_week_injure", 0);
    set("armor_prop/defense_attack", 11);
