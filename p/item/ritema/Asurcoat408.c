...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;37m八卦有“休”“生”“伤”“杜”“死”“景”“惊”“开”之别，创自诸葛武候，集天下万变于一身！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤九两六钱的[1;37m八卦之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m创世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/hammer", 23);
    set("armor_prop/spear", 43);
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 15);
    ...
    set("armor_prop/max_busy_fenjin", 10);
