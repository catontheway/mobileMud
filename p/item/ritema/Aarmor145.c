...
void create()
{
	      set_name("[1;32m烟雨之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
烟雨之披风[2;37;0m这是一件由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤四两三钱的[1;32m烟雨之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
