...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m干将威力无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤四两四钱的[31m干将之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m 
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 36000);
                  //  基础类
  set("forge/max", 238);
  set("forge/times_max", 238);
  set("level", 238);

     set("armor_prop/damage", 238);
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 22);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 45);
