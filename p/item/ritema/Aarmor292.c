...
void create()
{
	      set_name("[1;34m贺兰之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
贺兰之披风[2;37;0m这是一件由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两二钱的[1;34m贺兰之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m毁天[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
