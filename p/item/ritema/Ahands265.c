...
void create()
{
	      set_name("[34m清水之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
清水之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤零两六钱的[34m清水之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[35m标准[2;37;0m 
