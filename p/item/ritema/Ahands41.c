...
void create()
{
	      set_name("[37m怪之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
怪之手套[2;37;0m这是一副由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤六两二钱的[37m怪之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[35m标准[2;37;0m [40m地[2;37;0m:[36m不错[2;37;0m 
