...
void create()
{
	      set_name("[1;31m起云之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
起云之腰带[2;37;0m这是一条由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两七钱的[1;31m起云之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m 
