...
void create()
{
	      set_name("[33m冬雨之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
冬雨之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两四钱的[33m冬雨之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m [40m地[2;37;0m:[1;36m完美[2;37;0m 
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 9000);
                  //  基础类
  set("forge/max", 176);
  set("forge/times_max", 176);
  set("level", 176);

     set("armor_prop/damage", 176);
