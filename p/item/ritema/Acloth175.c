...
void create()
{
	      set_name("[1;31m黑云之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
黑云之服装[2;37;0m这是一件由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重三斤零两四钱的[1;31m黑云之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[31m精致[2;37;0m 
