...
void create()
{
	      set_name("[1;35m翡翠之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
翡翠之项链[2;37;0m这是一串由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两四钱的[1;35m翡翠之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m 
