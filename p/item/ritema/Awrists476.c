...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤七两二钱的[31m龙泉之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/kf_anti_hr", 26);
//伤害防御类
    set("armor_prop/deep_injure", 0);
    set("armor_prop/week_injure", 0);
    set("armor_prop/abs_week_injure", 24);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 48);
