...
void create()
{
	      set_name("[1;33m狂龙之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
狂龙之项链[2;37;0m这是一串由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两五钱的[1;33m狂龙之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;31m无双[2;37;0m 
