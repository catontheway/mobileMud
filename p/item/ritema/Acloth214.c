...
void create()
{
	      set_name("[33m延永之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
延永之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤六两八钱的[33m延永之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [37m天[2;37;0m:[1;36m完美[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 3);
...
//伤害防御类
    ...
    set("armor_prop/abs_week_injure", 3);
