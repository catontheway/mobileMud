...
void create()
{
	      set_name("[31m无敌之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
无敌之护腕[2;37;0m这是一双由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤四两九钱的[31m无敌之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m天圣[2;37;0m 
