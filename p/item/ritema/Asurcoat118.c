...
void create()
{
	      set_name("[1;35m旋风之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
旋风之肚带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两六钱的[1;35m旋风之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[35m标准[2;37;0m 
