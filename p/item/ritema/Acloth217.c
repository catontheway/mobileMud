...
void create()
{
	      set_name("[1;35m夜月之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
夜月之服装[2;37;0m这是一件由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两零钱的[1;35m夜月之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
