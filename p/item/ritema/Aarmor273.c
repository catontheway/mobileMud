...
void create()
{
	      set_name("[1;34m天竹之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
天竹之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两零钱的[1;34m天竹之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;35m绝世[2;37;0m [31m火[2;37;0m:[1;31m毁天[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
