...
void create()
{
	      set_name("[36m椒图之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
椒图之盾[2;37;0m这是一面由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤九两二钱的[36m椒图之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m 
