...
void create()
{
	      set_name("[1;34m龙头之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
龙头之盾[2;37;0m这是一面由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两一钱的[1;34m龙头之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m毁天[2;37;0m 
