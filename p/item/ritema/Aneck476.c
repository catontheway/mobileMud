...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一串由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤一两零钱的[31m纯钩之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;33m灭世[2;37;0m 
