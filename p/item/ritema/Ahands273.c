...
void create()
{
	      set_name("[33m盘古之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
盘古之手套[2;37;0m这是一副由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤零两五钱的[33m盘古之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
