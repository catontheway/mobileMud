...
void create()
{
	      set_name("[1;36m翠屏之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
翠屏之项链[2;37;0m这是一串由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两六钱的[1;36m翠屏之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[34m细碎[2;37;0m 
