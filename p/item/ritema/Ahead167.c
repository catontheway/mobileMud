...
void create()
{
	      set_name("[1;31m降魔之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
降魔之头盔[2;37;0m这是一顶由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两六钱的[1;31m降魔之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m 
