...
void create()
{
	      set_name("[37m断玉之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
断玉之盾[2;37;0m这是一面由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两四钱的[37m断玉之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[32m粗糙[2;37;0m [1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
