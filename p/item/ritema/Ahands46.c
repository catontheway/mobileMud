...
void create()
{
	      set_name("[1;33m怪之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
怪之手套[2;37;0m这是一副由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤七两九钱的[1;33m怪之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m [32m水[2;37;0m:[36m不错[2;37;0m 
