...
void create()
{
	      set_name("[1;37m白陽之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
白陽之头盔[2;37;0m这是一顶由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两三钱的[1;37m白陽之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[35m标准[2;37;0m 
