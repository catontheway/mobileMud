...
void create()
{
	      set_name("[31m东天之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
东天之服装[2;37;0m这是一件由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤一两八钱的[31m东天之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
