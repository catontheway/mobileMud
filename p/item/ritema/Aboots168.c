...
void create()
{
	      set_name("[1;34m火薇之靴[2;37;0m", ({ "general boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
火薇之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两二钱的[1;34m火薇之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#
