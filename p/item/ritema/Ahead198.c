...
void create()
{
	      set_name("[1;34m月龙之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
月龙之头盔[2;37;0m这是一顶由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两九钱的[1;34m月龙之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m [31m火[2;37;0m:[34m细碎[2;37;0m 
