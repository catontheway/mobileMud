...
void create()
{
	      set_name("[34m月龙之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
月龙之盾[2;37;0m这是一面由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤六两二钱的[34m月龙之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[33m很高[2;37;0m 
