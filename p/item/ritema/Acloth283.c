...
void create()
{
	      set_name("[36m仙雨之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
仙雨之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤一两一钱的[36m仙雨之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
