...
void create()
{
	      set_name("[31m魔竹之头盔[2;37;0m", ({ "good head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
魔竹之头盔[2;37;0m这是一顶由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两一钱的[31m魔竹之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [37m天[2;37;0m:[1;31m无双[2;37;0m 
