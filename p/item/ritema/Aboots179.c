...
void create()
{
	      set_name("[1;32m青鶴之靴[2;37;0m", ({ "general boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
青鶴之靴[2;37;0m这是一双由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两八钱的[1;32m青鶴之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;36m完美[2;37;0m 
