...
void create()
{
	      set_name("[31m娥眉之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
娥眉之盾[2;37;0m这是一面由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤六两零钱的[31m娥眉之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#[1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
