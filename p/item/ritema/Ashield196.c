...
void create()
{
	      set_name("[34m文昌之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
文昌之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两一钱的[34m文昌之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
