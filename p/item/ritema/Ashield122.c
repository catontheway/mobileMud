...
void create()
{
	      set_name("[1;33m松峦之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
松峦之盾[2;37;0m这是一面由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤一两四钱的[1;33m松峦之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
