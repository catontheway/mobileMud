...
void create()
{
	      set_name("[33m小之靴[2;37;0m", ({ "bad boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
小之靴[2;37;0m这是一双由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤五两零钱的[33m小之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m [1;34m电[2;37;0m:[33m很高[2;37;0m 
