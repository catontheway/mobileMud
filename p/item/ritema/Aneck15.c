...
void create()
{
	      set_name("[34m小之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
小之项链[2;37;0m这是一串由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两五钱的[34m小之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m 
