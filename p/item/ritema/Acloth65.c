...
void create()
{
	      set_name("[31m小之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
小之服装[2;37;0m这是一件由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤七两八钱的[31m小之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m 
