...
void create()
{
	      set_name("[1;33m怪之靴[2;37;0m", ({ "bad boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
怪之靴[2;37;0m这是一双由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤三两九钱的[1;33m怪之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m 
