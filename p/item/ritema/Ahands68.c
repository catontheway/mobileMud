...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
柔之手套[2;37;0m这是一副由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤零两三钱的[1;36m柔之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m [1;36m人[2;37;0m:[33m很高[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_jiemai", 2);
