...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[1;36m	笑江湖浪迹十年游，空负少年头。$br#对铜陀巷泊，吟情渺渺，心事悠悠！ $br#酒令诗残梦断，南国正清愁。 $br#把剑凄然望，无处招归舟。 $br#明月天涯路远，问谁留楚佩，弄影中洲？$br#数英雄儿女，俯仰古今愁。$br#难消受灯昏罗帐，伥昙花一现恨难休！$br#飘零惯，金戈铁马，拼葬荒丘！ $br#[2;37;0m这是一串由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤一两零钱的[1;36m昆仑之项链[2;37;0m。$br#
