...
void create()
{
	      set_name("[1;37m紫芒之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
紫芒之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两二钱的[1;37m紫芒之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[40m地[2;37;0m:[1;31m开元[2;37;0m 
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 2000);
                  //  基础类
  set("forge/max", 146);
  set("forge/times_max", 146);
  set("level", 146);

     set("armor_prop/damage", 146);
