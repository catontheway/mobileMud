...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[35m天龙之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤零两六钱的[35m天龙之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m [1;36m人[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     set("armor_prop/attack_factor", 11);
