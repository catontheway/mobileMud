...
void create()
{
	      set_name("[33m开山之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
开山之腰带[2;37;0m这是一条由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两零钱的[33m开山之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m毁天[2;37;0m 
