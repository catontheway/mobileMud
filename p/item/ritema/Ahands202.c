...
void create()
{
	      set_name("[33m啸天之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
啸天之手套[2;37;0m这是一副由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两一钱的[33m啸天之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
