...
void create()
{
	      set_name("[1;34m晶电之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
晶电之披风[2;37;0m这是一件由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两五钱的[1;34m晶电之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;32m魔王[2;37;0m 
