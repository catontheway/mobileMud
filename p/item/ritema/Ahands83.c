...
void create()
{
	      set_name("[1;35m铁之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
铁之手套[2;37;0m这是一副由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤九两六钱的[1;35m铁之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [1;31m魔[2;37;0m:[32m粗糙[2;37;0m 
