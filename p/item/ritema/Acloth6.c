...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
巨之服装[2;37;0m这是一件由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤八两七钱的[1;34m巨之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[32m粗糙[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_confuse", 4);
