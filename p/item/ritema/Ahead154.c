...
void create()
{
	      set_name("[1;36m影残之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
影残之头盔[2;37;0m这是一顶由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤零两七钱的[1;36m影残之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[33m很高[2;37;0m 
