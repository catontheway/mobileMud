...
void create()
{
	      set_name("[37m必胜之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
必胜之披风[2;37;0m这是一件由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤一两二钱的[37m必胜之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m 
