...
void create()
{
	      set_name("[36m望月之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
望月之项链[2;37;0m这是一串由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤一两九钱的[36m望月之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m [1;34m电[2;37;0m:[1;31m创世[2;37;0m 
