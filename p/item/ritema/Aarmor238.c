...
void create()
{
	      set_name("[35m玉皇之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
玉皇之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤一两一钱的[35m玉皇之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;32m魔王[2;37;0m 
