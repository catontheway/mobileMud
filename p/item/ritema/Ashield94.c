...
void create()
{
	      set_name("[1;32m阖之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
阖之盾[2;37;0m这是一面由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤八两六钱的[1;32m阖之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[31m精致[2;37;0m 
