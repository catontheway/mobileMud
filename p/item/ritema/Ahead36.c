...
void create()
{
	      set_name("[1;31m大之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
大之头盔[2;37;0m这是一顶由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤零两五钱的[1;31m大之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m 
