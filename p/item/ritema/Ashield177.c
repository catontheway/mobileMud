...
void create()
{
	      set_name("[1;37m白陽之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
白陽之盾[2;37;0m这是一面由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤八两零钱的[1;37m白陽之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
