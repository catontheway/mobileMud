...
void create()
{
	      set_name("[1;37m宾之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
宾之服装[2;37;0m这是一件由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重三斤一两九钱的[1;37m宾之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m 
