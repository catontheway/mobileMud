...
void create()
{
	      set_name("[35m地狱之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
地狱之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两七钱的[35m地狱之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m毁天[2;37;0m [31m火[2;37;0m:[1;31m毁天[2;37;0m [33m土[2;37;0m:[1;33m天圣[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 9);
