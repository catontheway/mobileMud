...
void create()
{
	      set_name("[33m叠之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
叠之服装[2;37;0m这是一件由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤七两八钱的[33m叠之服装[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/max_busy_body", 2);
    set("armor_prop/AllPoisonsImmune", 2);
    set("armor_prop/PoisonAttack", 0);
    set("armor_prop/kf_hit_rate", 0);
    set("armor_prop/kf_anti_hr", 0);
//伤害防御类
    set("armor_prop/deep_injure", 2);
