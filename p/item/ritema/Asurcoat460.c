...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[31m湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤九两一钱的[31m湛卢之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
...
//伤害防御类
    ...
    set("armor_prop/abs_week_injure", 30);
    ...
    set("armor_prop/attack_speed", 0);
     ...
     set("armor_prop/dodge_factor", 25);
//气血恢复治疗类
