...
void create()
{
	      set_name("[33m裂心之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
裂心之腰带[2;37;0m这是一条由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两零钱的[33m裂心之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m开元[2;37;0m 
