...
void create()
{
	      set_name("[31m千芒之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
千芒之项链[2;37;0m这是一串由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两九钱的[31m千芒之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;36m完美[2;37;0m 
