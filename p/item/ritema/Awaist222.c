...
void create()
{
	      set_name("[37m深渊之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
深渊之腰带[2;37;0m这是一条由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两四钱的[37m深渊之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m [1;34m电[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;31m无双[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/AllPoisonsImmune", 17);
