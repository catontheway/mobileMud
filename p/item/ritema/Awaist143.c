...
void create()
{
	      set_name("[37m集仙之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
集仙之腰带[2;37;0m这是一条由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两九钱的[37m集仙之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m 
