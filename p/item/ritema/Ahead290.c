...
void create()
{
	      set_name("[1;36m深渊之头盔[2;37;0m", ({ "good head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
深渊之头盔[2;37;0m这是一顶由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤四两一钱的[1;36m深渊之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m 
