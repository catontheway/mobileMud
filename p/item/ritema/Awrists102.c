...
void create()
{
	      set_name("[1;35m聚鹤之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
聚鹤之护腕[2;37;0m这是一双由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两四钱的[1;35m聚鹤之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m 
