...
void create()
{
	      set_name("[34m叠之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
叠之服装[2;37;0m这是一件由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重三斤一两三钱的[34m叠之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[32m粗糙[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/hammer", 5);
    set("armor_prop/spear", 0);
    set("armor_prop/throwing", 3);
...
//气血恢复治疗类
    set("armor_prop/max_qi", 2);
    set("armor_prop/max_jing", 0);
    set("armor_prop/neili_recover", 3);
