...
void create()
{
	      set_name("[1;33m啼莺之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
啼莺之护腕[2;37;0m这是一双由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两五钱的[1;33m啼莺之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m 
