...
void create()
{
	      set_name("[33m铜之肚带[2;37;0m", ({ "bad surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
铜之肚带[2;37;0m这是一条由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤三两二钱的[33m铜之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#[37m天[2;37;0m:[31m精致[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/armor_vs_force", 5);
