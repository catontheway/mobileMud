...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[31m干将威力无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一面由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤九两零钱的[31m干将之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [36m木[2;37;0m:[1;33m天圣[2;37;0m [37m天[2;37;0m:[1;36m完美[2;37;0m [1;36m人[2;37;0m:[1;31m创世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 9);
