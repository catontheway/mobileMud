...
void create()
{
	      set_name("[33m浮云之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
浮云之腰带[2;37;0m这是一条由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两三钱的[33m浮云之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m 
