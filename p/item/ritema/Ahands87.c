...
void create()
{
	      set_name("[34m叠之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
叠之手套[2;37;0m这是一副由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤一两二钱的[34m叠之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[32m粗糙[2;37;0m 
