...
void create()
{
	      set_name("[1;31m翠屏之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
翠屏之盾[2;37;0m这是一面由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤六两零钱的[1;31m翠屏之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [36m木[2;37;0m:[1;32m魔王[2;37;0m 
