...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤六两四钱的[31m太阿之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 49);
