...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;32m青萍之肚带[2;37;0m这是一条由十分坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两七钱的[1;32m青萍之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spirituality", 21);
