...
void create()
{
	      set_name("[1;36m怪之腰带[2;37;0m", ({ "bad waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
怪之腰带[2;37;0m这是一条由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤六两三钱的[1;36m怪之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[33m很高[2;37;0m 
