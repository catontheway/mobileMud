...
void create()
{
	      set_name("[33m弯月之靴[2;37;0m", ({ "good boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
弯月之靴[2;37;0m这是一双由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两零钱的[33m弯月之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
