...
void create()
{
	      set_name("[36m阔之靴[2;37;0m", ({ "bad boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
阔之靴[2;37;0m这是一双由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤零两九钱的[36m阔之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[36m不错[2;37;0m 
