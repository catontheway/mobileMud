...
void create()
{
	      set_name("[1;32m玫瑰之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
玫瑰之服装[2;37;0m这是一件由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重三斤零两零钱的[1;32m玫瑰之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#
