...
void create()
{
	      set_name("[1;31m小之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
小之项链[2;37;0m这是一串由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤一两六钱的[1;31m小之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[34m细碎[2;37;0m [1;31m魔[2;37;0m:[36m不错[2;37;0m 
