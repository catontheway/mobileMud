...
void create()
{
	      set_name("[1;34m巧之靴[2;37;0m", ({ "bad boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
巧之靴[2;37;0m这是一双由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤八两九钱的[1;34m巧之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[35m标准[2;37;0m $br#[1;34m电[2;37;0m:[36m不错[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_body", 3);
