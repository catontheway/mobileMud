...
void create()
{
	      set_name("[1;32m蝙蝠之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
蝙蝠之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤六两二钱的[1;32m蝙蝠之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[34m细碎[2;37;0m [37m天[2;37;0m:[35m标准[2;37;0m 
