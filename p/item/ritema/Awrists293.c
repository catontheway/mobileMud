...
void create()
{
	      set_name("[1;33m怒涛之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
怒涛之护腕[2;37;0m这是一双由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两九钱的[1;33m怒涛之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m创世[2;37;0m [37m天[2;37;0m:[1;35m绝世[2;37;0m [1;36m人[2;37;0m:[1;31m创世[2;37;0m 
