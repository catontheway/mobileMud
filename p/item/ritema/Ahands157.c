...
void create()
{
	      set_name("[1;34m集仙之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
集仙之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两四钱的[1;34m集仙之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m [1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
