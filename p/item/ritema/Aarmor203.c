...
void create()
{
	      set_name("[1;34m猛虎之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
猛虎之披风[2;37;0m这是一件由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两六钱的[1;34m猛虎之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
