...
void create()
{
	      set_name("[36m相思之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
相思之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两五钱的[36m相思之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [33m土[2;37;0m:[1;35m绝世[2;37;0m 
