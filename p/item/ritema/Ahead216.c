...
void create()
{
	      set_name("[1;37m赤云之头盔[2;37;0m", ({ "good head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
赤云之头盔[2;37;0m这是一顶由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两六钱的[1;37m赤云之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m 
