...
void create()
{
	      set_name("[36m暗光之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
暗光之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两七钱的[36m暗光之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;31m无双[2;37;0m 
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 9000);
                  //  基础类
  set("forge/max", 168);
  set("forge/times_max", 168);
  set("level", 168);

     set("armor_prop/damage", 168);
