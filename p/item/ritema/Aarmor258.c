...
void create()
{
	      set_name("[1;36m贺兰之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
贺兰之披风[2;37;0m这是一件由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两八钱的[1;36m贺兰之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;36m完美[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m 
