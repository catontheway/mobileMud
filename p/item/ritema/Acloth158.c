...
void create()
{
	      set_name("[33m芍药之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
芍药之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤四两七钱的[33m芍药之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 9);
    ...
    set("armor_prop/max_busy_jiemai", 9);
    set("armor_prop/max_busy_fenjin", 0);
    set("armor_prop/max_busy_confuse", 9);
