...
void create()
{
	      set_name("[1;32m玫瑰之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
玫瑰之项链[2;37;0m这是一串由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤四两五钱的[1;32m玫瑰之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m [1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#[1;36m人[2;37;0m:[33m很高[2;37;0m 
