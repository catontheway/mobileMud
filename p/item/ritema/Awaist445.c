...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;32m此物已达出神入化，登峰造极，神乎其神之境界！俗说万物归宗，便是这“无极”！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤四两四钱的[1;32m无极之腰带[2;37;0m。$br#
...
//伤害防御类
    ...
    set("armor_prop/defense_attack", 21);
