...
void create()
{
	      set_name("[1;33m阔之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
阔之项链[2;37;0m这是一串由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤七两三钱的[1;33m阔之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[36m不错[2;37;0m 
