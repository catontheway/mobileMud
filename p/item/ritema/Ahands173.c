...
void create()
{
	      set_name("[36m霞蔚之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
霞蔚之手套[2;37;0m这是一副由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两零钱的[36m霞蔚之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;36m完美[2;37;0m 
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 2000);
                  //  基础类
  set("forge/max", 148);
  set("forge/times_max", 148);
  set("level", 148);

     set("armor_prop/damage", 148);
...
//伤害防御类
    ...
    set("armor_prop/armor_vs_force", 9);
