...
void create()
{
	      set_name("[31m雷霆之头盔[2;37;0m", ({ "good head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
雷霆之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两六钱的[31m雷霆之头盔[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 8);
