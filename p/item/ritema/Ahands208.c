...
void create()
{
	      set_name("[34m春兰之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
春兰之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两七钱的[34m春兰之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;31m开元[2;37;0m 
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 9000);
                  //  基础类
  set("forge/max", 170);
  set("forge/times_max", 170);
  set("level", 170);

     set("armor_prop/damage", 170);
