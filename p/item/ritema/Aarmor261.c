...
void create()
{
	      set_name("[1;32m鬼王之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
鬼王之披风[2;37;0m这是一件由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两二钱的[1;32m鬼王之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m 
