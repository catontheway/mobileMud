...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;32m此物已达出神入化，登峰造极，神乎其神之境界！俗说万物归宗，便是这“无极”！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤六两四钱的[1;32m无极之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;35m绝世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_jiemai", 19);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 22);
