...
void create()
{
	      set_name("[1;32m浮云之肚带[2;37;0m", ({ "good surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
浮云之肚带[2;37;0m这是一条由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两八钱的[1;32m浮云之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[35m标准[2;37;0m 
