...
void create()
{
	      set_name("[34m飞星之靴[2;37;0m", ({ "general boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
飞星之靴[2;37;0m这是一双由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两一钱的[34m飞星之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
