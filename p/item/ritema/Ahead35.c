...
void create()
{
	      set_name("[31m小之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
小之头盔[2;37;0m这是一顶由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两七钱的[31m小之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[32m粗糙[2;37;0m 
