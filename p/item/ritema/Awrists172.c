...
void create()
{
	      set_name("[1;36m文昌之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
文昌之护腕[2;37;0m这是一双由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两三钱的[1;36m文昌之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m 
