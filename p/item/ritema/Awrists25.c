...
void create()
{
	      set_name("[1;35m铁之护腕[2;37;0m", ({ "bad wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
铁之护腕[2;37;0m这是一双由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤九两七钱的[1;35m铁之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#
