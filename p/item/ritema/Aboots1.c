...
void create()
{
	      set_name("[1;32m铜之靴[2;37;0m", ({ "bad boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
铜之靴[2;37;0m这是一双由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两四钱的[1;32m铜之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[34m细碎[2;37;0m 
