...
void create()
{
	      set_name("[1;37m赤霞之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
赤霞之盾[2;37;0m这是一面由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤二两七钱的[1;37m赤霞之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
