...
void create()
{
	      set_name("[33m怪之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
怪之头盔[2;37;0m这是一顶由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤七两一钱的[33m怪之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[33m很高[2;37;0m 
