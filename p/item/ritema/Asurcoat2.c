...
void create()
{
	      set_name("[34m柔之肚带[2;37;0m", ({ "bad surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
柔之肚带[2;37;0m这是一条由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两零钱的[34m柔之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[32m粗糙[2;37;0m 
