...
void create()
{
	      set_name("[1;34m天秤之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
天秤之护腕[2;37;0m这是一双由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两五钱的[1;34m天秤之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m 
