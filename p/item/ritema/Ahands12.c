...
void create()
{
	      set_name("[1;35m柔之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
柔之手套[2;37;0m这是一副由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤二两一钱的[1;35m柔之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m 
