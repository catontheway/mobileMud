...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[34m恶鬼之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤六两一钱的[34m恶鬼之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 20);
