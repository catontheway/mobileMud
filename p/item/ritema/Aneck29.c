...
void create()
{
	      set_name("[31m铜之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
铜之项链[2;37;0m这是一串由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤五两四钱的[31m铜之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[34m细碎[2;37;0m [1;37m雷[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[32m粗糙[2;37;0m 
