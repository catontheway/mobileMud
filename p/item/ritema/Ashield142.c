...
void create()
{
	      set_name("[1;31m飞星之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
飞星之盾[2;37;0m这是一面由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤三两六钱的[1;31m飞星之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m 
