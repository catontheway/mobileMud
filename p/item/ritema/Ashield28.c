...
void create()
{
	      set_name("[1;35m阖之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
阖之盾[2;37;0m这是一面由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤四两一钱的[1;35m阖之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[36m不错[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_jiemai", 4);
