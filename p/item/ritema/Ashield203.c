...
void create()
{
	      set_name("[35m浮云之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
浮云之盾[2;37;0m这是一面由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两四钱的[35m浮云之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;33m天圣[2;37;0m 
