...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;32m九天之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两九钱的[1;32m九天之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m [1;37m雷[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_body", 10);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 32);
    set("armor_prop/qi_recover", 0);
    set("armor_prop/jing_recover", 23);
