...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
韧之手套[2;37;0m这是一副由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤一两六钱的[1;36m韧之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m [40m地[2;37;0m:[32m粗糙[2;37;0m 
