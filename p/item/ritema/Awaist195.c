...
void create()
{
	      set_name("[1;37m聚泉之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
聚泉之腰带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两六钱的[1;37m聚泉之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m开元[2;37;0m [1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#[37m天[2;37;0m:[1;32m魔王[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
