...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
大之头盔[2;37;0m这是一顶由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤三两一钱的[1;33m大之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [40m地[2;37;0m:[32m粗糙[2;37;0m [1;36m人[2;37;0m:[36m不错[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 4);
    set("armor_prop/qi_recover", 0);
    set("armor_prop/jing_recover", 6);
    set("armor_prop/jingli_recover", 0);
    set("armor_prop/qi_cure", 1);
