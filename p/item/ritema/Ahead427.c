...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;33m此物左右两边分别以黑白两种奇铁溶铸而成，一黑一白，切合乾坤，包含阴阳之气，好一柄宝物！$br#[2;37;0m这是一顶由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤七两四钱的[1;33m乾坤之头盔[2;37;0m。$br#
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 38);
    set("armor_prop/jingli_recover", 21);
