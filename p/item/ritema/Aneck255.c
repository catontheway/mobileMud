...
void create()
{
	      set_name("[1;37m神竹之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
神竹之项链[2;37;0m这是一串由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两二钱的[1;37m神竹之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m天圣[2;37;0m 
