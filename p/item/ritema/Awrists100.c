...
void create()
{
	      set_name("[1;35m月龙之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
月龙之护腕[2;37;0m这是一双由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两七钱的[1;35m月龙之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [33m土[2;37;0m:[1;32m魔王[2;37;0m [1;34m电[2;37;0m:[1;31m开元[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_body", 9);
    set("armor_prop/max_all_busy", 0);
    set("armor_prop/max_busy_dianxue", 0);
    set("armor_prop/max_busy_jiemai", 12);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 14);
