...
void create()
{
	      set_name("[1;32m螭吻之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
螭吻之护腕[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两六钱的[1;32m螭吻之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;33m天圣[2;37;0m 
