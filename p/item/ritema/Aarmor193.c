...
void create()
{
	      set_name("[1;36m撼山之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
撼山之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两四钱的[1;36m撼山之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
