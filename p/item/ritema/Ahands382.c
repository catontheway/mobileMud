...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[36m天后之手套[2;37;0m这是一副由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤七两二钱的[36m天后之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 16000);
                  //  基础类
  set("forge/max", 198);
  set("forge/times_max", 198);
  set("level", 198);

     set("armor_prop/damage", 198);
