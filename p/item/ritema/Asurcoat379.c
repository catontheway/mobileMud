...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[36m青虹之肚带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两五钱的[36m青虹之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_fenjin", 16);
...
//气血恢复治疗类
    ...
    set("armor_prop/max_jing", 15);
    set("armor_prop/neili_recover", 0);
    set("armor_prop/qi_recover", 25);
    set("armor_prop/jing_recover", 18);
    set("armor_prop/jingli_recover", 7);
    set("armor_prop/qi_cure", 0);
    set("armor_prop/jing_cure", 15);
