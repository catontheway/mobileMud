...
void create()
{
	      set_name("[31m明月之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
明月之盾[2;37;0m这是一面由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两九钱的[31m明月之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m开元[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
