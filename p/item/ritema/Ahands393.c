...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[36m白虹之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两三钱的[36m白虹之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m开元[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 16000);
                  //  基础类
  set("forge/max", 196);
  set("forge/times_max", 196);
  set("level", 196);

     set("armor_prop/damage", 196);
     set("armor_prop/attack", 0);
     set("armor_prop/defense", 0);
     set("armor_prop/armor", 34);
     set("armor_prop/magic", 18);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 28);
