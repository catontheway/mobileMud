...
void create()
{
	      set_name("[35m芍药之靴[2;37;0m", ({ "general boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
芍药之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两七钱的[35m芍药之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[31m精致[2;37;0m 
