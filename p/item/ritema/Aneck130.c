...
void create()
{
	      set_name("[1;32m火陽之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
火陽之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两九钱的[1;32m火陽之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [1;37m雷[2;37;0m:[1;33m天圣[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 11);
