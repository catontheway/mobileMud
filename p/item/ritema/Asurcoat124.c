...
void create()
{
	      set_name("[1;34m千芒之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
千芒之肚带[2;37;0m这是一条由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两三钱的[1;34m千芒之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m 
