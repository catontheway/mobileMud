...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
铁之手套[2;37;0m这是一副由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤五两五钱的[1;34m铁之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [1;31m魔[2;37;0m:[34m细碎[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 1);
