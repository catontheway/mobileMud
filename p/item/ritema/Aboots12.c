...
void create()
{
	      set_name("[31m柔之靴[2;37;0m", ({ "bad boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
柔之靴[2;37;0m这是一双由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤三两五钱的[31m柔之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[36m不错[2;37;0m [37m天[2;37;0m:[36m不错[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_fenjin", 4);
