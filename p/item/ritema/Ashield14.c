...
void create()
{
	      set_name("[37m怪之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
怪之盾[2;37;0m这是一面由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤八两零钱的[37m怪之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[34m细碎[2;37;0m [1;36m人[2;37;0m:[35m标准[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_confuse", 1);
