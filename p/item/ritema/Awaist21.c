...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
铁之腰带[2;37;0m这是一条由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤零两九钱的[33m铁之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_body", 1);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 5);
