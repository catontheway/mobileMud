...
void create()
{
	      set_name("[35m巧之腰带[2;37;0m", ({ "bad waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
巧之腰带[2;37;0m这是一条由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤九两零钱的[35m巧之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[35m标准[2;37;0m [40m地[2;37;0m:[34m细碎[2;37;0m 
