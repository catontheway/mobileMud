...
void create()
{
	      set_name("[33m月季之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
月季之护腕[2;37;0m这是一双由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两二钱的[33m月季之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m 
