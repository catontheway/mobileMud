...
void create()
{
	      set_name("[1;34m白鶴之靴[2;37;0m", ({ "general boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
白鶴之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两一钱的[1;34m白鶴之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#
