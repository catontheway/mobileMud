...
void create()
{
	      set_name("[37m钢之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
钢之手套[2;37;0m这是一副由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两七钱的[37m钢之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[34m细碎[2;37;0m 
