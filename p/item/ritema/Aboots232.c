...
void create()
{
	      set_name("[1;33m白云之靴[2;37;0m", ({ "good boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
白云之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两八钱的[1;33m白云之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[32m粗糙[2;37;0m 
