...
void create()
{
	      set_name("[1;36m戈壁之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
戈壁之肚带[2;37;0m这是一条由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两六钱的[1;36m戈壁之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[34m细碎[2;37;0m 
