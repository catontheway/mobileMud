...
void create()
{
	      set_name("[1;32m蜍夏之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
蜍夏之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两五钱的[1;32m蜍夏之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[1;34m举世[2;37;0m [1;36m人[2;37;0m:[1;36m完美[2;37;0m 
