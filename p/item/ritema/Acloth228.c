...
void create()
{
	      set_name("[33m竹叶之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
竹叶之服装[2;37;0m这是一件由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤九两四钱的[33m竹叶之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;36m完美[2;37;0m [1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [1;34m电[2;37;0m:[1;34m举世[2;37;0m 
