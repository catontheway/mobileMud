...
void create()
{
	      set_name("[1;32m铜之披风[2;37;0m", ({ "bad armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
铜之披风[2;37;0m这是一件由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤零两一钱的[1;32m铜之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[36m不错[2;37;0m [1;37m雷[2;37;0m:[33m很高[2;37;0m [40m地[2;37;0m:[32m粗糙[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 4);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 3);
