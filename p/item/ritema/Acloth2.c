...
void create()
{
	      set_name("[1;31m柔之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
柔之服装[2;37;0m这是一件由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重三斤一两零钱的[1;31m柔之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[32m粗糙[2;37;0m 
