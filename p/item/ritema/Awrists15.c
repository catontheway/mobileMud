...
void create()
{
	      set_name("[1;31m怪之护腕[2;37;0m", ({ "bad wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
怪之护腕[2;37;0m这是一双由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤八两一钱的[1;31m怪之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[32m粗糙[2;37;0m 
