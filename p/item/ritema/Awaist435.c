...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;31m天兵神通，走势要平善，气要随行，两眼顾尖，气沉两足稳，身法需自然，身行如飞燕，身落如停风，收如花絮，刺如钢钉！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤八两七钱的[1;31m神通之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;31m开元[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 22);
