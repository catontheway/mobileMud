...
void create()
{
	      set_name("[35m天门之头盔[2;37;0m", ({ "good head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
天门之头盔[2;37;0m这是一顶由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两六钱的[35m天门之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m 
