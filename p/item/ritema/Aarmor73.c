...
void create()
{
	      set_name("[1;34m韧之披风[2;37;0m", ({ "bad armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
韧之披风[2;37;0m这是一件由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤二两五钱的[1;34m韧之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[34m细碎[2;37;0m 
