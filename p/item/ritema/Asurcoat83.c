...
void create()
{
	      set_name("[1;32m大之肚带[2;37;0m", ({ "bad surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
大之肚带[2;37;0m这是一条由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤九两七钱的[1;32m大之肚带[2;37;0m。$br#
