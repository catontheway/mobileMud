...
void create()
{
	      set_name("[1;33m扣骨之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
扣骨之服装[2;37;0m这是一件由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤六两四钱的[1;33m扣骨之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [33m土[2;37;0m:[1;32m魔王[2;37;0m 
