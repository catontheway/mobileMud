...
void create()
{
	      set_name("[35m巨之靴[2;37;0m", ({ "bad boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
巨之靴[2;37;0m这是一双由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤一两七钱的[35m巨之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m [1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#
