...
void create()
{
	      set_name("[36m璨星之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
璨星之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤二两七钱的[36m璨星之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[33m很高[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_body", 2);
