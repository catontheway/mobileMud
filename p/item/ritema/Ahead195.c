...
void create()
{
	      set_name("[34m四季之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
四季之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤四两八钱的[34m四季之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[35m标准[2;37;0m $br#
