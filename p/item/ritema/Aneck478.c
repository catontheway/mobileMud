...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一串由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤零两七钱的[31m纯钩之项链[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/max_all_busy", 25);
