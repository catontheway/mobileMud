...
void create()
{
	      set_name("[36m盘古之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
盘古之项链[2;37;0m这是一串由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两八钱的[36m盘古之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m 
