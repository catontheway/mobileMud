...
void create()
{
	      set_name("[33m猛虎之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
猛虎之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重三斤零两五钱的[33m猛虎之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m毁天[2;37;0m 
