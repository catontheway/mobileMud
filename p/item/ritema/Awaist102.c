...
void create()
{
	      set_name("[36m百合之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
百合之腰带[2;37;0m这是一条由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两二钱的[36m百合之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[33m很高[2;37;0m 
