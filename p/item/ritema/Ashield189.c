...
void create()
{
	      set_name("[1;35m矗页之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
矗页之盾[2;37;0m这是一面由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤四两八钱的[1;35m矗页之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m 
