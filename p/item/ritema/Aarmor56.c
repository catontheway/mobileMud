...
void create()
{
	      set_name("[1;32m小之披风[2;37;0m", ({ "bad armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
小之披风[2;37;0m这是一件由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤六两零钱的[1;32m小之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[34m细碎[2;37;0m $br#
