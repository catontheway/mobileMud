...
void create()
{
	      set_name("[1;32m上升之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
上升之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重三斤零两一钱的[1;32m上升之服装[2;37;0m。$br#
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 5);
