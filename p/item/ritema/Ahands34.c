...
void create()
{
	      set_name("[1;33m钢之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
钢之手套[2;37;0m这是一副由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤六两六钱的[1;33m钢之手套[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 1);
    ...
    set("armor_prop/max_busy_dianxue", 2);
