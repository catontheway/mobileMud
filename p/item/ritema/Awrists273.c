...
void create()
{
	      set_name("[34m龟文之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
龟文之护腕[2;37;0m这是一双由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两二钱的[34m龟文之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
