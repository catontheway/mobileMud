...
void create()
{
	      set_name("[34m叠之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
叠之盾[2;37;0m这是一面由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤九两零钱的[34m叠之盾[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 2);
