...
void create()
{
	      set_name("[1;31m蔷薇之靴[2;37;0m", ({ "general boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
蔷薇之靴[2;37;0m这是一双由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤零两四钱的[1;31m蔷薇之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m 
