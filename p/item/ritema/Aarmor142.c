...
void create()
{
	      set_name("[1;32m天师之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
天师之披风[2;37;0m这是一件由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤零两五钱的[1;32m天师之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#[37m天[2;37;0m:[1;36m完美[2;37;0m [1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
