...
void create()
{
	      set_name("[1;36m落雪之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
落雪之肚带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤零两七钱的[1;36m落雪之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m 
