...
void create()
{
	      set_name("[1;37m飞雪之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
飞雪之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两一钱的[1;37m飞雪之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m [1;36m人[2;37;0m:[1;36m完美[2;37;0m 
