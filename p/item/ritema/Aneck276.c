...
void create()
{
	      set_name("[34m流水之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
流水之项链[2;37;0m这是一串由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两零钱的[34m流水之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;32m魔王[2;37;0m 
