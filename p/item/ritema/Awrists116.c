...
void create()
{
	      set_name("[1;35m摘星之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
摘星之护腕[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两一钱的[1;35m摘星之护腕[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 3);
