...
void create()
{
	      set_name("[1;33m魔竹之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
魔竹之披风[2;37;0m这是一件由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两六钱的[1;33m魔竹之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [33m土[2;37;0m:[1;32m魔王[2;37;0m [1;37m雷[2;37;0m:[35m标准[2;37;0m 
