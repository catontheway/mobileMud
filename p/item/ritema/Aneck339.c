...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[37m震电之项链[2;37;0m这是一串由相当坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两一钱的[37m震电之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#
