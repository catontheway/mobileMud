...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[36m王者之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤六两五钱的[36m王者之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m无双[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/max_jing", 9);
    set("armor_prop/neili_recover", 17);
