...
void create()
{
	      set_name("[1;31m阔之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
阔之头盔[2;37;0m这是一顶由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤八两六钱的[1;31m阔之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    //技能类
    set("armor_prop/claw", 1);
    set("armor_prop/cuff", 1);
