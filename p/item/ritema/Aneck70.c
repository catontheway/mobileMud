...
void create()
{
	      set_name("[35m宾之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
宾之项链[2;37;0m这是一串由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤八两二钱的[35m宾之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[32m粗糙[2;37;0m 
