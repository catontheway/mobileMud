...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
贺兰之项链[2;37;0m这是一串由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两三钱的[1;37m贺兰之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 14);
