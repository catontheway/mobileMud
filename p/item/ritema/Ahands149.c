...
void create()
{
	      set_name("[33m冰陽之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
冰陽之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两四钱的[33m冰陽之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 2000);
                  //  基础类
  set("forge/max", 154);
  set("forge/times_max", 154);
  set("level", 154);

     set("armor_prop/damage", 154);
