...
void create()
{
	      set_name("[37m钢之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
钢之项链[2;37;0m这是一串由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两零钱的[37m钢之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[36m不错[2;37;0m 
