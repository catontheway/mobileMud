...
void create()
{
	      set_name("[1;37m叠之披风[2;37;0m", ({ "bad armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
叠之披风[2;37;0m这是一件由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤七两四钱的[1;37m叠之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[36m不错[2;37;0m 
