...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[36m凝霜之盾[2;37;0m这是一面由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤六两六钱的[36m凝霜之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/throwing", 28);
    
    
   
//特效数值
    set("armor_prop/kf_def_wound", 17);
