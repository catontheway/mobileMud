...
void create()
{
	      set_name("[36m铁之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
铁之手套[2;37;0m这是一副由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤八两七钱的[36m铁之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[31m精致[2;37;0m 
