...
void create()
{
	      set_name("[36m铜之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
铜之盾[2;37;0m这是一面由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤五两二钱的[36m铜之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m 
