...
void create()
{
	      set_name("[36m撼山之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
撼山之盾[2;37;0m这是一面由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤六两一钱的[36m撼山之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m [37m天[2;37;0m:[1;36m完美[2;37;0m 
