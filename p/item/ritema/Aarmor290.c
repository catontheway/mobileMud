...
void create()
{
	      set_name("[33m神狮之披风[2;37;0m", ({ "good armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
神狮之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤零两四钱的[33m神狮之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;35m绝世[2;37;0m 
