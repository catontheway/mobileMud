...
void create()
{
	      set_name("[1;34m魔袱之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
魔袱之护腕[2;37;0m这是一双由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两零钱的[1;34m魔袱之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [31m火[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
