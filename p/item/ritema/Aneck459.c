...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一串由极其坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤九两二钱的[31m工布之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 18);
     ...
     set("armor_prop/dodge_factor", 28);
//气血恢复治疗类
