...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m巨阙坚硬无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤五两一钱的[31m巨阙之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
...
//特效数值
    set("armor_prop/kf_def_wound", 16);
    set("armor_prop/kf_wound", 0);
    set("armor_prop/cant_all_busy", 19);
    set("armor_prop/cant_busy_dianxue", 9);
    ...
    set("armor_prop/max_busy_jiemai", 16);
...
//伤害防御类
    ...
    set("armor_prop/week_injure", 18);
    set("armor_prop/abs_week_injure", 0);
    set("armor_prop/defense_attack", 0);
    set("armor_prop/armor_vs_force", 18);
    set("armor_prop/armor_effect_armor_vs_force", 13);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 19);
    set("armor_prop/qi_cure", 12);
