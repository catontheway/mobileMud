...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤六两四钱的[31m工布之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 26);
...
//气血恢复治疗类
    ...
    set("armor_prop/qi_cure", 39);
    set("armor_prop/jing_cure", 27);
