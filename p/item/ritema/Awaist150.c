...
void create()
{
	      set_name("[1;31m撼山之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
撼山之腰带[2;37;0m这是一条由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两四钱的[1;31m撼山之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m 
