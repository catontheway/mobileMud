...
void create()
{
	      set_name("[1;32m双锋之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
双锋之护腕[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两一钱的[1;32m双锋之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m创世[2;37;0m 
