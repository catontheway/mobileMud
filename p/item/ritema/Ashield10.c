...
void create()
{
	      set_name("[34m宾之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
宾之盾[2;37;0m这是一面由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤四两八钱的[34m宾之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[34m细碎[2;37;0m 
