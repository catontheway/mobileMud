...
void create()
{
	      set_name("[35m韧之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
韧之服装[2;37;0m这是一件由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤五两七钱的[35m韧之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m 
