...
void create()
{
	      set_name("[31m弦月之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
弦月之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤七两九钱的[31m弦月之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#[1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
