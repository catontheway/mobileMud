...
void create()
{
	      set_name("[1;35m赤云之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
赤云之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两二钱的[1;35m赤云之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m 
