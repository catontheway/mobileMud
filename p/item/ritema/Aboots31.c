...
void create()
{
	      set_name("[1;37m钢之靴[2;37;0m", ({ "bad boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
钢之靴[2;37;0m这是一双由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤七两六钱的[1;37m钢之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[33m很高[2;37;0m 
