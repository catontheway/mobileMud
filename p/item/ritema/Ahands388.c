...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[36m王者之手套[2;37;0m这是一副由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两一钱的[36m王者之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spirituality", 20);
		set("armor_prop/dexerity",0);
		set("armor_prop/constitution",0);
    //技能类
    set("armor_prop/claw", 18);
...
//特效数值
    ...
    set("armor_prop/max_busy_jiemai", 13);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 12);
