...
void create()
{
	      set_name("[31m阖之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
阖之项链[2;37;0m这是一串由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两零钱的[31m阖之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#
