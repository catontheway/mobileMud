...
void create()
{
	      set_name("[37m开山之头盔[2;37;0m", ({ "good head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
开山之头盔[2;37;0m这是一顶由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两八钱的[37m开山之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m开元[2;37;0m 
