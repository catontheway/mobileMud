...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[36m蓝虹之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两六钱的[36m蓝虹之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#
...
//特效数值
    ...
    set("armor_prop/max_busy_body", 20);
