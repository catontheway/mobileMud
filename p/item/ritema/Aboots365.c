...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[37m生死之靴[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两九钱的[37m生死之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [1;37m雷[2;37;0m:[1;31m无双[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spirituality", 19);
    ...
    set("armor_prop/unarmed", 32);
    set("armor_prop/blade", 15);
    set("armor_prop/whip", 0);
    set("armor_prop/staff", 14);
    set("armor_prop/force", 0);
    set("armor_prop/dagge", 15);
...
//伤害防御类
    ...
    set("armor_prop/armor_vs_force", 13);
