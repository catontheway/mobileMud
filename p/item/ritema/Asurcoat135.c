...
void create()
{
	      set_name("[34m天秤之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
天秤之肚带[2;37;0m这是一条由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两二钱的[34m天秤之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;34m举世[2;37;0m 
