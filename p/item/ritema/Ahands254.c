...
void create()
{
	      set_name("[1;32m地羽之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
地羽之手套[2;37;0m这是一副由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两零钱的[1;32m地羽之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[1;32m魔王[2;37;0m 
