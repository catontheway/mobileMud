...
void create()
{
	      set_name("[37m秀骨之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
秀骨之披风[2;37;0m这是一件由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两五钱的[37m秀骨之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m 
