...
void create()
{
	      set_name("[37m矗页之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
矗页之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重三斤一两三钱的[37m矗页之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[31m精致[2;37;0m 
