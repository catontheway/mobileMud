...
void create()
{
	      set_name("[33m松峦之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
松峦之披风[2;37;0m这是一件由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两八钱的[33m松峦之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;32m魔王[2;37;0m 
