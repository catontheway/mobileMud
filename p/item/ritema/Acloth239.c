...
void create()
{
	      set_name("[33m五步之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
五步之服装[2;37;0m这是一件由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重三斤零两一钱的[33m五步之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#
