...
void create()
{
	      set_name("[1;36m天师之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
天师之手套[2;37;0m这是一副由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两四钱的[1;36m天师之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;32m魔王[2;37;0m [1;37m雷[2;37;0m:[1;36m完美[2;37;0m 
