...
void create()
{
	      set_name("[36m竹之护腕[2;37;0m", ({ "bad wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
竹之护腕[2;37;0m这是一双由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤三两五钱的[36m竹之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[35m标准[2;37;0m 
