...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;36m大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”$br#[2;37;0m这是一顶由极为坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤一两四钱的[1;36m三清之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [32m水[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 23);
    set("armor_prop/cant_busy_confuse", 25);
...
//伤害防御类
    ...
    set("armor_prop/defense_attack", 25);
