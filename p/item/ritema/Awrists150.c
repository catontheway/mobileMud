...
void create()
{
	      set_name("[1;37m蓝薇之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
蓝薇之护腕[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两五钱的[1;37m蓝薇之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[34m细碎[2;37;0m 
