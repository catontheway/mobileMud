...
void create()
{
	      set_name("[1;34m双锋之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
双锋之腰带[2;37;0m这是一条由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两四钱的[1;34m双锋之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m [1;34m电[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;31m创世[2;37;0m 
