...
void create()
{
	      set_name("[1;31m铁之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
铁之盾[2;37;0m这是一面由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤九两零钱的[1;31m铁之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m 
