...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[33m鸿钧之项链[2;37;0m这是一串由相当坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两零钱的[33m鸿钧之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m无双[2;37;0m [40m地[2;37;0m:[1;31m开元[2;37;0m 
