...
void create()
{
	      set_name("[31m铁之腰带[2;37;0m", ({ "bad waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
铁之腰带[2;37;0m这是一条由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤五两零钱的[31m铁之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[32m粗糙[2;37;0m 
