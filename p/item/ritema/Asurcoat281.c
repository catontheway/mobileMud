...
void create()
{
	      set_name("[37m素臂之肚带[2;37;0m", ({ "good surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
素臂之肚带[2;37;0m这是一条由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两四钱的[37m素臂之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;35m绝世[2;37;0m 
