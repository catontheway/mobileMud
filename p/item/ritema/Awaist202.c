...
void create()
{
	      set_name("[31m天竹之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
天竹之腰带[2;37;0m这是一条由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤一两七钱的[31m天竹之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;34m举世[2;37;0m 
