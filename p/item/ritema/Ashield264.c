...
void create()
{
	      set_name("[1;37m日月之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
日月之盾[2;37;0m这是一面由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤七两五钱的[1;37m日月之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;32m魔王[2;37;0m 
