...
void create()
{
	      set_name("[31m天师之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
天师之盾[2;37;0m这是一面由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤六两零钱的[31m天师之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [1;34m电[2;37;0m:[1;31m无双[2;37;0m 
