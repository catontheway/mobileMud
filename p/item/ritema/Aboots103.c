...
void create()
{
	      set_name("[1;33m清相之靴[2;37;0m", ({ "general boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
清相之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两六钱的[1;33m清相之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[35m标准[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_jiemai", 5);
