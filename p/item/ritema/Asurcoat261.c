...
void create()
{
	      set_name("[1;32m蟠钢之肚带[2;37;0m", ({ "good surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
蟠钢之肚带[2;37;0m这是一条由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两四钱的[1;32m蟠钢之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m创世[2;37;0m 
