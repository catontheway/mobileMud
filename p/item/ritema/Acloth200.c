...
void create()
{
	      set_name("[1;34m神虎之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
神虎之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤九两七钱的[1;34m神虎之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m开元[2;37;0m [33m土[2;37;0m:[1;32m魔王[2;37;0m 
