...
void create()
{
	      set_name("[1;31m夺魂之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
夺魂之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两三钱的[1;31m夺魂之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;35m绝世[2;37;0m [40m地[2;37;0m:[1;35m绝世[2;37;0m 
