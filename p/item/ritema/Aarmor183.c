...
void create()
{
	      set_name("[1;34m双星之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
双星之披风[2;37;0m这是一件由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两三钱的[1;34m双星之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
