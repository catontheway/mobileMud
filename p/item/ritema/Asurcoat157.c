...
void create()
{
	      set_name("[36m紫芒之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
紫芒之肚带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两五钱的[36m紫芒之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[34m细碎[2;37;0m [36m木[2;37;0m:[35m标准[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
