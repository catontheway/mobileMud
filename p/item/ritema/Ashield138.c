...
void create()
{
	      set_name("[1;34m银铃之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
银铃之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤九两一钱的[1;34m银铃之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m 
