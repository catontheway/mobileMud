...
void create()
{
	      set_name("[1;37m宾之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
宾之手套[2;37;0m这是一副由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤五两五钱的[1;37m宾之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[35m标准[2;37;0m 
