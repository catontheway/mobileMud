...
void create()
{
	      set_name("[34m大之肚带[2;37;0m", ({ "bad surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
大之肚带[2;37;0m这是一条由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤六两三钱的[34m大之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/defense_attack", 2);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 6);
