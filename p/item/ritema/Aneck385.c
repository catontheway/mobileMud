...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[33m夜叉之项链[2;37;0m这是一串由相当坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两七钱的[33m夜叉之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [33m土[2;37;0m:[1;32m魔王[2;37;0m 
