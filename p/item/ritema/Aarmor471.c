...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤五两九钱的[31m胜邪之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m天圣[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 53);
