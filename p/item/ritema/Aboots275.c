...
void create()
{
	      set_name("[31m鬼雨之靴[2;37;0m", ({ "good boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
鬼雨之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两一钱的[31m鬼雨之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[31m精致[2;37;0m 
