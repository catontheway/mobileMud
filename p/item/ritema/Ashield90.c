...
void create()
{
	      set_name("[33m怪之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
怪之盾[2;37;0m这是一面由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤五两二钱的[33m怪之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[35m标准[2;37;0m $br#
