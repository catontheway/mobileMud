...
void create()
{
	      set_name("[34m卷云之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
卷云之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两四钱的[34m卷云之手套[2;37;0m。$br#
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 19);
