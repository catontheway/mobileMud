...
void create()
{
	      set_name("[31m韧之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
韧之服装[2;37;0m这是一件由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤五两四钱的[31m韧之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[34m细碎[2;37;0m $br#[1;36m人[2;37;0m:[33m很高[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 6);
    ...
    set("armor_prop/max_busy_body", 4);
...
//伤害防御类
    ...
    set("armor_prop/week_injure", 4);
    set("armor_prop/abs_week_injure", 0);
    set("armor_prop/defense_attack", 3);
