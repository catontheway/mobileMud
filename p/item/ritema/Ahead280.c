...
void create()
{
	      set_name("[37m鬼雨之头盔[2;37;0m", ({ "good head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
鬼雨之头盔[2;37;0m这是一顶由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两八钱的[37m鬼雨之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m毁天[2;37;0m 
