...
void create()
{
	      set_name("[1;32m漩流之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
漩流之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重三斤一两八钱的[1;32m漩流之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m [1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 4);
    set("armor_prop/cant_busy_dianxue", 0);
    set("armor_prop/cant_busy_jiemai", 3);
    ...
    set("armor_prop/AllPoisonsImmune", 5);
...
//伤害防御类
    ...
    set("armor_prop/defense_attack", 4);
