...
void create()
{
	      set_name("[1;36m绿影之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
绿影之服装[2;37;0m这是一件由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤七两八钱的[1;36m绿影之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;36m完美[2;37;0m 
