...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[35m凤凰之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤三两八钱的[35m凤凰之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/whip", 27);
    set("armor_prop/staff", 0);
    set("armor_prop/force", 29);
