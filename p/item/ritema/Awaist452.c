...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤一两一钱的[31m莫邪之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spirituality", 23);
...
//伤害防御类
    ...
    set("armor_prop/abs_week_injure", 25);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 29);
