...
void create()
{
	      set_name("[35m啸天之腰带[2;37;0m", ({ "good waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
啸天之腰带[2;37;0m这是一条由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两九钱的[35m啸天之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m 
