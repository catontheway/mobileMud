...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤二两零钱的[31m工布之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 52);
