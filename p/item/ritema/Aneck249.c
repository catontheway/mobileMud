...
void create()
{
	      set_name("[33m神狼之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
神狼之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两七钱的[33m神狼之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m创世[2;37;0m [1;37m雷[2;37;0m:[1;31m创世[2;37;0m 
