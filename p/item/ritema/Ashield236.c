...
void create()
{
	      set_name("[1;31m牛头之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
牛头之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤二两一钱的[1;31m牛头之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m无双[2;37;0m 
