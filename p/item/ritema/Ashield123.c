...
void create()
{
	      set_name("[1;35m魔袱之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
魔袱之盾[2;37;0m这是一面由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重三斤一两六钱的[1;35m魔袱之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m 
