...
void create()
{
	      set_name("[1;32m龙菊之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
龙菊之手套[2;37;0m这是一副由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两八钱的[1;32m龙菊之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m天圣[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 7);
