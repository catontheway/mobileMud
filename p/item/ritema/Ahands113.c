...
void create()
{
	      set_name("[1;33m蒲牢之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
蒲牢之手套[2;37;0m这是一副由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两二钱的[1;33m蒲牢之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m天圣[2;37;0m 
