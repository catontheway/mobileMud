...
void create()
{
	      set_name("[37m柔之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
柔之盾[2;37;0m这是一面由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤四两六钱的[37m柔之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[36m不错[2;37;0m [1;36m人[2;37;0m:[32m粗糙[2;37;0m 
