...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;36m	笑江湖浪迹十年游，空负少年头。$br#对铜陀巷泊，吟情渺渺，心事悠悠！ $br#酒令诗残梦断，南国正清愁。 $br#把剑凄然望，无处招归舟。 $br#明月天涯路远，问谁留楚佩，弄影中洲？$br#数英雄儿女，俯仰古今愁。$br#难消受灯昏罗帐，伥昙花一现恨难休！$br#飘零惯，金戈铁马，拼葬荒丘！ $br#[2;37;0m这是一双由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤九两五钱的[1;36m昆仑之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m毁天[2;37;0m [36m木[2;37;0m:[1;31m创世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 18);
...
//伤害防御类
    set("armor_prop/deep_injure", 20);
    set("armor_prop/week_injure", 21);
    set("armor_prop/abs_week_injure", 0);
    set("armor_prop/defense_attack", 0);
    set("armor_prop/armor_vs_force", 0);
    set("armor_prop/armor_effect_armor_vs_force", 20);
