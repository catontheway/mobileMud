...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m巨阙坚硬无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤二两二钱的[31m巨阙之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;31m无双[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spirituality", 16);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 19);
...
//气血恢复治疗类
    ...
    set("armor_prop/qi_recover", 31);
    set("armor_prop/jing_recover", 0);
    set("armor_prop/jingli_recover", 27);
