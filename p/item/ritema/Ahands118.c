...
void create()
{
	      set_name("[1;32m含翠之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
含翠之手套[2;37;0m这是一副由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两三钱的[1;32m含翠之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;36m完美[2;37;0m 
