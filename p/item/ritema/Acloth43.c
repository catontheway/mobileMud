...
void create()
{
	      set_name("[37m小之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
小之服装[2;37;0m这是一件由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤七两三钱的[37m小之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/armor_effect_armor_vs_force", 2);
