...
void create()
{
	      set_name("[34m玉指之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
玉指之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤四两八钱的[34m玉指之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m开元[2;37;0m [1;34m电[2;37;0m:[1;31m开元[2;37;0m 
...
//特效数值
    set("armor_prop/kf_def_wound", 11);
