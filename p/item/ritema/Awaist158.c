...
void create()
{
	      set_name("[1;36m飘雪之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
飘雪之腰带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两七钱的[1;36m飘雪之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m [1;36m人[2;37;0m:[33m很高[2;37;0m 
