...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤六两五钱的[31m纯钩之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 27);
    ...
    set("armor_prop/max_busy_fenjin", 29);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 27);
     set("armor_prop/attack_factor", 0);
     set("armor_prop/parry_factor", 29);
