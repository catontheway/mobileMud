...
void create()
{
	      set_name("[35m须弥之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
须弥之头盔[2;37;0m这是一顶由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两零钱的[35m须弥之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
