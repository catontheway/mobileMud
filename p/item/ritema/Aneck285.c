...
void create()
{
	      set_name("[36m燕尾之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
燕尾之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤零两九钱的[36m燕尾之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
