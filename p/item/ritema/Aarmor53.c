...
void create()
{
	      set_name("[31m阖之披风[2;37;0m", ({ "bad armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
阖之披风[2;37;0m这是一件由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤七两七钱的[31m阖之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m 
