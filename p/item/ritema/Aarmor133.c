...
void create()
{
	      set_name("[31m芙蓉之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
芙蓉之披风[2;37;0m这是一件由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两四钱的[31m芙蓉之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[33m很高[2;37;0m 
