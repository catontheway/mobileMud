...
void create()
{
	      set_name("[33m怪之手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
怪之手套[2;37;0m这是一副由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤零两二钱的[33m怪之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[32m粗糙[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 2);
