...
void create()
{
	      set_name("[35m千仞之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
千仞之盾[2;37;0m这是一面由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤九两一钱的[35m千仞之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[33m很高[2;37;0m [37m天[2;37;0m:[32m粗糙[2;37;0m [1;31m魔[2;37;0m:[33m很高[2;37;0m 
