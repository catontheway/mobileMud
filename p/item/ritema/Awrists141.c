...
void create()
{
	      set_name("[1;33m冰陽之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
冰陽之护腕[2;37;0m这是一双由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两八钱的[1;33m冰陽之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
