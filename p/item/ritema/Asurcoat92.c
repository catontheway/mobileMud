...
void create()
{
	      set_name("[33m钢之肚带[2;37;0m", ({ "bad surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
钢之肚带[2;37;0m这是一条由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤六两四钱的[33m钢之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[35m标准[2;37;0m 
