...
void create()
{
	      set_name("[1;35m阔之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
阔之头盔[2;37;0m这是一顶由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤一两零钱的[1;35m阔之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[34m细碎[2;37;0m 
