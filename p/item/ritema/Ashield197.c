...
void create()
{
	      set_name("[34m渡心之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
渡心之盾[2;37;0m这是一面由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤七两八钱的[34m渡心之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[31m精致[2;37;0m 
