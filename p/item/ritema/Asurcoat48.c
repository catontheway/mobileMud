...
void create()
{
	      set_name("[31m宾之肚带[2;37;0m", ({ "bad surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
宾之肚带[2;37;0m这是一条由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤二两零钱的[31m宾之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[36m不错[2;37;0m 
