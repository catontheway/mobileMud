...
void create()
{
	      set_name("[1;35m千仞之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
千仞之手套[2;37;0m这是一副由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两零钱的[1;35m千仞之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[32m粗糙[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_fenjin", 3);
