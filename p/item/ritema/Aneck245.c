...
void create()
{
	      set_name("[1;34m鱼鳞之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
鱼鳞之项链[2;37;0m这是一串由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两七钱的[1;34m鱼鳞之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m [32m水[2;37;0m:[1;31m无双[2;37;0m 
