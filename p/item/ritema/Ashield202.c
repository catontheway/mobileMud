...
void create()
{
	      set_name("[1;35m地雨之盾[2;37;0m", ({ "good shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
地雨之盾[2;37;0m这是一面由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤四两一钱的[1;35m地雨之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;31m开元[2;37;0m 
