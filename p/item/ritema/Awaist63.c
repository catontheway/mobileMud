...
void create()
{
	      set_name("[1;37m宾之腰带[2;37;0m", ({ "bad waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
宾之腰带[2;37;0m这是一条由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤八两九钱的[1;37m宾之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[35m标准[2;37;0m 
