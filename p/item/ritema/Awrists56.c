...
void create()
{
	      set_name("[36m巨之护腕[2;37;0m", ({ "bad wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
巨之护腕[2;37;0m这是一双由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两六钱的[36m巨之护腕[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/AllPoisonsImmune", 1);
