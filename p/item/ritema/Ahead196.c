...
void create()
{
	      set_name("[37m紫鶴之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
紫鶴之头盔[2;37;0m这是一顶由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两八钱的[37m紫鶴之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m [1;34m电[2;37;0m:[1;33m天圣[2;37;0m 
