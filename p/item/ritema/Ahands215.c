...
void create()
{
	      set_name("[1;32m天锋之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
天锋之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤零两零钱的[1;32m天锋之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[33m很高[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     set("armor_prop/attack_factor", 4);
