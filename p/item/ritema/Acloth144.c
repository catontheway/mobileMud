...
void create()
{
	      set_name("[1;31m四季之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
四季之服装[2;37;0m这是一件由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤五两八钱的[1;31m四季之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[34m细碎[2;37;0m [1;36m人[2;37;0m:[1;36m完美[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_confuse", 2);
