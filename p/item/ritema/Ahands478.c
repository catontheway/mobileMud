...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一副由绝对坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤五两六钱的[31m龙泉之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/defense_attack", 27);
