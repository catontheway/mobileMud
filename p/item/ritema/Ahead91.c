...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
铜之头盔[2;37;0m这是一顶由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤二两九钱的[1;35m铜之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#[1;34m电[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[35m标准[2;37;0m 
