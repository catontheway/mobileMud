...
void create()
{
	      set_name("[37m苍岩之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
苍岩之腰带[2;37;0m这是一条由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤四两四钱的[37m苍岩之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[33m很高[2;37;0m [1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[31m精致[2;37;0m 
