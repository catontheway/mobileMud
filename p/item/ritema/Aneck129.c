...
void create()
{
	      set_name("[34m螭吻之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
螭吻之项链[2;37;0m这是一串由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两七钱的[34m螭吻之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m 
