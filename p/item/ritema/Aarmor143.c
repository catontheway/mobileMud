...
void create()
{
	      set_name("[36m渡心之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
渡心之披风[2;37;0m这是一件由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两二钱的[36m渡心之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m 
