...
void create()
{
	      set_name("[34m钢之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
钢之头盔[2;37;0m这是一顶由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤一两二钱的[34m钢之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[34m细碎[2;37;0m [33m土[2;37;0m:[36m不错[2;37;0m 
