...
void create()
{
	      set_name("[1;34m巨威之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
巨威之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤六两八钱的[1;34m巨威之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m [1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#[40m地[2;37;0m:[1;31m无双[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/AllPoisonsImmune", 8);
