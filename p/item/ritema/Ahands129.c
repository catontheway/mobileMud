...
void create()
{
	      set_name("[1;32m扣骨之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
扣骨之手套[2;37;0m这是一副由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两七钱的[1;32m扣骨之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m 
