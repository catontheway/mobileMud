...
void create()
{
	      set_name("[1;36m钢之腰带[2;37;0m", ({ "bad waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
钢之腰带[2;37;0m这是一条由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤九两六钱的[1;36m钢之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#[1;31m魔[2;37;0m:[34m细碎[2;37;0m 
