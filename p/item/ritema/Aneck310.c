...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[36m天后之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两四钱的[36m天后之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;34m举世[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/abs_week_injure", 5);
