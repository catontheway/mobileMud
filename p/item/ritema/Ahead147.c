...
void create()
{
	      set_name("[1;36m玉魔之头盔[2;37;0m", ({ "general head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
玉魔之头盔[2;37;0m这是一顶由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两零钱的[1;36m玉魔之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
