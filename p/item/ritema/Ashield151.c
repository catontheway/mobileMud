...
void create()
{
	      set_name("[31m摘星之盾[2;37;0m", ({ "general shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
摘星之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤七两一钱的[31m摘星之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;31m无双[2;37;0m 
