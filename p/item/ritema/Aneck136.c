...
void create()
{
	      set_name("[31m松柏之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
松柏之项链[2;37;0m这是一串由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两二钱的[31m松柏之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
