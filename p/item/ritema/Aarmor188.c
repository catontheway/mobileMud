...
void create()
{
	      set_name("[1;37m黑云之披风[2;37;0m", ({ "general armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
黑云之披风[2;37;0m这是一件由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤零两一钱的[1;37m黑云之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m 
