...
void create()
{
	      set_name("[31m撼山之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
撼山之肚带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两五钱的[31m撼山之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[33m很高[2;37;0m 
