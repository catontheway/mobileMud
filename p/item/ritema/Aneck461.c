...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一串由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤四两五钱的[31m胜邪之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/finger", 12);
    set("armor_prop/hand", 0);
    set("armor_prop/parry", 0);
    set("armor_prop/strike", 0);
    set("armor_prop/unarmed", 31);
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 11);
...
//伤害防御类
    ...
    set("armor_prop/abs_week_injure", 9);
...
//气血恢复治疗类
    ...
    set("armor_prop/qi_recover", 35);
    set("armor_prop/jing_recover", 25);
