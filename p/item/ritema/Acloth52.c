...
void create()
{
	      set_name("[1;31m阔之服装[2;37;0m", ({ "bad cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
阔之服装[2;37;0m这是一件由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重二斤九两五钱的[1;31m阔之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/abs_week_injure", 2);
