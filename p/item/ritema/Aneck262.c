...
void create()
{
	      set_name("[35m大川之项链[2;37;0m", ({ "good neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
大川之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤零两六钱的[35m大川之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m毁天[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m 
