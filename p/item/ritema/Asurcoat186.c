...
void create()
{
	      set_name("[31m龙菊之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
龙菊之肚带[2;37;0m这是一条由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两九钱的[31m龙菊之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
