...
void create()
{
	      set_name("[31m柔之肚带[2;37;0m", ({ "bad surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
柔之肚带[2;37;0m这是一条由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤零两三钱的[31m柔之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m 
