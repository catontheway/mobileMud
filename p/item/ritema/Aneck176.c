...
void create()
{
	      set_name("[1;35m紫芒之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
紫芒之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两零钱的[1;35m紫芒之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m [37m天[2;37;0m:[31m精致[2;37;0m 
