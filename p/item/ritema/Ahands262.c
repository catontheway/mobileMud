...
void create()
{
	      set_name("[37m狂龙之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
狂龙之手套[2;37;0m这是一副由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两二钱的[37m狂龙之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;31m无双[2;37;0m 
