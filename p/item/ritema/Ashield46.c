...
void create()
{
	      set_name("[1;37m铁之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
铁之盾[2;37;0m这是一面由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤五两四钱的[1;37m铁之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[34m细碎[2;37;0m 
