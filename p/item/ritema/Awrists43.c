...
void create()
{
	      set_name("[31m钢之护腕[2;37;0m", ({ "bad wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
钢之护腕[2;37;0m这是一双由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤一两一钱的[31m钢之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[32m粗糙[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 1);
...
//伤害防御类
    ...
    set("armor_prop/armor_vs_force", 2);
