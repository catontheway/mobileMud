...
void create()
{
	      set_name("[34m洛神之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
洛神之手套[2;37;0m这是一副由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两一钱的[34m洛神之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[34m细碎[2;37;0m 
