...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;31m三十三天下有地，地下有城，城名鬼城，大小妖魔，人神畜生都在此轮回往返，谓之“炼狱”！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤二两九钱的[1;31m炼狱之腰带[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/AllPoisonsImmune", 25);
