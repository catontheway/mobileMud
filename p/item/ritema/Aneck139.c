...
void create()
{
	      set_name("[36m紫芒之项链[2;37;0m", ({ "general neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
紫芒之项链[2;37;0m这是一串由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两零钱的[36m紫芒之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
