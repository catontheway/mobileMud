...
void create()
{
	      set_name("[1;37m怪之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
怪之盾[2;37;0m这是一面由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤八两三钱的[1;37m怪之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[33m很高[2;37;0m 
