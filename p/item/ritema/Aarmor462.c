...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤九两三钱的[31m胜邪之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_confuse", 22);
    ...
    set("armor_prop/max_busy_fenjin", 27);
