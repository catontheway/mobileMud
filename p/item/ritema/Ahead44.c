...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
铁之头盔[2;37;0m这是一顶由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤二两二钱的[1;31m铁之头盔[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 1);
...
//伤害防御类
    ...
    set("armor_prop/defense_attack", 1);
