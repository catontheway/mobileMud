...
void create()
{
	      set_name("[35m叠之腰带[2;37;0m", ({ "bad waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
叠之腰带[2;37;0m这是一条由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤四两六钱的[35m叠之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m [40m地[2;37;0m:[32m粗糙[2;37;0m 
