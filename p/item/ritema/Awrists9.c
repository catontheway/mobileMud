...
void create()
{
	      set_name("[1;34m韧之护腕[2;37;0m", ({ "bad wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
韧之护腕[2;37;0m这是一双由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤零两五钱的[1;34m韧之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[36m不错[2;37;0m 
