...
void create()
{
	      set_name("[33m寒梅之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
寒梅之肚带[2;37;0m这是一条由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两九钱的[33m寒梅之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m 
