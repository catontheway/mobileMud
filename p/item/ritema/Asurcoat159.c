...
void create()
{
	      set_name("[35m矗页之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
矗页之肚带[2;37;0m这是一条由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两一钱的[35m矗页之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[34m细碎[2;37;0m [31m火[2;37;0m:[1;34m举世[2;37;0m 
