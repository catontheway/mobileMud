...
void create()
{
	      set_name("[1;32m魔竹之手套[2;37;0m", ({ "good hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
魔竹之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两二钱的[1;32m魔竹之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[31m精致[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/PoisonAttack", 4);
    set("armor_prop/kf_hit_rate", 5);
