...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[1;32m天地浩气之神兵，扫魔除妖，为国为民，侠之大者！$br#[2;37;0m这是一串由极为坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤四两零钱的[1;32m浩气之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m [1;37m雷[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 10);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 8);
    set("armor_prop/qi_cure", 0);
    set("armor_prop/jing_cure", 29);
