...
void create()
{
	      set_name("[36m宾之项链[2;37;0m", ({ "bad neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
宾之项链[2;37;0m这是一串由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤八两三钱的[36m宾之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/AllPoisonsImmune", 3);
