...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤九两六钱的[31m胜邪之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    set("armor_prop/kf_def_wound", 25);
