...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[1;33m太极者，无极而生，阴阳之母也。动之则分，静之则合。无过不及，随曲就伸。人刚我柔谓之走，我顺人背谓之粘。动急则急应，动缓则缓随。虽变化万端，而理为一贯！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤九两四钱的[1;33m太极之手套[2;37;0m。$br#
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 25000);
                  //  基础类
  set("forge/max", 218);
  set("forge/times_max", 218);
  set("level", 218);

     set("armor_prop/damage", 218);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     ...
     set("armor_prop/parry_factor", 16);
