...
void create()
{
	      set_name("[36m璨星之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
璨星之腰带[2;37;0m这是一条由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两一钱的[36m璨星之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[34m细碎[2;37;0m $br#[1;37m雷[2;37;0m:[1;36m完美[2;37;0m 
