...
void create()
{
	      set_name("[36m缦理之服装[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
缦理之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤七两八钱的[36m缦理之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m创世[2;37;0m [33m土[2;37;0m:[1;35m绝世[2;37;0m [1;34m电[2;37;0m:[1;31m毁天[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_jiemai", 10);
