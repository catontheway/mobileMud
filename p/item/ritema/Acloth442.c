...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;35m昔日黄帝持此物立于指南车上，驱迷雾，扫阴霾，率应龙旱魃，御百兽而战蚩尤！$br#[2;37;0m这是一件由极为坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重三斤零两三钱的[1;35m轩辕之服装[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/max_busy_fenjin", 23);
