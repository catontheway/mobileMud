...
void create()
{
	      set_name("[31m瀚海之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
瀚海之腰带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两五钱的[31m瀚海之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m [33m土[2;37;0m:[1;36m完美[2;37;0m 
