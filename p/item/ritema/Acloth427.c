...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;34m在西方查理曼统治的时代，最简朴的剑也能值三头母牛的价钱。而查理大帝自己的那把传奇式的神兵“乔依乌斯”据说是半人半神的“韦兰铁匠”所造，乃当世界神兵！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤九两八钱的[1;34m乔依乌斯之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#[37m天[2;37;0m:[1;31m开元[2;37;0m 
