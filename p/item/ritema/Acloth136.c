...
void create()
{
	      set_name("[33m風信之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
風信之服装[2;37;0m这是一件由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重三斤一两一钱的[33m風信之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[33m很高[2;37;0m 
