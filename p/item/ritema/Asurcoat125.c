...
void create()
{
	      set_name("[37m飞星之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
飞星之肚带[2;37;0m这是一条由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两五钱的[37m飞星之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;31m开元[2;37;0m 
