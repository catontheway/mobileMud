...
void create()
{
	      set_name("[1;36m丹陽之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
丹陽之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两九钱的[1;36m丹陽之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;36m完美[2;37;0m 
