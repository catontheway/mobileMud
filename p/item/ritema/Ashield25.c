...
void create()
{
	      set_name("[36m小之盾[2;37;0m", ({ "bad shield", "shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
小之盾[2;37;0m这是一面由相当坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤二两一钱的[36m小之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[36m不错[2;37;0m 
