...
void create()
{
	      set_name("[36m延永之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
延永之护腕[2;37;0m这是一双由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两七钱的[36m延永之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m 
