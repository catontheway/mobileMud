...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一副由极为坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤零两六钱的[31m龙泉之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 25);
