...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤八两八钱的[31m工布之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/finger", 21);
    set("armor_prop/hand", 18);
    set("armor_prop/parry", 0);
    set("armor_prop/strike", 0);
    set("armor_prop/unarmed", 44);
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 6);
    set("armor_prop/cant_busy_dianxue", 7);
    ...
    set("armor_prop/max_busy_confuse", 10);
    set("armor_prop/max_busy_body", 0);
    set("armor_prop/AllPoisonsImmune", 0);
    set("armor_prop/PoisonAttack", 11);
...
//伤害防御类
    ...
    set("armor_prop/armor_effect_armor_vs_force", 9);
