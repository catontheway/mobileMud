...
void create()
{
	      set_name("[1;36m集仙之护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
集仙之护腕[2;37;0m这是一双由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两八钱的[1;36m集仙之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
