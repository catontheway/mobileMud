...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[1;32m飞龙之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两八钱的[1;32m飞龙之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[35m标准[2;37;0m $br#[40m地[2;37;0m:[35m标准[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
...
LONG
    ...
    set("no_get",1);
	  ...
	  set("systemmake",1);
		set("value", 16000);
                  //  基础类
  set("forge/max", 204);
  set("forge/times_max", 204);
  set("level", 204);

     set("armor_prop/damage", 204);
 ...
 //先天类    
    ...
    set("armor_prop/dagge", 25);
    set("armor_prop/hammer", 0);
    set("armor_prop/spear", 0);
    set("armor_prop/throwing", 30);
...
//特效数值
    ...
    set("armor_prop/max_busy_confuse", 5);
    set("armor_prop/max_busy_body", 0);
    set("armor_prop/AllPoisonsImmune", 0);
    set("armor_prop/PoisonAttack", 5);
    set("armor_prop/kf_hit_rate", 10);
    set("armor_prop/kf_anti_hr", 8);
//伤害防御类
