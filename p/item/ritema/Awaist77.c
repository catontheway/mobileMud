...
void create()
{
	      set_name("[1;32m小之腰带[2;37;0m", ({ "bad waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
小之腰带[2;37;0m这是一条由非常坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤七两七钱的[1;32m小之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[33m很高[2;37;0m 
