...
void create()
{
	      set_name("[34m阴霾之服装[2;37;0m", ({ "general cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
阴霾之服装[2;37;0m这是一件由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤六两零钱的[34m阴霾之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[33m很高[2;37;0m 
