...
void create()
{
	      set_name("[1;33m神水之肚带[2;37;0m", ({ "good surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
神水之肚带[2;37;0m这是一条由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两六钱的[1;33m神水之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[31m精致[2;37;0m 
