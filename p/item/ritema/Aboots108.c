...
void create()
{
	      set_name("[1;36m松柏之靴[2;37;0m", ({ "general boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
松柏之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两零钱的[1;36m松柏之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;36m完美[2;37;0m [31m火[2;37;0m:[1;34m举世[2;37;0m 
