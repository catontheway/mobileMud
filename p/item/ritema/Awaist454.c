...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤六两五钱的[31m太阿之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[37m天[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_confuse", 26);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 32);
