...
void create()
{
	      set_name("[37m西天之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
西天之手套[2;37;0m这是一副由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两五钱的[37m西天之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;34m举世[2;37;0m 
