...
void create()
{
	set_name("[1;32m飞星之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(7021);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","飞星之剑[2;37;0m这是一把由十分坚硬的[33m生铁[2;37;0m制成，重十四斤零两四钱的[1;32m飞星之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#[1;31m魔[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
