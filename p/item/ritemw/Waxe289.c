...
void create()
{
	set_name("[1;37m神狮之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(14819);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","神狮之斧[2;37;0m这是一柄由极为坚硬的[33m软铁[2;37;0m制成，重二十九斤六两三钱的[1;37m神狮之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
