...
void create()
{
	set_name("[1;34m戈壁之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(10474);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","戈壁之锤[2;37;0m这是一柄由非常坚硬的[33m生铁[2;37;0m制成，重二十斤九两四钱的[1;34m戈壁之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m [31m火[2;37;0m:[1;36m完美[2;37;0m [1;34m电[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
