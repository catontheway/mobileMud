...
void create()
{
	set_name("[1;36m饕餮之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(7012);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","饕餮之锤[2;37;0m这是一柄由相当坚硬的[33m生铁[2;37;0m制成，重十四斤零两二钱的[1;36m饕餮之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
