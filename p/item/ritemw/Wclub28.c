...
void create()
{
	set_name("[1;33m巨之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(9096);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","巨之棍[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重十八斤一两九钱的[1;33m巨之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[34m细碎[2;37;0m [1;35m风[2;37;0m:[35m标准[2;37;0m $br#[1;36m人[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
