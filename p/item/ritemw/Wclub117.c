...
void create()
{
	set_name("[35m月龙之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(14236);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","月龙之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十八斤四两七钱的[35m月龙之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
