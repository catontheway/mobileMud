...
void create()
{
	set_name("[1;32m韧之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(10706);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","韧之匕首[2;37;0m这是一把由还算坚硬的[32m青铜[2;37;0m制成，重二十一斤四两一钱的[1;32m韧之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
