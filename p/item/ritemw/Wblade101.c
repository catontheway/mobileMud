...
void create()
{
	set_name("[35m椒图之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(5326);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","椒图之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十斤六两五钱的[35m椒图之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
