...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[37m绿玉之棍[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重十九斤一两四钱的[37m绿玉之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[33m很高[2;37;0m [1;37m雷[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    set("weapon_prop/kf_def_wound", 4);
