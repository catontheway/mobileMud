...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;36m天地之初，女娲补天所留下的天地间至尊之物之一经千秋万载所制，功能开天劈地！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重二十六斤四两零钱的[1;36m天地之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 0);
     ...
     set("weapon_prop/dodge_factor", 18);
//气血恢复治疗类
