...
void create()
{
	set_name("[33m杜鹃之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(8467);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","杜鹃之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十六斤九两三钱的[33m杜鹃之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
