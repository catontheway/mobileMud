...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[33m金光之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二十二斤二两八钱的[33m金光之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m开元[2;37;0m [1;36m人[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
