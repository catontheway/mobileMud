...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重二十五斤六两七钱的[31m莫邪之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m毁天[2;37;0m [31m火[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
  ...
  //  基础类
  set("forge/max", 82);
  set("forge/times_max", 82);
  set("level", 82);
if(query("weapon_prop/damage"))
     set("weapon_prop/damage", 82);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 40);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 33);
    //set("weapon_prop/hand", 47);
    set("weapon_prop/parry", 0);
    //set("weapon_prop/strike", 0);
    //set("weapon_prop/unarmed", 0);
    //set("weapon_prop/blade", 0);
    //set("weapon_prop/whip", 33);
...
//特效数值
    set("weapon_prop/kf_def_wound", 17);
    ...
    set("weapon_prop/max_busy_confuse", 15);
...
//伤害防御类
    ...
    set("weapon_prop/armor_vs_force", 17);
...
//气血恢复治疗类
    ...
    set("weapon_prop/max_jing", 33);
    set("weapon_prop/neili_recover", 45);
    set("weapon_prop/qi_recover", 0);
    set("weapon_prop/jing_recover", 60);
    set("weapon_prop/jingli_recover", 0);
    set("weapon_prop/qi_cure", 0);
    set("weapon_prop/jing_cure", 57);
