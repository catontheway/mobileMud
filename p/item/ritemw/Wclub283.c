...
void create()
{
	set_name("[37m大川之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(8326);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","大川之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十六斤六两五钱的[37m大川之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;32m魔王[2;37;0m [1;31m魔[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
