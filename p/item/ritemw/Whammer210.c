...
void create()
{
	set_name("[35m竹叶之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(2862);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","竹叶之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重五斤七两二钱的[35m竹叶之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [1;36m人[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
