...
void create()
{
	set_name("[36m万丈之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(13112);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","万丈之匕首[2;37;0m这是一把由极其坚硬的[33m生铁[2;37;0m制成，重二十六斤二两二钱的[36m万丈之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#[1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_dianxue", 4);
