...
void create()
{
	set_name("[35m天锋之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(13809);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","天锋之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十七斤六两一钱的[35m天锋之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m [40m地[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 14);
