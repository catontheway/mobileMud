...
void create()
{
	set_name("[36m渡心之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(4168);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","渡心之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重八斤三两三钱的[36m渡心之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
