...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m干将威力无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重十二斤六两七钱的[31m干将之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;31m创世[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m [1;36m人[2;37;0m:[1;31m毁天[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_all_busy", 18);
    ...
    set("weapon_prop/max_busy_dianxue", 17);
...
//伤害防御类
    ...
    set("weapon_prop/defense_attack", 20);
