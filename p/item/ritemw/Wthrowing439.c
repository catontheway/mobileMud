...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[1;36m	笑江湖浪迹十年游，空负少年头。$br#对铜陀巷泊，吟情渺渺，心事悠悠！ $br#酒令诗残梦断，南国正清愁。 $br#把剑凄然望，无处招归舟。 $br#明月天涯路远，问谁留楚佩，弄影中洲？$br#数英雄儿女，俯仰古今愁。$br#难消受灯昏罗帐，伥昙花一现恨难休！$br#飘零惯，金戈铁马，拼葬荒丘！ $br#[2;37;0m这是一支由绝对坚硬的[31m流花石[2;37;0m制成，重零斤四两七钱的[1;36m昆仑之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
