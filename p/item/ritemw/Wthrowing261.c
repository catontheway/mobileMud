...
void create()
{
	set_name("[35m神豹之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(57);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","神豹之暗器[2;37;0m这是一支由相当坚硬的[33m软铁[2;37;0m制成，重零斤一两一钱的[35m神豹之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
