...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[32m地凤之棍[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重八斤一两零钱的[32m地凤之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
		...
		set("weapon_prop/personality",17);
...
//特效数值
    ...
    set("weapon_prop/AllPoisonsImmune", 4);
