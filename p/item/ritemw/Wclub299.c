...
void create()
{
	set_name("[37m仙品之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(13783);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","仙品之棍[2;37;0m这是一根由极为坚硬的[33m软铁[2;37;0m制成，重二十七斤五两六钱的[37m仙品之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
