...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m干将威力无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重十八斤一两五钱的[31m干将之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 22);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 42);
    set("weapon_prop/qi_recover", 26);
