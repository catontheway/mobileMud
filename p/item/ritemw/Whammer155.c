...
void create()
{
	set_name("[36m东天之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(13757);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","东天之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十七斤五两一钱的[36m东天之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
