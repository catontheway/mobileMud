...
void create()
{
	set_name("[1;35m望月之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(14305);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","望月之鞭[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重二十八斤六两一钱的[1;35m望月之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
