...
void create()
{
	set_name("[36m神狮之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(3642);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","神狮之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重七斤二两八钱的[36m神狮之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [32m水[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_jiemai", 4);
    set("weapon_prop/max_busy_fenjin", 3);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 11);
