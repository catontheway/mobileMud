...
void create()
{
	set_name("[35m竹之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(6246);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","竹之鞭[2;37;0m这是一根由相当坚硬的[32m青铜[2;37;0m制成，重十二斤四两九钱的[35m竹之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[33m很高[2;37;0m $br#[1;34m电[2;37;0m:[36m不错[2;37;0m [40m地[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
