...
void create()
{
	set_name("[36m探星之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(12750);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","探星之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十五斤五两零钱的[36m探星之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[1;35m绝世[2;37;0m [1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#[37m天[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 8);
    set("weapon_prop/cant_busy_jiemai", 0);
    set("weapon_prop/cant_busy_fenjin", 10);
...
//伤害防御类
    set("weapon_prop/deep_injure", 11);
    set("weapon_prop/week_injure", 0);
    set("weapon_prop/abs_week_injure", 0);
    set("weapon_prop/defense_attack", 12);
    ...
    set("weapon_prop/attack_speed", 0);
     ...
     set("weapon_prop/dodge_factor", 9);
//气血恢复治疗类
