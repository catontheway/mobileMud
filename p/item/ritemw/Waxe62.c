...
void create()
{
	set_name("[1;37m竹之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(13085);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","竹之斧[2;37;0m这是一柄由非常坚硬的[32m青铜[2;37;0m制成，重二十六斤一两七钱的[1;37m竹之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
