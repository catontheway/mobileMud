...
void create()
{
	set_name("[33m大之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(1246);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","大之刀[2;37;0m这是一柄由还算坚硬的[32m青铜[2;37;0m制成，重二斤四两九钱的[33m大之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
