...
void create()
{
	set_name("[35m五步之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(746);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","五步之暗器[2;37;0m这是一支由极为坚硬的[33m软铁[2;37;0m制成，重一斤四两九钱的[35m五步之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
