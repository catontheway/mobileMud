...
void create()
{
	set_name("[1;34m芙蓉之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(8878);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","芙蓉之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重十七斤七两五钱的[1;34m芙蓉之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [31m火[2;37;0m:[1;32m魔王[2;37;0m [40m地[2;37;0m:[31m精致[2;37;0m [1;36m人[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
