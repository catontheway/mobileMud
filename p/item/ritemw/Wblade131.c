...
void create()
{
	set_name("[35m芍药之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(9818);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","芍药之刀[2;37;0m这是一柄由相当坚硬的[33m生铁[2;37;0m制成，重十九斤六两三钱的[35m芍药之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
