...
void create()
{
	set_name("[1;37m落雪之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(11890);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","落雪之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十三斤七两八钱的[1;37m落雪之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [32m水[2;37;0m:[1;34m举世[2;37;0m [31m火[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
