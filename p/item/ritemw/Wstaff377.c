...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;37m白虎之杖[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重二十九斤六两四钱的[1;37m白虎之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[35m标准[2;37;0m $br#[37m天[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
