...
void create()
{
	set_name("[1;36m太陽之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(15530);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","太陽之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重三十一斤零两六钱的[1;36m太陽之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
