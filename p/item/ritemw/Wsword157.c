...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","芍药之剑[2;37;0m这是一把由非常坚硬的[33m生铁[2;37;0m制成，重十六斤一两六钱的[1;36m芍药之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
