...
void create()
{
	set_name("[1;35m须弥之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(9452);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","须弥之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重十八斤九两零钱的[1;35m须弥之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
