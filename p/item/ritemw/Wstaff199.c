...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","常青之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重六斤一两一钱的[1;32m常青之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m无双[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
