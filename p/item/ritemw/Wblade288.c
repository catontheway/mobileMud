...
void create()
{
	set_name("[34m天雨之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(13219);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天雨之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十六斤四两三钱的[34m天雨之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 3);
...
//气血恢复治疗类
    set("weapon_prop/max_qi", 16);
    set("weapon_prop/max_jing", 0);
    set("weapon_prop/neili_recover", 0);
    set("weapon_prop/qi_recover", 0);
    set("weapon_prop/jing_recover", 20);
    set("weapon_prop/jingli_recover", 10);
