...
void create()
{
	set_name("[35m扣骨之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(4943);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","扣骨之棍[2;37;0m这是一根由相当坚硬的[33m生铁[2;37;0m制成，重九斤八两八钱的[35m扣骨之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
