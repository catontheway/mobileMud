...
void create()
{
	set_name("[36m竹之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(9535);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","竹之斧[2;37;0m这是一柄由极其坚硬的[32m青铜[2;37;0m制成，重十九斤零两七钱的[36m竹之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[34m细碎[2;37;0m [1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
