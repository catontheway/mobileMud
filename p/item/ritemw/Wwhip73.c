...
void create()
{
	set_name("[34m阔之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(6517);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阔之鞭[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重十三斤零两三钱的[34m阔之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[36m不错[2;37;0m [33m土[2;37;0m:[34m细碎[2;37;0m [37m天[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
