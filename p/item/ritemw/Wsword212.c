...
void create()
{
	set_name("[1;34m日月之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(13066);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","日月之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十六斤一两三钱的[1;34m日月之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m [1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
