...
void create()
{
	set_name("[33m盘古之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(6555);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","盘古之剑[2;37;0m这是一把由绝对坚硬的[33m软铁[2;37;0m制成，重十三斤一两一钱的[33m盘古之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
