...
void create()
{
	set_name("[36m鸿门之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(4418);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","鸿门之斧[2;37;0m这是一柄由相当坚硬的[33m软铁[2;37;0m制成，重八斤八两三钱的[36m鸿门之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
