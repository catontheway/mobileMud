...
void create()
{
	set_name("[1;34m龟文之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(11489);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","龟文之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十二斤九两七钱的[1;34m龟文之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m开元[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#[1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
