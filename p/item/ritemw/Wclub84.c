...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","韧之棍[2;37;0m这是一根由绝对坚硬的[32m青铜[2;37;0m制成，重二十六斤一两五钱的[1;34m韧之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[34m细碎[2;37;0m [32m水[2;37;0m:[34m细碎[2;37;0m [31m火[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_jiemai", 1);
