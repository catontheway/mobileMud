...
void create()
{
	set_name("[37m北天之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(6247);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","北天之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十二斤四两九钱的[37m北天之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
