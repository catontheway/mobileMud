...
void create()
{
	set_name("[1;35m雪花之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(7954);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","雪花之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十五斤九两零钱的[1;35m雪花之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
