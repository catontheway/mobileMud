...
void create()
{
	set_name("[33m青黛之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(12042);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","青黛之剑[2;37;0m这是一把由相当坚硬的[33m软铁[2;37;0m制成，重二十四斤零两八钱的[33m青黛之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
