...
void create()
{
	set_name("[37m魔袱之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(2298);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","魔袱之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重四斤五两九钱的[37m魔袱之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
