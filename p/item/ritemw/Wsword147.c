...
void create()
{
	set_name("[1;33m起云之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(8153);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","起云之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十六斤三两零钱的[1;33m起云之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
