...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;37m八卦有“休”“生”“伤”“杜”“死”“景”“惊”“开”之别，创自诸葛武候，集天下万变于一身！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重十八斤六两九钱的[1;37m八卦之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
