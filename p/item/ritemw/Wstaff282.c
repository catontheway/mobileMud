...
void create()
{
	set_name("[31m紫云之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(5225);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","紫云之杖[2;37;0m这是一根由极为坚硬的[33m软铁[2;37;0m制成，重十斤四两五钱的[31m紫云之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 8);
    set("weapon_prop/jingli_recover", 14);
