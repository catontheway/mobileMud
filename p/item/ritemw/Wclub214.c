...
void create()
{
	set_name("[1;32m魔水之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(9526);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","魔水之棍[2;37;0m这是一根由十分坚硬的[33m软铁[2;37;0m制成，重十九斤零两五钱的[1;32m魔水之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
