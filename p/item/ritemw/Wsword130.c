...
void create()
{
	set_name("[37m铁鲨之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(6804);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","铁鲨之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十三斤六两零钱的[37m铁鲨之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [36m木[2;37;0m:[1;34m举世[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
