...
void create()
{
	set_name("[1;37m浮云之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(13859);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","浮云之剑[2;37;0m这是一把由绝对坚硬的[33m软铁[2;37;0m制成，重二十七斤七两一钱的[1;37m浮云之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
