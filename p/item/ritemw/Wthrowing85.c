...
void create()
{
	set_name("[1;33m巧之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(596);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","巧之暗器[2;37;0m这是一支由极为坚硬的[32m青铜[2;37;0m制成，重一斤一两九钱的[1;33m巧之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[35m标准[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
