...
void create()
{
	set_name("[36m常青之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(15157);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","常青之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重三十斤三两一钱的[36m常青之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
