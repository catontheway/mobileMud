...
void create()
{
	set_name("[36m魔水之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(14882);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","魔水之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十九斤七两六钱的[36m魔水之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [31m火[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
