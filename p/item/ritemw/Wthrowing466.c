...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重零斤九两零钱的[31m湛卢之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m [1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#[37m天[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 29);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/blade", 49);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 40);
    set("weapon_prop/force", 0);
    set("weapon_prop/dagge", 0);
    //set("weapon_prop/hammer", 49);
...
//特效数值
    ...
    set("weapon_prop/kf_hit_rate", 15);
