...
void create()
{
	set_name("[1;32m宾之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(15373);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","宾之棍[2;37;0m这是一根由非常坚硬的[32m青铜[2;37;0m制成，重三十斤七两四钱的[1;32m宾之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
