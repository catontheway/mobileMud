...
void create()
{
	set_name("[31m降魔之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(6113);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","降魔之杖[2;37;0m这是一根由绝对坚硬的[33m生铁[2;37;0m制成，重十二斤二两二钱的[31m降魔之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
