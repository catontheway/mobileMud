...
void create()
{
	set_name("[34m天雨之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(11145);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天雨之锤[2;37;0m这是一柄由相当坚硬的[33m软铁[2;37;0m制成，重二十二斤二两九钱的[34m天雨之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m创世[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
