...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","火薇之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十五斤一两一钱的[36m火薇之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
