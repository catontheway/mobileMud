...
void create()
{
	set_name("[1;32m天锋之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(5185);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天锋之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十斤三两七钱的[1;32m天锋之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m天圣[2;37;0m [1;36m人[2;37;0m:[1;31m创世[2;37;0m [1;31m魔[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
