...
void create()
{
	set_name("[37m月龙之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(11636);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","月龙之锤[2;37;0m这是一柄由十分坚硬的[33m生铁[2;37;0m制成，重二十三斤二两七钱的[37m月龙之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
