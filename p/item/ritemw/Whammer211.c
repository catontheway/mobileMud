...
void create()
{
	set_name("[33m天锋之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(1249);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天锋之锤[2;37;0m这是一柄由相当坚硬的[33m软铁[2;37;0m制成，重二斤四两九钱的[33m天锋之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#[1;37m雷[2;37;0m:[1;35m绝世[2;37;0m [1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
