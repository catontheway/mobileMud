...
void create()
{
	set_name("[1;33m千仞之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(4080);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","千仞之匕首[2;37;0m这是一把由极其坚硬的[33m生铁[2;37;0m制成，重八斤一两六钱的[1;33m千仞之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[34m细碎[2;37;0m $br#[40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
