...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[1;34m黑龙之暗器[2;37;0m这是一支由绝对坚硬的[1;32m绿石[2;37;0m制成，重一斤五两六钱的[1;34m黑龙之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m开元[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m [1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
