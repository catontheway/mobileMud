...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重二十二斤五两一钱的[31m纯钩之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m开元[2;37;0m [1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 38);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/finger", 50);
    //set("weapon_prop/hand", 0);
    set("weapon_prop/parry", 69);
