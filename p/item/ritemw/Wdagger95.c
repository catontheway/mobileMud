...
void create()
{
	set_name("[31m铁之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(14320);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","铁之匕首[2;37;0m这是一把由比较坚硬的[32m青铜[2;37;0m制成，重二十八斤六两四钱的[31m铁之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
