...
void create()
{
	set_name("[35m瀚海之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(9845);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","瀚海之锤[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重十九斤六两九钱的[35m瀚海之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#[37m天[2;37;0m:[1;34m举世[2;37;0m [1;36m人[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
