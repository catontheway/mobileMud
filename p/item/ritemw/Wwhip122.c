...
void create()
{
	set_name("[1;31m聚鹤之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(15385);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","聚鹤之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重三十斤七两七钱的[1;31m聚鹤之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
