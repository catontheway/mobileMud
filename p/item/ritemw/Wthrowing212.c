...
void create()
{
	set_name("[37m虎泉之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(687);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","虎泉之暗器[2;37;0m这是一支由相当坚硬的[33m软铁[2;37;0m制成，重一斤三两七钱的[37m虎泉之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
