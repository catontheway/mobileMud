...
void create()
{
	set_name("[1;37m聚泉之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(9787);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","聚泉之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重十九斤五两七钱的[1;37m聚泉之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#[1;37m雷[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
