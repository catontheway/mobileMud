...
void create()
{
	set_name("[31m神狼之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(6343);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","神狼之刀[2;37;0m这是一柄由非常坚硬的[33m软铁[2;37;0m制成，重十二斤六两八钱的[31m神狼之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [1;36m人[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
