...
void create()
{
	set_name("[1;35m仙品之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(6269);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","仙品之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十二斤五两三钱的[1;35m仙品之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
