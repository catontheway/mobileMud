...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","铜之锤[2;37;0m这是一柄由比较坚硬的[32m青铜[2;37;0m制成，重十二斤零两五钱的[1;35m铜之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[34m细碎[2;37;0m [37m天[2;37;0m:[33m很高[2;37;0m [40m地[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
