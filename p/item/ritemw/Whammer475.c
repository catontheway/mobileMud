...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m干将威力无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一柄由绝对坚硬的[1;37m软银[2;37;0m制成，重三斤二两七钱的[31m干将之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;36m完美[2;37;0m [1;37m雷[2;37;0m:[1;35m绝世[2;37;0m [1;34m电[2;37;0m:[1;35m绝世[2;37;0m [37m天[2;37;0m:[32m粗糙[2;37;0m [40m地[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
