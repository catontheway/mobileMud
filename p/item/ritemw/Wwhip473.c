...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重二十六斤五两五钱的[31m鱼肠之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 56);
    ...
    set("weapon_prop/force", 58);
    set("weapon_prop/dagge", 56);
...
//伤害防御类
    ...
    set("weapon_prop/abs_week_injure", 20);
