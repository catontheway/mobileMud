...
void create()
{
	set_name("[1;35m登龙之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(6579);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","登龙之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十三斤一两五钱的[1;35m登龙之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
