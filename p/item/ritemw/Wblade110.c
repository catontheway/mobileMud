...
void create()
{
	set_name("[34m瀚海之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(1489);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","瀚海之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二斤九两七钱的[34m瀚海之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m [33m土[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
