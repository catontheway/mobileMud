...
void create()
{
	set_name("[35m神鹰之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(4107);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","神鹰之匕首[2;37;0m这是一把由极其坚硬的[33m软铁[2;37;0m制成，重八斤二两一钱的[35m神鹰之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
