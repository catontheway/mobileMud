...
void create()
{
	set_name("[1;36m地锋之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(15069);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","地锋之剑[2;37;0m这是一把由非常坚硬的[33m软铁[2;37;0m制成，重三十斤一两三钱的[1;36m地锋之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
