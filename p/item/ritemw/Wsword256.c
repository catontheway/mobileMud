...
void create()
{
	set_name("[37m虎枭之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(10872);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","虎枭之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十一斤七两四钱的[37m虎枭之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
