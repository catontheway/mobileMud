...
void create()
{
	set_name("[1;36m飞雪之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(15083);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","飞雪之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重三十斤一两六钱的[1;36m飞雪之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 10);
