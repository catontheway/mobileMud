...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[1;31m麒麟之暗器[2;37;0m这是一支由无比坚硬的[1;32m绿石[2;37;0m制成，重一斤二两九钱的[1;31m麒麟之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m [1;37m雷[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
