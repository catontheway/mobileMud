...
void create()
{
	set_name("[1;34m小之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(4503);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","小之剑[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重九斤零两零钱的[1;34m小之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
