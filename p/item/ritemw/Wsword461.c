...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重十三斤四两九钱的[31m莫邪之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;31m创世[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 21);
    ...
    set("weapon_prop/max_busy_jiemai", 21);
    set("weapon_prop/max_busy_fenjin", 17);
...
//伤害防御类
    ...
    set("weapon_prop/week_injure", 17);
