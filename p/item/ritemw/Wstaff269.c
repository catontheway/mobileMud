...
void create()
{
	set_name("[31m天竹之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(1847);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","天竹之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重三斤六两九钱的[31m天竹之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [1;34m电[2;37;0m:[1;34m举世[2;37;0m [37m天[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
