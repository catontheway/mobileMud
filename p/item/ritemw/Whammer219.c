...
void create()
{
	set_name("[34m魂魄之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(11000);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","魂魄之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十二斤零两零钱的[34m魂魄之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
