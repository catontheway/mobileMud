...
void create()
{
	set_name("[1;31m皓齿之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(723);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","皓齿之暗器[2;37;0m这是一支由极为坚硬的[33m软铁[2;37;0m制成，重一斤四两四钱的[1;31m皓齿之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [31m火[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
