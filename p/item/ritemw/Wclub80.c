...
void create()
{
	set_name("[33m阔之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(6206);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阔之棍[2;37;0m这是一根由绝对坚硬的[32m青铜[2;37;0m制成，重十二斤四两一钱的[33m阔之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
