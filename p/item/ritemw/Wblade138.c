...
void create()
{
	set_name("[1;34m火薇之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(7583);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","火薇之刀[2;37;0m这是一柄由绝对坚硬的[33m生铁[2;37;0m制成，重十五斤一两六钱的[1;34m火薇之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m开元[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#[37m天[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
