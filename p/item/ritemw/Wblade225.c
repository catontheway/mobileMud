...
void create()
{
	set_name("[35m春兰之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(10074);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","春兰之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十斤一两四钱的[35m春兰之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 8);
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 20);
    ...
    //set("weapon_prop/hammer", 14);
    //set("weapon_prop/spear", 21);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_fenjin", 9);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 13);
