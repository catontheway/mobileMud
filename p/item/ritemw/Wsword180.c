...
void create()
{
	set_name("[1;37m登龙之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(15237);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","登龙之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重三十斤四两七钱的[1;37m登龙之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
