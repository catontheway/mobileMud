...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;34m在西方查理曼统治的时代，最简朴的剑也能值三头母牛的价钱。而查理大帝自己的那把传奇式的神兵“乔依乌斯”据说是半人半神的“韦兰铁匠”所造，乃当世界神兵！$br#[2;37;0m这是一根由无比坚硬的[31m流花石[2;37;0m制成，重三十斤七两三钱的[1;34m乔依乌斯之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m开元[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 24);
   // set("weapon_prop/cuff", 0);
    ...
    set("weapon_prop/force", 23);
    set("weapon_prop/dagge", 47);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 6);
...
//伤害防御类
    ...
    set("weapon_prop/defense_attack", 10);
