...
void create()
{
	set_name("[1;34m冬雨之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(9910);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","冬雨之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十九斤八两二钱的[1;34m冬雨之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[40m地[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
		...
		set("weapon_prop/personality",16);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 14);
