...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;32m鸟翔之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重三斤七两零钱的[1;32m鸟翔之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[31m精致[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
