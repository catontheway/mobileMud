...
void create()
{
	set_name("[37m渡心之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(11347);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","渡心之刀[2;37;0m这是一柄由比较坚硬的[33m生铁[2;37;0m制成，重二十二斤六两九钱的[37m渡心之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;34m举世[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
