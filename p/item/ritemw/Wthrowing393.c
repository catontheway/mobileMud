...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[37m雷电之暗器[2;37;0m这是一支由极其坚硬的[1;32m绿石[2;37;0m制成，重零斤八两九钱的[37m雷电之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
