...
void create()
{
	set_name("[1;31m白鶴之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(8039);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","白鶴之斧[2;37;0m这是一柄由绝对坚硬的[33m生铁[2;37;0m制成，重十六斤零两七钱的[1;31m白鶴之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
