...
void create()
{
	set_name("[34m叠之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(15179);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","叠之斧[2;37;0m这是一柄由相当坚硬的[32m青铜[2;37;0m制成，重三十斤三两五钱的[34m叠之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[36m不错[2;37;0m [37m天[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 2);
