...
void create()
{
	set_name("[35m烟雨之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(4501);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","烟雨之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重九斤零两零钱的[35m烟雨之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
