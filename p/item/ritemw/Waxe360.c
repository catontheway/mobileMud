...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[37m红玉之斧[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重十六斤五两零钱的[37m红玉之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m天圣[2;37;0m [33m土[2;37;0m:[1;36m完美[2;37;0m [1;34m电[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
     ...
     set("weapon_prop/magic", 39);
     
     
 //先天类    
		set("weapon_prop/intelligence",0);
		set("weapon_prop/strength",0);
		set("weapon_prop/personality",23);
