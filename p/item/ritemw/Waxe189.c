...
void create()
{
	set_name("[34m北天之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(13480);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","北天之斧[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重二十六斤九两六钱的[34m北天之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [31m火[2;37;0m:[1;36m完美[2;37;0m [33m土[2;37;0m:[1;31m开元[2;37;0m [1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
