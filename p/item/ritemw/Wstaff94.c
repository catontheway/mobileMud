...
void create()
{
	set_name("[31m阔之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(4951);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阔之杖[2;37;0m这是一根由绝对坚硬的[32m青铜[2;37;0m制成，重九斤九两零钱的[31m阔之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
