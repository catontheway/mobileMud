...
void create()
{
	set_name("[34m连衡之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(9277);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","连衡之棍[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重十八斤五两五钱的[34m连衡之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [33m土[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
