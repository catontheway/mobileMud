...
void create()
{
	set_name("[1;33m鱼鳞之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(7546);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","鱼鳞之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重十五斤零两九钱的[1;33m鱼鳞之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m [40m地[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
