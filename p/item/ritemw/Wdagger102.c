...
void create()
{
	set_name("[1;33m望霞之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(6870);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","望霞之匕首[2;37;0m这是一把由相当坚硬的[33m生铁[2;37;0m制成，重十三斤七两四钱的[1;33m望霞之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
