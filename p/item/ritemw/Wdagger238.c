...
void create()
{
	set_name("[1;37m慑魂之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(13959);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","慑魂之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十七斤九两一钱的[1;37m慑魂之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
