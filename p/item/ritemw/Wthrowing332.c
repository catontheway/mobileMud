...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[36m幻影之暗器[2;37;0m这是一支由十分坚硬的[1;32m绿石[2;37;0m制成，重一斤三两零钱的[36m幻影之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
