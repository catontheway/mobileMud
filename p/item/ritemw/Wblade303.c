...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[37m霹雳之刀[2;37;0m这是一柄由十分坚硬的[1;32m绿石[2;37;0m制成，重十三斤九两二钱的[37m霹雳之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 37);
