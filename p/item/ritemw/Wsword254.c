...
void create()
{
	set_name("[36m倒海之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(12578);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","倒海之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十五斤一两五钱的[36m倒海之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
