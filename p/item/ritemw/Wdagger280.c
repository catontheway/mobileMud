...
void create()
{
	set_name("[1;31m狮枭之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(6777);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","狮枭之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重十三斤五两五钱的[1;31m狮枭之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#[40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
