...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[32m天凤之鞭[2;37;0m这是一根由十分坚硬的[1;32m绿石[2;37;0m制成，重十三斤二两四钱的[32m天凤之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
