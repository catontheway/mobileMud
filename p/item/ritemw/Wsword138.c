...
void create()
{
	set_name("[31m霞蔚之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(4462);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","霞蔚之剑[2;37;0m这是一把由极其坚硬的[33m生铁[2;37;0m制成，重八斤九两二钱的[31m霞蔚之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
