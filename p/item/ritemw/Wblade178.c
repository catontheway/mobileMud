...
void create()
{
	set_name("[35m须弥之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(4813);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","须弥之刀[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重九斤六两二钱的[35m须弥之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
