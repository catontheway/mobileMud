...
void create()
{
	set_name("[31m钢之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(8100);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","钢之斧[2;37;0m这是一柄由极为坚硬的[32m青铜[2;37;0m制成，重十六斤二两零钱的[31m钢之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[34m细碎[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
