...
void create()
{
	set_name("[34m紫芒之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(11053);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","紫芒之杖[2;37;0m这是一根由绝对坚硬的[33m生铁[2;37;0m制成，重二十二斤一两零钱的[34m紫芒之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
