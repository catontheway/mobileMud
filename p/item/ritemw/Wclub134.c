...
void create()
{
	set_name("[1;35m海棠之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(6953);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","海棠之棍[2;37;0m这是一根由十分坚硬的[33m生铁[2;37;0m制成，重十三斤九两零钱的[1;35m海棠之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_fenjin", 3);
