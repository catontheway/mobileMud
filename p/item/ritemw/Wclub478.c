...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重四斤五两八钱的[31m胜邪之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [32m水[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/AllPoisonsImmune", 5);
...
//伤害防御类
    ...
    set("weapon_prop/abs_week_injure", 8);
...
//气血恢复治疗类
    ...
    set("weapon_prop/qi_recover", 49);
    set("weapon_prop/jing_recover", 0);
    set("weapon_prop/jingli_recover", 52);
