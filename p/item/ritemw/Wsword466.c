...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重六斤四两零钱的[31m胜邪之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
