...
void create()
{
	set_name("[31m豹枭之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(15164);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","豹枭之杖[2;37;0m这是一根由非常坚硬的[33m软铁[2;37;0m制成，重三十斤三两二钱的[31m豹枭之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m [40m地[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
