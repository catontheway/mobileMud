...
void create()
{
	set_name("[1;34m慈云之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(265);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","慈云之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重零斤五两三钱的[1;34m慈云之暗器[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
		...
		set("weapon_prop/personality",13);
