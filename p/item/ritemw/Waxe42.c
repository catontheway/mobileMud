...
void create()
{
	set_name("[1;37m巧之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(13992);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巧之斧[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重二十七斤九两八钱的[1;37m巧之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
