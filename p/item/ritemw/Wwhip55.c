...
void create()
{
	set_name("[1;32m宾之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(2712);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","宾之鞭[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重五斤四两二钱的[1;32m宾之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m [1;37m雷[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
