...
void create()
{
	set_name("[1;33m白陽之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(10852);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","白陽之锤[2;37;0m这是一柄由相当坚硬的[33m生铁[2;37;0m制成，重二十一斤七两零钱的[1;33m白陽之锤[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
