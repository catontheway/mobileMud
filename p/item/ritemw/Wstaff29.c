...
void create()
{
	set_name("[1;36m钢之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(4909);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","钢之杖[2;37;0m这是一根由比较坚硬的[32m青铜[2;37;0m制成，重九斤八两一钱的[1;36m钢之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
