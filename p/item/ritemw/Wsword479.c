...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一把由极为坚硬的[1;37m软银[2;37;0m制成，重二十九斤零两八钱的[31m龙泉之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 51);
