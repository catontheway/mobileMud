...
void create()
{
	set_name("[37m玉指之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(15073);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","玉指之鞭[2;37;0m这是一根由十分坚硬的[33m软铁[2;37;0m制成，重三十斤一两四钱的[37m玉指之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#[1;37m雷[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
