...
void create()
{
	set_name("[34m柔之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(13749);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","柔之剑[2;37;0m这是一把由绝对坚硬的[32m青铜[2;37;0m制成，重二十七斤四两九钱的[34m柔之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[36m不错[2;37;0m [1;36m人[2;37;0m:[34m细碎[2;37;0m [1;31m魔[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
