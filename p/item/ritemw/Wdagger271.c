...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","魂魄之匕首[2;37;0m这是一把由绝对坚硬的[33m软铁[2;37;0m制成，重五斤三两六钱的[1;37m魂魄之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [32m水[2;37;0m:[1;35m绝世[2;37;0m [1;37m雷[2;37;0m:[1;34m举世[2;37;0m [40m地[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 18);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 0);
    //set("weapon_prop/hand", 20);
