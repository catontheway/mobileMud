...
void create()
{
	set_name("[34m朝云之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(11310);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","朝云之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十二斤六两二钱的[34m朝云之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
