...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","铁之斧[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重十五斤二两八钱的[31m铁之斧[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_jiemai", 1);
