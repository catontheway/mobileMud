...
void create()
{
	set_name("[36m松纹之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(4227);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","松纹之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重八斤四两五钱的[36m松纹之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
