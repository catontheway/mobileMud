...
void create()
{
	set_name("[31m夏雨之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(5596);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","夏雨之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十一斤一两九钱的[31m夏雨之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
