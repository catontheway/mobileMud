...
void create()
{
	set_name("[1;32m旋风之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(10014);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","旋风之斧[2;37;0m这是一柄由绝对坚硬的[33m生铁[2;37;0m制成，重二十斤零两二钱的[1;32m旋风之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [31m火[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
