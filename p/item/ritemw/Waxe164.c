...
void create()
{
	set_name("[34m聚鹤之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(14848);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","聚鹤之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十九斤六两九钱的[34m聚鹤之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m [1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
