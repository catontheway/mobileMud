...
void create()
{
	set_name("[1;34m阖之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(12533);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阖之杖[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重二十五斤零两六钱的[1;34m阖之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
