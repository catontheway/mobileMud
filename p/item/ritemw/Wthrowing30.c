...
void create()
{
	set_name("[31m叠之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(485);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","叠之暗器[2;37;0m这是一支由十分坚硬的[32m青铜[2;37;0m制成，重零斤九两七钱的[31m叠之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
