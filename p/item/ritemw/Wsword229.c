...
void create()
{
	set_name("[31m白云之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(15277);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","白云之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重三十斤五两五钱的[31m白云之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[32m粗糙[2;37;0m [1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#[1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
