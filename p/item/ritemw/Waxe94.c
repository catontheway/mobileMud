...
void create()
{
	set_name("[1;34m铜之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(11813);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","铜之斧[2;37;0m这是一柄由还算坚硬的[32m青铜[2;37;0m制成，重二十三斤六两二钱的[1;34m铜之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
