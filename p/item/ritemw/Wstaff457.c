...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m巨阙坚硬无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由极为坚硬的[1;37m软银[2;37;0m制成，重十九斤三两零钱的[31m巨阙之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_body", 22);
    ...
    set("weapon_prop/kf_anti_hr", 23);
//伤害防御类
    set("weapon_prop/deep_injure", 24);
    set("weapon_prop/week_injure", 25);
    set("weapon_prop/abs_week_injure", 0);
    set("weapon_prop/defense_attack", 18);
    set("weapon_prop/armor_vs_force", 21);
