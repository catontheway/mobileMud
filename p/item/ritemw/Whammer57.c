...
void create()
{
	set_name("[35m韧之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(14503);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","韧之锤[2;37;0m这是一柄由极为坚硬的[32m青铜[2;37;0m制成，重二十九斤零两零钱的[35m韧之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[34m细碎[2;37;0m [1;36m人[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
