...
void create()
{
	set_name("[1;31m宾之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(3809);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","宾之杖[2;37;0m这是一根由还算坚硬的[32m青铜[2;37;0m制成，重七斤六两一钱的[1;31m宾之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
