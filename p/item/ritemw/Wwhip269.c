...
void create()
{
	set_name("[1;31m神光之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(15188);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","神光之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重三十斤三两七钱的[1;31m神光之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m开元[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m [1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
