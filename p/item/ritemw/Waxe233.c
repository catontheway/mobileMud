...
void create()
{
	set_name("[33m高山之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(4109);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","高山之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重八斤二两一钱的[33m高山之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [1;34m电[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
