...
void create()
{
	set_name("[1;32m富貴之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(8595);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","富貴之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重十七斤一两九钱的[1;32m富貴之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [1;34m电[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 7);
    set("weapon_prop/qi_recover", 9);
