...
void create()
{
	set_name("[1;34m猛虎之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(14832);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","猛虎之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十九斤六两六钱的[1;34m猛虎之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m创世[2;37;0m [33m土[2;37;0m:[1;35m绝世[2;37;0m [1;34m电[2;37;0m:[1;32m魔王[2;37;0m [1;31m魔[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 7);
