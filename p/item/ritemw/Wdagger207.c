...
void create()
{
	set_name("[1;34m秋菊之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(7109);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","秋菊之匕首[2;37;0m这是一把由非常坚硬的[33m软铁[2;37;0m制成，重十四斤二两一钱的[1;34m秋菊之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
