...
void create()
{
	set_name("[1;36m丹陽之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(12471);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","丹陽之刀[2;37;0m这是一柄由绝对坚硬的[33m生铁[2;37;0m制成，重二十四斤九两四钱的[1;36m丹陽之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#[1;37m雷[2;37;0m:[1;36m完美[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
