...
void create()
{
	set_name("[1;31m降魔之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(656);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","降魔之暗器[2;37;0m这是一支由无比坚硬的[33m生铁[2;37;0m制成，重一斤三两一钱的[1;31m降魔之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#[1;37m雷[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 7);
