...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！$br#[2;37;0m这是一柄由绝对坚硬的[1;37m软银[2;37;0m制成，重十二斤一两七钱的[31m湛卢之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m毁天[2;37;0m [36m木[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_confuse", 15);
    ...
    set("weapon_prop/PoisonAttack", 12);
    set("weapon_prop/kf_hit_rate", 13);
    set("weapon_prop/kf_anti_hr", 12);
//伤害防御类
