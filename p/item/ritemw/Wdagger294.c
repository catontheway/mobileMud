...
void create()
{
	set_name("[1;35m明月之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(12335);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","明月之匕首[2;37;0m这是一把由十分坚硬的[33m软铁[2;37;0m制成，重二十四斤六两七钱的[1;35m明月之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [33m土[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
