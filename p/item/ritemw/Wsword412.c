...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;32m天地浩气之神兵，扫魔除妖，为国为民，侠之大者！$br#[2;37;0m这是一把由相当坚硬的[31m流花石[2;37;0m制成，重二十斤四两九钱的[1;32m浩气之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
