...
void create()
{
	set_name("[37m寒梅之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(12463);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","寒梅之刀[2;37;0m这是一柄由相当坚硬的[33m生铁[2;37;0m制成，重二十四斤九两二钱的[37m寒梅之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
