...
void create()
{
	set_name("[1;31m上升之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(1143);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","上升之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二斤二两八钱的[1;31m上升之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m [31m火[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
