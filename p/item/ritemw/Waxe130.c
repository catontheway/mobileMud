...
void create()
{
	set_name("[1;34m金牛之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(9538);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","金牛之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十九斤零两七钱的[1;34m金牛之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
