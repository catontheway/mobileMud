...
void create()
{
	set_name("[37m相思之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(14265);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","相思之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十八斤五两三钱的[37m相思之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m天圣[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#[1;37m雷[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[35m标准[2;37;0m [1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 15);
    set("weapon_prop/jingli_recover", 0);
    set("weapon_prop/qi_cure", 12);
