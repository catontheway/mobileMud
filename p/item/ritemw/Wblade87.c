...
void create()
{
	set_name("[36m韧之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(14116);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","韧之刀[2;37;0m这是一柄由绝对坚硬的[32m青铜[2;37;0m制成，重二十八斤二两三钱的[36m韧之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
