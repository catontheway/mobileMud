...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","阔之棍[2;37;0m这是一根由绝对坚硬的[32m青铜[2;37;0m制成，重十九斤七两九钱的[1;32m阔之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[36m不错[2;37;0m $br#[1;36m人[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
