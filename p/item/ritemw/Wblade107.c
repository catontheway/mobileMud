...
void create()
{
	set_name("[1;34m蓝薇之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(8720);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","蓝薇之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十七斤四两四钱的[1;34m蓝薇之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
