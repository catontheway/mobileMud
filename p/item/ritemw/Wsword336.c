...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;32m破甲之剑[2;37;0m这是一把由相当坚硬的[1;32m绿石[2;37;0m制成，重三十一斤八两三钱的[1;32m破甲之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
