...
void create()
{
	set_name("[36m木樨之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(5991);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","木樨之锤[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重十一斤九两八钱的[36m木樨之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
