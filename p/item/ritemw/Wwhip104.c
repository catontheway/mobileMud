...
void create()
{
	set_name("[33m南天之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(14477);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","南天之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十八斤九两五钱的[33m南天之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
