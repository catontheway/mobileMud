...
void create()
{
	set_name("[37m巧之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(3133);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","巧之杖[2;37;0m这是一根由比较坚硬的[32m青铜[2;37;0m制成，重六斤二两六钱的[37m巧之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[34m细碎[2;37;0m [33m土[2;37;0m:[34m细碎[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#[1;36m人[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
