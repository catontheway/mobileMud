...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","巧之匕首[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重十五斤三两六钱的[1;36m巧之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
