...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[35m天玑之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重五斤七两八钱的[35m天玑之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m毁天[2;37;0m [36m木[2;37;0m:[1;32m魔王[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m [1;34m电[2;37;0m:[1;31m毁天[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
