...
void create()
{
	set_name("[33m矗页之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(6192);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","矗页之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重十二斤三两八钱的[33m矗页之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
