...
void create()
{
	set_name("[36m浮云之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(15993);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","浮云之杖[2;37;0m这是一根由极其坚硬的[33m软铁[2;37;0m制成，重三十一斤九两八钱的[36m浮云之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m [1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
