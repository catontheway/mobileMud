...
void create()
{
	set_name("[1;37m燕尾之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(6653);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","燕尾之棍[2;37;0m这是一根由十分坚硬的[33m软铁[2;37;0m制成，重十三斤三两零钱的[1;37m燕尾之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[1;33m天圣[2;37;0m [37m天[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
