...
void create()
{
	set_name("[1;35m月形之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(9816);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","月形之鞭[2;37;0m这是一根由极其坚硬的[33m生铁[2;37;0m制成，重十九斤六两三钱的[1;35m月形之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
