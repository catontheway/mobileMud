...
void create()
{
	set_name("[1;37m柔之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(11159);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","柔之杖[2;37;0m这是一根由极其坚硬的[32m青铜[2;37;0m制成，重二十二斤三两一钱的[1;37m柔之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
