...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[33m黄龙之暗器[2;37;0m这是一支由无比坚硬的[1;32m绿石[2;37;0m制成，重一斤一两三钱的[33m黄龙之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m毁天[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
