...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","螭吻之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十七斤六两零钱的[1;34m螭吻之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m [1;37m雷[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
