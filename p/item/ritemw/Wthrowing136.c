...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","清相之暗器[2;37;0m这是一支由极为坚硬的[33m生铁[2;37;0m制成，重一斤零两五钱的[35m清相之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [1;37m雷[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
