...
void create()
{
	set_name("[36m须弥之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(9901);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","须弥之棍[2;37;0m这是一根由相当坚硬的[33m生铁[2;37;0m制成，重十九斤八两零钱的[36m须弥之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[34m细碎[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
