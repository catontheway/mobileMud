...
void create()
{
	set_name("[1;32m月形之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(12743);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","月形之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十五斤四两八钱的[1;32m月形之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
