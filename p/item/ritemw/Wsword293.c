...
void create()
{
	set_name("[1;33m流波之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(11935);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","流波之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十三斤八两七钱的[1;33m流波之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
