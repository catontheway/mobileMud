...
void create()
{
	set_name("[1;35m泼水之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(15138);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","泼水之锤[2;37;0m这是一柄由十分坚硬的[33m软铁[2;37;0m制成，重三十斤二两七钱的[1;35m泼水之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m [1;35m风[2;37;0m:[35m标准[2;37;0m $br#[37m天[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
