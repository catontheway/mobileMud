...
void create()
{
	set_name("[1;35m飞武之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(14290);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","飞武之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十八斤五两八钱的[1;35m飞武之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/spear", 15);
    //set("weapon_prop/throwing", 13);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_jiemai", 6);
