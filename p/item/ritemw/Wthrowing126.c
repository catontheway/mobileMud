...
void create()
{
	set_name("[34m玫瑰之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(345);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","玫瑰之暗器[2;37;0m这是一支由非常坚硬的[33m生铁[2;37;0m制成，重零斤六两九钱的[34m玫瑰之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [1;37m雷[2;37;0m:[35m标准[2;37;0m [1;31m魔[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
