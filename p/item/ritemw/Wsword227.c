...
void create()
{
	set_name("[34m云髻之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(9111);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","云髻之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重十八斤二两二钱的[34m云髻之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [32m水[2;37;0m:[1;31m无双[2;37;0m [1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#[1;36m人[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
