...
void create()
{
	set_name("[33m地锋之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(7611);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","地锋之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十五斤二两二钱的[33m地锋之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
