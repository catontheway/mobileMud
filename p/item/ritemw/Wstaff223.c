...
void create()
{
	set_name("[37m慈云之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(12378);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","慈云之杖[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重二十四斤七两五钱的[37m慈云之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
