...
void create()
{
	set_name("[1;34m椒图之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(7182);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","椒图之斧[2;37;0m这是一柄由相当坚硬的[33m生铁[2;37;0m制成，重十四斤三两六钱的[1;34m椒图之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m [1;36m人[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
