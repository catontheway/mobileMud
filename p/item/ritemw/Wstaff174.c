...
void create()
{
	set_name("[37m杜鹃之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(2937);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","杜鹃之杖[2;37;0m这是一根由绝对坚硬的[33m生铁[2;37;0m制成，重五斤八两七钱的[37m杜鹃之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m [1;37m雷[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
