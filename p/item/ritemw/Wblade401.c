...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[1;36m天地之初，女娲补天所留下的天地间至尊之物之一经千秋万载所制，功能开天劈地！$br#[2;37;0m这是一柄由相当坚硬的[31m流花石[2;37;0m制成，重二十八斤三两九钱的[1;36m天地之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
