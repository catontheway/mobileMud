...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[35m开阳之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二十四斤一两四钱的[35m开阳之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
