...
void create()
{
	set_name("[33m阔之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(2453);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阔之杖[2;37;0m这是一根由比较坚硬的[32m青铜[2;37;0m制成，重四斤九两零钱的[33m阔之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
