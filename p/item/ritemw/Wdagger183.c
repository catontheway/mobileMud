...
void create()
{
	set_name("[1;34m黑魅之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(12997);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","黑魅之匕首[2;37;0m这是一把由非常坚硬的[33m生铁[2;37;0m制成，重二十五斤九两九钱的[1;34m黑魅之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
