...
void create()
{
	set_name("[1;36m啼莺之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(4347);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","啼莺之剑[2;37;0m这是一把由绝对坚硬的[33m软铁[2;37;0m制成，重八斤六两九钱的[1;36m啼莺之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
