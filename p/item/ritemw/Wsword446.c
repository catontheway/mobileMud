...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;35m所谓风云际会，天地变色！仗此行千里，老魔小丑，岂堪一击！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重二十九斤九两七钱的[1;35m风云之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [36m木[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
