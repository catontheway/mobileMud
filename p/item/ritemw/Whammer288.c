...
void create()
{
	set_name("[36m天竹之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(13528);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天竹之锤[2;37;0m这是一柄由非常坚硬的[33m软铁[2;37;0m制成，重二十七斤零两五钱的[36m天竹之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m [1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
