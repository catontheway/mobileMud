...
void create()
{
	set_name("[1;35m弦月之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(3023);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","弦月之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重六斤零两四钱的[1;35m弦月之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
