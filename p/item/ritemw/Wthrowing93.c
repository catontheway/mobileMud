...
void create()
{
	set_name("[36m巨之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(356);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","巨之暗器[2;37;0m这是一支由无比坚硬的[32m青铜[2;37;0m制成，重零斤七两一钱的[36m巨之暗器[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_all_busy", 4);
