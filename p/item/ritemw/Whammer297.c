...
void create()
{
	set_name("[33m鬼气之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(8738);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","鬼气之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十七斤四两七钱的[33m鬼气之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m [37m天[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
