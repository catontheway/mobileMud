...
void create()
{
	set_name("[1;35m狂龙之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(70);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","狂龙之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重零斤一两四钱的[1;35m狂龙之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m [1;34m电[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 18);
