...
void create()
{
	set_name("[35m娥眉之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(14728);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","娥眉之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十九斤四两五钱的[35m娥眉之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
