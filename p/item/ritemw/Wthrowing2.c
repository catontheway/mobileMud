...
void create()
{
	set_name("[1;35m钢之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(125);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","钢之暗器[2;37;0m这是一支由还算坚硬的[32m青铜[2;37;0m制成，重零斤二两五钱的[1;35m钢之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
