...
void create()
{
	set_name("[1;34m赤霞之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(9772);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","赤霞之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十九斤五两四钱的[1;34m赤霞之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
