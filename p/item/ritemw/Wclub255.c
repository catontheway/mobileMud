...
void create()
{
	set_name("[34m青羊之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(15157);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","青羊之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重三十斤三两一钱的[34m青羊之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m [31m火[2;37;0m:[32m粗糙[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
