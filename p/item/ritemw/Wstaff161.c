...
void create()
{
	set_name("[1;35m璨星之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(12667);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","璨星之杖[2;37;0m这是一根由绝对坚硬的[33m生铁[2;37;0m制成，重二十五斤三两三钱的[1;35m璨星之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m [1;34m电[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
