...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重十五斤九两一钱的[31m莫邪之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
