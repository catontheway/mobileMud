...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一柄由极其坚硬的[1;37m软银[2;37;0m制成，重十九斤八两四钱的[31m鱼肠之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [31m火[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
