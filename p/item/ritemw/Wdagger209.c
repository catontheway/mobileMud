...
void create()
{
	set_name("[1;34m芙蓉之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(15253);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","芙蓉之匕首[2;37;0m这是一把由相当坚硬的[33m软铁[2;37;0m制成，重三十斤五两零钱的[1;34m芙蓉之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
