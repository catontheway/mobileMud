...
void create()
{
	set_name("[1;35m小之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(3397);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","小之鞭[2;37;0m这是一根由极为坚硬的[32m青铜[2;37;0m制成，重六斤七两九钱的[1;35m小之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[34m细碎[2;37;0m [33m土[2;37;0m:[33m很高[2;37;0m [1;36m人[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
