...
void create()
{
	set_name("[1;32m赤云之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(12851);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","赤云之锤[2;37;0m这是一柄由极其坚硬的[33m软铁[2;37;0m制成，重二十五斤七两零钱的[1;32m赤云之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;34m举世[2;37;0m [1;36m人[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
