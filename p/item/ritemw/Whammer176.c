...
void create()
{
	set_name("[36m白荷之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(6920);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","白荷之锤[2;37;0m这是一柄由非常坚硬的[33m生铁[2;37;0m制成，重十三斤八两四钱的[36m白荷之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
