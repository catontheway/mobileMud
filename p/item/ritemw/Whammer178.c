...
void create()
{
	set_name("[35m相思之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(8919);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","相思之锤[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重十七斤八两三钱的[35m相思之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
