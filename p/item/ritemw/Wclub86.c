...
void create()
{
	set_name("[36m铜之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(2417);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","铜之棍[2;37;0m这是一根由绝对坚硬的[32m青铜[2;37;0m制成，重四斤八两三钱的[36m铜之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
