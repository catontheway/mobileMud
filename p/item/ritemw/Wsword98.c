...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","大之剑[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重七斤八两七钱的[33m大之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
