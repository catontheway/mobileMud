...
void create()
{
	set_name("[1;35m银铃之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(6508);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","银铃之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十三斤零两一钱的[1;35m银铃之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
