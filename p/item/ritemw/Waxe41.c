...
void create()
{
	set_name("[1;37m钢之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(14115);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","钢之斧[2;37;0m这是一柄由十分坚硬的[32m青铜[2;37;0m制成，重二十八斤二两三钱的[1;37m钢之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
