...
void create()
{
	set_name("[1;37m怪之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(5372);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","怪之斧[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重十斤七两四钱的[1;37m怪之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[34m细碎[2;37;0m [32m水[2;37;0m:[32m粗糙[2;37;0m [31m火[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
