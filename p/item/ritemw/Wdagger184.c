...
void create()
{
	set_name("[37m飘雪之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(12021);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","飘雪之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十四斤零两四钱的[37m飘雪之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[35m标准[2;37;0m $br#[37m天[2;37;0m:[33m很高[2;37;0m [1;36m人[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
