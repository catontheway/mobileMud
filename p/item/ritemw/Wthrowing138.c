...
void create()
{
	set_name("[1;31m月龙之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(710);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","月龙之暗器[2;37;0m这是一支由十分坚硬的[33m生铁[2;37;0m制成，重一斤四两二钱的[1;31m月龙之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[33m很高[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
