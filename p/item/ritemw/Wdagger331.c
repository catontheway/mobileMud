...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[36m幻影之匕首[2;37;0m这是一把由极为坚硬的[1;32m绿石[2;37;0m制成，重二十九斤零两六钱的[36m幻影之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m无双[2;37;0m [1;36m人[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
