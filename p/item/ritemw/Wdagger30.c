...
void create()
{
	set_name("[1;31m小之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(14097);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","小之匕首[2;37;0m这是一把由十分坚硬的[32m青铜[2;37;0m制成，重二十八斤一两九钱的[1;31m小之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
