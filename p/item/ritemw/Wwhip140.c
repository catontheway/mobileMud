...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","飞凤之鞭[2;37;0m这是一根由极其坚硬的[33m生铁[2;37;0m制成，重九斤二两八钱的[31m飞凤之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;32m魔王[2;37;0m [1;34m电[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 16);
