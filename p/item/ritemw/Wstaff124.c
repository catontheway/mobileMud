...
void create()
{
	set_name("[1;34m白荷之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(14223);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","白荷之杖[2;37;0m这是一根由比较坚硬的[33m生铁[2;37;0m制成，重二十八斤四两四钱的[1;34m白荷之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
