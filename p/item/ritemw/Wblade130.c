...
void create()
{
	set_name("[36m青鶴之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(7377);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","青鶴之刀[2;37;0m这是一柄由比较坚硬的[33m生铁[2;37;0m制成，重十四斤七两五钱的[36m青鶴之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m [1;35m风[2;37;0m:[35m标准[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
