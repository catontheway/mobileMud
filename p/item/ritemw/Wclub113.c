...
void create()
{
	set_name("[31m璨星之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(6336);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","璨星之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重十二斤六两七钱的[31m璨星之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
