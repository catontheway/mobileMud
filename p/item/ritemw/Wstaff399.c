...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[36m王者之杖[2;37;0m这是一根由十分坚硬的[1;32m绿石[2;37;0m制成，重八斤一两九钱的[36m王者之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#[40m地[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    set("weapon_prop/kf_def_wound", 9);
    ...
    set("weapon_prop/max_busy_dianxue", 6);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 17);
    set("weapon_prop/jingli_recover", 0);
    set("weapon_prop/qi_cure", 18);
