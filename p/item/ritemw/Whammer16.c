...
void create()
{
	set_name("[1;37m钢之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(7593);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","钢之锤[2;37;0m这是一柄由极其坚硬的[32m青铜[2;37;0m制成，重十五斤一两八钱的[1;37m钢之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
