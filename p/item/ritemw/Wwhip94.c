...
void create()
{
	set_name("[1;37m竹之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(7767);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","竹之鞭[2;37;0m这是一根由非常坚硬的[32m青铜[2;37;0m制成，重十五斤五两三钱的[1;37m竹之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#[37m天[2;37;0m:[36m不错[2;37;0m [1;36m人[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
