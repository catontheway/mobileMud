...
void create()
{
	set_name("[36m赤霞之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(562);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","赤霞之暗器[2;37;0m这是一支由极其坚硬的[33m生铁[2;37;0m制成，重一斤一两二钱的[36m赤霞之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
