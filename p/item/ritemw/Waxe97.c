...
void create()
{
	set_name("[36m宾之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(8735);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","宾之斧[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重十七斤四两七钱的[36m宾之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[34m细碎[2;37;0m $br#[1;36m人[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
