...
void create()
{
	set_name("[35m小之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(15843);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","小之斧[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重三十一斤六两八钱的[35m小之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[33m很高[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
