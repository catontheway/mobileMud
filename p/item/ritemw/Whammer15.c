...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","竹之锤[2;37;0m这是一柄由十分坚硬的[32m青铜[2;37;0m制成，重二十斤六两九钱的[36m竹之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m [31m火[2;37;0m:[32m粗糙[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
