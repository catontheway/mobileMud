...
void create()
{
	set_name("[35m连衡之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(9511);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","连衡之斧[2;37;0m这是一柄由极为坚硬的[33m软铁[2;37;0m制成，重十九斤零两二钱的[35m连衡之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
