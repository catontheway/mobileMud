...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[1;32m婉盘之暗器[2;37;0m这是一支由无比坚硬的[1;32m绿石[2;37;0m制成，重一斤二两二钱的[1;32m婉盘之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#[1;37m雷[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
