...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重十九斤五两四钱的[31m湛卢之锤[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 38);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 25);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_jiemai", 14);
    set("weapon_prop/cant_busy_fenjin", 0);
    set("weapon_prop/cant_busy_confuse", 9);
