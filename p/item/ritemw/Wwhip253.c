...
void create()
{
	set_name("[1;31m双锋之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(5968);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","双锋之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十一斤九两三钱的[1;31m双锋之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
