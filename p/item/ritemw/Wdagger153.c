...
void create()
{
	set_name("[37m秀骨之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(12536);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","秀骨之匕首[2;37;0m这是一把由极为坚硬的[33m生铁[2;37;0m制成，重二十五斤零两七钱的[37m秀骨之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m [32m水[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/hand", 12);
    set("weapon_prop/parry", 0);
    //set("weapon_prop/strike", 8);
