...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;31m炎龙之棍[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重三十斤零两九钱的[1;31m炎龙之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/hammer", 32);
    //set("weapon_prop/spear", 20);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 5);
