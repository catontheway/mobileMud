...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重一斤一两八钱的[31m龙泉之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;31m开元[2;37;0m [1;35m风[2;37;0m:[1;31m创世[2;37;0m $br#[1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_body", 20);
    set("weapon_prop/max_all_busy", 21);
    set("weapon_prop/max_busy_dianxue", 0);
    set("weapon_prop/max_busy_jiemai", 19);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 53);
    set("weapon_prop/jingli_recover", 33);
    set("weapon_prop/qi_cure", 0);
    set("weapon_prop/jing_cure", 39);
