...
void create()
{
	set_name("[1;36m铁之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(13129);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","铁之匕首[2;37;0m这是一把由相当坚硬的[32m青铜[2;37;0m制成，重二十六斤二两五钱的[1;36m铁之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[34m细碎[2;37;0m [33m土[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
