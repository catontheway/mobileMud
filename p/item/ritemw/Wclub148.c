...
void create()
{
	set_name("[31m绿影之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(15727);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","绿影之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重三十一斤四两五钱的[31m绿影之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [31m火[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/finger", 14);
    //set("weapon_prop/hand", 10);
