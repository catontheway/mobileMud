...
void create()
{
	set_name("[37m璨星之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(12077);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","璨星之棍[2;37;0m这是一根由极为坚硬的[33m生铁[2;37;0m制成，重二十四斤一两五钱的[37m璨星之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m天圣[2;37;0m [1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
