...
void create()
{
	set_name("[1;37m宾之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(14079);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","宾之斧[2;37;0m这是一柄由极为坚硬的[32m青铜[2;37;0m制成，重二十八斤一两五钱的[1;37m宾之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
