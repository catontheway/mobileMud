...
void create()
{
	set_name("[1;36m天锋之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(2367);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天锋之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重四斤七两三钱的[1;36m天锋之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [1;37m雷[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
