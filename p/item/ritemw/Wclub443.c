...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;36m大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”$br#[2;37;0m这是一根由无比坚硬的[31m流花石[2;37;0m制成，重十一斤一两一钱的[1;36m三清之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m [1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
