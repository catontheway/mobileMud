...
void create()
{
	set_name("[1;31m狮吼之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(2542);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","狮吼之斧[2;37;0m这是一柄由十分坚硬的[33m软铁[2;37;0m制成，重五斤零两八钱的[1;31m狮吼之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m [40m地[2;37;0m:[1;35m绝世[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
