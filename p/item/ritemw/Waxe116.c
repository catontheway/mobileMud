...
void create()
{
	set_name("[1;36m天师之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(4121);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天师之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重八斤二两四钱的[1;36m天师之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
