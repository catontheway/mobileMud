...
void create()
{
	set_name("[36m钢之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(7529);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","钢之斧[2;37;0m这是一柄由十分坚硬的[32m青铜[2;37;0m制成，重十五斤零两五钱的[36m钢之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
