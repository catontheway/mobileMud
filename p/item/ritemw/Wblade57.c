...
void create()
{
	set_name("[37m阔之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(7361);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","阔之刀[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重十四斤七两二钱的[37m阔之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
