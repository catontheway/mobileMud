...
void create()
{
	set_name("[31m大之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(15430);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","大之鞭[2;37;0m这是一根由非常坚硬的[32m青铜[2;37;0m制成，重三十斤八两六钱的[31m大之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
