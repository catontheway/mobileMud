...
void create()
{
	set_name("[1;33m缦理之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(1244);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","缦理之棍[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重二斤四两八钱的[1;33m缦理之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [1;37m雷[2;37;0m:[1;34m举世[2;37;0m [1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
		...
		set("weapon_prop/personality",11);
