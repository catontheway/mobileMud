...
void create()
{
	set_name("[31m绿影之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(15922);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","绿影之锤[2;37;0m这是一柄由绝对坚硬的[33m生铁[2;37;0m制成，重三十一斤八两四钱的[31m绿影之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#[1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
