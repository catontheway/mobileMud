...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","柔之暗器[2;37;0m这是一支由相当坚硬的[32m青铜[2;37;0m制成，重零斤二两六钱的[37m柔之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
