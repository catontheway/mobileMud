...
void create()
{
	set_name("[35m聚泉之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(3588);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","聚泉之鞭[2;37;0m这是一根由极为坚硬的[33m生铁[2;37;0m制成，重七斤一两七钱的[35m聚泉之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [32m水[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
