...
void create()
{
	set_name("[1;34m玫瑰之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(5040);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","玫瑰之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重十斤零两八钱的[1;34m玫瑰之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
