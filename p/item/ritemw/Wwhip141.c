...
void create()
{
	set_name("[37m霞蔚之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(2395);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","霞蔚之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重四斤七两九钱的[37m霞蔚之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
