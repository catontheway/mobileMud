...
void create()
{
	set_name("[1;36m雪花之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(8725);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","雪花之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重十七斤四两五钱的[1;36m雪花之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
