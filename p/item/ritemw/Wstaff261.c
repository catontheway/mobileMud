...
void create()
{
	set_name("[33m秋菊之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(11981);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","秋菊之杖[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重二十三斤九两六钱的[33m秋菊之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m [1;34m电[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
