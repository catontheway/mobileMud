...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;36m大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”$br#[2;37;0m这是一根由极其坚硬的[31m流花石[2;37;0m制成，重九斤一两八钱的[1;36m三清之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m [32m水[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    set("weapon_prop/force", 17);
    set("weapon_prop/dagge", 0);
    //set("weapon_prop/hammer", 20);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 23);
