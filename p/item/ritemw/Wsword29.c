...
void create()
{
	set_name("[1;31m铁之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(3939);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","铁之剑[2;37;0m这是一把由还算坚硬的[32m青铜[2;37;0m制成，重七斤八两七钱的[1;31m铁之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
