...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[32m凤舞之棍[2;37;0m这是一根由极其坚硬的[1;32m绿石[2;37;0m制成，重二十七斤二两七钱的[32m凤舞之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m [31m火[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
