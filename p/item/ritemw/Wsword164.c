...
void create()
{
	set_name("[1;37m富貴之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(14697);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","富貴之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十九斤三两九钱的[1;37m富貴之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 9);
