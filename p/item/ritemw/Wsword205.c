...
void create()
{
	set_name("[1;36m素臂之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(3556);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","素臂之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重七斤一两一钱的[1;36m素臂之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
