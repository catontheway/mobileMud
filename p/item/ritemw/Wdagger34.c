...
void create()
{
	set_name("[34m钢之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(10567);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","钢之匕首[2;37;0m这是一把由还算坚硬的[32m青铜[2;37;0m制成，重二十一斤一两三钱的[34m钢之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[36m不错[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
