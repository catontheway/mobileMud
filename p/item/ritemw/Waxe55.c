...
void create()
{
	set_name("[36m大之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(2325);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","大之斧[2;37;0m这是一柄由绝对坚硬的[32m青铜[2;37;0m制成，重四斤六两五钱的[36m大之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
