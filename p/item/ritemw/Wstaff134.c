...
void create()
{
	set_name("[36m洛神之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(15886);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","洛神之杖[2;37;0m这是一根由极其坚硬的[33m生铁[2;37;0m制成，重三十一斤七两七钱的[36m洛神之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
