...
void create()
{
	set_name("[35m圣母之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(3459);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","圣母之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重六斤九两一钱的[35m圣母之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
