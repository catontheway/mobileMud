...
void create()
{
	set_name("[1;37m地门之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(14400);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","地门之匕首[2;37;0m这是一把由绝对坚硬的[33m软铁[2;37;0m制成，重二十八斤八两零钱的[1;37m地门之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
