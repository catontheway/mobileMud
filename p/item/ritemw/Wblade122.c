...
void create()
{
	set_name("[33m海棠之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(9728);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","海棠之刀[2;37;0m这是一柄由十分坚硬的[33m生铁[2;37;0m制成，重十九斤四两五钱的[33m海棠之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
