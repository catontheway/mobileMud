...
void create()
{
	set_name("[35m叠之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(1882);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","叠之斧[2;37;0m这是一柄由相当坚硬的[32m青铜[2;37;0m制成，重三斤七两六钱的[35m叠之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
