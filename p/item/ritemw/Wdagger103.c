...
void create()
{
	set_name("[1;32m文昌之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(7958);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","文昌之匕首[2;37;0m这是一把由比较坚硬的[33m生铁[2;37;0m制成，重十五斤九两一钱的[1;32m文昌之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
