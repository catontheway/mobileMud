...
void create()
{
	set_name("[1;35m泼水之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(14567);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","泼水之刀[2;37;0m这是一柄由十分坚硬的[33m软铁[2;37;0m制成，重二十九斤一两三钱的[1;35m泼水之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
