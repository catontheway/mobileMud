...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重十八斤九两九钱的[31m龙泉之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_dianxue", 26);
    set("weapon_prop/max_busy_jiemai", 0);
    set("weapon_prop/max_busy_fenjin", 20);
    set("weapon_prop/max_busy_confuse", 24);
...
//伤害防御类
    ...
    set("weapon_prop/armor_vs_force", 26);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 36);
