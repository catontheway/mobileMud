...
void create()
{
	set_name("[37m浮云之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(167);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","浮云之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重零斤三两三钱的[37m浮云之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [36m木[2;37;0m:[1;35m绝世[2;37;0m [1;35m风[2;37;0m:[35m标准[2;37;0m $br#[1;37m雷[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
