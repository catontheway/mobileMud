...
void create()
{
	set_name("[1;35m天羽之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(2152);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天羽之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重四斤三两零钱的[1;35m天羽之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
