...
void create()
{
	set_name("[31m青陽之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(10116);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","青陽之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十斤二两三钱的[31m青陽之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
