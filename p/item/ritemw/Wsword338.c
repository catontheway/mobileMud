...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[36m青索之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重七斤五两九钱的[36m青索之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;34m举世[2;37;0m [1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
