...
void create()
{
	set_name("[35m巧之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(8783);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","巧之棍[2;37;0m这是一根由绝对坚硬的[32m青铜[2;37;0m制成，重十七斤五两六钱的[35m巧之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
