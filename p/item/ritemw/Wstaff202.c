...
void create()
{
	set_name("[1;31m无敌之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(14595);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","无敌之杖[2;37;0m这是一根由极为坚硬的[33m软铁[2;37;0m制成，重二十九斤一两九钱的[1;31m无敌之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
