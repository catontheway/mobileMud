...
void create()
{
	set_name("[1;36m神狮之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(14370);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","神狮之锤[2;37;0m这是一柄由极为坚硬的[33m软铁[2;37;0m制成，重二十八斤七两四钱的[1;36m神狮之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
