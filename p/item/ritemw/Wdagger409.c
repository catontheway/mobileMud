...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;31m三十三天下有地，地下有城，城名鬼城，大小妖魔，人神畜生都在此轮回往返，谓之“炼狱”！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重三斤四两六钱的[1;31m炼狱之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
