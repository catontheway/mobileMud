...
void create()
{
	set_name("[1;34m铜之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(12616);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","铜之匕首[2;37;0m这是一把由十分坚硬的[32m青铜[2;37;0m制成，重二十五斤二两三钱的[1;34m铜之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m [33m土[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
