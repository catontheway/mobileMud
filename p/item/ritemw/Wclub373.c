...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;31m炎龙之棍[2;37;0m这是一根由十分坚硬的[1;32m绿石[2;37;0m制成，重七斤九两八钱的[1;31m炎龙之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [1;37m雷[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_fenjin", 4);
    set("weapon_prop/max_busy_confuse", 3);
