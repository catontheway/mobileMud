...
void create()
{
	set_name("[36m烟雨之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(12651);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","烟雨之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十五斤三两零钱的[36m烟雨之杖[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
