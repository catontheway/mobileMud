...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m工布天生怪异，功能参商！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重三十一斤七两三钱的[31m工布之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;31m毁天[2;37;0m [1;36m人[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_jiemai", 10);
    ...
    set("weapon_prop/max_busy_jiemai", 7);
...
//伤害防御类
    ...
    set("weapon_prop/armor_effect_armor_vs_force", 12);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 62);
