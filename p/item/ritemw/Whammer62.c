...
void create()
{
	set_name("[35m巧之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(5078);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巧之锤[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重十斤一两五钱的[35m巧之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m [37m天[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
