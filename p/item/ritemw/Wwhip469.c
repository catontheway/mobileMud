...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重九斤八两零钱的[31m胜邪之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 45);
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/unarmed", 50);
    //set("weapon_prop/blade", 63);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 0);
    set("weapon_prop/force", 63);
...
//特效数值
    ...
    set("weapon_prop/max_busy_jiemai", 23);
