...
void create()
{
	set_name("[1;36m霞蔚之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(13257);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","霞蔚之锤[2;37;0m这是一柄由极为坚硬的[33m生铁[2;37;0m制成，重二十六斤五两一钱的[1;36m霞蔚之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
