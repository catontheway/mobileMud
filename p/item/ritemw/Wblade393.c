...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[35m开阳之刀[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重二十五斤六两一钱的[35m开阳之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;35m绝世[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
