...
void create()
{
	set_name("[33m常青之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(487);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","常青之暗器[2;37;0m这是一支由相当坚硬的[33m生铁[2;37;0m制成，重零斤九两七钱的[33m常青之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
