...
void create()
{
	set_name("[34m青云之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(9887);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","青云之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重十九斤七两七钱的[34m青云之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
