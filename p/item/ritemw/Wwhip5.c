...
void create()
{
	set_name("[1;37m柔之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(14096);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","柔之鞭[2;37;0m这是一根由极其坚硬的[32m青铜[2;37;0m制成，重二十八斤一两九钱的[1;37m柔之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[36m不错[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
