...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;31m天兵神通，走势要平善，气要随行，两眼顾尖，气沉两足稳，身法需自然，身行如飞燕，身落如停风，收如花絮，刺如钢钉！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重二斤八两三钱的[1;31m神通之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m [37m天[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
