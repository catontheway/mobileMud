...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[37m雷电之杖[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重十六斤七两二钱的[37m雷电之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m [40m地[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
