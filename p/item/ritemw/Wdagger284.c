...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","仙水之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十二斤四两二钱的[1;36m仙水之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#[1;36m人[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
