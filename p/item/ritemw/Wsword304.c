...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;32m破甲之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重三斤八两四钱的[1;32m破甲之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
