...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","铜之匕首[2;37;0m这是一把由极为坚硬的[32m青铜[2;37;0m制成，重十四斤七两零钱的[1;36m铜之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/blade", 3);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 3);
