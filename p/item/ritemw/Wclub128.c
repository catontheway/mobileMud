...
void create()
{
	set_name("[37m富貴之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(14687);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","富貴之棍[2;37;0m这是一根由非常坚硬的[33m生铁[2;37;0m制成，重二十九斤三两七钱的[37m富貴之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[34m细碎[2;37;0m [1;35m风[2;37;0m:[34m细碎[2;37;0m $br#[1;37m雷[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
