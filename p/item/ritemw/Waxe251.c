...
void create()
{
	set_name("[36m慑魂之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(12526);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","慑魂之斧[2;37;0m这是一柄由十分坚硬的[33m软铁[2;37;0m制成，重二十五斤零两五钱的[36m慑魂之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
