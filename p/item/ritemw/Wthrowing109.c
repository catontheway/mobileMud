...
void create()
{
	set_name("[1;32m矗页之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(489);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","矗页之暗器[2;37;0m这是一支由无比坚硬的[33m生铁[2;37;0m制成，重零斤九两七钱的[1;32m矗页之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 8);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 0);
    //set("weapon_prop/hand", 0);
    set("weapon_prop/parry", 0);
    //set("weapon_prop/strike", 16);
    //set("weapon_prop/unarmed", 15);
...
//特效数值
    ...
    set("weapon_prop/AllPoisonsImmune", 8);
...
//气血恢复治疗类
    ...
    set("weapon_prop/qi_recover", 16);
    set("weapon_prop/jing_recover", 10);
