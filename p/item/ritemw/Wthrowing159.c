...
void create()
{
	set_name("[1;36m青陽之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(771);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","青陽之暗器[2;37;0m这是一支由相当坚硬的[33m生铁[2;37;0m制成，重一斤五两四钱的[1;36m青陽之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
