...
void create()
{
	set_name("[1;37m玉泉之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(2721);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","玉泉之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重五斤四两四钱的[1;37m玉泉之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m [37m天[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
