...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m工布天生怪异，功能参商！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重零斤七两六钱的[31m工布之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m毁天[2;37;0m [1;36m人[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_fenjin", 18);
