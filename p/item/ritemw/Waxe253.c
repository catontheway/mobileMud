...
void create()
{
	set_name("[34m皓齿之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(5165);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","皓齿之斧[2;37;0m这是一柄由十分坚硬的[33m软铁[2;37;0m制成，重十斤三两三钱的[34m皓齿之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 0);
     ...
     set("weapon_prop/dodge_factor", 3);
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 25);
