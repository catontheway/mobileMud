...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;37m八卦有“休”“生”“伤”“杜”“死”“景”“惊”“开”之别，创自诸葛武候，集天下万变于一身！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重十七斤九两四钱的[1;37m八卦之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    set("weapon_prop/force", 44);
    set("weapon_prop/dagge", 25);
    //set("weapon_prop/hammer", 24);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_jiemai", 4);
