...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一把由极为坚硬的[1;37m软银[2;37;0m制成，重七斤五两三钱的[31m莫邪之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_body", 16);
...
//伤害防御类
    ...
    set("weapon_prop/week_injure", 16);
...
//气血恢复治疗类
    ...
    set("weapon_prop/qi_cure", 35);
    set("weapon_prop/jing_cure", 55);
