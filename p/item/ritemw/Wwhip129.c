...
void create()
{
	set_name("[31m摘星之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(7948);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","摘星之鞭[2;37;0m这是一根由非常坚硬的[33m生铁[2;37;0m制成，重十五斤八两九钱的[31m摘星之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [1;34m电[2;37;0m:[1;32m魔王[2;37;0m [40m地[2;37;0m:[1;34m举世[2;37;0m [1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 8);
    ...
    //set("weapon_prop/strike", 13);
    //set("weapon_prop/unarmed", 9);
    //set("weapon_prop/blade", 12);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 0);
    set("weapon_prop/force", 0);
    set("weapon_prop/dagge", 11);
