...
void create()
{
	set_name("[35m天门之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(5087);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","天门之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重十斤一两七钱的[35m天门之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
