...
void create()
{
	set_name("[35m泪痕之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(6012);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","泪痕之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十二斤零两二钱的[35m泪痕之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;34m举世[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
