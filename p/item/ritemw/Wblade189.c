...
void create()
{
	set_name("[36m武圣之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(6779);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","武圣之刀[2;37;0m这是一柄由十分坚硬的[33m生铁[2;37;0m制成，重十三斤五两五钱的[36m武圣之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
