...
void create()
{
	set_name("[1;33m双手之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(12146);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","双手之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十四斤二两九钱的[1;33m双手之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;35m绝世[2;37;0m [1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 17);
   // set("weapon_prop/cuff", 8);
    ...
    set("weapon_prop/force", 13);
    set("weapon_prop/dagge", 0);
    //set("weapon_prop/hammer", 23);
