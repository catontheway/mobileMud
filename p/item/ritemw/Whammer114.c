...
void create()
{
	set_name("[1;37m巨威之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(2179);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巨威之锤[2;37;0m这是一柄由非常坚硬的[33m生铁[2;37;0m制成，重四斤三两五钱的[1;37m巨威之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [36m木[2;37;0m:[1;33m天圣[2;37;0m [1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#[1;34m电[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
