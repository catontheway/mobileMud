...
void create()
{
	set_name("[1;32m相思之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(4109);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","相思之杖[2;37;0m这是一根由十分坚硬的[33m生铁[2;37;0m制成，重八斤二两一钱的[1;32m相思之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
