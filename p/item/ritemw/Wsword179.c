...
void create()
{
	set_name("[35m富貴之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(15236);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","富貴之剑[2;37;0m这是一把由十分坚硬的[33m生铁[2;37;0m制成，重三十斤四两七钱的[35m富貴之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
