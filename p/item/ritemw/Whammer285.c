...
void create()
{
	set_name("[1;33m流波之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(11165);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","流波之锤[2;37;0m这是一柄由极其坚硬的[33m软铁[2;37;0m制成，重二十二斤三两三钱的[1;33m流波之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m [1;37m雷[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
