...
void create()
{
	set_name("[34m睚眦之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(1827);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","睚眦之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重三斤六两五钱的[34m睚眦之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 12);
