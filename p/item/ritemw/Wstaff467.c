...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m巨阙坚硬无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重二十三斤一两八钱的[31m巨阙之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m毁天[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/unarmed", 22);
    //set("weapon_prop/blade", 0);
    //set("weapon_prop/whip", 34);
...
//特效数值
    set("weapon_prop/kf_def_wound", 21);
    set("weapon_prop/kf_wound", 17);
    ...
    set("weapon_prop/max_busy_fenjin", 21);
    ...
    set("weapon_prop/kf_hit_rate", 20);
    set("weapon_prop/kf_anti_hr", 0);
//伤害防御类
    set("weapon_prop/deep_injure", 25);
    ...
    set("weapon_prop/attack_speed", 0);
     ...
     set("weapon_prop/dodge_factor", 23);
//气血恢复治疗类
    set("weapon_prop/max_qi", 0);
    set("weapon_prop/max_jing", 26);
    set("weapon_prop/neili_recover", 30);
    set("weapon_prop/qi_recover", 31);
    set("weapon_prop/jing_recover", 44);
    set("weapon_prop/jingli_recover", 0);
    set("weapon_prop/qi_cure", 0);
    set("weapon_prop/jing_cure", 24);
