...
void create()
{
	set_name("[33m丹陽之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(5632);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","丹陽之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十一斤二两六钱的[33m丹陽之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
