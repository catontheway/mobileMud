...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m工布天生怪异，功能参商！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重二十一斤六两零钱的[31m工布之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_body", 25);
...
//伤害防御类
    set("weapon_prop/deep_injure", 23);
    ...
    set("weapon_prop/attack_speed", 0);
     ...
     set("weapon_prop/parry_factor", 19);
     set("weapon_prop/dodge_factor", 24);
//气血恢复治疗类
    set("weapon_prop/max_qi", 0);
    set("weapon_prop/max_jing", 0);
    set("weapon_prop/neili_recover", 46);
