...
void create()
{
	set_name("[34m东天之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(602);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","东天之暗器[2;37;0m这是一支由绝对坚硬的[33m生铁[2;37;0m制成，重一斤二两零钱的[34m东天之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m [1;34m电[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
