...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重三斤八两三钱的[31m纯钩之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/PoisonAttack", 5);
