...
void create()
{
	set_name("[1;33m叠之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(5430);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","叠之剑[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重十斤八两六钱的[1;33m叠之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m [1;37m雷[2;37;0m:[33m很高[2;37;0m [1;34m电[2;37;0m:[34m细碎[2;37;0m [37m天[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_body", 3);
