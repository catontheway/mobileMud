...
void create()
{
	set_name("[1;35m竹叶之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(15179);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","竹叶之刀[2;37;0m这是一柄由十分坚硬的[33m软铁[2;37;0m制成，重三十斤三两五钱的[1;35m竹叶之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 19);
