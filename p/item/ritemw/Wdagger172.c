...
void create()
{
	set_name("[1;36m玫瑰之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(8694);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","玫瑰之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十七斤三两八钱的[1;36m玫瑰之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
