...
void create()
{
	set_name("[1;33m朱唇之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(2419);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","朱唇之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重四斤八两三钱的[1;33m朱唇之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
