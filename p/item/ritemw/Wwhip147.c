...
void create()
{
	set_name("[1;31m天师之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(8365);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","天师之鞭[2;37;0m这是一根由极其坚硬的[33m生铁[2;37;0m制成，重十六斤七两三钱的[1;31m天师之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
