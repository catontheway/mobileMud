...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[32m地凤之暗器[2;37;0m这是一支由无比坚硬的[1;32m绿石[2;37;0m制成，重零斤五两五钱的[32m地凤之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
