...
void create()
{
	set_name("[35m夏雨之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(2560);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","夏雨之鞭[2;37;0m这是一根由绝对坚硬的[33m软铁[2;37;0m制成，重五斤一两二钱的[35m夏雨之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#[1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
