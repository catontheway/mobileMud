...
void create()
{
	set_name("[36m四季之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(475);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","四季之暗器[2;37;0m这是一支由极其坚硬的[33m生铁[2;37;0m制成，重零斤九两五钱的[36m四季之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
