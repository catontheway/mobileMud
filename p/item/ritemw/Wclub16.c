...
void create()
{
	set_name("[34m阖之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(9985);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阖之棍[2;37;0m这是一根由比较坚硬的[32m青铜[2;37;0m制成，重十九斤九两七钱的[34m阖之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
