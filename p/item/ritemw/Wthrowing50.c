...
void create()
{
	set_name("[1;36m叠之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(739);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","叠之暗器[2;37;0m这是一支由还算坚硬的[32m青铜[2;37;0m制成，重一斤四两七钱的[1;36m叠之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#[1;36m人[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
