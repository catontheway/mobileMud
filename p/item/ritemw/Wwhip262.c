...
void create()
{
	set_name("[1;33m天光之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(12203);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","天光之鞭[2;37;0m这是一根由极其坚硬的[33m软铁[2;37;0m制成，重二十四斤四两零钱的[1;33m天光之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [1;34m电[2;37;0m:[1;35m绝世[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
