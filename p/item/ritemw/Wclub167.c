...
void create()
{
	set_name("[1;34m月季之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(8664);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","月季之棍[2;37;0m这是一根由非常坚硬的[33m生铁[2;37;0m制成，重十七斤三两二钱的[1;34m月季之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#[1;37m雷[2;37;0m:[34m细碎[2;37;0m [1;34m电[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
