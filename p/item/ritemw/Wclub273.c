...
void create()
{
	set_name("[1;33m流波之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(13664);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","流波之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十七斤三两二钱的[1;33m流波之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
