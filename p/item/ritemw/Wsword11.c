...
void create()
{
	set_name("[1;35m钢之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(15151);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","钢之剑[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重三十斤三两零钱的[1;35m钢之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m [1;35m风[2;37;0m:[34m细碎[2;37;0m $br#[37m天[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
