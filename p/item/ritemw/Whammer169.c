...
void create()
{
	set_name("[33m天师之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(7197);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天师之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十四斤三两九钱的[33m天师之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m [1;31m魔[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
