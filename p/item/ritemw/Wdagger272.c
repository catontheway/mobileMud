...
void create()
{
	set_name("[1;35m夏荷之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(5440);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","夏荷之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重十斤八两八钱的[1;35m夏荷之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
