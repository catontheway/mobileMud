...
void create()
{
	set_name("[36m聚泉之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(10291);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","聚泉之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十斤五两八钱的[36m聚泉之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
