...
void create()
{
	set_name("[1;31m铁之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(11665);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","铁之鞭[2;37;0m这是一根由相当坚硬的[32m青铜[2;37;0m制成，重二十三斤三两三钱的[1;31m铁之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
