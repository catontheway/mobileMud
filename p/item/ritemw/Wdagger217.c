...
void create()
{
	set_name("[1;37m盘古之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(3672);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","盘古之匕首[2;37;0m这是一把由极其坚硬的[33m软铁[2;37;0m制成，重七斤三两四钱的[1;37m盘古之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
