...
void create()
{
	set_name("[1;32m阔之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(12942);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阔之杖[2;37;0m这是一根由极为坚硬的[32m青铜[2;37;0m制成，重二十五斤八两八钱的[1;32m阔之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
