...
void create()
{
	set_name("[1;35m巨之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(13037);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巨之锤[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重二十六斤零两七钱的[1;35m巨之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [32m水[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
