...
void create()
{
	set_name("[1;34m青鶴之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(2392);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","青鶴之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重四斤七两八钱的[1;34m青鶴之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
