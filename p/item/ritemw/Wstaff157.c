...
void create()
{
	set_name("[31m朝云之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(2544);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","朝云之杖[2;37;0m这是一根由比较坚硬的[33m生铁[2;37;0m制成，重五斤零两八钱的[31m朝云之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
