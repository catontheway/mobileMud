...
void create()
{
	set_name("[34m蒲牢之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(10629);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","蒲牢之锤[2;37;0m这是一柄由绝对坚硬的[33m生铁[2;37;0m制成，重二十一斤二两五钱的[34m蒲牢之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
