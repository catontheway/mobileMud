...
void create()
{
	set_name("[1;33m白荷之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(14991);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","白荷之斧[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重二十九斤九两八钱的[1;33m白荷之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[34m细碎[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
