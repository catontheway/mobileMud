...
void create()
{
	set_name("[1;31m小之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(13736);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","小之锤[2;37;0m这是一柄由还算坚硬的[32m青铜[2;37;0m制成，重二十七斤四两七钱的[1;31m小之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m [36m木[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_fenjin", 1);
