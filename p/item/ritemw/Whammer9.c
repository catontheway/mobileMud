...
void create()
{
	set_name("[34m巨之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(7782);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巨之锤[2;37;0m这是一柄由十分坚硬的[32m青铜[2;37;0m制成，重十五斤五两六钱的[34m巨之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[34m细碎[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
