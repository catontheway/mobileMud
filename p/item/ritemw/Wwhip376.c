...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[37m赤玉之鞭[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重十二斤零两五钱的[37m赤玉之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
