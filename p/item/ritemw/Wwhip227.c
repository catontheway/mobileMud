...
void create()
{
	set_name("[1;33m青云之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(1034);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","青云之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二斤零两六钱的[1;33m青云之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [31m火[2;37;0m:[33m很高[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
