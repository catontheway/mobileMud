...
void create()
{
	set_name("[1;31m富貴之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(10477);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","富貴之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十斤九两五钱的[1;31m富貴之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[1;33m天圣[2;37;0m [1;36m人[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
