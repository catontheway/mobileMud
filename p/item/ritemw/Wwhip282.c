...
void create()
{
	set_name("[1;31m毒蛇之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(14327);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","毒蛇之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十八斤六两五钱的[1;31m毒蛇之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;34m举世[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
