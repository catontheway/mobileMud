...
void create()
{
	set_name("[36m赤云之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(8548);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","赤云之剑[2;37;0m这是一把由极为坚硬的[33m软铁[2;37;0m制成，重十七斤零两九钱的[36m赤云之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
