...
void create()
{
	set_name("[1;32m柔之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(14405);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","柔之锤[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重二十八斤八两一钱的[1;32m柔之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[32m粗糙[2;37;0m [1;36m人[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
