...
void create()
{
	set_name("[1;35m青陽之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(13961);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","青陽之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十七斤九两二钱的[1;35m青陽之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
