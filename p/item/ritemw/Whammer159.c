...
void create()
{
	set_name("[37m天师之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(10447);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天师之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十斤八两九钱的[37m天师之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m [1;37m雷[2;37;0m:[32m粗糙[2;37;0m [1;36m人[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
