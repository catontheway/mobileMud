...
void create()
{
	set_name("[34m鬼头之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(15430);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","鬼头之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重三十斤八两六钱的[34m鬼头之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
