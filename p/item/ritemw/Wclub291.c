...
void create()
{
	set_name("[31m神光之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(9410);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","神光之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十八斤八两二钱的[31m神光之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
