...
void create()
{
	set_name("[33m万丈之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(14553);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","万丈之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十九斤一两零钱的[33m万丈之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
