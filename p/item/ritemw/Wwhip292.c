...
void create()
{
	set_name("[1;33m倒海之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(2530);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","倒海之鞭[2;37;0m这是一根由极其坚硬的[33m软铁[2;37;0m制成，重五斤零两六钱的[1;33m倒海之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [40m地[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
