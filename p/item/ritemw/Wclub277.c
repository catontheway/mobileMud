...
void create()
{
	set_name("[35m延永之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(9179);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","延永之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十八斤三两五钱的[35m延永之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
