...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[34m七星之暗器[2;37;0m这是一支由相当坚硬的[1;32m绿石[2;37;0m制成，重一斤五两七钱的[34m七星之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
