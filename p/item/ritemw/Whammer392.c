...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[33m广成之锤[2;37;0m这是一柄由十分坚硬的[1;32m绿石[2;37;0m制成，重十六斤六两零钱的[33m广成之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m开元[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
