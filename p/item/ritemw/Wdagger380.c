...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[37m白玉之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二十二斤六两二钱的[37m白玉之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
		...
		set("weapon_prop/personality",12);
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    set("weapon_prop/force", 20);
    set("weapon_prop/dagge", 16);
