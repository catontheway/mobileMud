...
void create()
{
	set_name("[36m魂魄之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(4605);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","魂魄之锤[2;37;0m这是一柄由绝对坚硬的[33m软铁[2;37;0m制成，重九斤二两一钱的[36m魂魄之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m [31m火[2;37;0m:[1;31m开元[2;37;0m [33m土[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
