...
void create()
{
	set_name("[1;31m秀骨之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(15853);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","秀骨之锤[2;37;0m这是一柄由比较坚硬的[33m生铁[2;37;0m制成，重三十一斤七两零钱的[1;31m秀骨之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
