...
void create()
{
	set_name("[31m韧之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(5282);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","韧之锤[2;37;0m这是一柄由绝对坚硬的[32m青铜[2;37;0m制成，重十斤五两六钱的[31m韧之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
