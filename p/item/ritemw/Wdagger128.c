...
void create()
{
	set_name("[33m風信之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(4739);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","風信之匕首[2;37;0m这是一把由相当坚硬的[33m生铁[2;37;0m制成，重九斤四两七钱的[33m風信之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
