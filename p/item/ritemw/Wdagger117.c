...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","白荷之匕首[2;37;0m这是一把由相当坚硬的[33m生铁[2;37;0m制成，重二十九斤九两六钱的[35m白荷之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[33m很高[2;37;0m [37m天[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
