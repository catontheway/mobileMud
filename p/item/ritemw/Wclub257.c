...
void create()
{
	set_name("[1;31m鬼雨之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(3566);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","鬼雨之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重七斤一两三钱的[1;31m鬼雨之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m天圣[2;37;0m [1;37m雷[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
