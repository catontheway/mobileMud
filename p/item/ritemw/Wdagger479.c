...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重二十九斤六两六钱的[31m鱼肠之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m毁天[2;37;0m $br#[1;34m电[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
  ...
  //  基础类
  set("forge/max", 65);
  set("forge/times_max", 65);
  set("level", 65);
if(query("weapon_prop/damage"))
     set("weapon_prop/damage", 65);
