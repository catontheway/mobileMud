...
void create()
{
	set_name("[1;35m魔袱之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(15091);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","魔袱之棍[2;37;0m这是一根由极为坚硬的[33m生铁[2;37;0m制成，重三十斤一两八钱的[1;35m魔袱之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#[1;34m电[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
