...
void create()
{
	set_name("[36m仙水之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(10754);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","仙水之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十一斤五两零钱的[36m仙水之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
