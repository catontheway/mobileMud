...
void create()
{
	set_name("[34m宾之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(9250);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","宾之剑[2;37;0m这是一把由相当坚硬的[32m青铜[2;37;0m制成，重十八斤五两零钱的[34m宾之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
