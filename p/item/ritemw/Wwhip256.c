...
void create()
{
	set_name("[36m泼水之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(7578);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","泼水之鞭[2;37;0m这是一根由极其坚硬的[33m软铁[2;37;0m制成，重十五斤一两五钱的[36m泼水之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m [1;34m电[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
