...
void create()
{
	set_name("[31m曙光之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(12475);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","曙光之刀[2;37;0m这是一柄由极其坚硬的[33m软铁[2;37;0m制成，重二十四斤九两五钱的[31m曙光之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
