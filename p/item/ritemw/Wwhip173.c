...
void create()
{
	set_name("[31m常青之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(15492);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","常青之鞭[2;37;0m这是一根由绝对坚硬的[33m生铁[2;37;0m制成，重三十斤九两八钱的[31m常青之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m [31m火[2;37;0m:[31m精致[2;37;0m [1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#[1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
