...
void create()
{
	set_name("[31m紫薇之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(10316);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","紫薇之剑[2;37;0m这是一把由比较坚硬的[33m生铁[2;37;0m制成，重二十斤六两三钱的[31m紫薇之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
