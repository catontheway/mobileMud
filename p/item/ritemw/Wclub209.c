...
void create()
{
	set_name("[33m风泉之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(13308);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","风泉之棍[2;37;0m这是一根由非常坚硬的[33m软铁[2;37;0m制成，重二十六斤六两一钱的[33m风泉之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
