...
void create()
{
	set_name("[36m天威之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(14464);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","天威之鞭[2;37;0m这是一根由极其坚硬的[33m生铁[2;37;0m制成，重二十八斤九两二钱的[36m天威之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    set("weapon_prop/max_qi", 10);
    set("weapon_prop/max_jing", 0);
    set("weapon_prop/neili_recover", 15);
