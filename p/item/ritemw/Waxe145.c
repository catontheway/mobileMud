...
void create()
{
	set_name("[1;35m火鶴之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(13161);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","火鶴之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十六斤三两二钱的[1;35m火鶴之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m [31m火[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
