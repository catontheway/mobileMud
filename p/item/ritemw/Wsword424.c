...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;33m此物左右两边分别以黑白两种奇铁溶铸而成，一黑一白，切合乾坤，包含阴阳之气，好一柄宝物！$br#[2;37;0m这是一把由极为坚硬的[31m流花石[2;37;0m制成，重二十四斤七两二钱的[1;33m乾坤之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 23);
...
//特效数值
    ...
    set("weapon_prop/AllPoisonsImmune", 15);
...
//伤害防御类
    ...
    set("weapon_prop/abs_week_injure", 9);
...
//气血恢复治疗类
    ...
    set("weapon_prop/max_jing", 35);
    set("weapon_prop/neili_recover", 49);
