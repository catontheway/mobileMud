...
void create()
{
	set_name("[33m地竹之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(3379);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","地竹之斧[2;37;0m这是一柄由绝对坚硬的[33m软铁[2;37;0m制成，重六斤七两五钱的[33m地竹之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
