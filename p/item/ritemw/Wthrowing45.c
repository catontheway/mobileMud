...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","柔之暗器[2;37;0m这是一支由无比坚硬的[32m青铜[2;37;0m制成，重零斤八两七钱的[1;31m柔之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_confuse", 1);
