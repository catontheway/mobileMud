...
void create()
{
	set_name("[33m竹之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(6921);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","竹之杖[2;37;0m这是一根由比较坚硬的[32m青铜[2;37;0m制成，重十三斤八两四钱的[33m竹之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[36m不错[2;37;0m [1;36m人[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
