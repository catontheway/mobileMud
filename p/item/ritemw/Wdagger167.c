...
void create()
{
	set_name("[36m血斩之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(13265);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","血斩之匕首[2;37;0m这是一把由十分坚硬的[33m生铁[2;37;0m制成，重二十六斤五两三钱的[36m血斩之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
