...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;36m青龙之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二十四斤四两八钱的[1;36m青龙之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m天圣[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
