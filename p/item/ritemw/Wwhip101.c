...
void create()
{
	set_name("[34m火陽之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(13878);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","火陽之鞭[2;37;0m这是一根由相当坚硬的[33m生铁[2;37;0m制成，重二十七斤七两五钱的[34m火陽之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
