...
void create()
{
	set_name("[1;35m皓齿之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(168);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","皓齿之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重零斤三两三钱的[1;35m皓齿之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m毁天[2;37;0m [1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
