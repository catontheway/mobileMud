...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","阔之匕首[2;37;0m这是一把由绝对坚硬的[32m青铜[2;37;0m制成，重三十一斤五两九钱的[1;37m阔之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[33m很高[2;37;0m $br#[1;37m雷[2;37;0m:[31m精致[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
