...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","竹之刀[2;37;0m这是一柄由极其坚硬的[32m青铜[2;37;0m制成，重二十七斤零两八钱的[31m竹之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#[1;37m雷[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
