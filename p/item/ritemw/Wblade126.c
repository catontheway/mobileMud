...
void create()
{
	set_name("[1;35m朝云之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(13925);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","朝云之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十七斤八两五钱的[1;35m朝云之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
