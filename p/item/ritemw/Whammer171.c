...
void create()
{
	set_name("[35m金铃之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(8270);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","金铃之锤[2;37;0m这是一柄由相当坚硬的[33m生铁[2;37;0m制成，重十六斤五两四钱的[35m金铃之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m开元[2;37;0m [32m水[2;37;0m:[1;32m魔王[2;37;0m [1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
