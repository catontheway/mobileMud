...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;33m此物左右两边分别以黑白两种奇铁溶铸而成，一黑一白，切合乾坤，包含阴阳之气，好一柄宝物！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重二斤三两零钱的[1;33m乾坤之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m [1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#[1;34m电[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
