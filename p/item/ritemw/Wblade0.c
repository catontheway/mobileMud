...
void create()
{
	set_name("[33m巨之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(3062);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巨之刀[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重六斤一两二钱的[33m巨之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/PoisonAttack", 1);
