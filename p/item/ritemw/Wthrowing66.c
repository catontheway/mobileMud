...
void create()
{
	set_name("[34m铜之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(726);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","铜之暗器[2;37;0m这是一支由无比坚硬的[32m青铜[2;37;0m制成，重一斤四两五钱的[34m铜之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m [1;36m人[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
