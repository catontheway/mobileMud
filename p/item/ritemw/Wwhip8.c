...
void create()
{
	set_name("[35m小之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(7734);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","小之鞭[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重十五斤四两六钱的[35m小之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
