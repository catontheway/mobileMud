...
void create()
{
	set_name("[33m流波之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(435);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","流波之暗器[2;37;0m这是一支由极为坚硬的[33m软铁[2;37;0m制成，重零斤八两七钱的[33m流波之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m毁天[2;37;0m [31m火[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
