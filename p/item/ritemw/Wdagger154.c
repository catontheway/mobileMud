...
void create()
{
	set_name("[34m翠屏之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(3050);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","翠屏之匕首[2;37;0m这是一把由极其坚硬的[33m生铁[2;37;0m制成，重六斤一两零钱的[34m翠屏之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
