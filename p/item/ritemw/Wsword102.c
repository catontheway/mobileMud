...
void create()
{
	set_name("[36m撼山之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(2857);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","撼山之剑[2;37;0m这是一把由比较坚硬的[33m生铁[2;37;0m制成，重五斤七两一钱的[36m撼山之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [31m火[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
