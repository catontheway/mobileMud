...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重四斤二两一钱的[31m胜邪之刀[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
