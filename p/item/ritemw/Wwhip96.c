...
void create()
{
	set_name("[37m韧之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(5577);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","韧之鞭[2;37;0m这是一根由比较坚硬的[32m青铜[2;37;0m制成，重十一斤一两五钱的[37m韧之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
