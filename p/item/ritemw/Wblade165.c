...
void create()
{
	set_name("[34m朝云之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(4032);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","朝云之刀[2;37;0m这是一柄由极为坚硬的[33m生铁[2;37;0m制成，重八斤零两六钱的[34m朝云之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 14);
   // set("weapon_prop/cuff", 0);
    ...
    set("weapon_prop/dagge", 9);
    //set("weapon_prop/hammer", 0);
    //set("weapon_prop/spear", 13);
