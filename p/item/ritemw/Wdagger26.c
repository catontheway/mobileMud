...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","柔之匕首[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重二十九斤零两九钱的[1;35m柔之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[36m不错[2;37;0m [1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
