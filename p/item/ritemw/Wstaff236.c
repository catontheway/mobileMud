...
void create()
{
	set_name("[1;32m怒涛之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(11954);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","怒涛之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十三斤九两零钱的[1;32m怒涛之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
