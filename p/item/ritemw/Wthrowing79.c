...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","钢之暗器[2;37;0m这是一支由无比坚硬的[32m青铜[2;37;0m制成，重零斤三两三钱的[1;37m钢之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
