...
void create()
{
	set_name("[34m纵横之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(6807);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","纵横之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十三斤六两一钱的[34m纵横之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[1;31m魔[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 0);
     ...
     set("weapon_prop/dodge_factor", 8);
//气血恢复治疗类
