...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重十七斤五两二钱的[31m莫邪之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [32m水[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    set("weapon_prop/kf_def_wound", 20);
    ...
    set("weapon_prop/PoisonAttack", 25);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 31);
    set("weapon_prop/qi_cure", 60);
