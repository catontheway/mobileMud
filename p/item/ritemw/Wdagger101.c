...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","魔袱之匕首[2;37;0m这是一把由比较坚硬的[33m生铁[2;37;0m制成，重二十三斤四两五钱的[1;34m魔袱之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#[37m天[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
