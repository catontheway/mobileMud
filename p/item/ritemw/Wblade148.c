...
void create()
{
	set_name("[31m月形之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(12073);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","月形之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十四斤一两四钱的[31m月形之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
