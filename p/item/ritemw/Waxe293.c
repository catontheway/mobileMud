...
void create()
{
	set_name("[34m夺魂之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(14850);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","夺魂之斧[2;37;0m这是一柄由极为坚硬的[33m软铁[2;37;0m制成，重二十九斤七两零钱的[34m夺魂之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
