...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;36m天地之初，女娲补天所留下的天地间至尊之物之一经千秋万载所制，功能开天劈地！$br#[2;37;0m这是一把由极为坚硬的[31m流花石[2;37;0m制成，重二十九斤零两四钱的[1;36m天地之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m [37m天[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
