...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[37m生死之匕首[2;37;0m这是一把由十分坚硬的[1;32m绿石[2;37;0m制成，重四斤一两七钱的[37m生死之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
