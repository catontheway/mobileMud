...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重零斤四两六钱的[31m湛卢之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    set("weapon_prop/deep_injure", 24);
    set("weapon_prop/week_injure", 22);
    set("weapon_prop/abs_week_injure", 19);
    set("weapon_prop/defense_attack", 23);
    set("weapon_prop/armor_vs_force", 25);
    set("weapon_prop/armor_effect_armor_vs_force", 21);
    set("weapon_prop/attack_speed", 0);
     set("weapon_prop/attack_factor", 24);
     set("weapon_prop/parry_factor", 0);
     set("weapon_prop/dodge_factor", 0);
//气血恢复治疗类
    set("weapon_prop/max_qi", 0);
    set("weapon_prop/max_jing", 60);
    set("weapon_prop/neili_recover", 0);
    set("weapon_prop/qi_recover", 50);
    set("weapon_prop/jing_recover", 0);
    set("weapon_prop/jingli_recover", 66);
