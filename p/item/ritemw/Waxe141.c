...
void create()
{
	set_name("[1;31m白薇之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(7477);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","白薇之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十四斤九两五钱的[1;31m白薇之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[34m细碎[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_fenjin", 2);
