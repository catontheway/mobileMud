...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重二十六斤六两九钱的[31m太阿之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [36m木[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;31m毁天[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/AllPoisonsImmune", 22);
