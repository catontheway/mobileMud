...
void create()
{
	set_name("[1;36m缦理之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(618);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","缦理之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重一斤二两三钱的[1;36m缦理之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;36m完美[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 3);
