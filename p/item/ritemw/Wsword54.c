...
void create()
{
	set_name("[34m韧之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(4840);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","韧之剑[2;37;0m这是一把由还算坚硬的[32m青铜[2;37;0m制成，重九斤六两八钱的[34m韧之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
