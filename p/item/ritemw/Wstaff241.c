...
void create()
{
	set_name("[36m伤痕之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(7061);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","伤痕之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十四斤一两二钱的[36m伤痕之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
