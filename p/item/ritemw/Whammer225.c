...
void create()
{
	set_name("[1;32m天光之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(11910);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天光之锤[2;37;0m这是一柄由非常坚硬的[33m软铁[2;37;0m制成，重二十三斤八两二钱的[1;32m天光之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
