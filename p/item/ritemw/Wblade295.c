...
void create()
{
	set_name("[31m天女之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(7340);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天女之刀[2;37;0m这是一柄由极其坚硬的[33m软铁[2;37;0m制成，重十四斤六两八钱的[31m天女之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
