...
void create()
{
	set_name("[1;36m龙菊之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(7509);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","龙菊之刀[2;37;0m这是一柄由非常坚硬的[33m生铁[2;37;0m制成，重十五斤零两一钱的[1;36m龙菊之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
