...
void create()
{
	set_name("[36m净坛之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(7664);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","净坛之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十五斤三两二钱的[36m净坛之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
