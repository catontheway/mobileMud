...
void create()
{
	set_name("[33m韧之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(3889);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","韧之匕首[2;37;0m这是一把由非常坚硬的[32m青铜[2;37;0m制成，重七斤七两七钱的[33m韧之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
