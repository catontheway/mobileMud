...
void create()
{
	set_name("[1;33m落雪之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(7363);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","落雪之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十四斤七两二钱的[1;33m落雪之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_confuse", 4);
    ...
    set("weapon_prop/max_busy_fenjin", 7);
...
//伤害防御类
    ...
    set("weapon_prop/defense_attack", 2);
    set("weapon_prop/armor_vs_force", 3);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 12);
