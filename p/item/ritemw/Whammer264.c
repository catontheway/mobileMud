...
void create()
{
	set_name("[1;31m晦光之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(4994);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","晦光之锤[2;37;0m这是一柄由十分坚硬的[33m软铁[2;37;0m制成，重九斤九两八钱的[1;31m晦光之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
