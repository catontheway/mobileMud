...
void create()
{
	set_name("[1;31m洛神之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(11715);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","洛神之剑[2;37;0m这是一把由非常坚硬的[33m生铁[2;37;0m制成，重二十三斤四两三钱的[1;31m洛神之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
