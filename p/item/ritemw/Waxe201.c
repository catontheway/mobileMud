...
void create()
{
	set_name("[1;33m风泉之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(2312);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","风泉之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重四斤六两二钱的[1;33m风泉之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m [33m土[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
