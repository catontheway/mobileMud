...
void create()
{
	set_name("[36m火鶴之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(11612);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","火鶴之匕首[2;37;0m这是一把由比较坚硬的[33m生铁[2;37;0m制成，重二十三斤二两二钱的[36m火鶴之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
