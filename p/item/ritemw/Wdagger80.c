...
void create()
{
	set_name("[1;32m宾之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(9739);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","宾之匕首[2;37;0m这是一把由比较坚硬的[32m青铜[2;37;0m制成，重十九斤四两七钱的[1;32m宾之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 3);
