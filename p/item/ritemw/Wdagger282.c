...
void create()
{
	set_name("[1;32m吴钩之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(9330);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","吴钩之匕首[2;37;0m这是一把由非常坚硬的[33m软铁[2;37;0m制成，重十八斤六两六钱的[1;32m吴钩之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#[40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
