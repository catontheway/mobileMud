...
void create()
{
	set_name("[37m阖之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(14668);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阖之棍[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重二十九斤三两三钱的[37m阖之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
