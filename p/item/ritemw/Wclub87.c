...
void create()
{
	set_name("[37m韧之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(3170);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","韧之棍[2;37;0m这是一根由相当坚硬的[32m青铜[2;37;0m制成，重六斤三两四钱的[37m韧之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
