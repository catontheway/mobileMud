...
void create()
{
	set_name("[33m扣骨之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(8735);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","扣骨之鞭[2;37;0m这是一根由绝对坚硬的[33m生铁[2;37;0m制成，重十七斤四两七钱的[33m扣骨之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [32m水[2;37;0m:[1;32m魔王[2;37;0m [31m火[2;37;0m:[35m标准[2;37;0m [1;36m人[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
