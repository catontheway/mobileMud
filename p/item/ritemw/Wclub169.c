...
void create()
{
	set_name("[33m须弥之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(5911);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","须弥之棍[2;37;0m这是一根由十分坚硬的[33m生铁[2;37;0m制成，重十一斤八两二钱的[33m须弥之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[32m粗糙[2;37;0m [1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
