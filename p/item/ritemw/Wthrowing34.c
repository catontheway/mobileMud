...
void create()
{
	set_name("[1;37m阖之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(111);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","阖之暗器[2;37;0m这是一支由无比坚硬的[32m青铜[2;37;0m制成，重零斤二两二钱的[1;37m阖之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
