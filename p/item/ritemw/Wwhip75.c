...
void create()
{
	set_name("[31m怪之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(4693);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","怪之鞭[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重九斤三两八钱的[31m怪之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
