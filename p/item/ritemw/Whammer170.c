...
void create()
{
	set_name("[36m巨威之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(11004);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巨威之锤[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重二十二斤零两零钱的[36m巨威之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m [37m天[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
