...
void create()
{
	set_name("[1;32m飞星之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(3031);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","飞星之杖[2;37;0m这是一根由十分坚硬的[33m生铁[2;37;0m制成，重六斤零两六钱的[1;32m飞星之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [33m土[2;37;0m:[1;34m举世[2;37;0m [1;34m电[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
