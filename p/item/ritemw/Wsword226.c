...
void create()
{
	set_name("[1;33m虎枭之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(7092);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","虎枭之剑[2;37;0m这是一把由非常坚硬的[33m软铁[2;37;0m制成，重十四斤一两八钱的[1;33m虎枭之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
