...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重二十四斤六两九钱的[31m莫邪之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_confuse", 8);
