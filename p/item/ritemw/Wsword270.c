...
void create()
{
	set_name("[31m天光之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(7486);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","天光之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重十四斤九两七钱的[31m天光之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
