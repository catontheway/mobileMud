...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","鬼气之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重十九斤八两六钱的[1;33m鬼气之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m开元[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m [40m地[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
