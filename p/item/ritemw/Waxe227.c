...
void create()
{
	set_name("[1;34m承天之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(1094);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","承天之斧[2;37;0m这是一柄由极其坚硬的[33m软铁[2;37;0m制成，重二斤一两八钱的[1;34m承天之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;32m魔王[2;37;0m [33m土[2;37;0m:[1;35m绝世[2;37;0m [37m天[2;37;0m:[1;31m无双[2;37;0m [1;36m人[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
