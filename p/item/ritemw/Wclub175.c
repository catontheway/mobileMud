...
void create()
{
	set_name("[34m睚眦之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(8332);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","睚眦之棍[2;37;0m这是一根由比较坚硬的[33m生铁[2;37;0m制成，重十六斤六两六钱的[34m睚眦之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
