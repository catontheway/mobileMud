...
void create()
{
	set_name("[1;33m万丈之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(1593);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","万丈之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重三斤一两八钱的[1;33m万丈之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
