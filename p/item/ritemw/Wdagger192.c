...
void create()
{
	set_name("[37m裂心之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(3592);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","裂心之匕首[2;37;0m这是一把由非常坚硬的[33m生铁[2;37;0m制成，重七斤一两八钱的[37m裂心之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
