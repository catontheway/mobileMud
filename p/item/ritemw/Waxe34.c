...
void create()
{
	set_name("[35m巧之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(2648);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巧之斧[2;37;0m这是一柄由还算坚硬的[32m青铜[2;37;0m制成，重五斤二两九钱的[35m巧之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
