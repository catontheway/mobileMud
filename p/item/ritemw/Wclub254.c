...
void create()
{
	set_name("[1;34m神狮之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(15894);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","神狮之棍[2;37;0m这是一根由绝对坚硬的[33m软铁[2;37;0m制成，重三十一斤七两八钱的[1;34m神狮之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;34m举世[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
