...
void create()
{
	set_name("[33m霞蔚之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(1700);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","霞蔚之剑[2;37;0m这是一把由极为坚硬的[33m生铁[2;37;0m制成，重三斤四两零钱的[33m霞蔚之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
