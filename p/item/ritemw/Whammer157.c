...
void create()
{
	set_name("[1;33m天师之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(9818);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天师之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十九斤六两三钱的[1;33m天师之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m [37m天[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/AllPoisonsImmune", 2);
