...
void create()
{
	set_name("[1;34m常青之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(13591);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","常青之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十七斤一两八钱的[1;34m常青之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
