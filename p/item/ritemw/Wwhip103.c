...
void create()
{
	set_name("[31m东天之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(12814);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","东天之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十五斤六两二钱的[31m东天之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [32m水[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
