...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","韧之刀[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重二十二斤一两三钱的[1;35m韧之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[34m细碎[2;37;0m [36m木[2;37;0m:[33m很高[2;37;0m [32m水[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 2);
