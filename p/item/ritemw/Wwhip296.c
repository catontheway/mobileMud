...
void create()
{
	set_name("[37m天竹之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(14432);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","天竹之鞭[2;37;0m这是一根由绝对坚硬的[33m软铁[2;37;0m制成，重二十八斤八两六钱的[37m天竹之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
