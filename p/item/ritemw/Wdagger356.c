...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[34m七星之匕首[2;37;0m这是一把由极为坚硬的[1;32m绿石[2;37;0m制成，重二十六斤零两七钱的[34m七星之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#[1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
