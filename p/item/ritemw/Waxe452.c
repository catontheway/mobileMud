...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一柄由极其坚硬的[1;37m软银[2;37;0m制成，重十五斤三两五钱的[31m太阿之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 26);
    ...
    //set("weapon_prop/staff", 20);
    set("weapon_prop/force", 0);
    set("weapon_prop/dagge", 25);
...
//伤害防御类
    ...
    set("weapon_prop/armor_effect_armor_vs_force", 20);
