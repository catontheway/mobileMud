...
void create()
{
	set_name("[37m高山之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(12119);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","高山之棍[2;37;0m这是一根由绝对坚硬的[33m软铁[2;37;0m制成，重二十四斤二两三钱的[37m高山之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#[37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
