...
void create()
{
	set_name("[31m日月之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(14745);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","日月之剑[2;37;0m这是一把由绝对坚硬的[33m软铁[2;37;0m制成，重二十九斤四两九钱的[31m日月之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
