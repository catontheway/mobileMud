...
void create()
{
	set_name("[31m丹陽之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(3765);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","丹陽之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重七斤五两三钱的[31m丹陽之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m [1;34m电[2;37;0m:[1;34m举世[2;37;0m [1;36m人[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
