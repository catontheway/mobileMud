...
void create()
{
	set_name("[1;33m白薇之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(2279);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","白薇之杖[2;37;0m这是一根由十分坚硬的[33m生铁[2;37;0m制成，重四斤五两五钱的[1;33m白薇之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
