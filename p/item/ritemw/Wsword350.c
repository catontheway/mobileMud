...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;32m武翼之剑[2;37;0m这是一把由极其坚硬的[1;32m绿石[2;37;0m制成，重八斤八两九钱的[1;32m武翼之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m [32m水[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
