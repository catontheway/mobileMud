...
void create()
{
	set_name("[31m西天之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(423);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","西天之暗器[2;37;0m这是一支由极其坚硬的[33m生铁[2;37;0m制成，重零斤八两四钱的[31m西天之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [36m木[2;37;0m:[1;34m举世[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
