...
void create()
{
	set_name("[31m韧之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(8355);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","韧之剑[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重十六斤七两一钱的[31m韧之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
