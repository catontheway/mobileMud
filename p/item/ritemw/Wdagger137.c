...
void create()
{
	set_name("[33m芙蓉之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(15721);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","芙蓉之匕首[2;37;0m这是一把由绝对坚硬的[33m生铁[2;37;0m制成，重三十一斤四两四钱的[33m芙蓉之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
