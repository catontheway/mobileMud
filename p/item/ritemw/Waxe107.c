...
void create()
{
	set_name("[33m文昌之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(3108);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","文昌之斧[2;37;0m这是一柄由比较坚硬的[33m生铁[2;37;0m制成，重六斤二两一钱的[33m文昌之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
