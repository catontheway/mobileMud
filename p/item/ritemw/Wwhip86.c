...
void create()
{
	set_name("[1;35m大之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(3289);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","大之鞭[2;37;0m这是一根由绝对坚硬的[32m青铜[2;37;0m制成，重六斤五两七钱的[1;35m大之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
