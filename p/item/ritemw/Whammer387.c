...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[37m霹雳之锤[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重三斤五两零钱的[37m霹雳之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m [37m天[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
