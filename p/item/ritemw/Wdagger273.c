...
void create()
{
	set_name("[36m神鹰之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(10042);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","神鹰之匕首[2;37;0m这是一把由十分坚硬的[33m软铁[2;37;0m制成，重二十斤零两八钱的[36m神鹰之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m [1;34m电[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
