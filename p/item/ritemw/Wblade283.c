...
void create()
{
	set_name("[1;35m夜云之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(15809);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","夜云之刀[2;37;0m这是一柄由十分坚硬的[33m软铁[2;37;0m制成，重三十一斤六两一钱的[1;35m夜云之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#[1;34m电[2;37;0m:[1;36m完美[2;37;0m [37m天[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
