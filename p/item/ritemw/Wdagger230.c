...
void create()
{
	set_name("[1;37m幻风之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(15948);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","幻风之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重三十一斤八两九钱的[1;37m幻风之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
