...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[1;33m此物左右两边分别以黑白两种奇铁溶铸而成，一黑一白，切合乾坤，包含阴阳之气，好一柄宝物！$br#[2;37;0m这是一支由无比坚硬的[31m流花石[2;37;0m制成，重零斤三两八钱的[1;33m乾坤之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    //技能类
  //  set("weapon_prop/claw", 43);
   // set("weapon_prop/cuff", 0);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 43);
...
//气血恢复治疗类
    ...
    set("weapon_prop/max_jing", 19);
    set("weapon_prop/neili_recover", 18);
