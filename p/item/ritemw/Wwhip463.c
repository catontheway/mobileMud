...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重十一斤三两二钱的[31m龙泉之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m [1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#[1;37m雷[2;37;0m:[33m很高[2;37;0m [37m天[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 56);
