...
void create()
{
	set_name("[1;33m牛头之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(13062);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","牛头之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十六斤一两二钱的[1;33m牛头之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [33m土[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
