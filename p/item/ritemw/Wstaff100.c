...
void create()
{
	set_name("[33m四季之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(1013);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","四季之杖[2;37;0m这是一根由绝对坚硬的[33m生铁[2;37;0m制成，重二斤零两二钱的[33m四季之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[1;33m天圣[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
