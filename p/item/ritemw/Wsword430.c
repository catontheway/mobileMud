...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;36m大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重十三斤六两四钱的[1;36m三清之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
