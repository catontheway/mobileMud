...
void create()
{
	set_name("[1;33m芍药之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(459);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","芍药之暗器[2;37;0m这是一支由无比坚硬的[33m生铁[2;37;0m制成，重零斤九两一钱的[1;33m芍药之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[34m细碎[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m [1;36m人[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
