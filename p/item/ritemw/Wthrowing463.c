...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重一斤零两零钱的[31m纯钩之暗器[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 50);
    ...
    //set("weapon_prop/strike", 55);
    //set("weapon_prop/unarmed", 0);
    //set("weapon_prop/blade", 0);
    //set("weapon_prop/whip", 43);
