...
void create()
{
	set_name("[1;32m饕餮之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(4061);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","饕餮之刀[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重八斤一两二钱的[1;32m饕餮之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [33m土[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 13);
