...
void create()
{
	set_name("[35m夏荷之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(14884);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","夏荷之斧[2;37;0m这是一柄由极为坚硬的[33m软铁[2;37;0m制成，重二十九斤七两六钱的[35m夏荷之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;32m魔王[2;37;0m [1;34m电[2;37;0m:[1;34m举世[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
