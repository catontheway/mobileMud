...
void create()
{
	set_name("[1;37m宾之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(237);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","宾之暗器[2;37;0m这是一支由相当坚硬的[32m青铜[2;37;0m制成，重零斤四两七钱的[1;37m宾之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
