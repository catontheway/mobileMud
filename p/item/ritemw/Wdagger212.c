...
void create()
{
	set_name("[1;36m江河之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(11182);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","江河之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十二斤三两六钱的[1;36m江河之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
