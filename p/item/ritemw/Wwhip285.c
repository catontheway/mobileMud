...
void create()
{
	set_name("[1;36m浪云之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(5061);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","浪云之鞭[2;37;0m这是一根由极其坚硬的[33m软铁[2;37;0m制成，重十斤一两二钱的[1;36m浪云之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
