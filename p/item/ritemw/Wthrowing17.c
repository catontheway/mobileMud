...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","巧之暗器[2;37;0m这是一支由比较坚硬的[32m青铜[2;37;0m制成，重零斤三两四钱的[1;36m巧之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[32m粗糙[2;37;0m [1;35m风[2;37;0m:[34m细碎[2;37;0m $br#[37m天[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
