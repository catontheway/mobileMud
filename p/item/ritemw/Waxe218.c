...
void create()
{
	set_name("[1;31m魂魄之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(11790);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","魂魄之斧[2;37;0m这是一柄由极其坚硬的[33m软铁[2;37;0m制成，重二十三斤五两八钱的[1;31m魂魄之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;36m完美[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
