...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","韧之匕首[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重十八斤三两一钱的[1;36m韧之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/abs_week_injure", 1);
