...
void create()
{
	set_name("[35m仙品之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(3177);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","仙品之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重六斤三两五钱的[35m仙品之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
