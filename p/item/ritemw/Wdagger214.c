...
void create()
{
	set_name("[35m鬼头之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(13515);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","鬼头之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十七斤零两三钱的[35m鬼头之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;36m完美[2;37;0m [1;34m电[2;37;0m:[1;31m无双[2;37;0m [1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
