...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[1;32m九天之暗器[2;37;0m这是一支由十分坚硬的[1;32m绿石[2;37;0m制成，重零斤八两零钱的[1;32m九天之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
