...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;37m赵客缦胡缨  吴钩霜雪明$br#银鞍照白马  飒沓如流星$br#十步杀一人  千里不留行	$br#事了拂衣去  深藏身与名$br#闲过信陵饮  脱剑膝前横	$br#将炙□朱亥  持觞劝侯嬴$br#三杯吐然诺  五狱倒为轻$br#眼花耳热後  意气素霓生$br#救赵挥金槌  邯郸先震惊$br#千秋二壮士  喧赫大梁城$br#纵死侠骨香  不惭世上英$br#谁能书阁下  白首太玄经$br#[2;37;0m这是一根由无比坚硬的[31m流花石[2;37;0m制成，重二十八斤九两六钱的[1;37m太白之杖[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_jiemai", 8);
