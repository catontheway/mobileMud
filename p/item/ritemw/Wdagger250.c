...
void create()
{
	set_name("[33m鱼鳞之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(4426);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","鱼鳞之匕首[2;37;0m这是一把由极其坚硬的[33m软铁[2;37;0m制成，重八斤八两五钱的[33m鱼鳞之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m [32m水[2;37;0m:[1;35m绝世[2;37;0m [1;37m雷[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
