...
void create()
{
	set_name("[1;32m芍药之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(6780);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","芍药之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十三斤五两六钱的[1;32m芍药之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
