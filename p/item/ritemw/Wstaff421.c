...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;33m此物左右两边分别以黑白两种奇铁溶铸而成，一黑一白，切合乾坤，包含阴阳之气，好一柄宝物！$br#[2;37;0m这是一根由绝对坚硬的[31m流花石[2;37;0m制成，重二斤零两八钱的[1;33m乾坤之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
