...
void create()
{
	set_name("[37m夜云之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(12075);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","夜云之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十四斤一两五钱的[37m夜云之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
