...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m巨阙坚硬无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重二十四斤六两二钱的[31m巨阙之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [32m水[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [1;34m电[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 33);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/unarmed", 42);
    //set("weapon_prop/blade", 42);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 52);
...
//伤害防御类
    ...
    set("weapon_prop/defense_attack", 15);
