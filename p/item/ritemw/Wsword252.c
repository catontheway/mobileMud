...
void create()
{
	set_name("[33m神豹之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(1778);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","神豹之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重三斤五两五钱的[33m神豹之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
