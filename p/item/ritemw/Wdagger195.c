...
void create()
{
	set_name("[34m双星之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(14281);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","双星之匕首[2;37;0m这是一把由极为坚硬的[33m生铁[2;37;0m制成，重二十八斤五两六钱的[34m双星之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
