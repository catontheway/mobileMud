...
void create()
{
	set_name("[33m双锋之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(8554);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","双锋之鞭[2;37;0m这是一根由非常坚硬的[33m软铁[2;37;0m制成，重十七斤一两零钱的[33m双锋之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
