...
void create()
{
	set_name("[1;31m叠之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(14444);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","叠之锤[2;37;0m这是一柄由十分坚硬的[32m青铜[2;37;0m制成，重二十八斤八两八钱的[1;31m叠之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_body", 2);
    ...
    set("weapon_prop/max_busy_confuse", 2);
