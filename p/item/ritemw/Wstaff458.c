...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重四斤零两五钱的[31m鱼肠之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m毁天[2;37;0m [40m地[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/staff", 47);
    set("weapon_prop/force", 0);
    set("weapon_prop/dagge", 0);
    //set("weapon_prop/hammer", 25);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 27);
    set("weapon_prop/qi_cure", 0);
    set("weapon_prop/jing_cure", 22);
