...
void create()
{
	set_name("[31m神鹰之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(7862);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","神鹰之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十五斤七两二钱的[31m神鹰之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
