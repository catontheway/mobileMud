...
void create()
{
	set_name("[1;31m聚泉之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(111);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","聚泉之暗器[2;37;0m这是一支由相当坚硬的[33m生铁[2;37;0m制成，重零斤二两二钱的[1;31m聚泉之暗器[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    set("weapon_prop/force", 2);
    set("weapon_prop/dagge", 6);
    //set("weapon_prop/hammer", 12);
