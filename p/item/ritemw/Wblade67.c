...
void create()
{
	set_name("[1;35m钢之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(3816);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","钢之刀[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重七斤六两三钱的[1;35m钢之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_dianxue", 1);
