...
void create()
{
	set_name("[1;34m飞燕之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(5118);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","飞燕之杖[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重十斤二两三钱的[1;34m飞燕之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;34m举世[2;37;0m [1;36m人[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
