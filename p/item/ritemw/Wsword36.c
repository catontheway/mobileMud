...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","铁之剑[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重十一斤四两零钱的[1;34m铁之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m [32m水[2;37;0m:[34m细碎[2;37;0m [1;34m电[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
