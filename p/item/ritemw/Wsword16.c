...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","柔之剑[2;37;0m这是一把由非常坚硬的[32m青铜[2;37;0m制成，重十六斤五两九钱的[1;35m柔之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m [32m水[2;37;0m:[31m精致[2;37;0m [31m火[2;37;0m:[36m不错[2;37;0m [1;36m人[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
