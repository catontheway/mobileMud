...
void create()
{
	set_name("[36m地锋之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(10275);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","地锋之斧[2;37;0m这是一柄由绝对坚硬的[33m软铁[2;37;0m制成，重二十斤五两五钱的[36m地锋之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
