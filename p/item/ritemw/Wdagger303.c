...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[37m震电之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重十二斤九两一钱的[37m震电之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
