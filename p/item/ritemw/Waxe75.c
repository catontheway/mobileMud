...
void create()
{
	set_name("[1;33m阔之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(6142);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","阔之斧[2;37;0m这是一柄由极其坚硬的[32m青铜[2;37;0m制成，重十二斤二两八钱的[1;33m阔之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
