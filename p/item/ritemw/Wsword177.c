...
void create()
{
	set_name("[34m武圣之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(6739);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","武圣之剑[2;37;0m这是一把由比较坚硬的[33m生铁[2;37;0m制成，重十三斤四两七钱的[34m武圣之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 11);
    set("weapon_prop/jingli_recover", 0);
    set("weapon_prop/qi_cure", 17);
