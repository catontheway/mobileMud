...
void create()
{
	set_name("[35m千芒之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(15926);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","千芒之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重三十一斤八两五钱的[35m千芒之锤[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    set("weapon_prop/kf_def_wound", 2);
