...
void create()
{
	set_name("[34m银铃之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(8427);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","银铃之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十六斤八两五钱的[34m银铃之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
