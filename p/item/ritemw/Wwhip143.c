...
void create()
{
	set_name("[37m绿影之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(13894);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","绿影之鞭[2;37;0m这是一根由非常坚硬的[33m生铁[2;37;0m制成，重二十七斤七两八钱的[37m绿影之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
