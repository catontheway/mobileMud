...
void create()
{
	set_name("[35m飞雪之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(7227);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","飞雪之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十四斤四两五钱的[35m飞雪之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_jiemai", 3);
