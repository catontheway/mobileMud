...
void create()
{
	set_name("[1;37m燕尾之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(13626);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","燕尾之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十七斤二两五钱的[1;37m燕尾之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;32m魔王[2;37;0m [1;37m雷[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 15);
...
//伤害防御类
    ...
    set("weapon_prop/armor_vs_force", 11);
