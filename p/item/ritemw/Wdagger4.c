...
void create()
{
	set_name("[1;35m怪之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(14128);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","怪之匕首[2;37;0m这是一把由十分坚硬的[32m青铜[2;37;0m制成，重二十八斤二两五钱的[1;35m怪之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [40m地[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
