...
void create()
{
	set_name("[37m江河之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(3284);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","江河之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重六斤五两六钱的[37m江河之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
