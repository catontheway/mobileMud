...
void create()
{
	set_name("[1;37m魔水之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(4709);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","魔水之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重九斤四两一钱的[1;37m魔水之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
