...
void create()
{
	set_name("[37m小之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(274);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","小之暗器[2;37;0m这是一支由绝对坚硬的[32m青铜[2;37;0m制成，重零斤五两四钱的[37m小之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m [1;35m风[2;37;0m:[35m标准[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/throwing", 1);
    
    
   
//特效数值
    set("weapon_prop/kf_def_wound", 0);
    set("weapon_prop/kf_wound", 4);
    ...
    set("weapon_prop/AllPoisonsImmune", 1);
...
//伤害防御类
    ...
    set("weapon_prop/armor_vs_force", 2);
