...
void create()
{
	set_name("[37m北天之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(13712);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","北天之杖[2;37;0m这是一根由极其坚硬的[33m生铁[2;37;0m制成，重二十七斤四两二钱的[37m北天之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
