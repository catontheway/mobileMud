...
void create()
{
	set_name("[1;34m千仞之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(15936);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","千仞之斧[2;37;0m这是一柄由相当坚硬的[33m生铁[2;37;0m制成，重三十一斤八两七钱的[1;34m千仞之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
