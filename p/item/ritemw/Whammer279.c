...
void create()
{
	set_name("[1;37m猛虎之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(14851);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","猛虎之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十九斤七两零钱的[1;37m猛虎之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 6);
