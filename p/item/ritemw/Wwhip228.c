...
void create()
{
	set_name("[37m狮吼之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(1678);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","狮吼之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重三斤三两五钱的[37m狮吼之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
