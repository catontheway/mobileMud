...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","铁之棍[2;37;0m这是一根由非常坚硬的[32m青铜[2;37;0m制成，重九斤五两四钱的[33m铁之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m [1;34m电[2;37;0m:[32m粗糙[2;37;0m [1;36m人[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 0);
     set("weapon_prop/attack_factor", 5);
