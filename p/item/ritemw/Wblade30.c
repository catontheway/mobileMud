...
void create()
{
	set_name("[1;32m小之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(13719);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","小之刀[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重二十七斤四两三钱的[1;32m小之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[36m不错[2;37;0m [36m木[2;37;0m:[35m标准[2;37;0m [33m土[2;37;0m:[33m很高[2;37;0m [1;35m风[2;37;0m:[36m不错[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 2);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 2);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_fenjin", 2);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 2);
