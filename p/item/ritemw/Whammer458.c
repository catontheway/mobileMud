...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m工布天生怪异，功能参商！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重四斤五两六钱的[31m工布之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m创世[2;37;0m [1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#[1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [1;34m电[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/unarmed", 27);
    //set("weapon_prop/blade", 47);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 58);
    set("weapon_prop/force", 0);
    set("weapon_prop/dagge", 0);
    //set("weapon_prop/hammer", 0);
    //set("weapon_prop/spear", 52);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_confuse", 19);
    ...
    set("weapon_prop/max_busy_fenjin", 10);
    set("weapon_prop/max_busy_confuse", 9);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 19);
