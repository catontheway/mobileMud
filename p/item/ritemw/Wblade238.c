...
void create()
{
	set_name("[37m玉指之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(8975);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","玉指之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十七斤九两五钱的[37m玉指之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;34m举世[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
