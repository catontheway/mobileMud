...
void create()
{
	set_name("[31m天光之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(1216);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天光之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二斤四两三钱的[31m天光之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
