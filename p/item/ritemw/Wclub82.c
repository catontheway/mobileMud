...
void create()
{
	set_name("[36m钢之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(5608);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","钢之棍[2;37;0m这是一根由十分坚硬的[32m青铜[2;37;0m制成，重十一斤二两一钱的[36m钢之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[36m不错[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
