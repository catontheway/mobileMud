...
void create()
{
	set_name("[1;37m照海之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(8750);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","照海之杖[2;37;0m这是一根由非常坚硬的[33m软铁[2;37;0m制成，重十七斤五两零钱的[1;37m照海之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/spear", 17);
    //set("weapon_prop/throwing", 19);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 13);
    set("weapon_prop/qi_cure", 0);
    set("weapon_prop/jing_cure", 16);
