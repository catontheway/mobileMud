...
void create()
{
	set_name("[1;31m風信之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(11419);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","風信之锤[2;37;0m这是一柄由绝对坚硬的[33m生铁[2;37;0m制成，重二十二斤八两三钱的[1;31m風信之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
