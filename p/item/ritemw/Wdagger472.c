...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m工布天生怪异，功能参商！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重二斤六两一钱的[31m工布之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [32m水[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 28);
    set("weapon_prop/qi_recover", 0);
    set("weapon_prop/jing_recover", 32);
