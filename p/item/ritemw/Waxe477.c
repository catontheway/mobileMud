...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一柄由极为坚硬的[1;37m软银[2;37;0m制成，重十四斤二两二钱的[31m鱼肠之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m创世[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#[1;36m人[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 38);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 10);
    ...
    set("weapon_prop/max_busy_jiemai", 12);
...
//气血恢复治疗类
    ...
    set("weapon_prop/qi_recover", 33);
    set("weapon_prop/jing_recover", 51);
    set("weapon_prop/jingli_recover", 35);
