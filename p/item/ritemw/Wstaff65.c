...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","钢之杖[2;37;0m这是一根由相当坚硬的[32m青铜[2;37;0m制成，重二十九斤四两一钱的[1;37m钢之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[36m不错[2;37;0m [31m火[2;37;0m:[35m标准[2;37;0m [1;36m人[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
