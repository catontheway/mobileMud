...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m工布天生怪异，功能参商！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重一斤二两二钱的[31m工布之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 12);
     set("weapon_prop/attack_factor", 7);
