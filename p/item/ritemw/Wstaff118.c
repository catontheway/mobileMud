...
void create()
{
	set_name("[37m降魔之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(10605);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","降魔之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十一斤二两一钱的[37m降魔之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [36m木[2;37;0m:[1;33m天圣[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
