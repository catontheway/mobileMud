...
void create()
{
	set_name("[1;33m叠之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(15251);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","叠之杖[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重三十斤五两零钱的[1;33m叠之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
