...
void create()
{
	set_name("[1;35m落雪之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(8768);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","落雪之鞭[2;37;0m这是一根由相当坚硬的[33m生铁[2;37;0m制成，重十七斤五两三钱的[1;35m落雪之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[1;32m魔王[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
