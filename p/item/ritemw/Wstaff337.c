...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;31m天火之杖[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重十四斤六两零钱的[1;31m天火之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/staff", 31);
    set("weapon_prop/force", 18);
    set("weapon_prop/dagge", 40);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 7);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 0);
     ...
     set("weapon_prop/parry_factor", 11);
     set("weapon_prop/dodge_factor", 7);
//气血恢复治疗类
    set("weapon_prop/max_qi", 0);
    set("weapon_prop/max_jing", 20);
    set("weapon_prop/neili_recover", 41);
    set("weapon_prop/qi_recover", 33);
    set("weapon_prop/jing_recover", 22);
