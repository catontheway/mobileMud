...
void create()
{
	set_name("[1;31m怪之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(547);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","怪之暗器[2;37;0m这是一支由无比坚硬的[32m青铜[2;37;0m制成，重一斤零两九钱的[1;31m怪之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m [31m火[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 3);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 0);
    //set("weapon_prop/hand", 4);
