...
void create()
{
	set_name("[36m叠之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(494);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","叠之暗器[2;37;0m这是一支由极为坚硬的[32m青铜[2;37;0m制成，重零斤九两八钱的[36m叠之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[34m细碎[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 6);
