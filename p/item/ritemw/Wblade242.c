...
void create()
{
	set_name("[1;31m春雨之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(9183);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","春雨之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十八斤三两六钱的[1;31m春雨之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;34m举世[2;37;0m [1;37m雷[2;37;0m:[1;34m举世[2;37;0m [1;34m电[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
