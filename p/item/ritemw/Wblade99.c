...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","巨之刀[2;37;0m这是一柄由还算坚硬的[32m青铜[2;37;0m制成，重十一斤六两四钱的[1;31m巨之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m [33m土[2;37;0m:[36m不错[2;37;0m [1;34m电[2;37;0m:[32m粗糙[2;37;0m [37m天[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
