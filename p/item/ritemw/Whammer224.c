...
void create()
{
	set_name("[36m紫云之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(13882);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","紫云之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十七斤七两六钱的[36m紫云之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
