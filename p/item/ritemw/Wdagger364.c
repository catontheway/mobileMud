...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[35m开阳之匕首[2;37;0m这是一把由极其坚硬的[1;32m绿石[2;37;0m制成，重三十一斤二两四钱的[35m开阳之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
