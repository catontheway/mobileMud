...
void create()
{
	set_name("[36m星龙之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(553);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","星龙之暗器[2;37;0m这是一支由无比坚硬的[33m生铁[2;37;0m制成，重一斤一两零钱的[36m星龙之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;32m魔王[2;37;0m [1;37m雷[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
