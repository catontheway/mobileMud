...
void create()
{
	set_name("[1;35m瀚海之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(14683);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","瀚海之斧[2;37;0m这是一柄由绝对坚硬的[33m生铁[2;37;0m制成，重二十九斤三两六钱的[1;35m瀚海之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/qi_recover", 8);
    set("weapon_prop/jing_recover", 0);
    set("weapon_prop/jingli_recover", 7);
