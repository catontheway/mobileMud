...
void create()
{
	set_name("[1;33m阔之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(12229);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阔之棍[2;37;0m这是一根由极为坚硬的[32m青铜[2;37;0m制成，重二十四斤四两五钱的[1;33m阔之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
