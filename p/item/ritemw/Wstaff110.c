...
void create()
{
	set_name("[35m飞星之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(2773);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","飞星之杖[2;37;0m这是一根由比较坚硬的[33m生铁[2;37;0m制成，重五斤五两四钱的[35m飞星之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m天圣[2;37;0m [1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
