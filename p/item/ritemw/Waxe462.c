...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重十三斤零两二钱的[31m纯钩之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[1;34m电[2;37;0m:[1;35m绝世[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_confuse", 21);
...
//伤害防御类
    ...
    set("weapon_prop/abs_week_injure", 11);
