...
void create()
{
	set_name("[1;37m阔之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(11912);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","阔之刀[2;37;0m这是一柄由十分坚硬的[32m青铜[2;37;0m制成，重二十三斤八两二钱的[1;37m阔之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [32m水[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
