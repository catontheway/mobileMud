...
void create()
{
	set_name("[1;35m朱唇之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(11145);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","朱唇之杖[2;37;0m这是一根由非常坚硬的[33m软铁[2;37;0m制成，重二十二斤二两九钱的[1;35m朱唇之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 12);
