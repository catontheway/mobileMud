...
void create()
{
	set_name("[34m伤痕之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(11932);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","伤痕之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十三斤八两六钱的[34m伤痕之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
