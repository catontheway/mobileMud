...
void create()
{
	set_name("[1;31m怪之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(3228);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","怪之斧[2;37;0m这是一柄由极为坚硬的[32m青铜[2;37;0m制成，重六斤四两五钱的[1;31m怪之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
