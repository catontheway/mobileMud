...
void create()
{
	set_name("[1;32m小之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(12088);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","小之匕首[2;37;0m这是一把由极为坚硬的[32m青铜[2;37;0m制成，重二十四斤一两七钱的[1;32m小之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[32m粗糙[2;37;0m [37m天[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
