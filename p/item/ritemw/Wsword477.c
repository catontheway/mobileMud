...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一把由绝对坚硬的[1;37m软银[2;37;0m制成，重七斤七两零钱的[31m纯钩之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
