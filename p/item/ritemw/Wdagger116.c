...
void create()
{
	set_name("[31m雪花之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(11762);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","雪花之匕首[2;37;0m这是一把由非常坚硬的[33m生铁[2;37;0m制成，重二十三斤五两二钱的[31m雪花之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [36m木[2;37;0m:[1;36m完美[2;37;0m [31m火[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#[1;36m人[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
