...
void create()
{
	set_name("[31m鸿门之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(11913);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","鸿门之锤[2;37;0m这是一柄由极其坚硬的[33m软铁[2;37;0m制成，重二十三斤八两二钱的[31m鸿门之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
