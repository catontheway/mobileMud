...
void create()
{
	set_name("[1;36m柔之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(12800);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","柔之杖[2;37;0m这是一根由极其坚硬的[32m青铜[2;37;0m制成，重二十五斤六两零钱的[1;36m柔之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[36m不错[2;37;0m $br#[1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
