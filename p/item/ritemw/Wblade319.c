...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[32m玄机之刀[2;37;0m这是一柄由相当坚硬的[1;32m绿石[2;37;0m制成，重十九斤二两六钱的[32m玄机之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
