...
void create()
{
	set_name("[1;34m降魔之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(14460);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","降魔之鞭[2;37;0m这是一根由十分坚硬的[33m生铁[2;37;0m制成，重二十八斤九两二钱的[1;34m降魔之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
