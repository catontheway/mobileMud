...
void create()
{
	set_name("[31m文昌之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(8722);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","文昌之匕首[2;37;0m这是一把由极其坚硬的[33m生铁[2;37;0m制成，重十七斤四两四钱的[31m文昌之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;36m完美[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
