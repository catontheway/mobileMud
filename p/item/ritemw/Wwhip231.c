...
void create()
{
	set_name("[31m青云之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(9137);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","青云之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十八斤二两七钱的[31m青云之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
