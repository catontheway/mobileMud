...
void create()
{
	set_name("[1;32m千仞之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(14099);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","千仞之棍[2;37;0m这是一根由绝对坚硬的[33m生铁[2;37;0m制成，重二十八斤一两九钱的[1;32m千仞之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [1;37m雷[2;37;0m:[1;34m举世[2;37;0m [1;34m电[2;37;0m:[1;35m绝世[2;37;0m [37m天[2;37;0m:[35m标准[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
