...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;34m在西方查理曼统治的时代，最简朴的剑也能值三头母牛的价钱。而查理大帝自己的那把传奇式的神兵“乔依乌斯”据说是半人半神的“韦兰铁匠”所造，乃当世界神兵！$br#[2;37;0m这是一根由无比坚硬的[31m流花石[2;37;0m制成，重三十斤一两零钱的[1;34m乔依乌斯之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
