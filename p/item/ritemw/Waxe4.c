...
void create()
{
	set_name("[1;34m巧之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(5464);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巧之斧[2;37;0m这是一柄由十分坚硬的[32m青铜[2;37;0m制成，重十斤九两二钱的[1;34m巧之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
