...
void create()
{
	set_name("[36m承天之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(4458);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","承天之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重八斤九两一钱的[36m承天之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m创世[2;37;0m [1;35m风[2;37;0m:[1;31m创世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
