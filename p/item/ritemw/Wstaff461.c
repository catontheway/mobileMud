...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重十八斤六两零钱的[31m湛卢之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/blade", 41);
    //set("weapon_prop/whip", 35);
    //set("weapon_prop/staff", 0);
    set("weapon_prop/force", 49);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 18);
