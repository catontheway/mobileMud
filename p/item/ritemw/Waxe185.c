...
void create()
{
	set_name("[31m白陽之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(7274);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","白陽之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十四斤五两四钱的[31m白陽之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m [36m木[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[1;31m无双[2;37;0m [1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#[37m天[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
