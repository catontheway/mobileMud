...
void create()
{
	set_name("[1;36m降魔之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(6729);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","降魔之匕首[2;37;0m这是一把由极其坚硬的[33m生铁[2;37;0m制成，重十三斤四两五钱的[1;36m降魔之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    set("weapon_prop/kf_def_wound", 3);
