...
void create()
{
	set_name("[1;36m日月之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(6577);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","日月之锤[2;37;0m这是一柄由绝对坚硬的[33m软铁[2;37;0m制成，重十三斤一两五钱的[1;36m日月之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
