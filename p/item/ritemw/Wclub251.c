...
void create()
{
	set_name("[1;36m伤痕之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(5458);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","伤痕之棍[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十斤九两一钱的[1;36m伤痕之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
