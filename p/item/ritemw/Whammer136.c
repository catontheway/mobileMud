...
void create()
{
	set_name("[31m千芒之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(1140);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","千芒之锤[2;37;0m这是一柄由极为坚硬的[33m生铁[2;37;0m制成，重二斤二两八钱的[31m千芒之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;32m魔王[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
