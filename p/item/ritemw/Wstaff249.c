...
void create()
{
	set_name("[1;33m兽皮之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(4579);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","兽皮之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重九斤一两五钱的[1;33m兽皮之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m开元[2;37;0m [1;34m电[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
