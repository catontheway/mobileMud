...
void create()
{
	set_name("[1;35m苍岩之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(10949);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","苍岩之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十一斤八两九钱的[1;35m苍岩之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
