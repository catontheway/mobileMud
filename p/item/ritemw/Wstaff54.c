...
void create()
{
	set_name("[36m竹之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(9026);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","竹之杖[2;37;0m这是一根由还算坚硬的[32m青铜[2;37;0m制成，重十八斤零两五钱的[36m竹之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
