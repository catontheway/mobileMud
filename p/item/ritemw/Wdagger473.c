...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！$br#[2;37;0m这是一把由极其坚硬的[1;37m软银[2;37;0m制成，重四斤七两三钱的[31m湛卢之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
  ...
  //  基础类
  set("forge/max", 67);
  set("forge/times_max", 67);
  set("level", 67);
if(query("weapon_prop/damage"))
     set("weapon_prop/damage", 67);
...
//特效数值
    ...
    set("weapon_prop/cant_all_busy", 19);
    set("weapon_prop/cant_busy_dianxue", 0);
    set("weapon_prop/cant_busy_jiemai", 23);
    set("weapon_prop/cant_busy_fenjin", 25);
    set("weapon_prop/cant_busy_confuse", 0);
    set("weapon_prop/cant_busy_body", 0);
    set("weapon_prop/max_all_busy", 0);
    set("weapon_prop/max_busy_dianxue", 18);
    set("weapon_prop/max_busy_jiemai", 25);
...
//伤害防御类
    ...
    set("weapon_prop/armor_vs_force", 24);
