...
void create()
{
	set_name("[36m夜云之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(11544);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","夜云之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十三斤零两八钱的[36m夜云之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
