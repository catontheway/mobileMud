...
void create()
{
	set_name("[33m魔竹之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(15191);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","魔竹之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重三十斤三两八钱的[33m魔竹之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
