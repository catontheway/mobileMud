...
void create()
{
	set_name("[33m紫云之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(6182);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","紫云之棍[2;37;0m这是一根由极为坚硬的[33m软铁[2;37;0m制成，重十二斤三两六钱的[33m紫云之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;35m绝世[2;37;0m [1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [1;34m电[2;37;0m:[1;35m绝世[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
