...
void create()
{
	set_name("[36m小之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(152);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","小之暗器[2;37;0m这是一支由比较坚硬的[32m青铜[2;37;0m制成，重零斤三两零钱的[36m小之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[36m不错[2;37;0m [32m水[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
