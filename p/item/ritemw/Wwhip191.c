...
void create()
{
	set_name("[1;32m金铃之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(4814);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","金铃之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重九斤六两二钱的[1;32m金铃之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [33m土[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
