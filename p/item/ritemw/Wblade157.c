...
void create()
{
	set_name("[35m雪花之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(4662);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","雪花之刀[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重九斤三两二钱的[35m雪花之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[34m细碎[2;37;0m $br#[37m天[2;37;0m:[1;34m举世[2;37;0m [1;36m人[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
