...
void create()
{
	set_name("[35m千芒之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(15696);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","千芒之棍[2;37;0m这是一根由非常坚硬的[33m生铁[2;37;0m制成，重三十一斤三两九钱的[35m千芒之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
