...
void create()
{
	set_name("[34m绿影之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(13152);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","绿影之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十六斤三两零钱的[34m绿影之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
