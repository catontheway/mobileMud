...
void create()
{
	set_name("[35m巨蟹之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(4766);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","巨蟹之剑[2;37;0m这是一把由极为坚硬的[33m生铁[2;37;0m制成，重九斤五两三钱的[35m巨蟹之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m [1;37m雷[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
