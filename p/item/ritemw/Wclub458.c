...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一根由极其坚硬的[1;37m软银[2;37;0m制成，重十斤八两八钱的[31m胜邪之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#[40m地[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 32);
...
//特效数值
    ...
    set("weapon_prop/cant_all_busy", 13);
    ...
    set("weapon_prop/PoisonAttack", 7);
    set("weapon_prop/kf_hit_rate", 0);
    set("weapon_prop/kf_anti_hr", 8);
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 0);
     set("weapon_prop/attack_factor", 15);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 29);
    set("weapon_prop/jingli_recover", 0);
    set("weapon_prop/qi_cure", 0);
    set("weapon_prop/jing_cure", 29);
