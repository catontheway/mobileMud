...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m干将威力无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重二斤零两零钱的[31m干将之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_confuse", 23);
    set("weapon_prop/cant_busy_body", 23);
    ...
    set("weapon_prop/kf_hit_rate", 21);
    set("weapon_prop/kf_anti_hr", 17);
//伤害防御类
