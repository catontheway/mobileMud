...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m干将威力无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重九斤八两三钱的[31m干将之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m创世[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    //技能类
  //  set("weapon_prop/claw", 35);
   // set("weapon_prop/cuff", 35);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 0);
    //set("weapon_prop/hand", 32);
    set("weapon_prop/parry", 59);
    //set("weapon_prop/strike", 0);
    //set("weapon_prop/unarmed", 58);
    //set("weapon_prop/blade", 35);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 44);
...
//特效数值
    ...
    set("weapon_prop/kf_wound", 15);
    set("weapon_prop/cant_all_busy", 0);
    set("weapon_prop/cant_busy_dianxue", 19);
    set("weapon_prop/cant_busy_jiemai", 0);
    set("weapon_prop/cant_busy_fenjin", 0);
    set("weapon_prop/cant_busy_confuse", 16);
...
//气血恢复治疗类
    ...
    set("weapon_prop/qi_recover", 55);
    set("weapon_prop/jing_recover", 0);
    set("weapon_prop/jingli_recover", 39);
