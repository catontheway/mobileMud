...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重十九斤六两七钱的[31m太阿之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 41);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/blade", 26);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 54);
    set("weapon_prop/force", 0);
    set("weapon_prop/dagge", 0);
    //set("weapon_prop/hammer", 33);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 24);
    ...
    set("weapon_prop/max_all_busy", 19);
    ...
    set("weapon_prop/PoisonAttack", 22);
    set("weapon_prop/kf_hit_rate", 0);
    set("weapon_prop/kf_anti_hr", 0);
//伤害防御类
    set("weapon_prop/deep_injure", 21);
