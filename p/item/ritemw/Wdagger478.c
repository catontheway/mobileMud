...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重三斤二两九钱的[31m龙泉之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m [31m火[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
