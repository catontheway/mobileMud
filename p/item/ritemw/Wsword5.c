...
void create()
{
	set_name("[1;31m叠之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(4918);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","叠之剑[2;37;0m这是一把由绝对坚硬的[32m青铜[2;37;0m制成，重九斤八两三钱的[1;31m叠之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
