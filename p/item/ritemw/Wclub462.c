...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一根由极其坚硬的[1;37m软银[2;37;0m制成，重三十一斤六两二钱的[31m龙泉之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;31m毁天[2;37;0m [37m天[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    set("weapon_prop/dagge", 65);
    //set("weapon_prop/hammer", 39);
...
//特效数值
    set("weapon_prop/kf_def_wound", 10);
    ...
    set("weapon_prop/kf_hit_rate", 12);
