...
void create()
{
	set_name("[37m松纹之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(1120);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","松纹之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二斤二两四钱的[37m松纹之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#[1;37m雷[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
