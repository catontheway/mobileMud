...
void create()
{
	set_name("[1;33m竹之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(116);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","竹之暗器[2;37;0m这是一支由绝对坚硬的[32m青铜[2;37;0m制成，重零斤二两三钱的[1;33m竹之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/unarmed", 1);
    //set("weapon_prop/blade", 0);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_confuse", 2);
