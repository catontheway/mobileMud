...
void create()
{
	set_name("[1;33m阖之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(4083);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阖之鞭[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重八斤一两六钱的[1;33m阖之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
