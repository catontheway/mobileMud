...
void create()
{
	set_name("[34m望月之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(3412);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","望月之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重六斤八两二钱的[34m望月之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 5);
