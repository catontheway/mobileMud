...
void create()
{
	set_name("[1;31m大之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(12543);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","大之刀[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重二十五斤零两八钱的[1;31m大之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 4);
    set("weapon_prop/qi_cure", 6);
