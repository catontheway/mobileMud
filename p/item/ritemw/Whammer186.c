...
void create()
{
	set_name("[36m双星之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(4128);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","双星之锤[2;37;0m这是一柄由比较坚硬的[33m生铁[2;37;0m制成，重八斤二两五钱的[36m双星之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
