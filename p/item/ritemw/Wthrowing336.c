...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[1;34m玄武之暗器[2;37;0m这是一支由极其坚硬的[1;32m绿石[2;37;0m制成，重一斤零两一钱的[1;34m玄武之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
