...
void create()
{
	set_name("[31m慑魂之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(3836);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","慑魂之剑[2;37;0m这是一把由极其坚硬的[33m软铁[2;37;0m制成，重七斤六两七钱的[31m慑魂之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
