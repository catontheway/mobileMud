...
void create()
{
	set_name("[31m暗光之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(3273);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","暗光之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重六斤五两四钱的[31m暗光之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
