...
void create()
{
	set_name("[1;31m仙品之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(10977);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","仙品之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十一斤九两五钱的[1;31m仙品之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [32m水[2;37;0m:[1;35m绝世[2;37;0m [1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#[1;37m雷[2;37;0m:[1;34m举世[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
