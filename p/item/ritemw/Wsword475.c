...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重十一斤三两二钱的[31m鱼肠之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m创世[2;37;0m [37m天[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
