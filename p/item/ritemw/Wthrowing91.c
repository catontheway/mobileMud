...
void create()
{
	set_name("[35m铁之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(99);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","铁之暗器[2;37;0m这是一支由还算坚硬的[32m青铜[2;37;0m制成，重零斤一两九钱的[35m铁之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/armor_vs_force", 1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 2);
