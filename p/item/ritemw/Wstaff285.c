...
void create()
{
	set_name("[1;37m云髻之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(1036);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","云髻之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二斤零两七钱的[1;37m云髻之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m毁天[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
