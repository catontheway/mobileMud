...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","竹之匕首[2;37;0m这是一把由非常坚硬的[32m青铜[2;37;0m制成，重二十八斤六两零钱的[33m竹之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[34m细碎[2;37;0m [1;35m风[2;37;0m:[36m不错[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
