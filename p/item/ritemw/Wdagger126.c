...
void create()
{
	set_name("[37m紫薇之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(2143);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","紫薇之匕首[2;37;0m这是一把由非常坚硬的[33m生铁[2;37;0m制成，重四斤二两八钱的[37m紫薇之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
