...
void create()
{
	set_name("[37m月龙之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(10832);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","月龙之匕首[2;37;0m这是一把由比较坚硬的[33m生铁[2;37;0m制成，重二十一斤六两六钱的[37m月龙之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
