...
void create()
{
	set_name("[1;37m海棠之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(2253);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","海棠之鞭[2;37;0m这是一根由相当坚硬的[33m生铁[2;37;0m制成，重四斤五两零钱的[1;37m海棠之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
