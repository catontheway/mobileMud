...
void create()
{
	set_name("[1;33m星龙之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(13620);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","星龙之鞭[2;37;0m这是一根由比较坚硬的[33m生铁[2;37;0m制成，重二十七斤二两四钱的[1;33m星龙之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
