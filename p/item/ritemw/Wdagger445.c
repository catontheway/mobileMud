...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;35m所谓风云际会，天地变色！仗此行千里，老魔小丑，岂堪一击！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重三十斤五两九钱的[1;35m风云之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;31m无双[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 17);
   // set("weapon_prop/cuff", 0);
    ...
    set("weapon_prop/dagge", 34);
    //set("weapon_prop/hammer", 0);
    //set("weapon_prop/spear", 22);
