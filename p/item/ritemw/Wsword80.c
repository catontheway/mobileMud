...
void create()
{
	set_name("[35m小之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(3356);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","小之剑[2;37;0m这是一把由比较坚硬的[32m青铜[2;37;0m制成，重六斤七两一钱的[35m小之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
