...
void create()
{
	set_name("[1;31m蓝薇之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(9650);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","蓝薇之剑[2;37;0m这是一把由极其坚硬的[33m生铁[2;37;0m制成，重十九斤三两零钱的[1;31m蓝薇之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
