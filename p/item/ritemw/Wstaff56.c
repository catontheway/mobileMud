...
void create()
{
	set_name("[35m铁之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(2534);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","铁之杖[2;37;0m这是一根由还算坚硬的[32m青铜[2;37;0m制成，重五斤零两六钱的[35m铁之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
