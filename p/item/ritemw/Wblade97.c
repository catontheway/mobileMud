...
void create()
{
	set_name("[1;36m铁之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(2680);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","铁之刀[2;37;0m这是一柄由非常坚硬的[32m青铜[2;37;0m制成，重五斤三两六钱的[1;36m铁之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [1;34m电[2;37;0m:[35m标准[2;37;0m [37m天[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
