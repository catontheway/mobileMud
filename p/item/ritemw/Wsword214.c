...
void create()
{
	set_name("[1;32m老君之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(15595);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","老君之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重三十一斤一两九钱的[1;32m老君之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
