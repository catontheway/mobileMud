...
void create()
{
	set_name("[1;35m韧之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(11432);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","韧之杖[2;37;0m这是一根由绝对坚硬的[32m青铜[2;37;0m制成，重二十二斤八两六钱的[1;35m韧之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
