...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","暗光之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十九斤零两五钱的[35m暗光之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [36m木[2;37;0m:[1;31m开元[2;37;0m [37m天[2;37;0m:[1;31m无双[2;37;0m [1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 9);
