...
void create()
{
	set_name("[1;34m浮云之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(11604);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","浮云之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十三斤二两零钱的[1;34m浮云之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
