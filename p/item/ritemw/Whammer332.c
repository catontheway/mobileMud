...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[37m赤玉之锤[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重六斤三两四钱的[37m赤玉之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [31m火[2;37;0m:[1;34m举世[2;37;0m [1;37m雷[2;37;0m:[1;36m完美[2;37;0m [1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 17);
