...
void create()
{
	set_name("[37m桃花之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(10616);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","桃花之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十一斤二两三钱的[37m桃花之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
