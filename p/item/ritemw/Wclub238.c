...
void create()
{
	set_name("[33m玉泉之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(4150);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","玉泉之棍[2;37;0m这是一根由十分坚硬的[33m软铁[2;37;0m制成，重八斤三两零钱的[33m玉泉之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[1;37m雷[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
