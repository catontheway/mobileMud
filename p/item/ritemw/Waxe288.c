...
void create()
{
	set_name("[34m天锋之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(7576);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天锋之斧[2;37;0m这是一柄由极其坚硬的[33m软铁[2;37;0m制成，重十五斤一两五钱的[34m天锋之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
