...
void create()
{
	set_name("[34m韧之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(2239);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","韧之鞭[2;37;0m这是一根由还算坚硬的[32m青铜[2;37;0m制成，重四斤四两七钱的[34m韧之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[32m粗糙[2;37;0m [1;31m魔[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
