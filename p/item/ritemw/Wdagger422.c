...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;33m此物左右两边分别以黑白两种奇铁溶铸而成，一黑一白，切合乾坤，包含阴阳之气，好一柄宝物！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重七斤九两二钱的[1;33m乾坤之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m [1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
