...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重九斤四两五钱的[31m鱼肠之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m毁天[2;37;0m [36m木[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;31m毁天[2;37;0m $br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
		...
		set("weapon_prop/personality",43);
    set("weapon_prop/spirituality", 33);
		set("weapon_prop/dexerity",0);
		set("weapon_prop/constitution",37);
    //技能类
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 55);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 51);
    //set("weapon_prop/hand", 0);
    set("weapon_prop/parry", 0);
    //set("weapon_prop/strike", 51);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_body", 17);
    set("weapon_prop/max_all_busy", 0);
    set("weapon_prop/max_busy_dianxue", 0);
    set("weapon_prop/max_busy_jiemai", 20);
...
//伤害防御类
    ...
    set("weapon_prop/defense_attack", 22);
    set("weapon_prop/armor_vs_force", 0);
    set("weapon_prop/armor_effect_armor_vs_force", 23);
    set("weapon_prop/attack_speed", 16);
