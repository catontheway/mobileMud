...
void create()
{
	set_name("[34m拘魂之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(6345);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","拘魂之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十二斤六两九钱的[34m拘魂之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
