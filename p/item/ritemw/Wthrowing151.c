...
void create()
{
	set_name("[33m芙蓉之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(394);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","芙蓉之暗器[2;37;0m这是一支由绝对坚硬的[33m生铁[2;37;0m制成，重零斤七两八钱的[33m芙蓉之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
