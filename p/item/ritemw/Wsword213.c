...
void create()
{
	set_name("[1;32m红云之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(2077);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","红云之剑[2;37;0m这是一把由十分坚硬的[33m软铁[2;37;0m制成，重四斤一两五钱的[1;32m红云之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
