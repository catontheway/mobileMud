...
void create()
{
	set_name("[1;34m巧之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(136);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","巧之暗器[2;37;0m这是一支由绝对坚硬的[32m青铜[2;37;0m制成，重零斤二两七钱的[1;34m巧之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_all_busy", 1);
    set("weapon_prop/max_busy_dianxue", 2);
