...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[35m天枢之暗器[2;37;0m这是一支由无比坚硬的[1;32m绿石[2;37;0m制成，重零斤一两六钱的[35m天枢之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m毁天[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
