...
void create()
{
	set_name("[1;37m翻天之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(13434);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","翻天之锤[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重二十六斤八两六钱的[1;37m翻天之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#[40m地[2;37;0m:[1;34m举世[2;37;0m [1;31m魔[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
