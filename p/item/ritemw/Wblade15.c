...
void create()
{
	set_name("[1;35m柔之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(9893);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","柔之刀[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重十九斤七两八钱的[1;35m柔之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
