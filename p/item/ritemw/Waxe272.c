...
void create()
{
	set_name("[1;35m双手之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(4399);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","双手之斧[2;37;0m这是一柄由非常坚硬的[33m软铁[2;37;0m制成，重八斤七两九钱的[1;35m双手之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
