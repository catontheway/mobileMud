...
void create()
{
	set_name("[1;32m蜍夏之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(11095);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","蜍夏之匕首[2;37;0m这是一把由极为坚硬的[33m生铁[2;37;0m制成，重二十二斤一两九钱的[1;32m蜍夏之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
