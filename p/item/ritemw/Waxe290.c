...
void create()
{
	set_name("[1;32m魔雨之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(15741);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","魔雨之斧[2;37;0m这是一柄由非常坚硬的[33m软铁[2;37;0m制成，重三十一斤四两八钱的[1;32m魔雨之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m [1;37m雷[2;37;0m:[1;36m完美[2;37;0m [37m天[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
		...
		set("weapon_prop/personality",7);
    set("weapon_prop/spirituality", 4);
		set("weapon_prop/dexerity",0);
		set("weapon_prop/constitution",5);
    //技能类
  //  set("weapon_prop/claw", 4);
