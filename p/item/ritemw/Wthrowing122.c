...
void create()
{
	set_name("[1;31m杜鹃之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(145);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","杜鹃之暗器[2;37;0m这是一支由相当坚硬的[33m生铁[2;37;0m制成，重零斤二两九钱的[1;31m杜鹃之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m [31m火[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    set("weapon_prop/max_qi", 6);
    set("weapon_prop/max_jing", 5);
