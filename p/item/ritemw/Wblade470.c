...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m干将威力无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重二十六斤三两三钱的[31m干将之刀[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/kf_hit_rate", 24);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 57);
