...
void create()
{
	set_name("[36m璨星之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(9032);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","璨星之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十八斤零两六钱的[36m璨星之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
