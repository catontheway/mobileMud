...
void create()
{
	set_name("[36m鬼雨之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(217);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","鬼雨之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重零斤四两三钱的[36m鬼雨之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
