...
void create()
{
	set_name("[31m怪之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(14188);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","怪之刀[2;37;0m这是一柄由极为坚硬的[32m青铜[2;37;0m制成，重二十八斤三两七钱的[31m怪之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[32m粗糙[2;37;0m [1;31m魔[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
