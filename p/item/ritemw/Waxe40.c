...
void create()
{
	set_name("[31m巨之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(1398);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巨之斧[2;37;0m这是一柄由十分坚硬的[32m青铜[2;37;0m制成，重二斤七两九钱的[31m巨之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
