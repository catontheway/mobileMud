...
void create()
{
	set_name("[1;35m相思之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(13699);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","相思之杖[2;37;0m这是一根由非常坚硬的[33m生铁[2;37;0m制成，重二十七斤三两九钱的[1;35m相思之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
