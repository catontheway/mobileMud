...
void create()
{
	set_name("[36m蝙蝠之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(14179);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","蝙蝠之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十八斤三两五钱的[36m蝙蝠之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
