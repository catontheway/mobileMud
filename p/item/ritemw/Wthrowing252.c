...
void create()
{
	set_name("[36m流波之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(656);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","流波之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重一斤三两一钱的[36m流波之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m天圣[2;37;0m [33m土[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
