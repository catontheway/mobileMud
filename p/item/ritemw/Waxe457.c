...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重六斤五两三钱的[31m太阿之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_dianxue", 5);
