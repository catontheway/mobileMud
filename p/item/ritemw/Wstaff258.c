...
void create()
{
	set_name("[1;34m春雨之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(11868);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","春雨之杖[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重二十三斤七两三钱的[1;34m春雨之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
