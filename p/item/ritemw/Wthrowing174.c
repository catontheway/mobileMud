...
void create()
{
	set_name("[36m白雪之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(290);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","白雪之暗器[2;37;0m这是一支由无比坚硬的[33m生铁[2;37;0m制成，重零斤五两八钱的[36m白雪之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m [37m天[2;37;0m:[33m很高[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
