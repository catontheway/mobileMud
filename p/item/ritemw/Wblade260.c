...
void create()
{
	set_name("[1;33m秋雨之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(11800);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","秋雨之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十三斤六两零钱的[1;33m秋雨之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
