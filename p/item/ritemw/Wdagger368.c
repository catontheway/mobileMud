...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[34m恶鬼之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重三十一斤二两二钱的[34m恶鬼之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [31m火[2;37;0m:[1;35m绝世[2;37;0m [37m天[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
