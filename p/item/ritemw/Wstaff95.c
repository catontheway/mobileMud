...
void create()
{
	set_name("[1;35m铁之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(15122);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","铁之杖[2;37;0m这是一根由极其坚硬的[32m青铜[2;37;0m制成，重三十斤二两四钱的[1;35m铁之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [36m木[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
