...
void create()
{
	set_name("[1;34m玉指之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(13392);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","玉指之杖[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重二十六斤七两八钱的[1;34m玉指之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;36m完美[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
