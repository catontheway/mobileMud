...
void create()
{
	set_name("[1;36m连衡之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(548);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","连衡之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重一斤零两九钱的[1;36m连衡之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
