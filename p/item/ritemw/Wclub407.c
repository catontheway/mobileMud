...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;31m三十三天下有地，地下有城，城名鬼城，大小妖魔，人神畜生都在此轮回往返，谓之“炼狱”！$br#[2;37;0m这是一根由相当坚硬的[31m流花石[2;37;0m制成，重六斤七两八钱的[1;31m炼狱之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m [36m木[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;31m毁天[2;37;0m [37m天[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 18);
    set("weapon_prop/qi_cure", 31);
    set("weapon_prop/jing_cure", 27);
