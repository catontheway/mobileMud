...
void create()
{
	set_name("[1;36m韧之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(4594);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","韧之匕首[2;37;0m这是一把由十分坚硬的[32m青铜[2;37;0m制成，重九斤一两八钱的[1;36m韧之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
