...
void create()
{
	set_name("[1;37m净坛之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(386);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","净坛之暗器[2;37;0m这是一支由比较坚硬的[33m生铁[2;37;0m制成，重零斤七两七钱的[1;37m净坛之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
