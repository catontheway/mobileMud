...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[36m蓝虹之暗器[2;37;0m这是一支由无比坚硬的[1;32m绿石[2;37;0m制成，重零斤六两六钱的[36m蓝虹之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
