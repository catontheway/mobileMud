...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[1;31m三十三天下有地，地下有城，城名鬼城，大小妖魔，人神畜生都在此轮回往返，谓之“炼狱”！$br#[2;37;0m这是一支由无比坚硬的[31m流花石[2;37;0m制成，重零斤七两六钱的[1;31m炼狱之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
