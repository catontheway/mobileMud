...
void create()
{
	set_name("[1;31m钢之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(217);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","钢之暗器[2;37;0m这是一支由极其坚硬的[32m青铜[2;37;0m制成，重零斤四两三钱的[1;31m钢之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[32m粗糙[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 3);
