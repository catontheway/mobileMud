...
void create()
{
	set_name("[1;31m巧之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(708);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","巧之暗器[2;37;0m这是一支由还算坚硬的[32m青铜[2;37;0m制成，重一斤四两一钱的[1;31m巧之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[36m不错[2;37;0m [40m地[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
