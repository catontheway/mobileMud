...
void create()
{
	set_name("[1;37m星龙之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(8179);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","星龙之斧[2;37;0m这是一柄由相当坚硬的[33m生铁[2;37;0m制成，重十六斤三两五钱的[1;37m星龙之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m [1;34m电[2;37;0m:[1;36m完美[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
