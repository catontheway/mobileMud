...
void create()
{
	set_name("[1;37m月季之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(1232);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","月季之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二斤四两六钱的[1;37m月季之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m [40m地[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
