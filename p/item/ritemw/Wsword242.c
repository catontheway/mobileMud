...
void create()
{
	set_name("[34m猛虎之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(14903);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","猛虎之剑[2;37;0m这是一把由相当坚硬的[33m软铁[2;37;0m制成，重二十九斤八两零钱的[34m猛虎之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m开元[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
