...
void create()
{
	set_name("[1;31m龙头之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(8874);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","龙头之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十七斤七两四钱的[1;31m龙头之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [31m火[2;37;0m:[1;32m魔王[2;37;0m [33m土[2;37;0m:[35m标准[2;37;0m [1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 11);
