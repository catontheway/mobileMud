...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[36m紫虹之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重三十斤三两九钱的[36m紫虹之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;32m魔王[2;37;0m [33m土[2;37;0m:[1;31m开元[2;37;0m [1;34m电[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
