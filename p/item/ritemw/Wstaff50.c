...
void create()
{
	set_name("[31m阖之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(10668);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阖之杖[2;37;0m这是一根由相当坚硬的[32m青铜[2;37;0m制成，重二十一斤三两三钱的[31m阖之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m [31m火[2;37;0m:[32m粗糙[2;37;0m [1;34m电[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
