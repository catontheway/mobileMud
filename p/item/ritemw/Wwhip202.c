...
void create()
{
	set_name("[1;35m伤痕之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(4322);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","伤痕之鞭[2;37;0m这是一根由极其坚硬的[33m软铁[2;37;0m制成，重八斤六两四钱的[1;35m伤痕之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
