...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[36m天圣之斧[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重二十七斤六两二钱的[36m天圣之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m [1;37m雷[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
