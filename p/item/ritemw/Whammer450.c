...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重十七斤八两四钱的[31m莫邪之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m [1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 27);
		set("weapon_prop/dexerity",0);
		set("weapon_prop/constitution",30);
    //技能类
  //  set("weapon_prop/claw", 25);
   // set("weapon_prop/cuff", 50);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 36);
    //set("weapon_prop/hand", 25);
    set("weapon_prop/parry", 0);
    //set("weapon_prop/strike", 52);
...
//特效数值
    ...
    set("weapon_prop/kf_wound", 24);
    set("weapon_prop/cant_all_busy", 22);
    set("weapon_prop/cant_busy_dianxue", 20);
    ...
    set("weapon_prop/AllPoisonsImmune", 21);
    set("weapon_prop/PoisonAttack", 0);
    set("weapon_prop/kf_hit_rate", 0);
    set("weapon_prop/kf_anti_hr", 24);
//伤害防御类
