...
void create()
{
	set_name("[33m星龙之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(2324);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","星龙之锤[2;37;0m这是一柄由绝对坚硬的[33m生铁[2;37;0m制成，重四斤六两四钱的[33m星龙之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
