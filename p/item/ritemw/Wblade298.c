...
void create()
{
	set_name("[36m延永之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(4250);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","延永之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重八斤五两零钱的[36m延永之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
