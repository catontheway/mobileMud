...
void create()
{
	set_name("[1;36m暗光之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(5066);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","暗光之杖[2;37;0m这是一根由非常坚硬的[33m软铁[2;37;0m制成，重十斤一两三钱的[1;36m暗光之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
