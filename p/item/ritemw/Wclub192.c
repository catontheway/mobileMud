...
void create()
{
	set_name("[1;35m圣母之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(15836);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","圣母之棍[2;37;0m这是一根由比较坚硬的[33m生铁[2;37;0m制成，重三十一斤六两七钱的[1;35m圣母之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m [33m土[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
