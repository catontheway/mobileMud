...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重一斤三两二钱的[31m太阿之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m [31m火[2;37;0m:[1;31m开元[2;37;0m [1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
		...
		set("weapon_prop/personality",44);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 61);
