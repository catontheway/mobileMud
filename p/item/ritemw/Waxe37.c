...
void create()
{
	set_name("[31m阔之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(4485);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","阔之斧[2;37;0m这是一柄由十分坚硬的[32m青铜[2;37;0m制成，重八斤九两七钱的[31m阔之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
