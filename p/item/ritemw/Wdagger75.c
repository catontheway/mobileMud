...
void create()
{
	set_name("[1;31m巧之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(11212);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","巧之匕首[2;37;0m这是一把由相当坚硬的[32m青铜[2;37;0m制成，重二十二斤四两二钱的[1;31m巧之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
