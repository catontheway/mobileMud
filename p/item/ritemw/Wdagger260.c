...
void create()
{
	set_name("[1;34m玉指之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(13959);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","玉指之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十七斤九两一钱的[1;34m玉指之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m [32m水[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
