...
void create()
{
	set_name("[35m钢之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(8688);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","钢之刀[2;37;0m这是一柄由极为坚硬的[32m青铜[2;37;0m制成，重十七斤三两七钱的[35m钢之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_fenjin", 1);
