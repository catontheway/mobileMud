...
void create()
{
	set_name("[33m兽皮之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(7904);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","兽皮之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重十五斤八两零钱的[33m兽皮之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
