...
void create()
{
	set_name("[34m雾鬟之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(10644);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","雾鬟之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十一斤二两八钱的[34m雾鬟之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
