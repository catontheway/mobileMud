...
void create()
{
	set_name("[1;33m青竹之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(5958);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","青竹之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十一斤九两一钱的[1;33m青竹之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
