...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一柄由极为坚硬的[1;37m软银[2;37;0m制成，重二斤九两二钱的[31m莫邪之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[35m标准[2;37;0m [1;36m人[2;37;0m:[1;31m创世[2;37;0m [1;31m魔[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 39);
    set("weapon_prop/dodge", 0);
    //set("weapon_prop/finger", 54);
    //set("weapon_prop/hand", 52);
    set("weapon_prop/parry", 0);
    //set("weapon_prop/strike", 0);
    //set("weapon_prop/unarmed", 51);
...
//特效数值
    ...
    set("weapon_prop/cant_all_busy", 9);
    set("weapon_prop/cant_busy_dianxue", 13);
    ...
    set("weapon_prop/max_busy_fenjin", 9);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 4);
     set("weapon_prop/attack_factor", 14);
     set("weapon_prop/parry_factor", 0);
     set("weapon_prop/dodge_factor", 4);
//气血恢复治疗类
    set("weapon_prop/max_qi", 0);
    set("weapon_prop/max_jing", 29);
    set("weapon_prop/neili_recover", 34);
    set("weapon_prop/qi_recover", 39);
