...
void create()
{
	set_name("[1;34m翠屏之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(7782);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","翠屏之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十五斤五两六钱的[1;34m翠屏之锤[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/PoisonAttack", 4);
