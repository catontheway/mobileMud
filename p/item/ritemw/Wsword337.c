...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[37m云梯之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二十六斤七两二钱的[37m云梯之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
