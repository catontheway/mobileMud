...
void create()
{
	set_name("[1;37m明光之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(10416);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","明光之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十斤八两三钱的[1;37m明光之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m无双[2;37;0m [37m天[2;37;0m:[1;35m绝世[2;37;0m [40m地[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
