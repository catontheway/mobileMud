...
void create()
{
	set_name("[1;36m泪痕之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(7939);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","泪痕之鞭[2;37;0m这是一根由绝对坚硬的[33m软铁[2;37;0m制成，重十五斤八两七钱的[1;36m泪痕之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [36m木[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
