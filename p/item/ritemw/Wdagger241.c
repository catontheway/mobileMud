...
void create()
{
	set_name("[1;32m夜月之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(14614);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","夜月之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十九斤二两二钱的[1;32m夜月之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
