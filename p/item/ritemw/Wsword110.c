...
void create()
{
	set_name("[1;36m常青之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(4878);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","常青之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重九斤七两五钱的[1;36m常青之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [37m天[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
