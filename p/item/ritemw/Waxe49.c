...
void create()
{
	set_name("[1;35m阔之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(1724);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","阔之斧[2;37;0m这是一柄由极为坚硬的[32m青铜[2;37;0m制成，重三斤四两四钱的[1;35m阔之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[36m不错[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    set("weapon_prop/kf_def_wound", 1);
...
//伤害防御类
    ...
    set("weapon_prop/defense_attack", 1);
