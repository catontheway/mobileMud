...
void create()
{
	set_name("[1;34m阔之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(4121);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","阔之锤[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重八斤二两四钱的[1;34m阔之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [1;31m魔[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 2);
