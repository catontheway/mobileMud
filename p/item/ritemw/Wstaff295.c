...
void create()
{
	set_name("[1;36m兽皮之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(2853);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","兽皮之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重五斤七两零钱的[1;36m兽皮之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
