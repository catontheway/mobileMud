...
void create()
{
	set_name("[36m夺魂之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(519);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","夺魂之暗器[2;37;0m这是一支由绝对坚硬的[33m软铁[2;37;0m制成，重一斤零两三钱的[36m夺魂之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
