...
void create()
{
	set_name("[37m铁之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(2078);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","铁之棍[2;37;0m这是一根由非常坚硬的[32m青铜[2;37;0m制成，重四斤一两五钱的[37m铁之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_jiemai", 2);
