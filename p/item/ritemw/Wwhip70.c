...
void create()
{
	set_name("[1;33m钢之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(10776);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","钢之鞭[2;37;0m这是一根由极为坚硬的[32m青铜[2;37;0m制成，重二十一斤五两五钱的[1;33m钢之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
