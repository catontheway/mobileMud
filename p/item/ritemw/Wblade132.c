...
void create()
{
	set_name("[31m青陽之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(8218);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","青陽之刀[2;37;0m这是一柄由极为坚硬的[33m生铁[2;37;0m制成，重十六斤四两三钱的[31m青陽之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 8);
    set("weapon_prop/qi_cure", 0);
    set("weapon_prop/jing_cure", 6);
