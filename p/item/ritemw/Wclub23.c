...
void create()
{
	set_name("[33m怪之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(14391);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","怪之棍[2;37;0m这是一根由非常坚硬的[32m青铜[2;37;0m制成，重二十八斤七两八钱的[33m怪之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
