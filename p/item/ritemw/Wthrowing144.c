...
void create()
{
	set_name("[31m文昌之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(368);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","文昌之暗器[2;37;0m这是一支由无比坚硬的[33m生铁[2;37;0m制成，重零斤七两三钱的[31m文昌之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;36m完美[2;37;0m [33m土[2;37;0m:[1;31m开元[2;37;0m [1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
