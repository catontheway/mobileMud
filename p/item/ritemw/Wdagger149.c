...
void create()
{
	set_name("[1;31m紫陽之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(11417);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","紫陽之匕首[2;37;0m这是一把由相当坚硬的[33m生铁[2;37;0m制成，重二十二斤八两三钱的[1;31m紫陽之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
