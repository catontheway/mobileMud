...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","大之剑[2;37;0m这是一把由非常坚硬的[32m青铜[2;37;0m制成，重三十斤二两二钱的[1;31m大之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 1);
