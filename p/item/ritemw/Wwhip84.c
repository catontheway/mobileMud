...
void create()
{
	set_name("[1;31m阖之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(14265);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阖之鞭[2;37;0m这是一根由还算坚硬的[32m青铜[2;37;0m制成，重二十八斤五两三钱的[1;31m阖之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m [31m火[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
