...
void create()
{
	set_name("[1;35m猛虎之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(7693);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","猛虎之锤[2;37;0m这是一柄由极其坚硬的[33m软铁[2;37;0m制成，重十五斤三两八钱的[1;35m猛虎之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
