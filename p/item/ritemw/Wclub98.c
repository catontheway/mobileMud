...
void create()
{
	set_name("[1;31m巨之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(3362);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","巨之棍[2;37;0m这是一根由相当坚硬的[32m青铜[2;37;0m制成，重六斤七两二钱的[1;31m巨之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
