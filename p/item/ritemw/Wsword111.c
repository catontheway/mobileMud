...
void create()
{
	set_name("[31m翠屏之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(12221);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","翠屏之剑[2;37;0m这是一把由比较坚硬的[33m生铁[2;37;0m制成，重二十四斤四两四钱的[31m翠屏之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#[40m地[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
