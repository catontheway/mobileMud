...
void create()
{
	set_name("[34m飞雪之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(12926);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","飞雪之棍[2;37;0m这是一根由绝对坚硬的[33m生铁[2;37;0m制成，重二十五斤八两五钱的[34m飞雪之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[35m标准[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
