...
void create()
{
	set_name("[36m木樨之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(15805);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","木樨之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重三十一斤六两一钱的[36m木樨之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
