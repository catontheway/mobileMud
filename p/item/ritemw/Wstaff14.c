...
void create()
{
	set_name("[1;33m巨之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(13485);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","巨之杖[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重二十六斤九两七钱的[1;33m巨之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[34m细碎[2;37;0m [1;37m雷[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
