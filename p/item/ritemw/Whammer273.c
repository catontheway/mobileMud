...
void create()
{
	set_name("[35m天羽之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(8798);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天羽之锤[2;37;0m这是一柄由相当坚硬的[33m软铁[2;37;0m制成，重十七斤五两九钱的[35m天羽之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
