...
void create()
{
	set_name("[36m月季之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(14445);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","月季之棍[2;37;0m这是一根由比较坚硬的[33m生铁[2;37;0m制成，重二十八斤八两九钱的[36m月季之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m [37m天[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
