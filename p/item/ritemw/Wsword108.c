...
void create()
{
	set_name("[1;35m富貴之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(13956);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","富貴之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十七斤九两一钱的[1;35m富貴之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [31m火[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
