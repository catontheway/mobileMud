...
void create()
{
	set_name("[35m柔之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(515);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","柔之暗器[2;37;0m这是一支由还算坚硬的[32m青铜[2;37;0m制成，重一斤零两三钱的[35m柔之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
