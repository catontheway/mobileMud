...
void create()
{
	set_name("[36m贺兰之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(3792);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","贺兰之斧[2;37;0m这是一柄由绝对坚硬的[33m软铁[2;37;0m制成，重七斤五两八钱的[36m贺兰之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [32m水[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
