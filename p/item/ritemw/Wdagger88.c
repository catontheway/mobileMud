...
void create()
{
	set_name("[31m钢之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(9268);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","钢之匕首[2;37;0m这是一把由极为坚硬的[32m青铜[2;37;0m制成，重十八斤五两三钱的[31m钢之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
