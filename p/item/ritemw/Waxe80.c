...
void create()
{
	set_name("[33m钢之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(14861);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","钢之斧[2;37;0m这是一柄由非常坚硬的[32m青铜[2;37;0m制成，重二十九斤七两二钱的[33m钢之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[32m粗糙[2;37;0m [1;36m人[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/blade", 5);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 0);
    set("weapon_prop/force", 4);
...
//伤害防御类
    ...
    set("weapon_prop/armor_effect_armor_vs_force", 2);
