...
void create()
{
	set_name("[34m太陽之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(1388);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","太陽之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二斤七两七钱的[34m太陽之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
