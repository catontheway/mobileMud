...
void create()
{
	set_name("[1;35m毒蛇之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(15031);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","毒蛇之斧[2;37;0m这是一柄由十分坚硬的[33m软铁[2;37;0m制成，重三十斤零两六钱的[1;35m毒蛇之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [1;36m人[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
