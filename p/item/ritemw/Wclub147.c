...
void create()
{
	set_name("[31m魔袱之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(2825);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","魔袱之棍[2;37;0m这是一根由相当坚硬的[33m生铁[2;37;0m制成，重五斤六两五钱的[31m魔袱之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[35m标准[2;37;0m [1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#[37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
