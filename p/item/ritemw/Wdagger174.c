...
void create()
{
	set_name("[1;34m紫芒之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(14724);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","紫芒之匕首[2;37;0m这是一把由绝对坚硬的[33m生铁[2;37;0m制成，重二十九斤四两四钱的[1;34m紫芒之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
