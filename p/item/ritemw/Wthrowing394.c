...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[35m摇光之暗器[2;37;0m这是一支由相当坚硬的[1;32m绿石[2;37;0m制成，重零斤一两二钱的[35m摇光之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 25);
