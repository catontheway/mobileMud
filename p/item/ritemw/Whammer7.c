...
void create()
{
	set_name("[1;36m阖之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(9950);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","阖之锤[2;37;0m这是一柄由极为坚硬的[32m青铜[2;37;0m制成，重十九斤九两零钱的[1;36m阖之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
