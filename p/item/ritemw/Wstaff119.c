...
void create()
{
	set_name("[31m火鶴之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(10455);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","火鶴之杖[2;37;0m这是一根由极为坚硬的[33m生铁[2;37;0m制成，重二十斤九两一钱的[31m火鶴之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[32m粗糙[2;37;0m [31m火[2;37;0m:[1;34m举世[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 0);
     ...
     set("weapon_prop/parry_factor", 2);
