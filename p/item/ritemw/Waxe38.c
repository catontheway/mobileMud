...
void create()
{
	set_name("[35m竹之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(15328);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","竹之斧[2;37;0m这是一柄由比较坚硬的[32m青铜[2;37;0m制成，重三十斤六两五钱的[35m竹之斧[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 0);
     set("weapon_prop/attack_factor", 1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 1);
