...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","竹之剑[2;37;0m这是一把由极其坚硬的[32m青铜[2;37;0m制成，重十一斤二两七钱的[31m竹之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/defense_attack", 3);
