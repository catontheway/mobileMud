...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重十七斤一两八钱的[31m鱼肠之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 26);
...
//特效数值
    ...
    set("weapon_prop/max_busy_fenjin", 16);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 23);
    set("weapon_prop/qi_cure", 46);
