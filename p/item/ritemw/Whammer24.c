...
void create()
{
	set_name("[35m阔之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(9008);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","阔之锤[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重十八斤零两一钱的[35m阔之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[36m不错[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
