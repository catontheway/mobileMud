...
void create()
{
	set_name("[1;35m盘古之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(5993);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","盘古之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十一斤九两八钱的[1;35m盘古之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 9);
