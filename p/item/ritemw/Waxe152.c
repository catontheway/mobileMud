...
void create()
{
	set_name("[1;35m金铃之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(13620);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","金铃之斧[2;37;0m这是一柄由比较坚硬的[33m生铁[2;37;0m制成，重二十七斤二两四钱的[1;35m金铃之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
