...
void create()
{
	set_name("[1;36m青陽之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(11437);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","青陽之斧[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重二十二斤八两七钱的[1;36m青陽之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[33m很高[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
