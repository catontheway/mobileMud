...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","巨之杖[2;37;0m这是一根由相当坚硬的[32m青铜[2;37;0m制成，重二十五斤七两八钱的[34m巨之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[36m不错[2;37;0m [40m地[2;37;0m:[31m精致[2;37;0m [1;36m人[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 6);
     ...
     set("weapon_prop/parry_factor", 1);
