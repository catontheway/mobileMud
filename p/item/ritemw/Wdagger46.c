...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","铁之匕首[2;37;0m这是一把由绝对坚硬的[32m青铜[2;37;0m制成，重二十九斤八两六钱的[1;37m铁之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
