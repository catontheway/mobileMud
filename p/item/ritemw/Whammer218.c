...
void create()
{
	set_name("[35m必胜之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(8073);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","必胜之锤[2;37;0m这是一柄由相当坚硬的[33m软铁[2;37;0m制成，重十六斤一两四钱的[35m必胜之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [40m地[2;37;0m:[1;31m创世[2;37;0m [1;36m人[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
