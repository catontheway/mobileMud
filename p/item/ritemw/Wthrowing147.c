...
void create()
{
	set_name("[36m牡丹之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(793);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","牡丹之暗器[2;37;0m这是一支由无比坚硬的[33m生铁[2;37;0m制成，重一斤五两八钱的[36m牡丹之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
