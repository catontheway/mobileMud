...
void create()
{
	set_name("[35m冬梅之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(9904);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","冬梅之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十九斤八两零钱的[35m冬梅之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m天圣[2;37;0m [1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
