...
void create()
{
	set_name("[31m千芒之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(2173);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","千芒之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重四斤三两四钱的[31m千芒之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#[40m地[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 4);
