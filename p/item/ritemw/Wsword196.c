...
void create()
{
	set_name("[36m蔷薇之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(10262);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","蔷薇之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十斤五两二钱的[36m蔷薇之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;36m完美[2;37;0m [1;36m人[2;37;0m:[1;32m魔王[2;37;0m [1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
