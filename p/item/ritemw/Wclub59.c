...
void create()
{
	set_name("[33m大之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(8850);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","大之棍[2;37;0m这是一根由极其坚硬的[32m青铜[2;37;0m制成，重十七斤七两零钱的[33m大之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [1;37m雷[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
