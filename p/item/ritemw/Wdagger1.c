...
void create()
{
	set_name("[35m柔之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(3640);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","柔之匕首[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重七斤二两八钱的[35m柔之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
