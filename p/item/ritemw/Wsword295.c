...
void create()
{
	set_name("[34m仙水之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(2784);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","仙水之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重五斤五两六钱的[34m仙水之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
