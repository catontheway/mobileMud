...
void create()
{
	set_name("[35m铜之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(3028);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","铜之斧[2;37;0m这是一柄由极其坚硬的[32m青铜[2;37;0m制成，重六斤零两五钱的[35m铜之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
