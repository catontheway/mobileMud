...
void create()
{
	set_name("[34m怪之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(7293);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","怪之匕首[2;37;0m这是一把由还算坚硬的[32m青铜[2;37;0m制成，重十四斤五两八钱的[34m怪之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
