...
void create()
{
	set_name("[37m竹之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(2575);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","竹之匕首[2;37;0m这是一把由无比坚硬的[32m青铜[2;37;0m制成，重五斤一两五钱的[37m竹之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#[1;34m电[2;37;0m:[34m细碎[2;37;0m [40m地[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
