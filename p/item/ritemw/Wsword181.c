...
void create()
{
	set_name("[1;35m渡心之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(7719);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","渡心之剑[2;37;0m这是一把由相当坚硬的[33m生铁[2;37;0m制成，重十五斤四两三钱的[1;35m渡心之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
