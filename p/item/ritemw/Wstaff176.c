...
void create()
{
	set_name("[1;34m百合之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(15617);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","百合之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重三十一斤二两三钱的[1;34m百合之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[32m粗糙[2;37;0m [33m土[2;37;0m:[1;32m魔王[2;37;0m [40m地[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
