...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[35m天玑之锤[2;37;0m这是一柄由相当坚硬的[1;32m绿石[2;37;0m制成，重十四斤四两四钱的[35m天玑之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m [40m地[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
