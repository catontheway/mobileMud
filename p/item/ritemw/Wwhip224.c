...
void create()
{
	set_name("[35m天门之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(10836);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","天门之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十一斤六两七钱的[35m天门之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
