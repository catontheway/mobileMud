...
void create()
{
	set_name("[1;33m千芒之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(14406);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","千芒之斧[2;37;0m这是一柄由非常坚硬的[33m生铁[2;37;0m制成，重二十八斤八两一钱的[1;33m千芒之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[32m粗糙[2;37;0m [1;35m风[2;37;0m:[32m粗糙[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
