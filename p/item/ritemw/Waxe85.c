...
void create()
{
	set_name("[33m怪之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(15224);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","怪之斧[2;37;0m这是一柄由无比坚硬的[32m青铜[2;37;0m制成，重三十斤四两四钱的[33m怪之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
