...
void create()
{
	set_name("[1;35m铁之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(14388);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","铁之棍[2;37;0m这是一根由相当坚硬的[32m青铜[2;37;0m制成，重二十八斤七两七钱的[1;35m铁之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
