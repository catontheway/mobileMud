...
void create()
{
	set_name("[34m拘魂之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(14323);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","拘魂之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十八斤六两四钱的[34m拘魂之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m天圣[2;37;0m [1;36m人[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
