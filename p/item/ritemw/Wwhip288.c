...
void create()
{
	set_name("[34m皓齿之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(6185);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","皓齿之鞭[2;37;0m这是一根由极为坚硬的[33m软铁[2;37;0m制成，重十二斤三两七钱的[34m皓齿之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
