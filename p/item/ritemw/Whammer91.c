...
void create()
{
	set_name("[33m阔之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(9009);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","阔之锤[2;37;0m这是一柄由相当坚硬的[32m青铜[2;37;0m制成，重十八斤零两一钱的[33m阔之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
