...
void create()
{
	set_name("[34m春兰之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(2284);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","春兰之锤[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重四斤五两六钱的[34m春兰之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m [37m天[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
