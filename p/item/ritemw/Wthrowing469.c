...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重一斤三两七钱的[31m鱼肠之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [32m水[2;37;0m:[1;31m毁天[2;37;0m [1;37m雷[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 24);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/unarmed", 46);
    //set("weapon_prop/blade", 37);
...
//特效数值
    ...
    set("weapon_prop/max_busy_dianxue", 14);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 22);
