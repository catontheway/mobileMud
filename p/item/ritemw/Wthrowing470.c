...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重一斤一两六钱的[31m鱼肠之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m [1;34m电[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 64);
    set("weapon_prop/qi_recover", 0);
    set("weapon_prop/jing_recover", 65);
