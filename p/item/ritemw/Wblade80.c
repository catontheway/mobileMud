...
void create()
{
	set_name("[1;31m韧之刀[2;37;0m", ({ "bad blade", "blade" }));
	set_weight(1914);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","韧之刀[2;37;0m这是一柄由非常坚硬的[32m青铜[2;37;0m制成，重三斤八两二钱的[1;31m韧之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_all_busy", 3);
