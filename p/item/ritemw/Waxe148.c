...
void create()
{
	set_name("[31m星龙之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(10317);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","星龙之斧[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重二十斤六两三钱的[31m星龙之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
