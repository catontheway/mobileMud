...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[32m玄机之棍[2;37;0m这是一根由极为坚硬的[1;32m绿石[2;37;0m制成，重二十四斤四两九钱的[32m玄机之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m天圣[2;37;0m [31m火[2;37;0m:[1;33m天圣[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
