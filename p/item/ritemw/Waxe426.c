...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[1;36m天地之初，女娲补天所留下的天地间至尊之物之一经千秋万载所制，功能开天劈地！$br#[2;37;0m这是一柄由无比坚硬的[31m流花石[2;37;0m制成，重五斤四两六钱的[1;36m天地之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/abs_week_injure", 18);
