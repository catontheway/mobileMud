...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;35m昔日黄帝持此物立于指南车上，驱迷雾，扫阴霾，率应龙旱魃，御百兽而战蚩尤！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重十二斤零两二钱的[1;35m轩辕之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [31m火[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
