...
void create()
{
	set_name("[33m倒海之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(5309);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","倒海之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重十斤六两一钱的[33m倒海之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [40m地[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
