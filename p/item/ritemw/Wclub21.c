...
void create()
{
	set_name("[31m宾之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(13386);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","宾之棍[2;37;0m这是一根由极其坚硬的[32m青铜[2;37;0m制成，重二十六斤七两七钱的[31m宾之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[35m标准[2;37;0m [37m天[2;37;0m:[36m不错[2;37;0m [1;31m魔[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_jiemai", 2);
