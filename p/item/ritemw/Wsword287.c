...
void create()
{
	set_name("[35m伤痕之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(1930);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","伤痕之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重三斤八两六钱的[35m伤痕之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m [36m木[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[1;31m创世[2;37;0m $br#[1;34m电[2;37;0m:[1;32m魔王[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
