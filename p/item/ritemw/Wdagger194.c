...
void create()
{
	set_name("[34m金牛之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(7570);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","金牛之匕首[2;37;0m这是一把由十分坚硬的[33m生铁[2;37;0m制成，重十五斤一两四钱的[34m金牛之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;34m举世[2;37;0m [37m天[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/staff", 7);
    set("weapon_prop/force", 0);
    set("weapon_prop/dagge", 13);
...
//特效数值
    ...
    set("weapon_prop/max_all_busy", 2);
    ...
    set("weapon_prop/max_busy_body", 2);
