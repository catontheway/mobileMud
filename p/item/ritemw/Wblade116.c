...
void create()
{
	set_name("[1;33m青薇之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(4821);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","青薇之刀[2;37;0m这是一柄由绝对坚硬的[33m生铁[2;37;0m制成，重九斤六两四钱的[1;33m青薇之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
