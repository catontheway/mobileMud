...
void create()
{
	set_name("[35m南天之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(8448);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","南天之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十六斤八两九钱的[35m南天之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [1;37m雷[2;37;0m:[1;35m绝世[2;37;0m [1;34m电[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
