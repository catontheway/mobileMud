...
void create()
{
	set_name("[1;36m狮枭之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(4106);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","狮枭之斧[2;37;0m这是一柄由极其坚硬的[33m软铁[2;37;0m制成，重八斤二两一钱的[1;36m狮枭之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
