...
void create()
{
	set_name("[33m冰陽之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(9028);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","冰陽之斧[2;37;0m这是一柄由极其坚硬的[33m生铁[2;37;0m制成，重十八斤零两五钱的[33m冰陽之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
