...
void create()
{
	set_name("[35m绿影之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(13726);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","绿影之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重二十七斤四两五钱的[35m绿影之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
