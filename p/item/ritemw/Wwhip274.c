...
void create()
{
	set_name("[1;34m雁翎之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(9743);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","雁翎之鞭[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重十九斤四两八钱的[1;34m雁翎之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 16);
