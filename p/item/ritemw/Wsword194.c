...
void create()
{
	set_name("[1;36m青鶴之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(3951);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","青鶴之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重七斤九两零钱的[1;36m青鶴之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[33m很高[2;37;0m [37m天[2;37;0m:[33m很高[2;37;0m [40m地[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/strike", 7);
    //set("weapon_prop/unarmed", 11);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_body", 4);
