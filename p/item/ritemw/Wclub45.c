...
void create()
{
	set_name("[36m铁之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(11071);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","铁之棍[2;37;0m这是一根由比较坚硬的[32m青铜[2;37;0m制成，重二十二斤一两四钱的[36m铁之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m [37m天[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
