...
void create()
{
	set_name("[1;36m红云之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(558);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","红云之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重一斤一两一钱的[1;36m红云之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 10);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/unarmed", 14);
    //set("weapon_prop/blade", 15);
