...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重三斤零两六钱的[31m太阿之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
    ...
    set("weapon_prop/spirituality", 22);
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    set("weapon_prop/force", 33);
    set("weapon_prop/dagge", 49);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_jiemai", 26);
    set("weapon_prop/cant_busy_fenjin", 0);
    set("weapon_prop/cant_busy_confuse", 20);
    set("weapon_prop/cant_busy_body", 0);
    set("weapon_prop/max_all_busy", 17);
    set("weapon_prop/max_busy_dianxue", 0);
    set("weapon_prop/max_busy_jiemai", 0);
    set("weapon_prop/max_busy_fenjin", 23);
    set("weapon_prop/max_busy_confuse", 0);
    set("weapon_prop/max_busy_body", 19);
...
//伤害防御类
    ...
    set("weapon_prop/week_injure", 21);
    set("weapon_prop/abs_week_injure", 22);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 31);
