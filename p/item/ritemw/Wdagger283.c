...
void create()
{
	set_name("[1;34m鬼雨之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(11383);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","鬼雨之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重二十二斤七两六钱的[1;34m鬼雨之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
