...
void create()
{
	set_name("[1;37m紫陽之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(3525);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","紫陽之杖[2;37;0m这是一根由十分坚硬的[33m生铁[2;37;0m制成，重七斤零两五钱的[1;37m紫陽之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[33m很高[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
