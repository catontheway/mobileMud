...
void create()
{
	set_name("[1;34m霞蔚之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(11628);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","霞蔚之棍[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十三斤二两五钱的[1;34m霞蔚之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[31m精致[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
