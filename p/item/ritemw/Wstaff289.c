...
void create()
{
	set_name("[1;32m雾鬟之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(15615);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","雾鬟之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重三十一斤二两三钱的[1;32m雾鬟之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
