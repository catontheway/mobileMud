...
void create()
{
	set_name("[36m雾鬟之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(2330);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","雾鬟之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重四斤六两六钱的[36m雾鬟之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m开元[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    set("weapon_prop/max_qi", 15);
    set("weapon_prop/max_jing", 20);
    set("weapon_prop/neili_recover", 8);
    set("weapon_prop/qi_recover", 0);
    set("weapon_prop/jing_recover", 16);
