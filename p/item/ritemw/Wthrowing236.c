...
void create()
{
	set_name("[34m飞燕之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(193);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","飞燕之暗器[2;37;0m这是一支由十分坚硬的[33m软铁[2;37;0m制成，重零斤三两八钱的[34m飞燕之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
