...
void create()
{
	set_name("[1;35m戈壁之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(6350);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","戈壁之棍[2;37;0m这是一根由极其坚硬的[33m生铁[2;37;0m制成，重十二斤七两零钱的[1;35m戈壁之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
