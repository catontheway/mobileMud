...
void create()
{
	set_name("[1;32m柔之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(15841);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","柔之剑[2;37;0m这是一把由相当坚硬的[32m青铜[2;37;0m制成，重三十一斤六两八钱的[1;32m柔之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
