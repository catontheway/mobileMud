...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重一斤三两四钱的[31m湛卢之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m毁天[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
