...
void create()
{
	set_name("[1;35m仙品之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(7491);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","仙品之杖[2;37;0m这是一根由十分坚硬的[33m软铁[2;37;0m制成，重十四斤九两八钱的[1;35m仙品之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
