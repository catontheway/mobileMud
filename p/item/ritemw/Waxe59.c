...
void create()
{
	set_name("[1;33m小之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(2003);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","小之斧[2;37;0m这是一柄由极为坚硬的[32m青铜[2;37;0m制成，重四斤零两零钱的[1;33m小之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
