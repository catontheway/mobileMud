...
void create()
{
	set_name("[36m流盼之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(15746);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","流盼之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重三十一斤四两九钱的[36m流盼之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;32m魔王[2;37;0m [1;37m雷[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
