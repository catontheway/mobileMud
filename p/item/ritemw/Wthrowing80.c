...
void create()
{
	set_name("[31m柔之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(355);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","柔之暗器[2;37;0m这是一支由非常坚硬的[32m青铜[2;37;0m制成，重零斤七两一钱的[31m柔之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m [33m土[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
