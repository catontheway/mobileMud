...
void create()
{
	set_name("[31m巨之锤[2;37;0m", ({ "bad hammer", "hammer" }));
	set_weight(14777);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","巨之锤[2;37;0m这是一柄由相当坚硬的[32m青铜[2;37;0m制成，重二十九斤五两五钱的[31m巨之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[36m不错[2;37;0m [33m土[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
