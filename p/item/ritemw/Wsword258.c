...
void create()
{
	set_name("[1;36m泼水之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(3931);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","泼水之剑[2;37;0m这是一把由相当坚硬的[33m软铁[2;37;0m制成，重七斤八两六钱的[1;36m泼水之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
