...
void create()
{
	set_name("[34m柔之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(5789);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","柔之斧[2;37;0m这是一柄由非常坚硬的[32m青铜[2;37;0m制成，重十一斤五两七钱的[34m柔之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m [32m水[2;37;0m:[36m不错[2;37;0m [31m火[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 2);
