...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重零斤七两一钱的[31m纯钩之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m创世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
