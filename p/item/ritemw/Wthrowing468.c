...
void create()
{
	...
	if (clonep())
		...
		set("unit", "支");
		set("long","[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一支由无比坚硬的[1;37m软银[2;37;0m制成，重零斤七两一钱的[31m龙泉之暗器[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/AllPoisonsImmune", 18);
    set("weapon_prop/PoisonAttack", 0);
    set("weapon_prop/kf_hit_rate", 0);
    set("weapon_prop/kf_anti_hr", 0);
//伤害防御类
    set("weapon_prop/deep_injure", 22);
    set("weapon_prop/week_injure", 26);
    set("weapon_prop/abs_week_injure", 21);
    set("weapon_prop/defense_attack", 0);
    set("weapon_prop/armor_vs_force", 22);
    set("weapon_prop/armor_effect_armor_vs_force", 0);
    set("weapon_prop/attack_speed", 0);
     set("weapon_prop/attack_factor", 25);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 40);
    set("weapon_prop/qi_cure", 0);
    set("weapon_prop/jing_cure", 48);
