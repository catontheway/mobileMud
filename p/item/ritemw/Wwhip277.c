...
void create()
{
	set_name("[1;36m夏雨之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(1924);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","夏雨之鞭[2;37;0m这是一根由极为坚硬的[33m软铁[2;37;0m制成，重三斤八两四钱的[1;36m夏雨之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
