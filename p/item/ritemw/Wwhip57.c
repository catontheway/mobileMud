...
void create()
{
	set_name("[31m韧之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(13624);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","韧之鞭[2;37;0m这是一根由还算坚硬的[32m青铜[2;37;0m制成，重二十七斤二两四钱的[31m韧之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[35m标准[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
