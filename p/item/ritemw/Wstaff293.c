...
void create()
{
	set_name("[1;35m夏荷之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(4136);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","夏荷之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重八斤二两七钱的[1;35m夏荷之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
