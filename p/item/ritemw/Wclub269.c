...
void create()
{
	set_name("[1;33m伤痕之棍[2;37;0m", ({ "good club", "club" }));
	set_weight(11276);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","伤痕之棍[2;37;0m这是一根由极为坚硬的[33m软铁[2;37;0m制成，重二十二斤五两五钱的[1;33m伤痕之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
