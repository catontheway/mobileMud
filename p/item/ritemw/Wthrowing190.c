...
void create()
{
	set_name("[33m冰薇之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(130);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","冰薇之暗器[2;37;0m这是一支由相当坚硬的[33m生铁[2;37;0m制成，重零斤二两六钱的[33m冰薇之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[40m地[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
