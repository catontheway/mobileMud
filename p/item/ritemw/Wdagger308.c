...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[33m鸿钧之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二斤七两四钱的[33m鸿钧之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
