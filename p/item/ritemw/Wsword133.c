...
void create()
{
	set_name("[1;35m巨威之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(13290);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","巨威之剑[2;37;0m这是一把由非常坚硬的[33m生铁[2;37;0m制成，重二十六斤五两八钱的[1;35m巨威之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
