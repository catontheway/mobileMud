...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[31m工布天生怪异，功能参商！$br#[2;37;0m这是一柄由无比坚硬的[1;37m软银[2;37;0m制成，重十七斤零两六钱的[31m工布之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_fenjin", 17);
    set("weapon_prop/cant_busy_confuse", 20);
    set("weapon_prop/cant_busy_body", 21);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 54);
