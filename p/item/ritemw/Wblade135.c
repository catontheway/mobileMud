...
void create()
{
	set_name("[36m裂心之刀[2;37;0m", ({ "general blade", "blade" }));
	set_weight(4917);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","裂心之刀[2;37;0m这是一柄由相当坚硬的[33m生铁[2;37;0m制成，重九斤八两三钱的[36m裂心之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
