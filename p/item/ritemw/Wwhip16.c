...
void create()
{
	set_name("[34m铜之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(10294);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","铜之鞭[2;37;0m这是一根由非常坚硬的[32m青铜[2;37;0m制成，重二十斤五两八钱的[34m铜之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
