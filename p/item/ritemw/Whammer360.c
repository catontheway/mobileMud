...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[37m太渊之锤[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重二十一斤七两三钱的[37m太渊之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [32m水[2;37;0m:[1;33m天圣[2;37;0m [1;37m雷[2;37;0m:[33m很高[2;37;0m [40m地[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 19);
