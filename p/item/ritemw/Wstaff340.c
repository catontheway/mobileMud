...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[33m瑶池之杖[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重十二斤三两八钱的[33m瑶池之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m [31m火[2;37;0m:[1;35m绝世[2;37;0m [1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_dianxue", 9);
...
//伤害防御类
    ...
    set("weapon_prop/armor_effect_armor_vs_force", 5);
...
//气血恢复治疗类
    ...
    set("weapon_prop/qi_cure", 23);
    set("weapon_prop/jing_cure", 26);
