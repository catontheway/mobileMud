...
void create()
{
	set_name("[31m探星之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(8851);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","探星之匕首[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十七斤七两零钱的[31m探星之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
