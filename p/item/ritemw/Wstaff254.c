...
void create()
{
	set_name("[36m青云之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(11593);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","青云之杖[2;37;0m这是一根由非常坚硬的[33m软铁[2;37;0m制成，重二十三斤一两八钱的[36m青云之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m [1;36m人[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
