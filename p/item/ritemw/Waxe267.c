...
void create()
{
	set_name("[1;37m弦月之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(11617);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","弦月之斧[2;37;0m这是一柄由非常坚硬的[33m软铁[2;37;0m制成，重二十三斤二两三钱的[1;37m弦月之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[35m标准[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
