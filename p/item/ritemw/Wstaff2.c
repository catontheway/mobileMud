...
void create()
{
	set_name("[34m铜之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(3299);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","铜之杖[2;37;0m这是一根由极其坚硬的[32m青铜[2;37;0m制成，重六斤五两九钱的[34m铜之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
