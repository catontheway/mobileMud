...
void create()
{
	set_name("[36m柔之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(11957);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","柔之鞭[2;37;0m这是一根由还算坚硬的[32m青铜[2;37;0m制成，重二十三斤九两一钱的[36m柔之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[32m粗糙[2;37;0m [1;34m电[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
