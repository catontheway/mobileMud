...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重五斤四两九钱的[31m莫邪之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m开元[2;37;0m [1;34m电[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 54);
    ...
    //set("weapon_prop/blade", 51);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 60);
