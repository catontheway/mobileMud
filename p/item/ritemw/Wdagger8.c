...
void create()
{
	set_name("[1;31m巨之匕首[2;37;0m", ({ "bad dagger", "dagger" }));
	set_weight(10635);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","巨之匕首[2;37;0m这是一把由比较坚硬的[32m青铜[2;37;0m制成，重二十一斤二两七钱的[1;31m巨之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[34m细碎[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
