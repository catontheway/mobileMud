...
void create()
{
	set_name("[34m天羽之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(10715);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","天羽之刀[2;37;0m这是一柄由非常坚硬的[33m软铁[2;37;0m制成，重二十一斤四两三钱的[34m天羽之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
