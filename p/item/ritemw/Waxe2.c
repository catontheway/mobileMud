...
void create()
{
	set_name("[33m韧之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(11617);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","韧之斧[2;37;0m这是一柄由比较坚硬的[32m青铜[2;37;0m制成，重二十三斤二两三钱的[33m韧之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
