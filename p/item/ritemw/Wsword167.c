...
void create()
{
	set_name("[31m万丈之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(4496);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","万丈之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重八斤九两九钱的[31m万丈之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m [33m土[2;37;0m:[33m很高[2;37;0m [40m地[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
