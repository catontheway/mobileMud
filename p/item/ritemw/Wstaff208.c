...
void create()
{
	set_name("[37m鱼鳞之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(8072);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","鱼鳞之杖[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重十六斤一两四钱的[37m鱼鳞之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;34m举世[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
