...
void create()
{
	set_name("[1;36m叠之斧[2;37;0m", ({ "bad axe", "axe" }));
	set_weight(1034);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","叠之斧[2;37;0m这是一柄由非常坚硬的[32m青铜[2;37;0m制成，重二斤零两六钱的[1;36m叠之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
