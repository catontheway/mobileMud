...
void create()
{
	set_name("[1;34m晦光之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(6219);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","晦光之杖[2;37;0m这是一根由十分坚硬的[33m软铁[2;37;0m制成，重十二斤四两三钱的[1;34m晦光之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#[40m地[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
