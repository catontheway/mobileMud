...
void create()
{
	set_name("[1;35m流盼之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(6909);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","流盼之鞭[2;37;0m这是一根由极其坚硬的[33m软铁[2;37;0m制成，重十三斤八两一钱的[1;35m流盼之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
