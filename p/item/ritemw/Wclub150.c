...
void create()
{
	set_name("[1;36m蚁峻之棍[2;37;0m", ({ "general club", "club" }));
	set_weight(2370);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","蚁峻之棍[2;37;0m这是一根由极为坚硬的[33m生铁[2;37;0m制成，重四斤七两四钱的[1;36m蚁峻之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[34m细碎[2;37;0m [1;37m雷[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
