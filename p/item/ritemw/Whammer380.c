...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[33m鸿钧之锤[2;37;0m这是一柄由绝对坚硬的[1;32m绿石[2;37;0m制成，重三十一斤八两八钱的[33m鸿钧之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m [1;35m风[2;37;0m:[33m很高[2;37;0m $br#[40m地[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_body", 5);
