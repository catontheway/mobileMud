...
void create()
{
	set_name("[1;34m神虎之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(15420);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","神虎之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重三十斤八两四钱的[1;34m神虎之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m创世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
