...
void create()
{
	set_name("[35m落雪之暗器[2;37;0m", ({ "general throwing", "throwing" }));
	set_weight(713);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","落雪之暗器[2;37;0m这是一支由无比坚硬的[33m生铁[2;37;0m制成，重一斤四两二钱的[35m落雪之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [32m水[2;37;0m:[1;34m举世[2;37;0m [1;34m电[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    set("weapon_prop/max_qi", 7);
    set("weapon_prop/max_jing", 0);
    set("weapon_prop/neili_recover", 9);
    set("weapon_prop/qi_recover", 0);
    set("weapon_prop/jing_recover", 6);
