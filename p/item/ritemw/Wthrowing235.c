...
void create()
{
	set_name("[37m豹枭之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(413);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","豹枭之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重零斤八两二钱的[37m豹枭之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m毁天[2;37;0m [33m土[2;37;0m:[1;31m毁天[2;37;0m [1;34m电[2;37;0m:[1;31m创世[2;37;0m [1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
