...
void create()
{
	set_name("[1;31m厉鬼之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(423);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","厉鬼之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重零斤八两四钱的[1;31m厉鬼之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [36m木[2;37;0m:[33m很高[2;37;0m [1;35m风[2;37;0m:[1;32m魔王[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
