...
void create()
{
	set_name("[1;35m松峦之匕首[2;37;0m", ({ "general dagger", "dagger" }));
	set_weight(13534);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","松峦之匕首[2;37;0m这是一把由十分坚硬的[33m生铁[2;37;0m制成，重二十七斤零两六钱的[1;35m松峦之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
