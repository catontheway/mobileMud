...
void create()
{
	set_name("[1;32m仙品之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(15725);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","仙品之杖[2;37;0m这是一根由极其坚硬的[33m软铁[2;37;0m制成，重三十一斤四两五钱的[1;32m仙品之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [1;31m魔[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
