...
void create()
{
	set_name("[1;36m白雪之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(15199);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","白雪之剑[2;37;0m这是一把由极其坚硬的[33m生铁[2;37;0m制成，重三十斤三两九钱的[1;36m白雪之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
