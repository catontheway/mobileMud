...
void create()
{
	set_name("[1;36m玫瑰之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(8418);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","玫瑰之鞭[2;37;0m这是一根由十分坚硬的[33m生铁[2;37;0m制成，重十六斤八两三钱的[1;36m玫瑰之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;36m完美[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
