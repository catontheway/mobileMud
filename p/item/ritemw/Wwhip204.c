...
void create()
{
	set_name("[1;37m狂狼之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(6129);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","狂狼之鞭[2;37;0m这是一根由非常坚硬的[33m软铁[2;37;0m制成，重十二斤二两五钱的[1;37m狂狼之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[32m粗糙[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
