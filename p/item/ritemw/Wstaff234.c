...
void create()
{
	set_name("[37m连衡之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(15539);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","连衡之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重三十一斤零两七钱的[37m连衡之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[35m标准[2;37;0m [1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
