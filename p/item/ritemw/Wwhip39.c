...
void create()
{
	set_name("[37m阔之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(7958);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","阔之鞭[2;37;0m这是一根由十分坚硬的[32m青铜[2;37;0m制成，重十五斤九两一钱的[37m阔之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
