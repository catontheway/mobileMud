...
void create()
{
	...
	if (clonep())
		...
		set("unit", "柄");
		set("long","[37m太风之刀[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重二十九斤七两四钱的[37m太风之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m [32m水[2;37;0m:[1;35m绝世[2;37;0m [31m火[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_confuse", 18);
