...
void create()
{
	set_name("[34m巨之鞭[2;37;0m", ({ "bad whip", "whip" }));
	set_weight(13226);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","巨之鞭[2;37;0m这是一根由无比坚硬的[32m青铜[2;37;0m制成，重二十六斤四两五钱的[34m巨之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[33m很高[2;37;0m [32m水[2;37;0m:[36m不错[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/armor_effect_armor_vs_force", 1);
