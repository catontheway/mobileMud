...
void create()
{
	set_name("[1;35m鱼鳞之刀[2;37;0m", ({ "good blade", "blade" }));
	set_weight(8463);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","鱼鳞之刀[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重十六斤九两二钱的[1;35m鱼鳞之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m创世[2;37;0m [1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
