...
void create()
{
	set_name("[1;31m白陽之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(7643);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","白陽之鞭[2;37;0m这是一根由相当坚硬的[33m生铁[2;37;0m制成，重十五斤二两八钱的[1;31m白陽之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m无双[2;37;0m [40m地[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
