...
void create()
{
	set_name("[1;37m怒涛之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(12876);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","怒涛之杖[2;37;0m这是一根由绝对坚硬的[33m软铁[2;37;0m制成，重二十五斤七两五钱的[1;37m怒涛之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
