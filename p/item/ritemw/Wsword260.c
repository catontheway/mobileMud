...
void create()
{
	set_name("[1;35m卧虎之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(6630);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","卧虎之剑[2;37;0m这是一把由相当坚硬的[33m软铁[2;37;0m制成，重十三斤二两六钱的[1;35m卧虎之剑[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
