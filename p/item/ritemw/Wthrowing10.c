...
void create()
{
	set_name("[1;37m铁之暗器[2;37;0m", ({ "bad throwing", "throwing" }));
	set_weight(754);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","铁之暗器[2;37;0m这是一支由绝对坚硬的[32m青铜[2;37;0m制成，重一斤五两零钱的[1;37m铁之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[33m很高[2;37;0m [1;37m雷[2;37;0m:[36m不错[2;37;0m [37m天[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
