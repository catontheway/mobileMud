...
void create()
{
	set_name("[33m洗心之剑[2;37;0m", ({ "general sword", "sword" }));
	set_weight(7873);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","洗心之剑[2;37;0m这是一把由无比坚硬的[33m生铁[2;37;0m制成，重十五斤七两四钱的[33m洗心之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[35m标准[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
