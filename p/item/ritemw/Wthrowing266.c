...
void create()
{
	set_name("[1;35m白云之暗器[2;37;0m", ({ "good throwing", "throwing" }));
	set_weight(107);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","白云之暗器[2;37;0m这是一支由无比坚硬的[33m软铁[2;37;0m制成，重零斤二两一钱的[1;35m白云之暗器[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
