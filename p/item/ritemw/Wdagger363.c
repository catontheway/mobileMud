...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[35m天璇之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重三十一斤七两九钱的[35m天璇之匕首[2;37;0m。$br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/blade", 23);
    //set("weapon_prop/whip", 21);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 22);
