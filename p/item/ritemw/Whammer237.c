...
void create()
{
	set_name("[37m拘魂之锤[2;37;0m", ({ "good hammer", "hammer" }));
	set_weight(1880);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","拘魂之锤[2;37;0m这是一柄由极为坚硬的[33m软铁[2;37;0m制成，重三斤七两六钱的[37m拘魂之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;35m绝世[2;37;0m [37m天[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/PoisonAttack", 6);
