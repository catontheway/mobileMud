...
void create()
{
	set_name("[1;33m怪之棍[2;37;0m", ({ "bad club", "club" }));
	set_weight(12789);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","怪之棍[2;37;0m这是一根由相当坚硬的[32m青铜[2;37;0m制成，重二十五斤五两七钱的[1;33m怪之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[32m粗糙[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#[37m天[2;37;0m:[33m很高[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 0);
     ...
     set("weapon_prop/dodge_factor", 1);
//气血恢复治疗类
