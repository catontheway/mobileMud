...
void create()
{
	set_name("[34m五步之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(4576);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","五步之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重九斤一两五钱的[34m五步之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
		...
		set("weapon_prop/personality",14);
