...
void create()
{
	set_name("[1;36m渡心之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(10471);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","渡心之鞭[2;37;0m这是一根由极为坚硬的[33m生铁[2;37;0m制成，重二十斤九两四钱的[1;36m渡心之鞭[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[35m标准[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
