...
void create()
{
	set_name("[1;31m泼水之剑[2;37;0m", ({ "good sword", "sword" }));
	set_weight(4692);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","泼水之剑[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重九斤三两八钱的[1;31m泼水之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [32m水[2;37;0m:[31m精致[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
