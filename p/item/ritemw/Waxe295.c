...
void create()
{
	set_name("[37m狮吼之斧[2;37;0m", ({ "good axe", "axe" }));
	set_weight(11853);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","狮吼之斧[2;37;0m这是一柄由无比坚硬的[33m软铁[2;37;0m制成，重二十三斤七两零钱的[37m狮吼之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
