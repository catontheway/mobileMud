...
void create()
{
	...
	if (clonep())
		...
		set("unit", "根");
		set("long","[1;32m武翼之棍[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重五斤零两六钱的[1;32m武翼之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;31m创世[2;37;0m [1;36m人[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	  set("no_put",1);
	  set("no_pawn",1);
