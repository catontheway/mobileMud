// 邪派的门派任务列表（包括"xingxiu", "baituo", "shenlongjiao", "riyuejiao","dalunsi",）
...
mapping quests_list = ([
    ...
    5012 : ({ "kill","道童",               "daotong", "","","120" }),
    5012 : ({ "kill","道士",               "shaohuo daoshi", "","","120" }), 
    3012 : ({ "kill","沙弥",               "sha mi", "","","120" }),
...
//   20172 : ({ "kill","岳灵珊",                 "yue lingshan","","","240"}),
   ...
   60172 : ({ "kill","尹志平",                 "yin zhiping","","","240"}), 
 ...
 2000020 : ({ "kill","廖自砺",               "liao zili",  "",  "", "800" }),   
 2000020 : ({ "kill","成自学",               "cheng zixue",  "",  "", "800" }), 
 2000020 : ({ "kill","齐自勉",               "qi zimian",  "",  "", "800" }),   
 2000020 : ({ "kill","梁自进",               "liang zijin",  "",  "", "800" }), 
 1400020 : ({ "win","岳不群",               "yue buqun",  "",  "", "800" }),           
