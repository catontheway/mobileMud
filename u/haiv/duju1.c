...
int  do_bet  (string  arg)
{
    ...
    me->set("duqiu/what1",1);  //确定本场预测局序号，以后预测局依次排序，防止bug
...
int  do_betlist  (string  arg)
{
    ...
    if( !me->query("duqiu/amount1") )
       ...
       write("你在本预测场买了"+me->query("duqiu/amount1")+" "+me->query("duqiu/money1")+"，代码是"+me->query("duqiu/code1")+"。\n"); 
