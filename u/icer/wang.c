...
//		"段公子"     : (: ask_bf :),
	...
	map_skill("force","yunu");
	map_skill("parry","meinu");
...
//	case "fang":
   ...
   command ("die "+ ob->query("id"));
    ...
    break;
    case 32:
    command ("chat 段公子快来啊，帮我打"+ ob->query("name") + "这个大色魔！\n") ;
    break;
    case 33:
    ...
    break;
    case 34:
    command ("chat 段公子快来啊，"+ ob->query("name") + "想要羞辱我！\n") ;
    command("chat 哎哟，谁想得到这" + RANK_D->query_rude(ob)+"，竟也是一个变态狂！\n");
...
varargs void drool(string msg, string who)
{
	...
	if((strsrch(msg, "别过") >= 0)||(strsrch(msg, "bye") >= 0)|| (strsrch(msg, "散") >= 0)|| (strsrch(msg, "离") >= 0))
	{
		...
		case 3:	command("chat* 王语嫣点了点头.\n");	break;
		case 4:command("chat* 王语嫣嚎啕大哭起来.\n"); break;
		case 5:command("chat* 王语嫣揉了揉哭红的眼睛道： "+who+",你真要走了就别再回来.\n"); break;
		case 6:	command("chat* 王语嫣深深地叹了一口气 。\n");	break;
	...
	if( (strsrch(msg, "kiss") >= 0)|| (strsrch(msg, "love") >= 0)|| (strsrch(msg, "吻") >= 0)
		...
		case 3:command("chat* 王语嫣被"+who+"气得晕了过去。\n"); break;
		case 4:command("chat* 王语嫣嚎啕大哭起来.\n"); break;
		case 5:command("chat 不要这样子嘛！\n"); break;
		case 6:command("chat 非礼啊非礼！"+who+"这小流氓又来啦！\n"); break;
		case 7:command ("chat 段公子快来啊，"+ who + "想要羞辱我！\n") ;
		case 8:	command("chat* 王语嫣嘻嘻地笑了几声.\n"); break;
		case 9:	command("chat* 王语嫣很生气地撅了撅嘴。\n");	break;
		case 10:command("chat* 王语嫣无奈的耸了耸肩.\n");	break;
		case 11:command("chat 你对女孩子总是这样吗？\n"); break;
		case 12:command("chat 大哥你怎么这样？\n"); break;
		case 13:command("chat* 王语嫣嫣然一笑，说：够了够了!\n"); break;
		case 14:command("chat* 王语嫣满脸胀得通红，急道：你。。。 。\n");	break;
		case 15:command("chat 嗯，"+who+"是天底下最好的人了！\n"); break;
	                case 16:command ("chat 段公子快来啊，"+ who + "欺负我！\n") ; break;
		}
		return;
	}
	if( (strsrch(msg, "猪") >= 0)||(strsrch(msg, "shit") >= 0)||(strsrch(msg, "pig") >= 0))
	{
		...
		case 3:	command("chat* 王语嫣很生气地撅了撅嘴。\n");	break;
		...
		case 9:	command("chat* 王语嫣鄙夷地看着"+who+",恨不得"+who+"去死。\n"); break;
		case 10:command("chat* 王语嫣被"+who+"气得晕了过去。\n"); break;
		case 11:command("chat* 王语嫣忽然大声说：打倒臭泥潭，打倒风！\n"); break;
		case 12:command("chat* 王语嫣揉了揉哭红的眼睛，跺脚道： "+who+",我恨死你了！\n"); break;
		case 13:command ("chat 段公子快来啊，"+ who + "又想要羞辱我！\n") ; break;
		}
	}
	if(  (strsrch(msg, "fool") >= 0)||(strsrch(msg, "笨") >= 0)|| (strsrch(msg, "fuck") >= 0))
	{
		...
		case 3:	command("chat* 王语嫣用手捂住鼻子，说“"+who+"说话好臭!\n");	break;
		case 4:	command("chat 你真的认为“" + msg + "”？\n"); break;
		case 5:	command("chat 我觉得你有点儿缠杂不清。\n"); break;
		case 6: command("chat 呸!\n"); break;
		case 7:	command("chat* 王语嫣怒道:你怎么知道“" + msg + "”？\n"); break;
		case 8:	command("chat "+ who+"滚出来!我要和你决斗！有胆子你就放马过来！\n"); break;
		case 9:	command("chat* 王语嫣鄙夷地看着"+who+",恨不得"+who+"去死。\n"); break;
		case 10:command("chat* 王语嫣嚎啕大哭起来.\n"); break;
		case 11:command("chat* 王语嫣揉了揉哭红的眼睛，跺脚道： "+who+"王八蛋给我滚出去！\n"); break;
	...
	if(  (strsrch(msg, "cool") >= 0)||(strsrch(msg, "thumb") >= 0)||(strsrch(msg, "praise") >= 0)|| (strsrch(msg, "admire") >= 0))
	{
		...
		case 3:	command("chat* 王语嫣嫣然一笑，说：够了!\n"); break;
		case 4:	command("chat 你真的认为“" + msg + "”？\n"); break;
		case 5: command("chat* 王语嫣忽然莞尔一笑道: 你这是不是有点儿。。。？\n");break;
		case 6:    command("chat* 王语嫣回头看了"+who+"一眼，没吭声。\n");break;
		case 7: command("chat 嗯,"+who+"是一个好孩子.\n"); break;
		case 8:command("chat "+who+",你不会是想讨好我吧?\n"); break;
		case 9:command("chat* 王语嫣拱了拱手道：过奖，过奖 !\n");break;
		case 10:command("chat* 王语嫣指着"+who+"赞叹道：“"+who+"是武林第一高手！”\n");break;
		case 11:command("chat* 一朵红云飞上了王语嫣的面颊.\n");break;
		}
		return;
        }
	}
	switch(random(80)) {
		...
		case 12:	command("chat* 王语嫣深深地叹了一口气 。\n");	break;
		case 13:	command("chat* 王语嫣被"+who+"气得晕了过去 。\n");	break;
		case 14:	command("chat* 王语嫣满脸胀得通红，急道：你。。。 。\n");	break;
		case 15:    command("chat* 王语嫣咬了咬牙，怒道: 嗯，谁要再敢欺负我，我就宰了他！\n");break;
		case 16:    command("chat* 王语嫣忽然莞尔一笑道: 你这又是何苦呢？\n");break;
		case 17:    command("chat* 王语嫣打了个呵欠，左手轻轻掩住樱桃小口，柔声道：我困了。\n"); break;
		case 18:    command("chat* 王语嫣回头看了"+who+"一眼，没吭声。\n");break;
		case 19:    command("chat* 王语嫣一甩头，说：哼，我都懒得理你。\n");break;
		...
		case 24:	command("chat* 王语嫣嫣然一笑，说：够了!\n"); break;
		case 25:	command("chat 居然有人骂我是猪!\n");
		 	command("chat* 王语嫣嚎啕大哭起来.\n"); break;
        case 26:	command ("chat 段公子快来啊，"+ who + "又来欺侮我！\n") ; break;
      	case 27:	command ("chat 我简直受不了了!\n") ; break;
        case 28:	command ("chat 我恨不得"+who+"去死!\n") ; break;
        case 29:	command ("chat 就你老和我过不去!\n") ; break;
        case 30:	command ("chat 请不要打扰我好不好?\n") ; break;
   		case 31:	command ("chat* 王语嫣终于忍不住哭了起来。\n") ; break;
		case 32:	command("chat* 王语嫣鄙夷地看着"+who+",恨不得"+who+"去死。\n"); break;
		case 33:    command("chat* 王语嫣咬了咬牙，怒道: 嗯，谁要敢欺负我，我就宰了他！\n");break;
		case 34:    command("chat* 王语嫣忽然莞尔一笑道: 你这是不是有点儿。。。？\n");break;
		case 35:    command("chat* 王语嫣打了个呵欠，左手轻轻掩住樱桃小口，柔声道：我有点儿困了。\n"); break;
		case 36:    command("chat* 王语嫣回头看了"+who+"一眼，没吭声。\n");break;
		case 37:    command("chat* 王语嫣一甩头，说：哼，我都懒得理你。\n");break;
		...
		case 54:command("chat* 王语嫣对"+who+"表示衷心的感谢.\n");break;
		case 55:command("chat 不要这样子嘛！\n"); break;
		case 56:command("chat* 王语嫣拱了拱手道：过奖，过奖 !\n");break;
		case 57:command("chat* 王语嫣怒道:你怎么知道“" + msg + "”？\n"); break;
		case 58:command("chat* 王语嫣指着"+who+"赞叹道：“"+who+"是武林第一高手！”\n");break;
		case 59:command("chat* 王语嫣笑嘻嘻的看着"+who+"\n");break;
		case 60:command("chat 为什么呢?\n");break;
		case 61:command("chat 你是在说我吗？\n"); break;
		case 62:command("chat 无聊!\n");break;
		case 63:command("chat* 一朵红云飞上了王语嫣的面颊.\n");break;
		case 64:command("chat* 王语嫣是个自恋狂。\n");break;
		default:
	    if (random(10)<3) command("chat* 王语嫣很生气地撅了撅嘴.\n");
	    else if(random(10)<3) command("chat* 王语嫣嘻嘻地笑了几声.\n");
	    break;
		}
	return;
	}
	if( (strsrch(msg, "哭") >= 0))
	{
	   if(random(5)<3)
		...
		case 2:	command("chat* 王语嫣嘻嘻的笑了几声.\n"); break;
		case 3:command("chat* 王语嫣露出迷惑的表情.\n"); break;
		case 4:command("chat* 王语嫣嚎啕大哭起来.\n"); break;
		case 5:command("chat* 王语嫣安慰"+who+",别难过了.\n"); break;
		case 6:	command("chat* 王语嫣深深地叹了一口气 。\n");	break;
		case 7:	command("chat* 王语嫣无奈的耸了耸肩.\n");	break;
		case 8: command("chat* 王语嫣轻轻拍了拍"+who+"的头.\n"); break;
		}
		return;
        }
	}
	if( (strsrch(msg, "别过") >= 0)||(strsrch(msg, "bye") >= 0)|| (strsrch(msg, "散") >= 0)|| (strsrch(msg, "离") >= 0))
	{
		...
		case 3:	command("chat* 王语嫣点了点头.\n");	break;
		case 4:command("chat* 王语嫣嚎啕大哭起来.\n"); break;
		case 5:command("chat* 王语嫣揉了揉哭红的眼睛，跺脚道： "+who+",你真要走了就别再回来！\n"); break;
		case 6:	command("chat* 王语嫣深深地叹了一口气 。\n");	break;
		case 7:	command("chat "+who+",再玩一会儿好不好?\n");	break;
		case 8:	command("chat "+msg+"\n");	break;
		case 9:	command("chat* 王语嫣无奈的耸了耸肩.\n");	break;
		}
		return;
	}
	if( (strsrch(msg, "猪") >= 0)||(strsrch(msg, "shit") >= 0)||(strsrch(msg, "pig") >= 0))
	{
		...
		case 11:	command("chat* 王语嫣嘻嘻的笑了几声.\n"); break;
		case 12:	command("chat* 王语嫣把把头摇得跟拨浪鼓似的.\n");	break;
		case 13:	command("chat* 王语嫣哈哈大笑起来.\n"); break;
		}
		return ;
        }
	}
		...
		case 12: command("chat* 王语嫣轻轻拍了拍"+who+"的头.\n"); break;
	...
	if( (strsrch(msg, "笑") >= 0))
	{
		...
		case 3:	command("chat "+who+"笑起来真丑。\n");
			if(random(10)<2) command("chat* 王语嫣嘻嘻地笑了几声.\n");break;
		case 4:	command("chat* 王语嫣咯咯地笑了起来.\n");break;
		case 5:	command("chat* 王语嫣高兴地拍了拍手.\n");break;
		case 6: command("chat* 王语嫣轻轻拍了拍"+who+"的头.\n"); break;
		case 7:	command("chat* 王语嫣哈哈大笑起来.\n"); break;
		case 8: command("chat* 王语嫣说道:同喜,同喜!!!\n" );break;
		...
		case 11:drool(); break;
		case 12:drool(); break;
		case 13:command("chat* 王语嫣嘻嘻地笑了几声.\n"); break;
		case 14:command("chat* 王语嫣摇了摇头，叹道：唉，真是世风日下，人心不古啊！\n"); break;
		case 15:command("chat 我对此表示怀疑.\n"); break;
		case 16:command("chat* 王语嫣深深地叹了一口气 。\n");	break;
		case 17:command("chat* 王语嫣露出迷惑的表情.\n"); break;
		...
		switch(random(250)) {
			...
			case 2: command("chat* 王语嫣「哼」地冷笑一声。\n"); break;
			case 3: command("chat* 王语嫣懒懒地伸了伸腰。\n"); break;
			case 4: command("chat* 王语嫣气得晕了过去.\n"); break;
			case 5: command("chat  哼！\n"); break;
			case 6: command("chat* 王语嫣露出迷惑的表情.\n"); break;
			case 7: command("chat* 王语嫣忽然作了个鬼脸,说：真想出去玩会儿.\n"); break;
			...
			case 11: command("chat* 王语嫣很生气地噘了噘嘴。\n"); break;
			...
			case 18: command("chat* 王语嫣摇头叹道：这世道，还是各人自扫门前雪，休管他人瓦上霜.\n");break;
			case 19: command("chat* 王语嫣作了一个揖，说道：“各位姐妹们，大家好！”\n");break;
			case 20: command("chat 我知道了，" + msg+"\n"); break;
			case 21:command("chat* 王语嫣露出迷惑的表情.\n"); break;
			...
			case 25: command("chat* 王语嫣无聊地绕着手绢，说：一个人，真没意思。\n"); break;
			case 26: command("chat* 王语嫣露出迷惑的表情.\n"); break;
			case 27: command("chat* 王语嫣用怀疑的眼光看了看"+who+"\n"); break;
			case 28: command("chat  我看未必.\n"); break;
			case 29: command("chat* 王语嫣奇道：是吗？\n"); break;
			case 30: command("chat  老师来啦，"+who+"你还不赶快去？\n"); break;
			case 31: command("chat "+who+",你今天怎么又逃课?\n"); break;
			case 32: command("chat* 王语嫣对所有在场的人表示感谢。\n"); break;
			case 33: command("chat* 王语嫣嘻嘻地笑了几声.\n");break;
			case 34: command("chat "+who+"说得好!\n"); break;
			case 35: command("chat* 王语嫣好奇地看着"+who+"\n"); break;
			case 36: command("chat "+who+",没想到你也会这样.\n"); break;
			case 37: command("chat* 王语嫣白了"+who+"一眼,说:你无聊不无聊啊?"); break;
			case 38:  command("chat* 王语嫣回头看了"+who+"一眼，没吭声。\n");break;
			case 39:command("chat* 王语嫣摇了摇头，叹道：唉，真是世风日下，人心不古啊！\n"); break;
			case 40:command("chat 嗯 ... " + who + "说得好！\n"); break;
			case 41:command("chat* 王语嫣无奈的耸了耸肩.\n");	break;
			case 42:command("chat 嗯，"+who+"是天底下最好的人了！\n"); break;
			case 43:command("chat* 王语嫣把把头摇得跟拨浪鼓似的.\n");	break;
			case 44:command("chat 我对此表示怀疑.\n"); break;
			case 45: command("chat 我觉得最佳表情奖应该授予"+who+".\n"); break;
			case 46: command("chat* 王语嫣轻轻拍了拍"+who+"的头.\n"); break;
			case 47: command("chat* 王语嫣笑嘻嘻的看着"+who+"\n"); break;
			case 48: command("rumor "+this_object()->query("killed")+"被"+this_object()->query("killer")+"就地正法了.\n"); break;
			case 49: command("rumor "+this_object()->query("killed")+"被"+this_object()->query("killer")+"就地正法了.\n"); break;
			case 50: command("rumor "+this_object()->query("killed")+"被"+this_object()->query("killer")+"就地正法了.\n"); break;
			...
			case 55: command("chat* 王语嫣打了"+who+"一个耳光.\n"); break;
			case 56:command("chat* 王语嫣给大家盈盈的福了一福.\n"); break;
			case 57:command("chat 不要这样嘛!\n"); break;
			case 58:command("chat 要死啊你!"+who+"!\n"); break;
			case 59:command("chat* 王语嫣忽然大声说：打倒臭泥潭，打倒风！\n"); break;
			case 60:command("chat* 王语嫣露出迷惑的表情.\n"); break;
			case 61:command("chat* 王语嫣振臂高呼：“我们热爱侠客行，侠客行万岁！”\n");break;
			case 62:command("chat* 王语嫣对大家摇摇头，叹道：“你们都太不要脸了。”\n");break;
			case 63:command("chat* 王语嫣点了点头.\n");	break;
			case 64:command("chat* 王语嫣哈哈大笑起来.\n"); break;
			case 65: command("chat 与其求人,不如求己!\n"); break;
			case 66:command("chat* 王语嫣失望极了!\n");break;
			case 67:command("chat 无聊!\n");break;
			case 68:command("chat 是吗?\n"); break;
		        case 69:command("chat 变态！\n"); break;
			case 70:command("chat* 王语嫣是个自恋狂。\n");break;
			case 71:command("chat 为什么？\n");break;
			case 72:command("chat 你烦不烦啊？\n");break;
			default:
	    if (random(10)<1) command("chat* 王语嫣皱了皱眉，似乎想说什么。\n");
		else if (random(10)<1) command("chat* 王语嫣嘻嘻地笑了几声.\n");
	    else if (random(10)<1) command("chat* 王语嫣懒懒的伸了伸腰.\n");
				break;
		}
	}
}
