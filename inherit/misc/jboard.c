...
int do_kan(string arg)
{
	...
	if( !pointerp(notes) || !sizeof(notes) )
      ...
      if( !arg ) return notify_fail("指令格式：kan <计划编号>[.<报告编号>]|new|next\n");
	if( arg=="new" || arg=="next" ) {
