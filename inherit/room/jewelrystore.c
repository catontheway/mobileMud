...
int do_deposit(string arg)
{
	...
	if ( !arg || sscanf(arg, "%d", bgolds)!=1)
	  return notify_fail(INPUTTXT("1 金条=100gold。你想买多少？","buy $txt#")+"\n");
...
int do_withdraw(string arg)
{
	...
	if (!arg || sscanf(arg, "%d", sgolds)!=1)
	  return notify_fail(INPUTTXT("1 金条=100gold。你想卖多少？","sell $txt#")+"\n");
...
string show_notice()
{
	...
	return "本店提供以下几种投资交易：\n"ZJOBACTS2+ZJMENUF(1,1,8,45)+"购买金条:buy"ZJSEP+"出售金条:sell"ZJSEP+"查询寄存金条:check"ZJSEP+"兑换宝石:exchange"ZJSEP+"地宝石:dang 地宝石"ZJSEP+"山宝石:dang 山宝石"ZJSEP+"水宝石:dang 水宝石"ZJSEP+"雷宝石:dang 雷宝石"ZJSEP+"火宝石:dang 火宝石"ZJSEP+"泽宝石:dang 泽宝石"ZJSEP+"天宝石:dang 天宝石\n";
