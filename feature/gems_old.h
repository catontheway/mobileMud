...
nosave mapping armor_effect = ([
	...
	"sapphire":	"提升魔法石发挥效用的几率和掉宝率",//apply(magic)
	"emerald":	"给防具淬毒",// armor_effect/poison
	"amethyst":	"提升盔甲使用者的防御",//apply(armor)
	"diamond":	"将气血伤害变成内力减少",//apply(armor_vs_force,armor_vs_weapon)
	"skull":	"将敌人的伤害转化成自己的内力",// //apply/healup : heal_up()
]);
nosave mapping ring_effect = ([
	...
	"skull":	"大幅度提升魔法石发挥效用的几率和掉宝率",// apply(magic)
]);
