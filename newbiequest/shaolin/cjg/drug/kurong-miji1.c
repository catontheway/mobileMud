...
void create()
{
	set_name(GRN"枯荣神功秘籍"NOR, ({"kurong miji", "book" }));
	if (clonep())
...
int do_read(string arg)
{
  ...
  if ( me->query("family/family_name") !="天龙寺" && me->query("chushi/last_family") !="天龙寺" )
	...
	{
	  tell_object(me, "你的潜力不足，无法领悟如此高深的心法秘籍。\n");
	  return 1;
	}
  ...
  if ( me->query_skill("kurong-shengong",1)>= 100 )
	...
	me->improve_skill("kurong-shengong", 100000);
	tell_object(me, "你仔细阅读了这本秘籍，对枯荣神功有了一些认识。\n");
