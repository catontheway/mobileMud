...
void create()
{
        set_name(WHT"鹿鞭大力丸"NOR, ({"lubian daliwan", "wan"}));
        set_weight(300+random(60));
        set("long", "这是一粒鹿鞭大力丸，能够让你大力大力更大力。\n");
        set("unit", "粒");
		set("value",1000);
		set_amount(1);
		setup();
...
int do_eat(string arg)
{
	...
	if (time()-me->query_temp("last_eat_daliwan")<900)
	{
