...
void create()
{
        set_name(WHT"狗鞭大力丸"NOR, ({"goubian daliwan", "wan"}));
        set_weight(300+random(60));
        set("long", "这是一粒狗鞭大力丸，能够让你大力大力更大力。\n");
        set("unit", "粒");
		set("value",1000);
		set_amount(1);
		setup();
...
int do_eat(string arg)
{
	...
	if (time()-me->query_temp("last_eat_daliwan")<600)
	{
