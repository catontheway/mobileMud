//Created by Whuan@pkuxkx,产生随机飞贼
#include <ansi.h>
void random_feizei()
{
	int exp;
	...
	string *places, place, skill, value;
        ...
        "/d/quanzhou2/zhongxin":"泉州城",
        "/d/quanzhou2/nanmen":"泉州城",
        "/d/quanzhou2/beimen":"泉州城",
  ...
  "/d/zhongyuan/ruzhou":"中原",
  "/d/zhongyuan/huaibei" :"中原",
  "/d/zhongyuan/guandao4" : "中原",
  "/d/jinyang/chaoximen":"晋阳城",
 "/d/jinyang/jinsumen":"晋阳城",
"/d/jinyang/taiyuanfu":"晋阳城",
"/d/jinyang/kaiyuanmen":"晋阳城",
"/d/hangzhou/nanmen":"杭州城",
"/d/hangzhou/dongmen":"杭州城",
"/d/hangzhou/beimen":"杭州城",
"/d/qufu/southgate":"曲阜",
"/d/qufu/westgate":"曲阜",
"/d/qufu/northgate":"曲阜",
"/d/changan/southgate":"长安城",
"/d/changan/westgate":"长安城",
"/d/changan/eastgate":"长安城",
        ]);
	...
	feizei->random_move();
        ...
        CHANNEL_D->do_channel(this_object(), "jh", CYN + rooms[place] + CYN"中有" + skill + CYN"横行，据说此贼带有价值" + value + CYN"的财宝！", -1);
}
