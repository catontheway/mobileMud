...
void init()
{
	object me=this_player();
        ...
        if(!userp(me) || wizardp(me)) return;
	if(!(present("hua",me))
		&& !(me->query_temp("murong/zhonghua"))
		&& (me->query("gender")!="女性"
                 || me->query("family/family_name")=="姑苏慕容") && objectp(present("wang furen", this_object())))
	{
                tell_object(me,"王夫人喝道：“你是什么东西？出去！\n");
