...
LONG
	...
	set("outdoors", "murong");
         ...
         set("item_desc", ([
              "bank" :
"岸不远，你可以试着跳(jump)上去。\n"
ZJOBACTS2+ZJMENUF(2,2,12,40)+"跳(jump)上去:jump bank\n",
              "jiang" :
"一把小桨，是划船用的(row)。你可以去划船去以下地方：\n
听香水榭(tingxiang)，燕子坞(yanziwu),曼陀山庄(mantuo)\n"
ZJOBACTS2+ZJMENUF(2,2,12,40)+"听香水榭:row tingxiang"+ZJSEP+"燕子坞:row yanziwu"+ZJSEP+"曼陀山庄:row mantuo\n",
                           ]));
    set("no_dbr_stage",1);
	setup();
}
