...
void create()
{
        ...
        set("long", @LONG
这里是黄河南岸，滚滚黄河一刻不停地奔腾东去。黄河在这里变得较为狭窄。
LONG
        );
        set("exits", ([
             "northeast" : __DIR__"dkn4",
             "southwest" : __DIR__"dkn4f",
        ...
        //]) );
	set("item_desc", ([
"黄河南岸" : "这里是黄河南岸，滚滚黄河一刻不停地奔腾东去。黄河在这里变得较为狭窄。\n"
		 ZJOBACTS2+ZJMENUF(2,2,12,40)+"涉水:sheshui\n",
    ]));
        set("no_clean_up", 0);
...
int pass(object me)
{
    ...
    if (me->query_temp("白驼过黄河")>=4)
    {
        ...
        me->move("/d/huanghenorth/hhb19");
        camel->move("/d/huanghenorth/hhb19");
        return 1;
    }
    else
    {
