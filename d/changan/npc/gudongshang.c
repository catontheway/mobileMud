...
void create()
{
	set_name("古董商", ({ "gudong shang","shang",}));
        
	set("long",
	"他是一个精于世故的古董商，想从他那里赚到便宜十分不易。\n"
         );
	set("gender", "男性");
    ...
    set("inquiry", ([
        ...
        setup();
        carry_object(__DIR__"obj/jin-cloth")->wear();
...
int adv()
{
    if (random(100)>95&&time()-query("adv_time")>600&&query("profit"))
    {
		set("adv_time",time());
		delete("profit");
        CHANNEL_D->do_channel(this_object(), "bd", "rich", 1);
    }
