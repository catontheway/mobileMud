...
int ask_quest()
{
    ...
    msg+="[1]"+ZJURL("cmds:select 1")+HIG"襄阳从军任务"NOR"       可获得【"+HIW+"侠之大者"+NOR+"】头衔，有几率获得先天臂力奖励。\n";
    msg+="[2]"+ZJURL("cmds:select 1")+HIC"周处除三害任务"NOR"     可获得【"+HIC+"降龙伏虎"+NOR+"】头衔，有几率获得先天悟性奖励。\n";
    msg+="[3]"+ZJURL("cmds:select 1")+HIY"游方天下任务"NOR"       可获得【"+HIG+"神行千里"+NOR+"】头衔，有几率获得先天身法及福源奖励。\n";
