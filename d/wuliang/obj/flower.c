...
void create()
{
  ...
  {
    case 0:
      { set_name(BBLU "蓝玫瑰" NOR, ({ "flower"})); break; }
    case 1:
      { set_name(BBLK "黑郁金香" NOR, ({ "flower"})); break; }
    case 2:
      { set_name(HIW "薄雪花" NOR, ({ "flower"})); break; }
    case 3:
      { set_name(HIM "野风信子" NOR, ({ "flower"})); break; }
    case 4:
      { set_name(HIW "玉白露" NOR, ({ "flower"})); break; }
    case 5:
      { set_name(RED "睡芙蓉" NOR, ({ "flower"})); break; }
    case 6:
      { set_name(MAG "紫蔷薇" NOR, ({ "flower"})); break; }
    case 7:
      { set_name(HIY "大丽花" NOR, ({ "flower"})); break; }
    case 8:
      { set_name(HBBLU "勿忘我" NOR, ({ "flower"})); break; }
    case 9:
      { set_name(HIW "白玫瑰" NOR, ({ "flower"})); break; }
    case 10:
      { set_name(HIG "翡翠绿" NOR, ({ "flower"})); break; }
    case 11:
      { set_name(HIW "雪腊梅" NOR, ({ "flower"})); break; }
  }
  set_weight(100);
  set("dry",0);
...
void need_water (object where)
{
  ...
  switch (flower->query("water"))
  {
    ...
    case 5:
      {
        msg = name+"终于干枯了。\n";
        if(flower->query("dry") == 0)
        {
          name=replace_string(name, "干", "");
