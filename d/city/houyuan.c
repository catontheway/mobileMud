...
void create()
{
	set("short", "财主后院");
	set("long", @LONG
这里是财主后院，各种古玩琳琅满目，商周青铜、汉瓦当、唐三彩……应有
尽有，只要拥有一件，就够你吃一辈子了。崔员外正坐在琉璃榻上，慢悠悠地喝
着参汤。东侧有一扇门(men)。
LONG);
	set("item_desc", ([
		"men" : "这扇门似乎通向一间密室。\n"
		ZJOBACTS2+ZJMENUF(2,2,12,40)+"门:unlock men\n",
	]));
...
{
	object ob = present("cui yuanwai", environment(me));  
	if ( objectp(ob) && living(ob) && dir == "west")
