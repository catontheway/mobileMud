...
/////////////
        ...
        for (i=0;i<Play;i++){
            ...
            Mj+=sprintf(" ^[1;36;46m   ^[0;36m   ^[1;37m%12s   ^[33m%8d   ^[35m%8d   ^[32m%8d   ^[34m%8d ^[1;36;46m   ^[0m\n",NowPlayerId[i],winner[0],winner[1],winner[2],winner[3]);
        }
        Mj+="[1;36;46m  ";
        for (i=0; i<26; i++) Mj+="  ";
        Mj+="[46m＼[0m\n";
...
write(@HELP
    ...
    │   topscore   topscore aip,top -p,top -w,top -h,top -d    │
    │    topscore -l看全部,-lw,-lh,-ld。               查资料  │
    └─────────────────────────────┘
HELP);
        return 1;
}
