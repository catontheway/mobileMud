...
*/
string* dart_area=({"/d/pker/dangpu","/d/xiangyang/dangpu","/d/city/qianzhuang",
"/d/guiyunzhuang/taihujie2","/d/quanzhou/qianzhuang","/d/suzhou/jubaozhai",
"/d/beijing/quanjude2","/d/beijing/baoyuan","/d/beijing/biaoju",
"/d/quanzhou/dangpu",   "/d/lingzhou/jiuguan", "/d/huashan/yuquan","/d/dalicheng/dalicheng11","/d/luoyang/qianzhuang" });
string* dart_short=({
"杀手帮当铺","襄阳当铺","扬州钱庄","太湖街","嘉兴钱庄",
"聚宝斋","全聚德雅座","宝源钱庄","武胜镖局大院","泉州当铺","酒馆",
"华山玉泉院","大理太和居二楼","洛阳四海钱庄"});
string* dart_id=({
"dugu meng","shi chunqiu","qian yankai","shang ren","bao fangyuan",
"sun baopi","wu liuqi","huo ji","wang wutong","wang fugui","xixia mingshang",
"fortune teller","song laoban","hu xueyuan"});
string* dart_name=({
"独孤梦","史春秋","钱眼开","商人","包方圆",
"孙剥皮","吴六奇","钱庄伙计","王武通","王福贵",
"西夏名商","李铁嘴","宋老板","胡雪源"
});
int* dart_value=({8,11,1,8,9,10,12,13,11,10,11,8,12,14});
...
//	if(time()-ob->query("last_yunbiao_time")<60)
	...
	if (arg == "1")
		...
		tell_object(ob,"林镇南对你说道：我这里有一批重镖，如果下次你想护可以跟我说。\n");
	}
	ob->set("in_dart",1);
...
//      rreward=(5+random(3))*ob->query_temp("yunbiao/bonus");
    ...
    ob->add("balance",random(10)*1000+2000);
    message("vision",HIW"你被奖励了：\n"+chinese_number(creward)+"点经验；\n"+
