...
{       
        seteuid(getuid());
        set_name(HIW"镖银"NOR, ({ "biao che", "cart", "che"}) );
     //   set_weight(300000);
       // set("no_get", 1);
        ...
        if(me->follow_path(dir)) 
{
        ...
        if ((random(30)<10&&time()-me->query("last_yunbiao_time")<=360)||(random(30)<7&&time()-me->query("last_yunbiao_time")>360)||(me->query_temp("shilian")&&random(30)>14&&time()-me->query("last_yunbiao_time")>60)||(me->query_temp("shilian")&&random(30)>10&&time()-me->query("last_yunbiao_time")>90)) //神尼任务下增加出匪概率 增加难度 Zine
            { 
...
void to_moveaway(object me)
{
	...
	if(!random(18)||(me->query("hbisrobot")&&!random(10)))
	{
...
void to_rob(object me)
{
  ...
  {
  	case 0:
  robber=new("/d/fuzhou/npc/robber0");
  break;
  	case 1:
  robber=new("/d/fuzhou/npc/robber1");
  break;
  	case 2:
  robber=new("/d/fuzhou/npc/robber2");
  break;
  	case 3:
  robber=new("/d/fuzhou/npc/robber3");
  break;
  	case 4:
  robber=new("/d/fuzhou/npc/robber4");
  break;
  	case 5:
  robber=new("/d/fuzhou/npc/robber5");
  break;  
  }
