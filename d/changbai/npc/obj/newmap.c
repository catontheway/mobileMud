...
void create()
{
  ...
  if (clonep())
    ...
    set("unit", "张");
    set("value", 0);
    set("long","这是一张胡一刀注释过闯王宝藏的藏宝图，不过很可惜，上面"+ZJURL("cmds:chakan bao tu")+HIG"标识"NOR"的地点你不认识。"+ZJURL("cmds:xunbao bao tu")+HIG"寻宝\n");
    set("no_store", 1);
    set("no_sell", 1);
    set("no_pawn",1);
    set("no_put",1);
...
//过滤非法任务地点和不明区域 by segate@pkuxkx
        ...
        write(HIW"你打开了闯王藏宝图，仔细查看……原来宝藏在"+fullplace+"\n"NOR);        
