...
void create()
{
 	set_name("冰狼",({"ice wolf", "wolf"}));
  	set("race", "野兽");
  	set("age", 3);
  	set("long","这是一匹来自北方的狼，看起来好像饿坏了！\n");
...
mapping query_action(object me)
{
	if( random(2) == 0)
	return ([
	"action": HIW"祗见$N猛扑上来，"+(random(2)?"右":"左")+"抓猛然抓向$n的$l"NOR,
	"force" : 200,
	"dodge" : 10,
	"parry" : 10,
	"damage" : 200,
	...
	"action": HIW"祗见$N飞身窜上前来，忽得朝$n的$l一口咬来！"NOR,
	"force" : 200,
	"dodge" : 100,
	"parry" : 0,
	"damage" : 200,
