...
void chaning(object me, object ob)
{
	...
	string *chan_msg = ({
		HIR"\n$n暗运劲力，想将压在身上的$N推开。但$N身子实在太重，丝毫不起作用。"+ZJURL("struggle")+HIG"挣脱\n"NOR,
		HIR"\n$N猛力下压，只箍得$n腰骨几欲折断。"+ZJURL("struggle")+HIG"挣脱\n"NOR,
		HIR"\n$N身子越压越紧，再也不放松，$n渐渐给$N压得喘不过气来。"+ZJURL("struggle")+HIG"挣脱\n"NOR,
		HIR"\n$n被$N压住，除了呻吟怒骂，再无反抗的能为。"+ZJURL("struggle")+HIG"挣脱\n"NOR,
	});
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor)
{
	...
	if(victim->query("race") == "人类") return HIR"$n一个疏神，已被$N压住，再也没法抗拒。"+ZJURL("struggle")+HIG"挣脱\n"NOR;
	else return HIR"这一下$n没有躲开，$N立刻压在$p身上，$n顿时动弹不得。"+ZJURL("struggle")+HIG"挣脱\n"NOR;
	}
