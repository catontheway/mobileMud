...
void create()
{
  ...
  if (clonep())
    ...
    set("unit", "张");
    set("value", 0);
    set("long","这是一张你自己画下的地图，似乎藏着什么东西，地图深奥难懂，你可以"+ZJURL("cmds:yanjiu qiguai xiansuo")+HIG"研究"NOR"(yanjiu)一下。"+ZJURL("cmds:xunzhao qiguai xiansuo")+HIG"寻找"NOR"\n");
    set("no_store", 1);
    set("no_sell", 1);
    set("no_pawn",1);
    set("no_put",1);
...
//过滤非法任务地点和不明区域 by segate@pkuxkx
        ...
        write(HIW"你打开了自己画的地图，仔细查看……在以下位置打了个宝物的标记"+fullplace+"。\n"NOR);        
