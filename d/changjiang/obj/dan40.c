...
void create()
{
	set_name(HIG"奇门八卦阵-惑心"NOR, ({ "huoxin pian","pian","book"}));
	set_weight(500);
    set("value",1);
	if (clonep())
		...
		{
			set("long", "这是奇门八卦阵布阵的用法之一：惑心的使用方法。\n");
			set("unit", "本");
		}
}
...
int do_yanjiu()
{
    ...
    {
        tell_object(me,"你不是已经学会了奇门八卦阵-惑心的使用方法了么？\n");
        return 1;
    }
    ...
    message_vision("$N开始认真研读$n，领悟了奇门八卦阵惑心的使用方法！\n"NOR, me,this_object());
    me->set("safari_skill/thd_huoxin",1);
    me->add("thd_qmbgz",1);
