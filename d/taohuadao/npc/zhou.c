...
string ask_xueyi()
{
    ...
    if( me->query_temp("zyhb/houlai"))
    {
        ...
        return "「结义之后我自当传你这套“"+ZJURL("cmds:answer yes")+HIG"双手互搏"NOR"”的功夫。(answer yes or no)」";
    }
    tell_object(me, "周伯通两只手正打得热火朝天，显然不会听你说话。\n");
    return "我现在正忙着呢！";
}
...
string ask_zyhb()
{
    ...
    if( me->query_temp("zyhb/zyhb"))
    {
        ...
        return "「你就来练练这“"+ZJURL("cmds:hua fangyuan")+HIG"画方圆"NOR"”(hua fangyuan)之术吧。(用halt命令停止)」";
    }
}
int do_hua(string arg)
{
