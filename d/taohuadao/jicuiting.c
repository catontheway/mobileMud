...
void create()
{
        set("short", "积翠亭");
     set("long", @LONG
这是一座竹枝搭成的凉亭，两旁悬着幅对联，正是“桃花影里
飞神剑，碧海潮生按玉箫”那两句。亭中放着竹台竹椅，全是多年之
物，用得润了，月光下现出淡淡黄色。竹亭之侧并肩生着两棵大松树，
...
*/
        ...
        for(i=0;i<times;i++)
        {
                ...
                {
                    if (arg=="throwing" && me->query("adv_weapon/class/throwing/lv")>=4)//高级兵器级别大于4级，加25%效率 Zine
                    {
