...
obj->die();
                ...
                message( "channel:" + "baowei",HIR + "【襄阳战报】郭靖夫妇由于寡不敌众战死杀场！帅府被占，襄阳沦陷！\n"NOR,users());
...
if (task->query("xyoccupied")>30)
                 message( "channel:" + "baowei",HIR + "【襄阳战报】襄阳岌岌可危！\n"NOR,users());
else if(task->query("xyoccupied")>20)
                 message( "channel:" + "baowei",HIR + "【襄阳战报】襄阳现在已尸横遍野！\n"NOR,users());
else if(task->query("xyoccupied")>10)
                 message( "channel:" + "baowei",HIR + "【襄阳战报】襄阳大乱！\n"NOR,users());
else if(task->query("xyoccupied")>5)
                 message( "channel:" + "baowei",HIR + "【襄阳战报】襄阳军情堪忧！\n"NOR,users());
else
{}
switch (random(5)){
case 0:
                message( "channel:" + "baowei",MAG + "【襄阳传言】襄阳某处陷入一片火海之中......\n"NOR,users());
break;
case 1:
                 message( "channel:" + "baowei",MAG + "【襄阳传言】蒙古兵在襄阳某处烧杀抢掠无恶不作......\n"NOR,users());
break;
case 2:
                message( "channel:" + "baowei",MAG + "【襄阳传言】襄阳的"+room->query("short")+MAG+"被鞑子夷为平地.....\n"NOR,users());
break;
case 3:
                message( "channel:" + "baowei",MAG + "【襄阳传言】襄阳某处死伤严重......\n"NOR,users());
break ;
case 4:
                 message( "channel:" + "baowei",MAG + "【襄阳传言】襄阳某处已成一片废墟......\n"NOR,users());
break ;
}
}
room->set("occupied",1);
