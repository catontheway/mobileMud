...
int ask_tasks()
{
    ...
    if (me->query_temp("mingtasks/dudufu/task")!=2)
    {
    ...
    if (me->query_temp("mingtasks/dudufu/scaolian_degree")>50)
    {
    ...
    {
        tell_object(me,"不必多说，要"+ZJURL("cmds:caolian")+HIG"操练(caolian)快来。\n");
        return 1;
    }
}
...
int gen(object me)
{
    ...
    tell_object(me,"水军已成，你和众水军踏上战船，准备回师应天府。\n");
    me->set_temp("mingtasks/战舰",1);
...
int do_caolian()
{
    ...
    me->add_busy(3);
    me->set_temp("mingtasks/dudufu/scaolian_degree",(int)me->query_temp("mingtasks/dudufu/scaolian_degree")+n);
