...
"up" : __DIR__"shu_fang",
 ...
 __DIR__"obj/lampw" : 1,
	...
	set("item_desc", ([
"四盏灯" : "四盏灯,南边一盏写着朱雀,北边是玄武,东边是苍龙,西边是白虎,
古人以北为尊,以东为贵,你可以试着点燃他们.但须小心在意.\n"
		 ZJOBACTS2+ZJMENUF(2,2,12,40)+"点燃:light lamp"+ZJSEP+"点燃朱雀:light lamps"+ZJSEP+"点燃苍龙:light lampe"+ZJSEP+"点燃玄武:light lampw"+ZJSEP+"点燃白虎:light lampn\n",
    ]));
