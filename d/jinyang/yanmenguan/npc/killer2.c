...
void do_copy(object me,int type)
{
        ...
        if (type==1)
        {
            ob->set("title",color1+"刺客"+NOR);
            ob->set("long","这是一位刺客。\n");
            tempskill=tempskill*7/10;
        }
        if (type==2)
        {
            ob->set("title",color1+"刺客头目"+NOR);
            ob->set("long","这是一位刺客头目。\n");
            tempskill=tempskill*9/10;
        }
        if (tempskill<300)
                 tempskill=300;
        ...
        if (ob->query("qi")>20000&&type==1)
        {
            ob->set("eff_qi",20000);
            ob->set("max_qi",20000);
            ob->set("qi",20000);
        }
        if (ob->query("qi")>32000&&type==2)
        {
            ob->set("eff_qi",32000);
            ob->set("max_qi",32000);
            ob->set("qi",32000);
