...
int do_look(string arg)
{
  ...
  $N感到莫名的兴奋，下面该不会有什么宝藏吧？可以(lookin)"+ZJURL("cmds:lookin")+HIG"看清楚些\n",me);
  }
  return 1;
}
...
int do_lookin(string arg)
{
  ...
  {
   tell_object(me,"你把头伸到洞里往下看,脚突然一滑，不过还好，幸亏你轻功好，\n
   体力又足，才反应快，没有掉下去，结果吓了一身冷汗。\n");
  }
  return 1;
}
