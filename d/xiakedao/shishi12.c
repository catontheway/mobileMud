...
LONG NOR
    ...
    set("exits", ([
        "east"  : __DIR__"shishi13",
        "west"   : __DIR__"shishi11",
    ]));
...
string look_shibi()
{
    object me;
    me = this_player();
    me->set_temp("石壁12/看",1);
    return HIB"壁上所刻图形，隐约可以看出是一套棍法。\n"NOR;
}
...
int do_watch(string arg)
{
   ...
   return canwu(me,"club","你看得片刻，随即挥棍如风，飘忽而沉重。\n",times);
}
