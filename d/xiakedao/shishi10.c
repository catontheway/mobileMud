...
LONG NOR
    ...
    set("exits", ([
        "east"  : __DIR__"shishi11",
        "south"   : __DIR__"shishi9",
    ]));
...
string look_shibi()
{
    object me;
    me = this_player();
    me->set_temp("石壁10/看",1);
    return HIB"壁上所刻图形，隐约可以看出是一套剑法。\n"NOR;
}
...
int do_watch(string arg)
{
   ...
   return canwu(me,"sword","你看得片刻，身随剑走，飘逸若仙。\n",times);
}
