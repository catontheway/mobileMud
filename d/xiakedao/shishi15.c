...
LONG NOR
    ...
    set("exits", ([
      "west" :__DIR__"shishi14",
      "east" :__DIR__"shishi16",
    ]));
...
string look_shibi()
{
    object me;
    me = this_player();
    me->set_temp("石壁15/看",1);
    return HIB"图中所示的是一些脉络之图，似乎是一套基本硬功心法。\n"NOR;
}
...
int do_watch(string arg)
{
   ...
   return canwu(me,"iron-cloth","你看得片刻，渐有所悟。\n",times);
}
