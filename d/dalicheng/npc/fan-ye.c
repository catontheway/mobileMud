...
void create()
{
    ...
    setup();
	carry_object("/d/dalicheng/obj/zipao.c")->wear();	
...
string ask_me()
{
	...
	if (environment(this_object())!=find_object("/d/dalicheng/sangong2"))
...
void skill_set1(object ob, int level)
{
	...
	case "星宿派拍马手" :
		...
		ob->set_skill("zhaixing-shou", level-35+random(35));
		ob->set_skill("strike", level-35+random(35));
		ob->set_skill("xingxiu-duzhang", level-35+random(35));
	...
	case "华山派弃徒" :
		...
		ob->set_skill("force", level-35+random(35));
		ob->set_skill("parry", level-35+random(35));
		ob->set_skill("zixia-shengong", level-35+random(35));
		...
		ob->set_skill("poyu-quan", level-35+random(35));
		ob->set_skill("strike", level-35+random(35));
		...
		case 0 :
			...
			ob->set_skill("fanliangyi-dao", level-35+random(35));
	...
	case "雪山派小喇嘛" :
		...
		ob->set_skill("force", level-35+random(35));
		ob->set_skill("parry", level-35+random(35));
		ob->set_skill("longxiang-gong", level-35+random(35));
...
void skill_set3(object ob, int level)
{
	...
	case "雪山派喇嘛" :
		...
		ob->set_skill("longxiang-long", level-35+random(5));
		ob->map_skill("force","longxiang-long");
