...
string ask_me()
{
	...
	if (environment(this_object())!=find_object("/d/dalicheng/sangong1"))
	...
	if (me->query("combat_exp")<500000) {
		ob = new("/d/dalicheng/npc/dlbandit1");
		skill_set1(ob, level);
		}
	else {
		if (me->query("combat_exp")<1500000) {
			ob = new("/d/dalicheng/npc/dlbandit2");
			skill_set2(ob, level);
			}
		else {
			ob = new("/d/dalicheng/npc/dlbandit3");
			skill_set3(ob, level);
			}
		}

	ob->move(load_object("/d/dalicheng/feiwo.c"));
	...
	room=load_object("/d/dalicheng/minov"+room_no+".c");
...
void skill_set1(object ob, int level)
{
	...
	case "星宿派拍马手" :
		...
		ob->set_skill("poison", level-40);
		ob->set_skill("huagong-dafa", level-40);
		ob->set_skill("zhaixinggong", level-40);
		ob->set_skill("tianshan-zhang", level-40);
		...
		ob->set_skill("zhaixing-shou", level-40);
		ob->set_skill("strike", level-40);
		ob->set_skill("xingxiu-duzhang", level-40);
		map_skill("strike","xingxiu-duzhang");
		map_skill("hand","zhaixing-shou");
		prepare_skill("hand","zhaixing-shou");
	...
	case "华山派弃徒" :
		...
		ob->set_skill("force", level-40);
		ob->set_skill("parry", level-40);
		ob->set_skill("zixia-shengong", level-40);
		ob->set_skill("huashan-shenfa", level-40);
		ob->map_skill("dodge","huashan-shenfa");
		ob->map_skill("force","zixia-shengong");
		ob->set_skill("cuff", level-40);
		ob->set_skill("poyu-quan", level-40);
		ob->set_skill("strike", level-40);
		ob->set_skill("hunyuan-zhang", level-40);
		...
		case 0 :
			...
			ob->set_skill("fanliangyi-dao", level-40);
			ob->map_skill("blade","fanliangyi-dao");
			ob->map_skill("parry","fanliangyi-dao");
		...
		case 1 :
			...
			ob->set_skill("huashan-jianfa", level-40);
	...
	case "雪山派小喇嘛" :
		...
		ob->set_skill("force", level-40);
		ob->set_skill("parry", level-40);
		ob->set_skill("longxiang-gong", level-40);
		ob->map_skill("force","longxiang-gong");
		ob->set_skill("shenkongxing", level-40);
		ob->map_skill("dodge","shenkongxing");
		ob->set_skill("cuff", level-40);
		ob->set_skill("yujiamu-quan", level-40);
		ob->set_skill("hand", level-40);
		ob->set_skill("dashou-yin", level-40);
		ob->map_skill("hand","dashou-yin");
		switch (random(3)) {
		case 0 :
			ob->set_skill("blade", level-40);
			ob->set_skill("xue-dao", level-40);
			ob->map_skill("blade","xue-dao");
			ob->map_skill("parry","xue-dao");
			weapon=new("/clone/weapon/gangdao.c");
			weapon->move(ob);
			weapon->wield();
			break;
		case 1 :
			ob->set_skill("sword", level-40);
			ob->set_skill("mingwang-jian", level-40);
		...
		case 2 :
			ob->set_skill("staff", level-40);
			ob->set_skill("jingang-chu", level-40);
			ob->map_skill("staff","jingang-chu");
			ob->map_skill("parry","jingang-chu");
			weapon=new("/clone/weapon/fachu");
			weapon->move(ob);
			weapon->wield();
			break;
		}
	...
	case "丐帮恶贼" :
		...
		ob->set_skill("xiaoyaoyou", level-40);
		ob->set_skill("xianglong-zhang", level-40);
		...
		ob->set_skill("stick", level-40);
		ob->set_skill("dagou-bang", level-40);
...
void skill_set2(object ob, int level)
{
	...
	case "西域少林恶僧" :
		...
		ob->set_skill("shaolin-shenfa", level-40);
		ob->map_skill("dodge","shaolin-shenfa");
		ob->map_skill("force","hunyuan-yiqi");
		switch (random(3)) {
		case 0 :
			ob->set_skill("finger", level-40);
			ob->set_skill("yizhi-chan", level-40);
			ob->set_skill("strike", level-40);
			ob->set_skill("banruo-zhang", level-40);
		...
		case 1 :
			ob->set_skill("cuff", level-40);
			ob->set_skill("jingang-quan", level-40);
			ob->map_skill("cuff","jingang-quan");
			ob->prepare_skill("cuff","jingang-quan");
			break;
		case 2 :
			ob->set_skill("finger", level-40);
			ob->set_skill("nianhua-zhi", level-40);
			ob->set_skill("strike", level-40);
			ob->set_skill("sanhua-zhang", level-40);
		...
		case 0 :
			ob->set_skill("blade", level-40);
			ob->set_skill("xiuluo-dao", level-40);
		...
		case 1 :
			ob->set_skill("sword", level-40);
			ob->set_skill("fumo-jian", level-40);
			...
			break;
		case 2 :
			ob->set_skill("club", level-40);
			ob->set_skill("zui-gun", level-40);
	...
	case "华山派弃徒" :
		...
		case 0 :
			ob->set_skill("blade", level-40);
			ob->set_skill("liangyi-dao", level-40);
			ob->map_skill("blade","fanliangyi-dao");
			ob->map_skill("parry","fanliangyi-dao");
			weapon=new("/clone/weapon/gangdao");
			weapon->move(ob);
...
void skill_set3(object ob, int level)
{
	...
	case "西域少林高僧" :
		...
		case 0 :
			ob->set_skill("blade", level-40);
			ob->set_skill("cibei-dao", level-40);
			...
			break;
		case 1 :
			ob->set_skill("whip", level-40);
			ob->set_skill("riyue-bian", level-40);
	...
	case "武当派叛徒" :
		...
		ob->set_skill("sword", level-40);
		ob->set_skill("taiji-shengong", level-40);
		ob->set_skill("taiji-jian", level-40);
		ob->set_skill("taiji-quan", level-40);
		ob->set_skill("tiyunzong", level-40);
		ob->map_skill("cuff","taiji-quan");
		ob->map_skill("sword","taiji-jian");
		ob->map_skill("dodge","tiyunzong");
		ob->map_skill("parry", "taiji-jian");
