...
LONG);
	set("exits", ([
		...
		set("item_desc", ([
"山壁" : "这是一道石壁，上面刻有九龙戏珠图，九龙张牙舞爪，神态各不相同。\n"
		 ZJOBACTS2+ZJMENUF(2,2,12,40)+"爬山壁:climb wall\n",
    ]));
	set("cost", 1);
	set("wangfu", 1);
	set("no_clean_up", 0);
...
int do_climb(string arg)
{
	...
	{
		me->receive_damage("qi", 50, "从墙上滚了下来摔");
		me->receive_wound("qi",  50, "从墙上滚了下来摔");
