...
string *high_npc = ({
	 "/d/emei/houshan/npc/miejue",
	 "/kungfu/class/gaibang/hong",
	 "/kungfu/class/huashan/ai",
	 "/kungfu/class/huashan/gao",
	 "/kungfu/class/shaolin/du-jie",
	 "/kungfu/class/shaolin/du-e",
	 "/kungfu/class/wudang/zhang",
	 "/kungfu/class/xingxiu/ding",
	 "/kungfu/class/xingxiu/li",
	 "/kungfu/class/gumu/yang",
	 "/kungfu/class/gumu/longer",
	 "/kungfu/class/lingjiu/tonglao",
	 "/kungfu/class/lingjiu/xuzhu",
	 "/kungfu/class/mingjiao/zhang",
	 "/kungfu/class/murong/murongbo",
	 "/kungfu/class/new_taohua/huang",
	 "/kungfu/class/quanzhen/wang",
	 "/kungfu/class/riyuejiao/dongfang",
	 "/kungfu/class/riyuejiao/ren2",
	 "/kungfu/class/shaolin/damo",
});
...
string *middle_npc = ({
	 ...
	 "/kungfu/class/xingxiu/chuchen",
	 "/kungfu/class/quanzhen/ma",
	 "/kungfu/class/quanzhen/sun",
	 "/kungfu/class/quanzhen/qiu",
	 "/kungfu/class/guiyunzhuang/lu",
	 "/kungfu/class/gumu/longer",
	 "/kungfu/class/gumu/binger",
	 "/kungfu/class/huashan/fengbuping",
	 "/kungfu/class/huashan/ning",
	 "/kungfu/class/huashan/yue",
	 "/kungfu/class/mingjiao/daiqisi",
	 "/kungfu/class/mingjiao/weiyixiao",
	 "/kungfu/class/mingjiao/xiexun",
	 "/kungfu/class/mingjiao/yangxiao",
	 "/kungfu/class/mingjiao/yintianzheng",
	 "/kungfu/class/murong/murongfu",
	 "/kungfu/class/riyuejiao/jiabu",
	 "/kungfu/class/riyuejiao/shangguan",
	 "/kungfu/class/riyuejiao/xiang",
});
...
string *low_npc = ({
	 ...
	 "/d/dalicheng/npc/kurong",
	 "/d/dalicheng/npc/benxiang",
	 "/d/guiyunzhuang/npc/zongguan",
	 "/d/guiyunzhuang/npc/wushi",
	 "/d/huashan/npc/dizi",
	 "/d/huashan/npc/haoke",
	 "/d/lingjiu/npc/dizi",
	 "/d/mingjiao/npc/xiaozhao",
	 "/d/mingjiao/npc/ht_zhong",
	 "/d/quanzhen/npc/liangong",
	 "/d/quanzhen/npc/mosheng",
	 "/d/quanzhen/npc/tong-ren",
	 "/d/riyuejiao/npc/jiaozhong4",
	 "/d/riyuejiao/npc/qinweibang",
	 "/d/riyuejiao/npc/dongfang",
	 "/d/riyuejiao/npc/woman",
	 "/d/taishan/npc/wei-shi1",
	 "/d/taishan/npc/wei-shi2",
	 "/d/taishan/npc/wei-shi3",
	 "/d/taishan/npc/jiang",
});

string *misc_npc = ({
	 "/d/guiyunzhuang/npc/tiger",
	 "/d/guiyunzhuang/npc/snake2",
	 "/d/guiyunzhuang/npc/snake3",
	 "/d/guiyunzhuang/npc/snake1",
	 "/d/guiyunzhuang/npc/heiying",
	 "/d/guiyunzhuang/npc/snake4",
	 "/d/guiyunzhuang/npc/yetu",
	 "/d/guiyunzhuang/npc/monkey1",
	 "/d/guiyunzhuang/npc/monkey",
	 "/d/guiyunzhuang/npc/horse",
	 "/d/lingjiu/npc/songshu",
	 "/d/quanzhen/npc/bee",
	 "/d/quanzhen/npc/beewang",
	 "/d/quanzhen/npc/bird",
	 "/d/quanzhen/npc/horse",
	 "/d/quanzhou/npc/choudiao",
	 "/d/quanzhou/npc/snake",
});
...
/*		  "/d/bwdh/sjsz/obj/obj/clone/weapon/xiangmo-chu.c",
		  "/d/bwdh/sjsz/obj/obj/clone/weapon/yitian-jian.c",  // 倚天剑
		  "/d/bwdh/sjsz/obj/obj/clone/unique/yuxiao.c",//       : 1,  // 玉箫
		  "/d/bwdh/sjsz/obj/obj/clone/unique/fumo-dao.c",//     : 1,  // 伏魔刀
		  "/d/bwdh/sjsz/obj/obj/clone/unique/jinshe-jian.c",//  : 1,  // 金蛇剑
		  "/d/bwdh/sjsz/obj/obj/clone/unique/eyujian.c",//      : 1,  // 鳄嘴剪
		  "/d/bwdh/sjsz/obj/obj/clone/unique/eweibian.c",//     : 1,  // 鳄尾鞭
		  "/d/bwdh/sjsz/obj/obj/clone/unique/xuantie-jian.c",// : 1,  // 玄铁重剑
		  "/d/bwdh/sjsz/obj/obj/clone/unique/yuzhu-zhang.c",//  : 1,  // 玉竹杖
		  "/d/bwdh/sjsz/obj/obj/clone/weapon/qijue.c",//        : 1,  // 七绝针
		  "/d/bwdh/sjsz/obj/obj/clone/unique/yuchang-jian.c",// : 1,  // 鱼肠剑
		  "/d/bwdh/sjsz/obj/obj/clone/unique/zhenwu.c",//       : 1,  // 真武剑
		  "/d/bwdh/sjsz/obj/obj/clone/unique/dulong-bian.c", //
		  "/d/bwdh/sjsz/obj/obj/clone/unique/tulong-dao.c", //
		  "/d/bwdh/sjsz/obj/obj/clone/unique/fan.c", //

		  "/d/bwdh/sjsz/obj/obj/clone/weapon/jingun.c",//
		  "/d/bwdh/sjsz/obj/obj/clone/weapon/falun5.c",//
		  "/d/bwdh/sjsz/obj/obj/clone/weapon/qixing-jian.c", //
		  "/d/bwdh/sjsz/obj/obj/clone/weapon/zijin-dao.c", //
		  "/d/bwdh/sjsz/obj/obj/clone/weapon/heilong-bian.c ", //
		  "/d/bwdh/sjsz/obj/obj/clone/weapon/songwen-jian.c ", //
		  "/d/bwdh/sjsz/obj/obj/clone/weapon/youlong.c ", //
*/

		  "/d/shaolin/obj/jingang-zhao.c",//: 1,  // 金刚罩
		  "/d/taohuadao/npc/obj/ruanwei-jia.c",//  : 1,  // 软猬甲
		  "/d/anqimen/npc/obj/xiuzhongjian.c", // 袖中剑
		  "/d/murong/obj/ting-jian.c",         // 听香剑
		  "/d/murong/obj/yan-dao.c",           // 燕翎刀
		  "/d/yuewangmu/obj/dpqiang.c",        // 夺魄枪
		  "/d/gumu/npc/obj/lingsuo.c",         // 铃索
		  "/d/gumu/obj/sword1.c",              // 淑女剑
		  "/d/gumu/obj/sword2.c",              // 君子剑
		  "/d/shaolin/obj/fumo-dao.c",         // 伏魔刀
		  "/d/pingxiwangfu/obj/baojia.c",      // 金丝甲	  
		  "/d/pingxiwangfu/obj/yangqiang.c",   // 洋枪	  
		  "/d/pingxiwangfu/obj/herosword.c",   // 英雄剑    
		  "/d/xingxiu/obj/bingpozhang.c",      // 冰魄杖	  
		  "/d/diaoyudao/obj/ruanjia.c",        // 护体软甲	  
		  "/d/mingjiao/obj/shenghuo-ling.c",   // 圣火令 
		  "/d/beijing/npc/obj/axe.c",          // 开山斧  
		  "/d/beijing/npc/obj/baojia.c",       // 真丝宝甲	  
		  "/d/riyuejiao/obj/bishuijian.c",     // 碧水剑	  
		  "/d/riyuejiao/obj/riyuejian.c",      // 日月神剑	 
		  "/d/riyuejiao/obj/riyuedao.c",       // 日月神刀
		  "/d/xiakedao/npc/obj/xgjia.c",       // 霞光甲	 
		  "/d/xiakedao/npc/obj/xguang.c",      // 侠光剑 
		  "/d/xiakedao/npc/obj/kylinpi.c",     // 火麒麟皮	 
		  "/d/yuewangmu/obj/jsbaojia.c",       // 紧身宝甲	 
		  "/d/city/obj/jiudai.c",              // 牛皮酒袋	
		  "/d/riyuejiao/obj/putaojiu.c",       // 葡萄酒 
		  "/d/riyuejiao/obj/baicaojiu.c",      // 百草酒 
		  "/d/mingjiao/npc/obj/jinhua.c",      // 金花
		  
		  
		  
/*		  
		  
		  "/d/bwdh/sjsz/obj/obj/clone/unique/xuedao.c",//       : 1,  // 血刀
		  "/d/bwdh/sjsz/obj/obj/clone/unique/yuandao.c",//       : 1,
		  "/d/bwdh/sjsz/obj/obj/clone/unique/yangdao.c",//       : 1,
*/		  
...
void make_npc(object room)
{
	 ...
	 {
                 ob = new("/d/city/npc/obj/jinchuang");
...
int update(int n, int result) {
	...
	for ( i = 0; i < sizeof(board->query( "team/" + sprintf("%d", n) + "/ids")); i++) {
								...
								player->add("repute",score*10);
								if (score > 0)
									tell_object(player,HIG"你的江湖声望增加了！\n"NOR);
...
int do_accept(string arg) {
	 ...
	 if( board->query("west") && board->query("east") )
	{
		 if ((time() - board->query("time")) > 1800)
		{
			 board->delete("west");
			 board->delete("east");
		}
		else
			 return notify_fail("山庄主人抱歉道：“现在有人已经占用比武场了。请稍后再来！”\n");
	}
	 s = "team/" + sprintf("%d", n);
