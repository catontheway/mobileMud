...
int valid_leave(object me, string dir)
{
    ...
    if (!::valid_leave(me, dir))
        ...
        {
      if ( (int)me->query("combat_exp") < 1000 || me->query("chushi/last_family")=="少林派" )
          {
           me->delete("is_shaolin");
          return notify_fail("壮年僧人说道: 此次叛师权且不算!\n");
       }
    else
    ...
    if ( (me->query("family/family_name") == "少林派"))
    {
        ...
        else
        {
            ...
            tell_object(me, "壮年僧人沉下脸来，说道：戒律院主持玄痛大师请师兄\n"
                "火速去戒律院陈述此行过犯。\n");
            return 1;
        }
    }
