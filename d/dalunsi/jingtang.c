...
LONG
        ...
        set("no_fight",1);
        	set("item_desc", ([
"禅定" : "有几个僧人正在柱下禅定\n"
		 ZJOBACTS2+ZJMENUF(2,2,12,40)+"禅定:chanding\n",
                 "冥想" : "还有些僧人对着墙壁上的经文冥想苦思\n"
		 ZJOBACTS2+ZJMENUF(2,2,12,40)+"冥想:mingxiang\n",
                 "经书" : "几个新来的僧人正围着石壁，仔细地抄写着经书(write jingshu)。\n"
		 ZJOBACTS2+ZJMENUF(2,2,12,40)+"抄经书:write jingshu\n",
    ]));
