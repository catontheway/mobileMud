...
LONG 
        ...
        set("exits", ([
                ...
                "southwest"     : __DIR__"hubianxiaolu2",
                "west" : __DIR__"shanchandu",
                "north" : __DIR__"tianxi",
                "south" : __DIR__"hubianxiaodian",
...
*/
        ...
        for(i=0;i<times;i++)
        {
                ...
                {
                    if (arg=="hammer" && me->query("adv_weapon/class/hammer/lv")>=4)//高级兵器级别大于4级，加25%效率 Zine
                    {
