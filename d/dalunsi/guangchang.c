...
void init()
{
        ...
        set("item_desc", ([
                "gate": "两扇红漆的大门紧紧关闭着，你可以拉(pull)门。\n"
                 ZJOBACTS2+ZJMENUF(2,2,12,40)+"拉(pull)门:pull gate\n",
...
int closedoor(object room)
{
        ...
        set("item_desc", ([
                "gate": "两扇红漆的大门紧紧关闭着，你可以"+ZJURL("cmds:pull gate")+HIG"拉(pull)门。\n",
                "门": "两扇红漆的大门紧紧关闭着，你可以"+ZJURL("cmds:clpull gate")+HIG"拉(pull)门。\n",
        ]) );
