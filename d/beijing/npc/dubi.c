...
int accept_object(object me, object ob)        
{
       ...
       if (me->query("marks/savesheni")==1 &&  ob->query("id") != "sishierzhang jing")
        {
        ...
        CHANNEL_D->do_channel(this_object(), "rumor", "听说"+me->query("name")+"学会了「神行百变」！", -1);
        return 1;
        }
...
int ask_bxj()
{
        ...
        if (me->query("marks/savesheni")<1) return 0;
