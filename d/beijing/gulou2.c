...
void create()
{
	set("short", HIC"鼓楼二层"NOR);
	set("long",
CYN"这里是鼓楼二楼的小屋子。屋子中间是一面两人怀抱不过来的
...
得见。屋子角上有个士兵在打盹儿。\n"NOR
	...
	"gu" : "一面牛皮鼓。旁边的鼓槌已经发白，可见已经有年月了。\n"
     ...
     ZJOBACTS2+ZJMENUF(2,2,12,40)+"打:da gu\n",
	]));
	set("no_clean_up", 0);
...
void make_gu_sound()
{
    ...
    //added by icer: traverser obj占用内存空间极大，数量很多，发现时new出之后没有destruct的结果，zhonglou2也作了相应的修改
    destruct(trav);
}
