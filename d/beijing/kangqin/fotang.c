...
//  	"down" : __DIR__"mishi",
	...
	set("objects",([
		...
		ZJOBACTS2+ZJMENUF(2,2,12,40)+"佛像:tao foxiang\n",
                "brick" : "\n很普通的石砖，一块一块嵌得很平整。\n"
				ZJOBACTS2+ZJMENUF(2,2,12,40)+"撬:qiao brick\n",    
        ]) );
	set("getkey",0);
...

{
...

	{
		...
		message("vision","登时露出一块铁板来，板上有个拉环，环下有个"+ZJURL("cmds:unlock lock")ZJSIZE(25)+"锁孔"NOR"锁孔(lock)。\n", environment(me));
