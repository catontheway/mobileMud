...
void create()
{
	set("short", HIC"钟楼二层"NOR);
	set("long",
CYN"这里是钟楼上层的小屋子。青铜铸造的铜钟 (zhong) 已经发绿，
...
次，钟声全城都听得见。屋子角上有个士兵在打盹儿。\n"NOR
	...
	"zhong" : "一只巨大的青铜钟。\n"
      ...
      ZJOBACTS2+ZJMENUF(2,2,12,40)+"敲:qiao zhong\n",
	]));
...
void make_zhong_sound()
{
    ...
    //added by icer: traverser obj占用内存空间极大，数量很多，发现时new出之后没有destruct的结果，gulou2也作了相应的修改
    destruct(trav);
