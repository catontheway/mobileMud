...
mapping *safari = ({
            ([  "id":1,"short_name":"襄阳保卫任务经验","name":"exp/xytask","desc":"通过襄阳保卫获得经验","per_day":100000,"max":50000,"min":20000,]),
            ([  "id":2,"short_name":"鄱阳湖寻宝经验  ","name":"exp/pyh","desc":"通过鄱阳湖获得经验","per_day":60000,"max":30000,"min":10000,]),
            //([  "id":3,"name":"exp/banhejob","desc":"通过萧半和任务获得经验","per_day":80000,"max":48000,"min":24000,]),
            ([  "id":3,"short_name":"胡一刀任务经验  ","name":"exp/yidao","desc":"通过胡一刀任务获得经验","per_day":100000,"max":50000,"min":20000,]),
            ([  "id":4,"short_name":"TASK任务经验    ","name":"exp/task","desc":"通过TASK获得经验","per_day":10000,"max":5000,"min":2000,]),
            ([  "id":5,"short_name":"韩员外任务经验  ","name":"exp/hyw","desc":"通过韩员外任务获得经验","per_day":100000,"max":50000,"min":20000,]),
            ([  "id":6,"short_name":"护镖任务经验    ","name":"exp/hubiao","desc":"通过护镖任务获得经验","per_day":10000,"max":5000,"min":3000,]),
            ([  "id":7,"short_name":"送信任务经验    ","name":"exp/songxin","desc":"通过送信任务获得经验","per_day":15000,"max":12500,"min":5000,]),
            ([  "id":8,"short_name":"萧峰任务经验    ","name":"exp/xiaofeng","desc":"通过萧峰任务获得经验","per_day":100000,"max":50000,"min":20000,"mirror":({9,16})]),
            ([  "id":9,"short_name":"慕容任务经验    ","name":"exp/murong","desc":"通过慕容任务获得经验","per_day":50000,"max":20000,"min":8000,]),
			([  "id":10,"short_name":"韩世忠任务经验  ","name":"exp/hansz","desc":"通过韩世忠任务获得经验","per_day":100000,"max":50000,"min":20000,"mirror":({7,12})]),
			([  "id":11,"short_name":"都府行刺任务经验","name":"exp/mzj","desc":"通过都府行刺任务获得经验","per_day":100000,"max":50000,"min":20000,]),
   //         ([  "id":12,"name":"newjobs/completed/xiaobanhe","desc":"完成萧半和任务一定次数","per_day":1,"max":1,"min":1,"index":75,]),
           
            ([  "id":12,"short_name":"韩员外任务次数  ","name":"newjobs/completed/hyw","desc":"完成韩员外任务一定次数","per_day":30,"max":15,"min":10,"index":5,]),
            ([  "id":13,"short_name":"萧峰任务次数    ","name":"jobs/completed/xiaofeng","desc":"完成萧峰任务一定次数","per_day":30,"max":15,"min":10,"index":5,"mirror":({9,16})]),
            ([  "id":14,"short_name":"胡一刀任务次数  ","name":"jobs/completed/huyidao","desc":"完成胡一刀任务一定次数","per_day":20,"max":10,"min":5,"index":8,]),
            ([  "id":15,"short_name":"护镖任务次数    ","name":"jobs/completed/hubiao","desc":"完成护镖任务一定次数","per_day":20,"max":10,"min":5,"index":4,]),
            ([  "id":16,"short_name":"TASK任务次数    ","name":"jobs/completed/task","desc":"完成TASK任务一定次数","per_day":10,"max":5,"min":3,"index":7,]),
			([  "id":17,"short_name":"韩世忠任务次数  ","name":"jobs/completed/hansz","desc":"完成韩世忠任务一定次数","per_day":30,"max":15,"min":10,"index":5,"mirror":({7,12})]),
            ([  "id":18,"short_name":"万安塔四以上次数","name":"newjobs/completed/wat","desc":"完成万安塔四层以上一定次数","per_day":20,"max":20,"min":10,"index":6,]),
			([  "id":19,"short_name":"鄱阳湖寻宝次数  ","name":"newjobs/completed/pyh","desc":"完成鄱阳湖任务一定次数","per_day":1,"max":1,"min":1,"index":50,]),
			([  "id":20,"short_name":"都府行刺任务次数","name":"newjobs/completed/mzj","desc":"完成都府行刺任务一定次数","per_day":30,"max":15,"min":10,"index":5,]),
        });
mapping * ret_safari()
{
	return safari;
