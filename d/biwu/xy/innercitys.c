...
void create()
{
	set("short", "瓮城");
	set("long", @LONG
这里是襄阳城南的瓮城，进来后你点燃了火折子。周围一片明亮，你发现两
...
LONG
	...
	set("exits", ([ /* sizeof() == 1 */
		"out" : __DIR__"southgate",
        "up": __DIR__"southtower",
	]));
		set("item_desc", ([
"瓮城" : "两侧的墙面有些奇怪。\n"
		 ZJOBACTS2+ZJMENUF(2,2,12,40)+"钻左:north"ZJSEP"钻右:south\n",
    ]));
	set("no_clean_up", 0);
	setup();
}
