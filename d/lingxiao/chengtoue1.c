...
LONG);
	...
	set("item_desc", ([
		...
		ZJOBACTS2+ZJMENUF(2,2,12,40)+"跃(yue)过:yue\n",
	]));
	set("exits", ([
		"northeast" : __DIR__"chengtoue2",
		"westup" : __DIR__"chenglou",
		"westdown" : __DIR__"chengmen",
	]));
	set("objects", ([
...
int do_yue(string arg)
{
	if (this_player()->query_skill("dodge")<=1000)
		return notify_fail("墙外的那么宽，你的轻功不足以让你跃过！\n");
	return 1;
}
