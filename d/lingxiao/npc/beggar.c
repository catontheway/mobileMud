...
void create()
{
        ...
        set("inquiry", ([
                ...
                "狗" : "我要找我的阿黄……",
                "求恳" : "你要给我银子便给，我可不会求你什么。",
                "开口求恳" : "你要给我银子便给，我可不会求你什么。",
                "乞讨" : "你要给我银子便给，我可不会求你什么。",
                "银子" : "你要给我银子便给，我可不会求你什么。",
        ]));
...
void xieyanke(object ob, object ling)
{
        ...
        msg = HIR"众人大惊之下，全部停手。\n"NOR;
        message_vision(msg, ob);
        ob->set("marks/xieyanke", -2);
        remove_call_out("xieyanke2");
        call_out("xieyanke2", 7, ob, xie);
}

void xieyanke2(object ob, object xie)
{
        string msg;
        if(!ob || !living(ob) || !present(ob, environment()))
                return;
        if(ob->query("marks/xieyanke") != -2 || random( ob->query("dex") ) <= 18 || random(4) != 0)
        {
