...
任盈盈不由得笑了起来。\n",
    ...
    (: perform_action, "sword.xuanmu" :),
        ...
        set_skill("music::shaw::meihua-sannong", 300);
        set_skill("music::shaw::yuqiao-wenwan", 300);
        set_skill("music::shaw::xiaoao-jianghu", 300);
...
string ask_music()
{
  ...
  if ( !SKILL_D("music")->valid_learn_subskill(me, ({"music","shaw","xiaoao-jianghu"})) )
    return "看来你没有能力学习笑傲江湖曲。";
  
  if ( me->query("family/family_name") != "日月神教" )
    return "我只教本教弟子学习笑傲江湖曲。";
  
  if ( me->query_sub_skill("music::shaw::xiaoao-jianghu",1)>=300 )
  ...
  me->set_skill("music::shaw::xiaoao-jianghu", me->query_sub_skill("music::shaw::xiaoao-jianghu",1)+1 );
