	...
	set("objects",([
 	   ...
 	   set("item_desc",([
            "table"   : "这是一张书桌，上面摆放了几本书。\n"
			 ZJOBACTS2+ZJMENUF(2,2,12,40)+"几本书:search table\n",
  	      "tong huan"	:"你可以抓着(pull)这铜环拉起铁板。\n"
			ZJOBACTS2+ZJMENUF(2,2,12,40)+"拉起铁板:pull tong huan\n",
		"chuang"	: "这是一张供人休息用的床榻。仔细观察可以看出上面擦痕很多，好象经常搬动。\n"
		ZJOBACTS2+ZJMENUF(2,2,12,40)+"搬动:move chuang\n",
 	   ]));
...
int do_move(string arg)
{
	...
	message_vision("$N用力推开床榻，下面却是块铁板，上有"+ZJURL("cmds:pull tong huan")+HIG"铜环(tong huan)。\n",me);
...
int do_pull(string arg)
{
	...
	message_vision("$N握住铜环，向上一提，一块四尺来阔、五尺来长的铁板应手而起，露出一个长大"+ZJURL("cmds:enter")+HIG"方洞。\n",me);
