...
{       
        seteuid(getuid());
        set_name(HIY"镖银"NOR, ({ "biao che", "cart", "che"}) );
      //  set_weight(300000);
        //set("no_get", 1);
        ...
        if(me->follow_path(dir)) 
{
        ...
        if ((random(30)<10&&time()-me->query("last_yunbiao_time")<=360)||(random(30)<7&&time()-me->query("last_yunbiao_time")>360)||(me->query_temp("shilian")&&random(30)>14&&time()-me->query("last_yunbiao_time")>60)||(me->query_temp("shilian")&&random(30)>10&&time()-me->query("last_yunbiao_time")>90)){ 
...
void to_moveaway(object me)
{
	...
	me->move(dest);
	if(!random(20)||(me->query("hbisrobot")&&!random(10)))
	{
