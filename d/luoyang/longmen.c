...
void create()
{
	set("short", "伊阙");
	set("long", @LONG
沿着宽阔的驿道，爬上了洛阳南面著名的伊阙山，伊水静静
的从山下流过，两边的石崖上刻满了佛像，原来这里就是著名的
龙门石窟。
LONG
	);

	set("exits", ([
		"south" : "/d/zhongyuan/yidao3",
...
*/
        ...
        for(i=0;i<times;i++)
        {
                ...
                {
                    if (arg=="staff" && me->query("adv_weapon/class/staff/lv")>=4)//高级兵器级别大于4级，加25%效率 Zine
                    {
