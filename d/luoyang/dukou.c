...
LONG
        ...
        set("item_desc", ([
                ...
                ZJOBACTS2+ZJMENUF(2,2,12,40)+"大声喊:yell 船家"+ZJSEP+"跃过江面:cross river\n",
        ]));
        set("objects", ([
...
int do_cross(string arg)
{
    ...
    if( !(room = find_object(__DIR__"dukou2")) )
        room = load_object(__DIR__"dukou2");
    me->move(room);    
