...
void set_kind(int poison)
{
	...
	case 0:
		...
		set("long", "一只有着三角形脑袋的蛇，尾巴沙沙做响。"+ZJURL("cmds:convert she")+HIG"化为蛇杖"NOR"\n");
		set("combat_exp", 1000);
		break;
	case 1:
		set_name("黑蛇", ({ "hei she", "snake" ,"she" }) );
		set("long", "这条黑蛇身子黑得发亮，身上白点也是闪闪发光，张开大口，露出四根獠牙。"+ZJURL("cmds:convert she")+HIG"化为蛇杖"NOR"\n");
		break;
	case 2:
		set_name("竹叶青", ({ "zhuye qing", "snake" }) );
		set("long", "一只身体碧绿的蛇，显得特别细小。"+ZJURL("cmds:convert she")+HIG"化为蛇杖"NOR"\n");
		break;
	case 3:
		set_name("百步蛇", ({ "baibu she", "she", "snake" }) );
		set("long", "一条青色长蛇，黄鳞覆体。据说被百步蛇咬了，走出一百步必死无疑。"+ZJURL("cmds:convert she")+HIG"化为蛇杖"NOR"\n");
		break;
	case 4:
		set_name("青花蛇", ({ "qinghua she", "she", "snake" }) );
		set("long", "一条混身青黄相间的毒蛇，斑条鲜明，蛇头奇扁，作三角之形，显具剧毒。"+ZJURL("cmds:convert she")+HIG"化为蛇杖"NOR"\n");
		break;
	case 5:
		set_name("蝮蛇", ({ "fu she", "she", "snake" }) );
		set("long", "一条细颈青身的蝮蛇。"+ZJURL("cmds:convert she")+HIG"化为蛇杖"NOR"\n");
		break;
	case 6:
		set_name("赤练蛇", ({ "chilian she", "chilian", "she", "snake" }) );
		set("long", "一条尺许长的赤练蛇，青红斑斓，甚是可怖。"+ZJURL("cmds:convert she")+HIG"化为蛇杖"NOR"\n");
		break;
	case 7:
		set_name("金线蛇", ({ "jinxian she", "she", "snake" }) );
		set("long", "一条方头小蛇，全身绿鳞覆体，一条金线由蛇腹而下。"+ZJURL("cmds:convert she")+HIG"化为蛇杖"NOR"\n");
		break;
	}
...
{
	F_POISON->poison_attack(me,victim,"snake_poison", 10 + me->query("snake_poison")/10 +
