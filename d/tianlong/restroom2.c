...
void wakeup(object me)
{
    ...
    else
    {
        ...
        {   
          ...
          /*  if (me->query_temp("tlnewbiejob/newbie/nian")!=1)
            {
                tell_object(me,"你做过早课了吗？\n");
                return;
            }
            if (me->query_temp("tlnewbiejob/newbie/qiao")!=1)
            {
                tell_object(me,"你敲响晨钟了吗？\n");
                return;
            }
            if (me->query_temp("tlnewbiejob/newbie/bangchu")!=1)
            {
                tell_object(me,"你早晚去帮厨了吗？\n");
                return;
            }
            if (me->query_temp("tlnewbiejob/newbie/dazuo")!=1)
            {
                tell_object(me,"你正午在雨花院打坐了吗？\n");
                return;
            }
            if (me->query_temp("tlnewbiejob/newbie/tiaoshui")!=1)
            {
            ...
            if (me->query_temp("tlnewbiejob/newbie/sleep")!=1)
            {
