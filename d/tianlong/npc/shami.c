...
int job2(object me)
{
    ...
    if (n>66)
    {
        ...
        command("say "+ZJURL("cmds:tsdx "+jushi->query("id"))+HIG+jushi->name()+NOR+"家里很有钱，你到大理城"+where->query("short")+"向他化缘(huayuan)重塑佛祖金身吧。\n");
        return 1;
    }
    else if (n>33)
    {
        ...
        jushi->set("gender",me->query("gender"));
        me->set_temp("tlnewbiejob/adv2/pin",pin);
        command("say "+ZJURL("cmds:tsdx "+jushi->query("id"))+HIG+jushi->name()+NOR+"家里很有钱，你到成都"+where->query("short")+"向他化缘(huayuan)重塑佛祖金身吧。\n");
        return 1;
    }
    else
    {
        ...
        jushi->set("gender",me->query("gender"));
        me->set_temp("tlnewbiejob/adv2/pin",pin);
        command("say "+ZJURL("cmds:tsdx "+jushi->query("id"))+HIG+jushi->name()+NOR+"家里很有钱，你到昆明"+where->query("short")+"向他化缘(huayuan)重塑佛祖金身吧。\n");
        return 1;
    }
}
...
int job1(object me)
{
    ...
    if (n>74)
    {
        ...
        command("say "+ZJURL("cmds:tsdx "+jushi->query("id"))+HIG+jushi->name()+NOR+"前些日子在我寺捐了很多香火钱，你到天龙"+where->query("short")+"把这本佛经送(song)给他吧。\n");
        return 1;
    }
    else if (n>49)
    {
        ...
        jushi->set("pin",pin);
        me->set_temp("tlnewbiejob/adv1/pin",pin);
        command("say "+ZJURL("cmds:tsdx "+jushi->query("id"))+HIG+jushi->name()+NOR"前些日子在我寺捐了很多香火钱，你到大理城"+where->query("short")+"把这本佛经送(song)给他吧。\n");
        return 1;
    }
    else if (n>24)
    {
        ...
        jushi->set("pin",pin);
        me->set_temp("tlnewbiejob/adv1/pin",pin);
        command("say "+ZJURL("cmds:tsdx "+jushi->query("id"))+HIG+jushi->name()+NOR+"前些日子在我寺捐了很多香火钱，你到昆明"+where->query("short")+"把这本佛经送(song)给他吧。\n");
        return 1;
    }
    else
    {
        ...
        jushi->set("pin",pin);
        me->set_temp("tlnewbiejob/adv1/pin",pin);
        command("say "+ZJURL("cmds:tsdx "+jushi->query("id"))+HIG+jushi->name()+NOR+"前些日子在我寺捐了很多香火钱，你到成都"+where->query("short")+"把这本佛经送(song)给他吧。\n");
        return 1;
    }
}
...
int ask_job()
{
    ...
    if (time()-me->query("tlnewbiejob_time")<60&&me->query("combat_exp")>45000)
    {
