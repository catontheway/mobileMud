...
int ask_job()
{
   ...
   tell_object(me,this_object()->query("name")+"说道：记住你的工号："+me->query_temp("chaojing/code")+"\n");
...
int ask_done()
{
        ...
        command("say 报上你的口令！report "+ZJURL("cmds:report "+me->query_temp("chaojing/code"))+HIC+"口令！\n"NOR);
