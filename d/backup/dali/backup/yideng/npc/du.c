...
杏花头上一枝横，	恐泄天机莫露口。\n
一点累累大如斗，	却掩半床无所有。\n
完名直待挂冠归，	本来面目君知否？"+ZJURL("cmds:answer 辛未状元")+HIR"回答\n");
...
int do_answer(string arg)
{
	if ((int)this_player()->query_temp("marks/读2")) 
	{
			if ( arg == "魑魅魍魉，四小鬼各自肚肠" )
			{
				...
				command("say 在下拜服！");
				write("那书生站了起来，让开了地方，你可以"+ZJURL("cmds:jump")+HIR"跳"NOR"(jump)过去了。\n");
				return 1;
			}
			else
			{
...
琴瑟琵琶，八大王一般头面 "+ZJURL("cmds:answer 魑魅魍魉，四小鬼各自肚肠")+HIR"对对联\n");
