...
int do_qu(string arg)
{
    ...
    else
    {
        ...
        {
            tell_object(me,"马车夫道：大爷，你脚下就是南昌了。\n");
            return 1;
        }
        if (arg=="dali"||arg=="大理")
        {
        ...
        {
            if (me->query_temp("jn/step4a"))
            {
                me->delete_temp("jn/step4a");
                me->set_temp("jn/step4b",1);
            }
        ...
        {
            me->set_temp("guche/target-yingtianfu",1);
            me->delete_temp("guche/qu");
            tell_object(me,"马车夫道：好嘞，马上就去应天府。又快又稳。\n");
        ...
        if (arg=="nanchang"||arg=="南昌")
        {
            ...
            me->delete_temp("guche/qu");
            tell_object(me,"马车夫道：好嘞，马上就去南昌。又快又稳。\n");
            me->apply_condition("mache", 2);
            return 1;
        }
        else
