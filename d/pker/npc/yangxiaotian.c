...
int ask_pk()
{
 	...
 	message("vision","这位"+RANK_D->query_respect(me)+"想做杀手啊？那我可得先考考你\n",me);
        switch(random(10)){
     case 0:
            write("要成为一个出色的杀手，最重要的是什么?"+ZJURL("cmds:answer 无情")+HIG"无情\n");me->set_temp("mark/文",1);break;  
     case 1:
            write("如果你接受的任务是要杀我，你会杀我吗?"+ZJURL("cmds:answer 当然")+HIG"回答\n");me->set_temp("mark/文",2);break;     
     case 2:
            write("如果对方的经验比你高，你有什么方法可以就地正法他"+ZJURL("cmds:answer 哈哈，这可就多了，说了你也不懂!")+HIG"回答\n");me->set_temp("mark/文",3);break;     
     case 3:
            write("你对Pk持的是什么态度?"+ZJURL("cmds:answer 人在江湖,身不由己")+HIG"回答\n");me->set_temp("mark/文",4);break;
     case 4:
            write("这世界上最该死的是谁?"+ZJURL("cmds:answer 克林顿")+HIG"回答\n");me->set_temp("mark/文",5);break;          
     case 5:
            write("青天有月来几时,下一句是什么?"+ZJURL("cmds:answer 我今停杯一问之")+HIG"回答\n");me->set_temp("mark/文",6);break;     
     case 6:
            write("天下哪个门派最为强大?"+ZJURL("cmds:answer 少林")+HIG"回答\n");me->set_temp("mark/文",7);break;     
     case 7:
            write("天下哪个门派最为可怕?"+ZJURL("cmds:answer 杀手帮")+HIG"回答\n");me->set_temp("mark/文",8);break;     
     case 8:
            write("我是谁?"+ZJURL("cmds:answer 不知道")+HIG"回答\n");me->set_temp("mark/文",9);break;     
     case 9:
            write("伏魔刀和金丝宝甲，你愿意要哪一个?"+ZJURL("cmds:answer 金丝甲")+HIG"回答\n");me->set_temp("mark/文",10);break;     
   }
   ...
   switch(answer)
{
    ...
    case "不知道":
                sole=9;say("杨啸天说道：很好!\n");break;
    case "金丝甲":
                sole=10;say("完全正确，行凶者第一必须学会自我保护\n");break;
    default:
