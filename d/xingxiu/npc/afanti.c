...
int accept_object(object who, object ob)
{
     ...
     if((string)ob->query("name")=="小毛驴" && (string)ob->query("id")=="donkey") {
          ...
          if(base_name(environment(this_object())) != "/d/xingxiu/house1")
         {
            message_vision("阿凡提对$N谢道：“我现在用不上毛驴了。”\n",who);
...
//               destruct(ob);
		       ...
		       break;
                   case 19:
                       ...
                       break;
                   case 20:
                       write("齐天大圣救命星。(打一本泥潭巫师名)\n");
                       who->set_temp("marks/谜", 21);
                       break;
                   case 21:
                       write("云飘飘。(打一本泥潭NPC名)\n");
                       who->set_temp("marks/谜", 22);
                       break;
                   case 22:
                       write("右手残废。(打一本泥潭NPC名)\n");
                       who->set_temp("marks/谜", 23);
                       break;
                  }
...
int do_answer(string arg)
{
	  ...
	  case "逍遥洞逍遥游" : soln=19; break;
          ...
          case "毫毛" : soln=21; break;
          case "风清扬" : soln=22; break;
          case "左全" : soln=23; break;
          default :
        ...
        if (riddle==soln) {
          ...
          say ("阿凡提对" + me->name() + "竖起大姆指：居然让你猜着了。黄金是巴依的不义之财，你拿去分给穷人吧。\n");
            ...
            this_player()->set("combat_exp",this_player()->query("combat_exp")+15);}
            else
