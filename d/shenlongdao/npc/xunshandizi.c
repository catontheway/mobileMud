...
#include <ansi.h>
string* names = ({
HIR"红衣"NOR,HIY"黄衣"NOR,WHT"黑衣"NOR,HIW"白衣"NOR,HIC"青衣"NOR,
});
string* ids = ({
...
void create()
{
        ...
        set_name(names[i]+"弟子", ({ids[i],"xunshan dizi","dizi"}));
        set("job_title", HIG"巡山弟子"NOR);
        ...
        weapon = random(2)?"/clone/weapon/changbian":"/clone/weapon/bishou";
        set("chat_chance",30);
        set("inquiry", ([
            "here" : "这里是神龙岛！",
        ]) );
