...
*/
	...
	set("chat_msg", ({
       ...
       // (:adv:),
        ...
        carry_object("/clone/misc/w_cloth")->wear();
}
int adv()
{
    if (random(100)>97)
    {
        message("rumor",HIM"【谣言】某人: 朱熹回到南昌岳麓书院后，从此无心政事，以讲学传道为己任。\n"NOR,users());
    }
}
void init()
{
...
int recognize_apprentice(object ob)
{
        ...
        {
             return notify_fail(this_object()->query("name")+"道：“一切等我回书院再说。”\n");
        }
        return 1;
}
