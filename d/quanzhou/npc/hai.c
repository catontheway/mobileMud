...
string ask_for_zigong()
{
       ...
       me->set_temp("pending/zigong", 1);
        return "自宫？这位公子相貌堂堂，何必... 我真希望能有你的那个。自宫之后，不可后悔，你若"+ZJURL("cmds:decide")+HIG"决心已定"NOR"(decide)，告诉我。";
}
...
string ask_for_dongchang()
{
	...
	player->set_temp("chaoting/dc", 1);
			return "一般人可不敢惹咱东厂，你若加入东厂，将来定会飞黄腾达，没准还是圣上身边的红人呢。怎么样？决定"+ZJURL("cmds:join")+HIG"加入吗？(join)";
}
