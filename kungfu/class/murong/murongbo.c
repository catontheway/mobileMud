...
//           new_name = ;
            ...
            if (name[0..1]!="慕容") new_name = "慕容" + name[0..3];
            else new_name=name;
			new_name=color+new_name+NOR;
           ob->set("name", new_name);
           command("say 从今以后你就叫做" + new_name + "，希望你能把慕容功夫发扬光大！");
			CHANNEL_D->do_channel(this_object(), "jh", "我“以彼之道 还施彼身”又收到一个可造之才！");
			CHANNEL_D->do_channel(this_object(), "jh", "我们复兴大燕又多了一份力量！！！");
