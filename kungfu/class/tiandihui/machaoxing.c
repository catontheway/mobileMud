...

{
	...
	set_skill("cangming-gong", 220);
	set_skill("lingding-piao", 240);
	set_skill("wuhu-duanmendao", 250);
	set_skill("fulong-shou", 240);
	set_skill("danxin-jian", 200);
	set_skill("jiulong-bian", 180);
...

{
	...
	if ((int)ob->query_skill("cangming-gong", 1) < 120) {
