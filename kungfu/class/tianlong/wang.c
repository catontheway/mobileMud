...
{
    if ((string)ob->query("family/master_name")=="枯荣大师"&&(int)ob->query("betrayer")<1&&(int)ob->query("score")>=2000&&(int)ob->query("shen") >=50000&&(int)ob->query_int()>=50)
    {
        return 1;
    }
}
int ask_skills()
{
	...
	if ((string)ob->query("family/master_name")=="枯荣大师"&&(int)ob->query("betrayer")<1&&(int)ob->query("score")>=2000&&(int)ob->query("shen") >=50000&&(int)ob->query_int()>=50)
    {
		msg=HBBLU+HIY+"王语嫣目前所学过的技能：（共七十七项技能）\n"+NOR;
		msg+="\n";
		msg+="┌    六项基本知识    ──────────────────────┐\n";
		msg+="│  读书写字 (literate)                      - 融会贯通 300/     0│\n";
		msg+="│  大乘涅磐功 (mahayana)                    - 融会贯通 300/     0│\n";
		msg+="│  医    术 (medical-skill)                 - 融会贯通 300/     0│\n";
		msg+="│  奇门遁甲 (qimen-dunjia)                  - 融会贯通 300/     0│\n";
		msg+="│  驱蜂术 (qufengshu)                       - 融会贯通 300/     0│\n";
		msg+="│  驭 兽 术 (training)                      - 融会贯通 300/     0│\n";
		msg+="└────────────────────────────────┘\n";
		msg+="┌    二项基本功夫    ──────────────────────┐\n";
		msg+="│  基本轻功 (dodge)                         - 平淡无奇 300/     0│\n";
		msg+="│  基本戟法 (halberd)                       - 平淡无奇 300/     0│\n";
		msg+="└────────────────────────────────┘\n";
		msg+="┌六十九项特殊功夫    ──────────────────────┐\n";
		msg+="│  般若掌 (banruo-zhang)                    - 平淡无奇 300/     0│\n";
		msg+="│  冰蚕毒掌 (bc-zhang)                      - 平淡无奇 300/     0│\n";
		msg+="│  蟾蜍步法 (chanchu-bufa)                  - 平淡无奇 300/     0│\n";
		msg+="│  长恨鞭法 (changhen-bian)                 - 平淡无奇 300/     0│\n";
		msg+="│  慈悲刀 (cibei-dao)                       - 平淡无奇 300/     0│\n";
		msg+="│  摧心掌 (cuixin-zhang)                    - 平淡无奇 300/     0│\n";
		msg+="│  打狗棒法 (dagou-bang)                    - 平淡无奇 300/     0│\n";
		msg+="│  达摩剑 (damo-jian)                       - 平淡无奇 300/     0│\n";
		msg+="│  大腾挪步法 (datengnuo-bufa)              - 平淡无奇 300/     0│\n";
		msg+="│  反两仪刀法 (fanliangyi-dao)              - 平淡无奇 300/     0│\n";
		msg+="│  飞花摘叶手法 (feihua-shou)               - 平淡无奇 300/     0│\n";
		msg+="│  飞花逐月 (feihua-zhuyue)                 - 平淡无奇 300/     0│\n";
		msg+="│  雪山剑法 (fengliu)                       - 平淡无奇 300/     0│\n";
		msg+="│  风云手 (fengyun-shou)                    - 平淡无奇 300/     0│\n";
		msg+="│  回风拂柳剑 (fuliu-jian)                  - 平淡无奇 300/     0│\n";
		msg+="│  伏摩剑 (fumo-jian)                       - 平淡无奇 300/     0│\n";
		msg+="│  兰花拂穴手 (fuxue-shou)                  - 平淡无奇 300/     0│\n";
		msg+="│  飞仙步法 (fx-step)                       - 平淡无奇 300/     0│\n";
		msg+="│  寒冰绵掌 (hanbing-zhang)                 - 平淡无奇 300/     0│\n";
		msg+="│  华山剑法 (huashan-jianfa)                - 平淡无奇 300/     0│\n";
		msg+="│  华山身法 (huashan-shenfa)                - 平淡无奇 300/     0│\n";
		msg+="│  混元掌 (hunyuan-zhang)                   - 平淡无奇 300/     0│\n";
		msg+="│  金顶绵掌 (jinding-mianzhang)             - 平淡无奇 300/     0│\n";
		msg+="│  大金刚拳 (jingang-quan)                  - 平淡无奇 300/     0│\n";
		msg+="│  金乌刀法 (jinwu-dao)                     - 平淡无奇 300/     0│\n";
		msg+="│  九阴白骨爪 (jiuyin-baiguzhao)            - 平淡无奇 300/     0│\n";
		msg+="│  空明拳 (kongming-quan)                   - 平淡无奇 300/     0│\n";
		msg+="│  快刀十三式 (kuai-dao)                    - 平淡无奇 300/     0│\n";
		msg+="│□凌波微步 (lingbo-weibu)                  - 平淡无奇 300/     0│\n";
		msg+="│  灵蛇杖法 (lingshe-zhangfa)               - 平淡无奇 300/     0│\n";
		msg+="│  六合刀 (liuhe-dao)                       - 平淡无奇 300/     0│\n";
		msg+="│  六脉神剑 (liumai-shenjian)               - 平淡无奇 300/     0│\n";
		msg+="│  吕家戟 (lujia-ji)                        - 平淡无奇 300/     0│\n";
		msg+="│  罗汉拳 (luohan-quan)                     - 平淡无奇 300/     0│\n";
		msg+="│  落英身法 (luoying-shenfa)                - 平淡无奇 300/     0│\n";
		msg+="│  落英神剑掌 (luoying-zhang)               - 平淡无奇 300/     0│\n";
		msg+="│□美女拳 (meinu-quan)                      - 平淡无奇 300/     0│\n";
		msg+="│  冥天九式 (mingtian-jiushi)               - 平淡无奇 300/     0│\n";
		msg+="│  拈花指 (nianhua-zhi)                     - 平淡无奇 300/     0│\n";
		msg+="│  辟邪剑法 (pixie-jian)                    - 平淡无奇 300/     0│\n";
		msg+="│  劈石破玉拳 (poyu-quan)                   - 平淡无奇 300/     0│\n";
		msg+="│  普渡杖 (pudu-zhang)                      - 平淡无奇 300/     0│\n";
		msg+="│  千灭银针手 (qianmie-shou)                - 平淡无奇 300/     0│\n";
		msg+="│  日月鞭法 (riyue-bian)                    - 平淡无奇 300/     0│\n";
		msg+="│  散花掌 (sanhua-zhang)                    - 平淡无奇 300/     0│\n";
		msg+="│  善诀 (shanjue)                           - 第四重楼 300/     0│\n";
		msg+="│  少林身法 (shaolin-shenfa)                - 平淡无奇 300/     0│\n";
		msg+="│  太极剑法 (taiji-jian)                    - 平淡无奇 300/     0│\n";
		msg+="│  太极拳 (taiji-quan)                      - 平淡无奇 300/     0│\n";
		msg+="│  天罡北斗阵 (tiangang-beidou)             - 平淡无奇 300/     0│\n";
		msg+="│  天罡指 (tiangang-zhi)                    - 平淡无奇 300/     0│\n";
		msg+="│  天山杖法 (tianshan-zhang)                - 平淡无奇 300/     0│\n";
		msg+="│  梯云纵 (tiyunzong)                       - 平淡无奇 300/     0│\n";
		msg+="│  同归剑法 (tonggui-jian)                  - 平淡无奇 300/     0│\n";
		msg+="│  万里独行 (wanli-duxing)                  - 平淡无奇 300/     0│\n";
		msg+="│  韦驮棍 (weituo-gun)                      - 平淡无奇 300/     0│\n";
		msg+="│  降龙十八掌 (xianglong-zhang)             - 平淡无奇 300/     0│\n";
		msg+="│  纤云步法 (xianyun)                       - 平淡无奇 300/     0│\n";
		msg+="│  逍遥剑法 (xiaoyao-jian)                  - 平淡无奇 300/     0│\n";
		msg+="│  逍遥掌法 (xiaoyao-zhang)                 - 平淡无奇 300/     0│\n";
		msg+="│  逍遥游 (xiaoyaoyou)                      - 平淡无奇 300/     0│\n";
		msg+="│  修罗刀 (xiuluo-dao)                      - 平淡无奇 300/     0│\n";
		msg+="│  养心拳 (yangxin-quan)                    - 平淡无奇 300/     0│\n";
		msg+="│  一阳指 (yiyang-zhi)                      - 平淡无奇 300/     0│\n";
		msg+="│  一指禅 (yizhi-chan)                      - 平淡无奇 300/     0│\n";
		msg+="│  玉女剑法 (yunu-jianfa)                   - 平淡无奇 300/     0│\n";
		msg+="│  摘星功 (zhaixinggong)                    - 平淡无奇 300/     0│\n";
		msg+="│  诸天化身法 (zhutian)                     - 平淡无奇 300/     0│\n";
		msg+="│  少林醉棍 (zui-gun)                       - 平淡无奇 300/     0│\n";
		msg+="└────────────────────────────────┘\n";
		tell_object(ob,msg);
        return 1;
    }
...
// 如果不是看 yi yi 的话， 返回 0 让系统函数去处?
	if( arg!="wang" )	return 0;
	...
	if( (strsrch(msg, "笑") >= 0))
	{
		...
		switch(random(250)) {
			...
			case 46: command("say 王语嫣轻轻拍了拍"+who+"的头.\n"); break;
                        ...
                        case 48: command("rumor "+this_object()->query("killed")+"被大狼狗就地正法了。\n"); break;
                        case 49: command("rumor "+this_object()->query("killed")+"被段誉就地正法了。\n"); break;
                        case 50: command("rumor "+this_object()->query("killed")+"被丁春秋就地正法了。\n"); break;
