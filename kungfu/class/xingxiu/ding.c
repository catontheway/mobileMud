...
string ask_for_leave()
{
  ...
  return "如果" + RANK_D->query_respect(me) + "真想离我星宿派而去，就请下决心"+ZJURL("cmds:leave")+"(leave)"NOR"吧！";
}
...
void attempt_apprentice(object me)
{
	...
	} else
	{
		...
		message_vision("星宿老怪微闭双眼，手捻长须，一付等人"+ZJURL("cmds:flatter 星宿老仙德配天地威震寰宇古今无比")+"拍马(flatter)"NOR"的样子。\n", me);
