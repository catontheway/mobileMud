...
饰俨然是个贵介公子。\n");
	...
	set_skill("sword", 350);
  set_skill("whip", 350);
	set_skill("bingchuan-xinfa", 380);
	set_skill("zhuangzi-mengwu", 350);
	set_skill("baihua-cuoquan", 400);
  set_skill("jiandun-zhusuo", 400);	
	set_skill("luohua-jian", 400);	
...
void attempt_apprentice(object ob)
{
        ...
        if ((int)ob->query_skill("bingchuan-xinfa", 1) < 100) {
