...
mapping *action2 = ({
([  "action" : HIY"$N斜里冲前一步，身法诡异，手中$w"+HIY+"横扫$n的$l"NOR,
    "damage": 385,
    "dodge" : 55,
    "damage_type" : "挫伤"
]),
([  "action" : HIY"$N忽然直身飞入半空，很久也不见人影，$n正搜寻间，$N已
飞身扑下，$w"+HIY+"攻向$n的$l"NOR,
    "damage": 440,
    "dodge" : 50,
    "damage_type" : "挫伤"
]),
([  "action" : HIY"$N原地一个后滚翻，却在落地的一刹那，身体向$n平飞过
去，手中$w"+HIY+"指向$n的$l"NOR,
    "damage": 385,
    "dodge" : 66,
    "damage_type" : "挫伤"
]),
([  "action" : HIY"$N突然一个急转身，$w"+HIY+"横扫一圈后挟着猛烈的劲道打向$n的$l"NOR,
    "damage": 495,
    "dodge" : 82,
    "damage_type" : "挫伤"
]),
([  "action" : HIY"$N向前扑出，顺势一滚，接着翻身跳起，手里$w"+HIY+"斜向上击
向$n的$l"NOR,
    "damage": 440,
    "dodge" : 72,
    "damage_type" : "挫伤"
