...
string query_name() { return "金刚不坏体神功"; }
int exert(object me)
{    
...
//      me->set_temp("tjj_jie", 1);
      ...
      me->set_temp("active_force_buffer/yijin-jing.jingang/effect1", "护甲防御+"+(me->query_skill("yijin-jing", 1)/4+me->query_skill("buddhism", 1)/2)+"点");       //效果描述1   
