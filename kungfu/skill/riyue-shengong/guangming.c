...
/*            age=(int)me->query("age");
            ...
            skill=(int)me->query_skill("riyue-shengong",1)/40;
            ...
            if (!me->query_temp("daguangming/minus"))
            {
                ...
                me->set_temp("active_debuff/riyue-shengong.guangming/name", "大光明心法");                            //buff名称
                me->set_temp("active_debuff/riyue-shengong.guangming/effect1", "后天根骨-8点");                       //效果描述1
                me->set_temp("active_debuff/riyue-shengong.guangming/effect2", "后天悟性-8点");                       //效果描述2
            }
//            dur=to_int(sqrt(to_float(me->query_skill("riyue-shengong",1))));
//            me->apply_condition("daguangming",dur);
            ...
            me->add("neili",-100);
            me->set_temp("active_force_buffer/riyue-shengong.guangming/name", "大光明心法");                            //buff名称
//            me->set_temp("active_force_buffer/riyue-shengong.guangming/last_time", time() + dur*10 );                   //持续时间
            me->set_temp("active_force_buffer/riyue-shengong.guangming/effect1", "最大气血+"+(gm_skill*skill)+"点");    //效果描述1   
            me->set_temp("active_force_buffer/riyue-shengong.guangming/effect2", "最大精神+"+(gm_skill*skill/5*3)+"点");//效果描述2
            return 1;
}
