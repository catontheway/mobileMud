...
int valid_combine(string combo) { return combo=="kaishan-zhang"; }
...
int valid_learn(object me)
{
	...
	if ((int)me->query_skill("riyue-shengong", 1) < 20)
		return notify_fail("你的日月神功火候不够，无法学鹰爪功。\n");
...
{
        int i, level;
	level   = (int) me->query_skill("ryingzhua-gong",1);
