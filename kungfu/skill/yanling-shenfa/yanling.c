...
int perform(object me, object target)
{
     ...
     msg = HIG"$N突然深吸一口气，突然之间拔高数丈，升势刚尽，又是一个翻身，" +
      ...
      me->start_call_out(__FILE__, "remove_effect", me->query_skill("yanling-shenfa") * 2/3, me, improve);
    me->start_perform(me->query_skill("yanling-shenfa")/3, "「灵动如燕」");
      return 1;
}
