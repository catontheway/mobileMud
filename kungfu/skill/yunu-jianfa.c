// yunu-jianfa 玉女剑法
// Modified by iszt@pkuxkx, 2007-03-21, replace $1 for $l

inherit SKILL;

mapping *action = ({
([      "action" : "$N一式「柳荫联句」，手中$w竖削三下，而后一剑掠出，划向$n的$l。",
        "damage" : 40,
        "dodge" : 10,
        "force": 100,
        "damage_type" : "刺伤"
]),
([      "action" : "只见$N左手外拨，右手中$w微举，陡变为数朵剑花，齐刺$n的$l，正是一招「竹帘临池」。",
        "force" : 200,
        "dodge" : 20,
        "damage" : 50,
        "damage_type" : "刺伤"
]),
([      "action" : "$N剑走轻灵，手中$w微抖，招断意连，绵绵不绝地逼向$n的$l，却是一招「池边调鹤」。",
        "force" : 200,
        "dodge": 30,
        "damage" : 60,
        "damage_type" : "刺伤"
]),
([      "action" : "$N使出一式「抚琴按箫」，左手微按，右手$w递出，但见青光激荡，剑花点点，四散而下，洒向$n.",
        "damage" : 80,
        "force" : 200,
        "dodge" : 30,
        "damage_type" : "刺伤"
...
([      "action" : "$N使出一招「浪迹天涯」，趋身而进，手中$w挥出，飘逸无比地向$n的$l掠去.",
        "damage" : 120,
        "dodge" : 50,
        "force": 250,
        "damage_type" : "刺伤"
...
([      "action" : "$N使出一招「彩笔画眉」，$w横剑斜削，然后微微两颤，合成一式「帘下梳妆」，刺向$n的$l.",
        "damage" : 160,
        "dodge" : 50,
        "force": 350,
        "damage_type" : "刺伤"
]),
([      "action" : "$N双手握住剑柄，举剑上挑，一式「举案齐眉」刺向$n的$l，剑意中温雅疑疑，风光旖旎。",
        "damage" : 140,
        "dodge" : 40,
        "force": 300,
        "damage_type" : "刺伤"
