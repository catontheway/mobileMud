...
{	
        if( damage_bonus > 100 ) 
{
        victim->receive_wound("qi", damage_bonus+800, me);
...
{       
        victim->receive_wound("qi", damage_bonus+200, me);	
...
{
	if (random(me->query_skill("six-finger",1)) > 80 &&
		me->query_skill("kurong-changong",1) > 80 &&
		me->query("neili") > 100)
	{
		me->add("neili", -100);
		return ([
