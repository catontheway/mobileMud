...
int perform(object me, object target)
{
	...
	if ( me->query_temp("cooldown") )	//CD写法	2017.9.7添加
		return ("你处于技能冷却状态中，过会在使用吧。\n");
		
	message_vision(HBWHT "$N贯通星宿派武学，使出了星宿派的绝学之精髓！\n" NOR, me, target);
	ap = me->query("xyzx_sys/level") + me->query_skill("chousui-zhang", 1) + me->query_skill("tianshan-zhang", 1) + me->query_skill("unarmed") + me->query_skill("force");
...
if(me->query_skill("chousui-zhang",1)>2000 && me->query_skill("tianshan-zhang",1)>2000 )
{	
...
if(me->query_skill("chousui-zhang",1)>3000 && me->query_skill("tianshan-zhang",1)>3000 )
{
