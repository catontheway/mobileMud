...
#include <ansi.h>
mapping *action = ({
([      "action" : "$N这一招“无孔不入”，乃是向敌人周身百骸就地正法，虽是一招，其实千头万绪，一招之中包含了数十招，竟是同时点$n全身各处大穴",
        "force" : 200,
        "dodge" : -5,
        "parry" : 10,
        "lvl" : 0,
...
mapping *action2 = ({
([      "action" : HIW"$N"+HIW+"这一招“无孔不入”，乃是向敌人周身百骸就地正法，虽是一招，其实千头万绪，一招之中包含了数十招，竟是同时点$n"+HIW+"全身各处大穴"NOR,
        "force" : 250,
        "dodge" : 25,
        "parry" : 20,
        "lvl" : 0,
...
mapping *action3 = ({
([      "action" : CYN"$N"+CYN+"这一招“无孔不入”，乃是向敌人周身百骸就地正法，虽是一招，其实千头万绪，一招之中包含了数十招，竟是同时点$n"+CYN+"全身各处大穴"NOR,
        "force" : 300,
        "dodge" : 80,
        "parry" : 10,
        "lvl" : 0,
