...
int valid_combine(string combo) { return combo=="fulong-shou"; }
...
int valid_learn(object me)
{
	...
	if ((int)me->query_skill("cangming-gong", 1) < 50)
		return notify_fail("你的浩气苍冥功火候不够，无法学云龙爪。\n");
	...
	if ((int)me->query_skill("claw",1) <40)
        ...
        if (2*(int)me->query_skill("cangming-gong",1) <(int)me->query_skill("yunlong-zhua",1))
                return notify_fail("你的浩气苍冥功火候不够，无法继续学云龙爪。\n");
	return 1;
}
