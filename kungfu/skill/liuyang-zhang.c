...
([	"action" : "$N一招「阳春白雪」，面色凝重，双掌轻飘飘地拍向$n",
	"force" : 120,
	"dodge" : 10,
	"damage" : 30,
	"lvl" : 20,
...
int valid_enable(string usage) { return usage=="strike" || usage=="parry"||usage=="throwing"; }
