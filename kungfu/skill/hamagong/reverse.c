...
inherit F_CLEAN_UP;
string query_name() { return "经脉"ZJBR"倒转"; }
...
int exert(object me, object target)
{
        ...
        me->add_temp("apply/dodge", skill*5);
		 me->add_temp("max_qi", skill*200);
		  me->add_temp("max_jing", skill*200);
        ...
        me->set_temp("active_force_buffer/hamagong.reverse/effect5", "护甲防御+"+(skill*3)+"点");  
me->set_temp("active_force_buffer/hamagong.reverse/effect7", "最大气血+"+(skill*200)+"点");
me->set_temp("active_force_buffer/hamagong.reverse/effect8", "最大精神+"+(skill*200)+"点");//效果描述5
...
void remove_effect(object me, int a_amount)
{
        ...
        me->add_temp("apply/armor", - a_amount*3);
		 me->add_temp("max_qi", - a_amount/200);
		  me->add_temp("max_jing", - a_amount/200);
