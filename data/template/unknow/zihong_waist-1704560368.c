// zihong_waist.c
// Create by TEMPLATE_D. Sun Oct 10 11:46:08 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m紫虹之腰带[2;37;0m", ({ "zihong waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[36m紫虹之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两六钱的[36m紫虹之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[35m标准[2;37;0m $br#
...
//特效数值
    ...
    set("armor_prop/max_busy_confuse", 11);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 9);
