// fengwu_dagger.c
// Create by TEMPLATE_D. Wed Oct 06 17:49:21 2021.
// gangjian.c
...
void create()
{
	set_name("[32m凤舞之匕首[2;37;0m", ({ "fengwu dagger" }));
	set_weight(3499);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[32m凤舞之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重六斤九两九钱的[32m凤舞之匕首[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
