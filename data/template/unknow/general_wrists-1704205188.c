// general_wrists.c
// Create by TEMPLATE_D. Thu Nov 10 20:55:43 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;37m扣骨之护腕[2;37;0m", ({ "general wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
扣骨之护腕[2;37;0m这是一双由极为坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两三钱的[1;37m扣骨之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m 
