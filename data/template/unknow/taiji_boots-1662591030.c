// taiji_boots.c
// Create by TEMPLATE_D. Tue Oct 19 08:32:02 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m太极之靴[2;37;0m", ({ "taiji boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;33m太极者，无极而生，阴阳之母也。动之则分，静之则合。无过不及，随曲就伸。人刚我柔谓之走，我顺人背谓之粘。动急则急应，动缓则缓随。虽变化万端，而理为一贯！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤八两七钱的[1;33m太极之靴[2;37;0m。$br#
