// yaohou_hands.c
// Create by TEMPLATE_D. Sat Oct 16 02:09:27 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m妖后之手套[2;37;0m", ({ "yaohou hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[36m妖后之手套[2;37;0m这是一副由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两八钱的[36m妖后之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_all_busy", 12);
