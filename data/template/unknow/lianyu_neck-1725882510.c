// lianyu_neck.c
// Create by TEMPLATE_D. Thu Oct 07 11:29:29 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m炼狱之项链[2;37;0m", ({ "lianyu neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[1;31m三十三天下有地，地下有城，城名鬼城，大小妖魔，人神畜生都在此轮回往返，谓之“炼狱”！$br#[2;37;0m这是一串由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤九两九钱的[1;31m炼狱之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m开元[2;37;0m [33m土[2;37;0m:[1;36m完美[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_all_busy", 16);
