// shengxie_armor.c
// Create by TEMPLATE_D. Fri Nov 11 07:33:08 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m胜邪之披风[2;37;0m", ({ "shengxie armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤四两五钱的[31m胜邪之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;33m灭世[2;37;0m 
