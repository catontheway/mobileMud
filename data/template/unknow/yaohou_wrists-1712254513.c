// yaohou_wrists.c
// Create by TEMPLATE_D. Wed Oct 06 22:48:45 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m妖后之护腕[2;37;0m", ({ "yaohou wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[36m妖后之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤七两五钱的[36m妖后之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m天圣[2;37;0m 
...
//特效数值
    set("armor_prop/kf_def_wound", 10);
