// taiyuan_head.c
// Create by TEMPLATE_D. Thu Oct 07 08:02:01 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m太渊之头盔[2;37;0m", ({ "taiyuan head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[37m太渊之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤六两零钱的[37m太渊之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
