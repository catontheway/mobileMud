// general_hands.c
// Create by TEMPLATE_D. Mon Oct 11 03:16:36 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m血斩之手套[2;37;0m", ({ "general hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
血斩之手套[2;37;0m这是一副由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两六钱的[1;32m血斩之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#
