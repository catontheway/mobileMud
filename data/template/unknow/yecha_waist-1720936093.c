// yecha_waist.c
// Create by TEMPLATE_D. Fri Nov 11 08:18:31 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m夜叉之腰带[2;37;0m", ({ "yecha waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[33m夜叉之腰带[2;37;0m这是一条由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两六钱的[33m夜叉之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spear", 21);
    set("armor_prop/throwing", 13);
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 12);
    ...
    set("armor_prop/max_busy_confuse", 19);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 31);
