// dilong_waist.c
// Create by TEMPLATE_D. Fri Oct 08 07:13:10 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[32m地龙之腰带[2;37;0m", ({ "dilong waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[32m地龙之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两八钱的[32m地龙之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;31m开元[2;37;0m 
