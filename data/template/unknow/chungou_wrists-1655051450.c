// chungou_wrists.c
// Create by TEMPLATE_D. Tue Oct 19 08:34:47 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m纯钩之护腕[2;37;0m", ({ "chungou wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一双由极为坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤二两八钱的[31m纯钩之护腕[2;37;0m。$br#
...
//特效数值
    set("armor_prop/kf_def_wound", 23);
    ...
    set("armor_prop/cant_busy_fenjin", 17);
    ...
    set("armor_prop/PoisonAttack", 17);
...
//伤害防御类
    ...
    set("armor_prop/defense_attack", 17);
    ...
    set("armor_prop/attack_speed", 0);
     ...
     set("armor_prop/dodge_factor", 22);
//气血恢复治疗类
    set("armor_prop/max_qi", 22);
