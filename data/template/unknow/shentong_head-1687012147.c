...
void create()
{
	set_name("[1;31m神通之头盔[2;37;0m", ({ "shentong head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;31m天兵神通，走势要平善，气要随行，两眼顾尖，气沉两足稳，身法需自然，身行如飞燕，身落如停风，收如花絮，刺如钢钉！$br#[2;37;0m这是一顶由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤五两七钱的[1;31m神通之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m毁天[2;37;0m $br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
