// general_boots.c
// Create by TEMPLATE_D. Thu Oct 07 14:37:01 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m圣母之靴[2;37;0m", ({ "general boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
圣母之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两三钱的[1;33m圣母之靴[2;37;0m。$br#
