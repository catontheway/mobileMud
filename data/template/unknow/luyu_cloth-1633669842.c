// luyu_cloth.c
// Create by TEMPLATE_D. Thu Oct 07 11:33:15 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m绿玉之服装[2;37;0m", ({ "luyu cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[37m绿玉之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤七两七钱的[37m绿玉之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 25);
