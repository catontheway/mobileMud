// zhanlu_cloth.c
// Create by TEMPLATE_D. Fri Oct 15 09:22:21 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m湛卢之服装[2;37;0m", ({ "zhanlu cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重三斤一两四钱的[31m湛卢之服装[2;37;0m。$br#
