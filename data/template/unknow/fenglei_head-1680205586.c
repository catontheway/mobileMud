// fenglei_head.c
// Create by TEMPLATE_D. Thu Oct 07 15:37:27 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m风雷之头盔[2;37;0m", ({ "fenglei head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[37m风雷之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两七钱的[37m风雷之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[35m标准[2;37;0m 
