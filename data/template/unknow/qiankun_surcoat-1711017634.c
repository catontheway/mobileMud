// qiankun_surcoat.c
// Create by TEMPLATE_D. Fri Oct 15 09:35:57 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m乾坤之肚带[2;37;0m", ({ "qiankun surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;33m此物左右两边分别以黑白两种奇铁溶铸而成，一黑一白，切合乾坤，包含阴阳之气，好一柄宝物！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤五两二钱的[1;33m乾坤之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/unarmed", 27);
    set("armor_prop/blade", 23);
    set("armor_prop/whip", 0);
    set("armor_prop/staff", 0);
    set("armor_prop/force", 20);
    set("armor_prop/dagge", 0);
    set("armor_prop/hammer", 19);
    set("armor_prop/spear", 24);
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 20);
    ...
    set("armor_prop/max_busy_jiemai", 20);
...
//伤害防御类
    ...
    set("armor_prop/armor_effect_armor_vs_force", 14);
    set("armor_prop/attack_speed", 21);
     set("armor_prop/attack_factor", 23);
     set("armor_prop/parry_factor", 0);
     set("armor_prop/dodge_factor", 23);
//气血恢复治疗类
