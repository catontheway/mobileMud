// bagua_cloth.c
// Create by TEMPLATE_D. Sat Oct 09 00:46:37 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;37m八卦之服装[2;37;0m", ({ "bagua cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;37m八卦有“休”“生”“伤”“杜”“死”“景”“惊”“开”之别，创自诸葛武候，集天下万变于一身！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重二斤五两五钱的[1;37m八卦之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m创世[2;37;0m [33m土[2;37;0m:[1;31m开元[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/staff", 34);
    set("armor_prop/force", 0);
    set("armor_prop/dagge", 0);
    set("armor_prop/hammer", 35);
