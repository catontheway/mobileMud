// qingping_dagger.c
// Create by TEMPLATE_D. Wed Oct 06 18:16:49 2021.
// gangjian.c
...
void create()
{
	set_name("[1;32m青萍之匕首[2;37;0m", ({ "qingping dagger" }));
	set_weight(15223);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[1;32m青萍之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重三十斤四两四钱的[1;32m青萍之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;36m完美[2;37;0m [37m天[2;37;0m:[1;31m无双[2;37;0m [1;36m人[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_dianxue", 14);
