// general_armor.c
// Create by TEMPLATE_D. Wed Oct 13 10:39:15 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m瀚海之披风[2;37;0m", ({ "general armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
瀚海之披风[2;37;0m这是一件由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两二钱的[31m瀚海之披风[2;37;0m。$br#
