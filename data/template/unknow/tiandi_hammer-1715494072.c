// tiandi_hammer.c
// Create by TEMPLATE_D. Thu Oct 07 16:49:00 2021.
// gangjian.c
...
void create()
{
	set_name("[1;36m天地之锤[2;37;0m", ({ "tiandi hammer" }));
	set_weight(6295);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","[1;36m天地之初，女娲补天所留下的天地间至尊之物之一经千秋万载所制，功能开天劈地！$br#[2;37;0m这是一柄由无比坚硬的[31m流花石[2;37;0m制成，重十二斤五两九钱的[1;36m天地之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [1;34m电[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m [1;36m人[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/blade", 22);
    //set("weapon_prop/whip", 22);
    //set("weapon_prop/staff", 0);
    set("weapon_prop/force", 34);
...
//特效数值
    ...
    set("weapon_prop/kf_hit_rate", 16);
...
//伤害防御类
    ...
    set("weapon_prop/armor_vs_force", 13);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 24);
