// yunti_wrists.c
// Create by TEMPLATE_D. Thu Nov 10 21:15:34 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m云梯之护腕[2;37;0m", ({ "yunti wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[37m云梯之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两五钱的[37m云梯之护腕[2;37;0m。$br#
