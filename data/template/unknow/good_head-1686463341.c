// good_head.c
// Create by TEMPLATE_D. Sat Oct 09 11:39:12 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m紫云之头盔[2;37;0m", ({ "good head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
紫云之头盔[2;37;0m这是一顶由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两四钱的[1;31m紫云之头盔[2;37;0m。$br#
