// good_armor.c
// Create by TEMPLATE_D. Sun Nov 13 15:01:03 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m玉皇之披风[2;37;0m", ({ "good armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
玉皇之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两三钱的[31m玉皇之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m [1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#
