// ningshuang_blade.c
// Create by TEMPLATE_D. Thu Oct 07 10:00:43 2021.
// gangjian.c
...
void create()
{
	set_name("[36m凝霜之刀[2;37;0m", ({ "ningshuang blade" }));
	set_weight(14793);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","[36m凝霜之刀[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重二十九斤五两八钱的[36m凝霜之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m [1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
