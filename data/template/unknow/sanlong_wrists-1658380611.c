// sanlong_wrists.c
// Create by TEMPLATE_D. Wed Oct 13 10:39:59 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m三龙之护腕[2;37;0m", ({ "sanlong wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[35m三龙之护腕[2;37;0m这是一双由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤零两一钱的[35m三龙之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m [37m天[2;37;0m:[1;31m创世[2;37;0m 
