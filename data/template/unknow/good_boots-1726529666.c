// good_boots.c
// Create by TEMPLATE_D. Thu Oct 07 23:41:33 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[34m地锋之靴[2;37;0m", ({ "good boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
地锋之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤一两七钱的[34m地锋之靴[2;37;0m。$br#
