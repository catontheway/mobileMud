// pixie_surcoat.c
// Create by TEMPLATE_D. Sat Oct 09 11:48:49 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m辟邪之肚带[2;37;0m", ({ "pixie surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;31m辟邪之肚带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两四钱的[1;31m辟邪之肚带[2;37;0m。$br#
...
//伤害防御类
    ...
    set("armor_prop/abs_week_injure", 13);
    ...
    set("armor_prop/attack_speed", 0);
     ...
     set("armor_prop/dodge_factor", 16);
//气血恢复治疗类
