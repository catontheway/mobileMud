// zhanlu_boots.c
// Create by TEMPLATE_D. Thu Oct 21 11:39:07 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m湛卢之靴[2;37;0m", ({ "zhanlu boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤五两七钱的[31m湛卢之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_confuse", 25);
