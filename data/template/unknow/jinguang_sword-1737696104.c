// jinguang_sword.c
// Create by TEMPLATE_D. Wed Nov 09 10:11:03 2022.
// gangjian.c
...
void create()
{
	set_name("[33m金光之剑[2;37;0m", ({ "jinguang sword" }));
	set_weight(2054);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[33m金光之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重四斤一两零钱的[33m金光之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_all_busy", 5);
