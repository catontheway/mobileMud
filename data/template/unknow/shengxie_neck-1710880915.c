// shengxie_neck.c
// Create by TEMPLATE_D. Wed Oct 06 16:39:10 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m胜邪之项链[2;37;0m", ({ "shengxie neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一串由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤九两七钱的[31m胜邪之项链[2;37;0m。$br#
