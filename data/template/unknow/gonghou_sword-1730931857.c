// gonghou_sword.c
// Create by TEMPLATE_D. Thu Oct 07 10:01:54 2021.
// gangjian.c
...
void create()
{
	set_name("[34m公侯之剑[2;37;0m", ({ "gonghou sword" }));
	set_weight(8806);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[34m公侯之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重十七斤六两一钱的[34m公侯之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
