// wuji_waist.c
// Create by TEMPLATE_D. Wed Oct 06 17:06:16 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m无极之腰带[2;37;0m", ({ "wuji waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;32m此物已达出神入化，登峰造极，神乎其神之境界！俗说万物归宗，便是这“无极”！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤六两六钱的[1;32m无极之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;35m绝世[2;37;0m 
