// tianlong_club.c
// Create by TEMPLATE_D. Thu Oct 21 11:40:02 2021.
// gangjian.c
...
void create()
{
	set_name("[35m天龙之棍[2;37;0m", ({ "tianlong club" }));
	set_weight(1880);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","[35m天龙之棍[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重三斤七两六钱的[35m天龙之棍[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
