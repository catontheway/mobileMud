// general_boots.c
// Create by TEMPLATE_D. Wed Oct 13 10:42:12 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m聚泉之靴[2;37;0m", ({ "general boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
聚泉之靴[2;37;0m这是一双由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两六钱的[1;31m聚泉之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[35m标准[2;37;0m 
