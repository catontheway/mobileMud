// general_shield.c
// Create by TEMPLATE_D. Sat Oct 09 23:57:05 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m四季之盾[2;37;0m", ({ "general shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
四季之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤一两一钱的[1;32m四季之盾[2;37;0m。$br#
