// tianquan_waist.c
// Create by TEMPLATE_D. Thu Oct 07 18:41:46 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m天权之腰带[2;37;0m", ({ "tianquan waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[35m天权之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两五钱的[35m天权之腰带[2;37;0m。$br#
