// bagua_hands.c
// Create by TEMPLATE_D. Mon Oct 11 18:04:28 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;37m八卦之手套[2;37;0m", ({ "bagua hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[1;37m八卦有“休”“生”“伤”“杜”“死”“景”“惊”“开”之别，创自诸葛武候，集天下万变于一身！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤三两七钱的[1;37m八卦之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [32m水[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 10);
    set("armor_prop/max_busy_jiemai", 0);
    set("armor_prop/max_busy_fenjin", 0);
    set("armor_prop/max_busy_confuse", 8);
    set("armor_prop/max_busy_body", 0);
    set("armor_prop/AllPoisonsImmune", 16);
    set("armor_prop/PoisonAttack", 0);
    set("armor_prop/kf_hit_rate", 12);
