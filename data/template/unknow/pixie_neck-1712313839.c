// pixie_neck.c
// Create by TEMPLATE_D. Tue Nov 15 18:57:28 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m辟邪之项链[2;37;0m", ({ "pixie neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[1;31m辟邪之项链[2;37;0m这是一串由相当坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两六钱的[1;31m辟邪之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m [1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#[1;37m雷[2;37;0m:[1;31m无双[2;37;0m [1;36m人[2;37;0m:[35m标准[2;37;0m 
