...
void create()
{
	set_name("[1;34m黑龙之护腕[2;37;0m", ({ "heilong wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;34m黑龙之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤三两一钱的[1;34m黑龙之护腕[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/cant_busy_confuse", 7);
