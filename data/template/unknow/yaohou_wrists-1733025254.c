// yaohou_wrists.c
// Create by TEMPLATE_D. Sun Oct 10 00:24:25 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m妖后之护腕[2;37;0m", ({ "yaohou wrists" }));
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[36m妖后之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两零钱的[36m妖后之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;31m开元[2;37;0m 
