// general_wrists.c
// Create by TEMPLATE_D. Thu Oct 07 23:36:08 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m丹陽之护腕[2;37;0m", ({ "general wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
丹陽之护腕[2;37;0m这是一双由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤一两七钱的[1;32m丹陽之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;34m举世[2;37;0m $br#[1;34m电[2;37;0m:[33m很高[2;37;0m 
