// difeng_sword.c
// Create by TEMPLATE_D. Fri Oct 08 10:05:55 2021.
// gangjian.c
...
void create()
{
	set_name("[32m地凤之剑[2;37;0m", ({ "difeng sword" }));
	set_weight(14745);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[32m地凤之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二十九斤四两九钱的[32m地凤之剑[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
