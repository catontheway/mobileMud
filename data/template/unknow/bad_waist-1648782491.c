// bad_waist.c
// Create by TEMPLATE_D. Thu Oct 07 19:36:43 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m怪之腰带[2;37;0m", ({ "bad waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
怪之腰带[2;37;0m这是一条由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤三两九钱的[1;33m怪之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[33m很高[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#
