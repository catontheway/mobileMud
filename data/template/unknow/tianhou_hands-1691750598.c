// tianhou_hands.c
// Create by TEMPLATE_D. Sun Oct 10 01:23:20 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m天后之手套[2;37;0m", ({ "tianhou hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[36m天后之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤七两一钱的[36m天后之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 6);
