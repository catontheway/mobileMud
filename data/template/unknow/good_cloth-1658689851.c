// good_cloth.c
// Create by TEMPLATE_D. Sat Oct 09 01:43:55 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m雁翎之服装[2;37;0m", ({ "good cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
雁翎之服装[2;37;0m这是一件由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重三斤一两六钱的[33m雁翎之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;34m举世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_body", 3);
