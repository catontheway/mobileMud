// lanhong_hammer.c
// Create by TEMPLATE_D. Thu Oct 07 16:55:11 2021.
// gangjian.c
...
void create()
{
	set_name("[36m蓝虹之锤[2;37;0m", ({ "lanhong hammer" }));
	set_weight(5444);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","[36m蓝虹之锤[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重十斤八两八钱的[36m蓝虹之锤[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [32m水[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_fenjin", 11);
    set("weapon_prop/cant_busy_confuse", 12);
    ...
    set("weapon_prop/max_busy_fenjin", 14);
