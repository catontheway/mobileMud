// xuling_wrists.c
// Create by TEMPLATE_D. Fri Oct 08 10:45:22 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m虚灵之护腕[2;37;0m", ({ "xuling wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[37m虚灵之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两五钱的[37m虚灵之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;35m绝世[2;37;0m 
