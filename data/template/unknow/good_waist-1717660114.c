// good_waist.c
// Create by TEMPLATE_D. Sat Oct 09 19:58:59 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m狮吼之腰带[2;37;0m", ({ "good waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
狮吼之腰带[2;37;0m这是一条由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤四两四钱的[33m狮吼之腰带[2;37;0m。$br#
