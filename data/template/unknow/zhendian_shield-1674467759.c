// zhendian_shield.c
// Create by TEMPLATE_D. Sat Oct 09 19:31:44 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m震电之盾[2;37;0m", ({ "zhendian shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[37m震电之盾[2;37;0m这是一面由十分坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤六两七钱的[37m震电之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;35m绝世[2;37;0m 
