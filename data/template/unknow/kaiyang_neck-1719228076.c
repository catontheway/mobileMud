// kaiyang_neck.c
// Create by TEMPLATE_D. Sun Oct 10 06:54:12 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m开阳之项链[2;37;0m", ({ "kaiyang neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[35m开阳之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤六两二钱的[35m开阳之项链[2;37;0m。$br#
