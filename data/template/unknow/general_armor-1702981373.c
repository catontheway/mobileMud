// general_armor.c
// Create by TEMPLATE_D. Sat Oct 09 23:57:44 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m風信之披风[2;37;0m", ({ "general armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
風信之披风[2;37;0m这是一件由比较坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两二钱的[31m風信之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [37m天[2;37;0m:[1;32m魔王[2;37;0m 
