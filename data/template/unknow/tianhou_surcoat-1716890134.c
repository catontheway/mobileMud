// tianhou_surcoat.c
// Create by TEMPLATE_D. Fri Oct 08 23:17:15 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m天后之肚带[2;37;0m", ({ "tianhou surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[36m天后之肚带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两五钱的[36m天后之肚带[2;37;0m。$br#
