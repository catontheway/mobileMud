// general_shield.c
// Create by TEMPLATE_D. Wed Nov 16 12:36:45 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m饕餮之盾[2;37;0m", ({ "general shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
饕餮之盾[2;37;0m这是一面由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤三两七钱的[1;33m饕餮之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;33m天圣[2;37;0m 
