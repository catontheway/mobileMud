// wuyi_surcoat.c
// Create by TEMPLATE_D. Sat Oct 09 09:20:57 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m武翼之肚带[2;37;0m", ({ "wuyi surcoat" }));
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;32m武翼之肚带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两三钱的[1;32m武翼之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;31m无双[2;37;0m 
