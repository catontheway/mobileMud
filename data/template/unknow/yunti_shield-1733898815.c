// yunti_shield.c
// Create by TEMPLATE_D. Mon Oct 18 08:19:26 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m云梯之盾[2;37;0m", ({ "yunti shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[37m云梯之盾[2;37;0m这是一面由绝对坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤三两七钱的[37m云梯之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;33m天圣[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/AllPoisonsImmune", 10);
