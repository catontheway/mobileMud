// yunti_cloth.c
// Create by TEMPLATE_D. Wed Oct 06 16:39:06 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m云梯之服装[2;37;0m", ({ "yunti cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[37m云梯之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两一钱的[37m云梯之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 16);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 19);
