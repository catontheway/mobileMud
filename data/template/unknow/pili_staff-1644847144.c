// pili_staff.c
// Create by TEMPLATE_D. Sun Oct 24 18:04:38 2021.
// gangjian.c
...
void create()
{
	set_name("[37m霹雳之杖[2;37;0m", ({ "pili staff" }));
	set_weight(6237);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","[37m霹雳之杖[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重十二斤四两七钱的[37m霹雳之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;34m举世[2;37;0m [37m天[2;37;0m:[1;31m开元[2;37;0m [1;36m人[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
 ...
 //先天类    
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 0);
    ...
    //set("weapon_prop/blade", 36);
    //set("weapon_prop/whip", 0);
    //set("weapon_prop/staff", 0);
    set("weapon_prop/force", 19);
...
//特效数值
    ...
    set("weapon_prop/AllPoisonsImmune", 7);
