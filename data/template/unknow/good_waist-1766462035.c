// good_waist.c
// Create by TEMPLATE_D. Sun Nov 13 14:58:06 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;34m冬梅之腰带[2;37;0m", ({ "good waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
冬梅之腰带[2;37;0m这是一条由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两一钱的[1;34m冬梅之腰带[2;37;0m。$br#
