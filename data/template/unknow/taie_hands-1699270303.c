// taie_hands.c
// Create by TEMPLATE_D. Thu Nov 10 17:39:22 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m太阿之手套[2;37;0m", ({ "taie hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤三两三钱的[31m太阿之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/armor_effect_armor_vs_force", 29);
