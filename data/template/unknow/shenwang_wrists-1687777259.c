// shenwang_wrists.c
// Create by TEMPLATE_D. Thu Oct 07 11:51:04 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m神王之护腕[2;37;0m", ({ "shenwang wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[36m神王之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤零两八钱的[36m神王之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m开元[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m 
