// pojia_wrists.c
// Create by TEMPLATE_D. Mon Oct 11 23:10:14 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m破甲之护腕[2;37;0m", ({ "pojia wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;32m破甲之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两一钱的[1;32m破甲之护腕[2;37;0m。$br#
