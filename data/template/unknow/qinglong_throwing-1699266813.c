// qinglong_throwing.c
// Create by TEMPLATE_D. Wed Oct 06 22:38:47 2021.
// gangjian.c
...
void create()
{
	set_name("[1;36m青龙之暗器[2;37;0m", ({ "qinglong throwing" }));
	set_weight(572);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "支");
		set("long","[1;36m青龙之暗器[2;37;0m这是一支由无比坚硬的[1;32m绿石[2;37;0m制成，重一斤一两四钱的[1;36m青龙之暗器[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[31m精致[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
