// jiulong_armor.c
// Create by TEMPLATE_D. Sat Oct 09 21:44:00 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m九龙之披风[2;37;0m", ({ "jiulong armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[35m九龙之披风[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两九钱的[35m九龙之披风[2;37;0m。$br#
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 23);
    set("armor_prop/qi_recover", 0);
    set("armor_prop/jing_recover", 0);
    set("armor_prop/jingli_recover", 31);
