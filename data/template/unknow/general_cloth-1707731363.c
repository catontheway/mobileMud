// general_cloth.c
// Create by TEMPLATE_D. Sat Oct 09 00:30:50 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m風鈴之服装[2;37;0m", ({ "general cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
風鈴之服装[2;37;0m这是一件由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重二斤九两四钱的[33m風鈴之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m 
