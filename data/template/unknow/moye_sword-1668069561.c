// moye_sword.c
// Create by TEMPLATE_D. Wed Oct 06 16:34:25 2021.
// gangjian.c
...
void create()
{
	set_name("[31m莫邪之剑[2;37;0m", ({ "moye sword" }));
	set_weight(12829);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重二十五斤六两五钱的[31m莫邪之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m创世[2;37;0m [36m木[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//特效数值
    set("weapon_prop/kf_def_wound", 5);
    set("weapon_prop/kf_wound", 5);
    set("weapon_prop/cant_all_busy", 8);
    set("weapon_prop/cant_busy_dianxue", 9);
    ...
    set("weapon_prop/max_busy_dianxue", 13);
    set("weapon_prop/max_busy_jiemai", 6);
    set("weapon_prop/max_busy_fenjin", 0);
    set("weapon_prop/max_busy_confuse", 11);
    set("weapon_prop/max_busy_body", 9);
    set("weapon_prop/AllPoisonsImmune", 13);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 11);
     ...
     set("weapon_prop/dodge_factor", 6);
//气血恢复治疗类
    ...
    set("weapon_prop/qi_cure", 50);
    set("weapon_prop/jing_cure", 40);
