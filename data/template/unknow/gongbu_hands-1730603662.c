// gongbu_hands.c
// Create by TEMPLATE_D. Mon Sep 20 16:10:18 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m工布之手套[2;37;0m", ({ "gongbu hands" }));
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤一两七钱的[31m工布之手套[2;37;0m。$br#
