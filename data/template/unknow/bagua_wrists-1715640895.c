// bagua_wrists.c
// Create by TEMPLATE_D. Fri Oct 08 22:07:41 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;37m八卦之护腕[2;37;0m", ({ "bagua wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;37m八卦有“休”“生”“伤”“杜”“死”“景”“惊”“开”之别，创自诸葛武候，集天下万变于一身！$br#[2;37;0m这是一双由极其坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤九两二钱的[1;37m八卦之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;31m开元[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 20);
     ...
     set("armor_prop/dodge_factor", 20);
//气血恢复治疗类
