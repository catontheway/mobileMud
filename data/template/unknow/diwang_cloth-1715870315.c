// diwang_cloth.c
// Create by TEMPLATE_D. Wed Oct 06 21:19:53 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m帝王之服装[2;37;0m", ({ "diwang cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[36m帝王之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤五两一钱的[36m帝王之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m天圣[2;37;0m 
