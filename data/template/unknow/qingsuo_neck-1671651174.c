// qingsuo_neck.c
// Create by TEMPLATE_D. Thu Oct 07 17:56:39 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m青索之项链[2;37;0m", ({ "qingsuo neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[36m青索之项链[2;37;0m这是一串由十分坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两七钱的[36m青索之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    set("armor_prop/kf_def_wound", 18);
