// lanhong_surcoat.c
// Create by TEMPLATE_D. Fri Oct 08 15:04:43 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m蓝虹之肚带[2;37;0m", ({ "lanhong surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[36m蓝虹之肚带[2;37;0m这是一条由极为坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤零两五钱的[36m蓝虹之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;36m完美[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_fenjin", 8);
