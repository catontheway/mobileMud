// yecha_head.c
// Create by TEMPLATE_D. Tue Nov 15 18:53:34 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m夜叉之头盔[2;37;0m", ({ "yecha head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[33m夜叉之头盔[2;37;0m这是一顶由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两三钱的[33m夜叉之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;31m开元[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_jiemai", 15);
