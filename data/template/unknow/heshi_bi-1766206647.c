// heshi_bi.c
// Create by TEMPLATE_D. Tue Nov 15 10:01:10 2022.
// sl_cloth.c
...
void create()
{
	...
	set("long", "[1;35m这是一块和氏璧，有[u:cmds:xu neili][s:20]注入[2;37;0m(xu neili)和[u:cmds:xi neili][s:20]汲取[2;37;0m(xi neili)的功效。[2;37;0m
[1;37m和[1;32m氏[1;34m璧[2;37;0m[1;35m之内已经蓄有十二道内力！[2;37;0m
");
                set("jhxk", 50);
	set("no_put", 1);
                set("no_get", 1);
