// shengxie_hands.c
// Create by TEMPLATE_D. Sun Oct 17 00:44:26 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m胜邪之手套[2;37;0m", ({ "shengxie hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤一两五钱的[31m胜邪之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m 
...
LONG
	...
	set("no_drop", 1);
	  ...
	  set("systemmake",1);
		set("value", 36000);
                  //  基础类
  set("forge/max", 258);
  set("forge/times_max", 258);
  set("level", 258);

     set("armor_prop/damage", 258);
     set("armor_prop/attack", 0);
     set("armor_prop/defense", 0);
     set("armor_prop/armor", 47);
     set("armor_prop/magic", 34);
 ...
 //先天类    
    ...
    set("armor_prop/force", 31);
    set("armor_prop/dagge", 18);
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 23);
    set("armor_prop/max_busy_jiemai", 18);
...
//伤害防御类
    set("armor_prop/deep_injure", 19);
    set("armor_prop/week_injure", 18);
    set("armor_prop/abs_week_injure", 0);
    set("armor_prop/defense_attack", 20);
