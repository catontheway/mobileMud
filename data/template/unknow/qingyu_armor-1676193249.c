// qingyu_armor.c
// Create by TEMPLATE_D. Sat Nov 12 21:27:28 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m青玉之披风[2;37;0m", ({ "qingyu armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[37m青玉之披风[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤三两零钱的[37m青玉之披风[2;37;0m。$br#
