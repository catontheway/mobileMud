// yaohou_boots.c
// Create by TEMPLATE_D. Thu Oct 07 10:33:23 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m妖后之靴[2;37;0m", ({ "yaohou boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[36m妖后之靴[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两一钱的[36m妖后之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;31m无双[2;37;0m $br#
