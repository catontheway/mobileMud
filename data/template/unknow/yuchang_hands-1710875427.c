// yuchang_hands.c
// Create by TEMPLATE_D. Sun Nov 13 15:01:51 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m鱼肠之手套[2;37;0m", ({ "yuchang hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤四两零钱的[31m鱼肠之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 26);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 13);
