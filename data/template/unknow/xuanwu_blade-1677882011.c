// xuanwu_blade.c
// Create by TEMPLATE_D. Thu Oct 07 18:03:10 2021.
// gangjian.c
...
void create()
{
	set_name("[1;34m玄武之刀[2;37;0m", ({ "xuanwu blade" }));
	set_weight(6008);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","[1;34m玄武之刀[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重十二斤零两一钱的[1;34m玄武之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m创世[2;37;0m [1;34m电[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
