// niaoxiang_blade.c
// Create by TEMPLATE_D. Fri Oct 15 20:18:14 2021.
// gangjian.c
...
void create()
{
	set_name("[1;32m鸟翔之刀[2;37;0m", ({ "niaoxiang blade" }));
	set_weight(8969);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","[1;32m鸟翔之刀[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重十七斤九两三钱的[1;32m鸟翔之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
