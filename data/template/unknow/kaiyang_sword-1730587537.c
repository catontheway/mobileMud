// kaiyang_sword.c
// Create by TEMPLATE_D. Wed Oct 06 23:25:10 2021.
// gangjian.c
...
void create()
{
	set_name("[35m开阳之剑[2;37;0m", ({ "kaiyang sword" }));
	set_weight(3576);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[35m开阳之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重七斤一两五钱的[35m开阳之剑[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
