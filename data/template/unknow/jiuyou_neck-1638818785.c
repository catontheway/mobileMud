// jiuyou_neck.c
// Create by TEMPLATE_D. Thu Oct 07 12:05:46 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m九幽之项链[2;37;0m", ({ "jiuyou neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[1;32m九幽之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两九钱的[1;32m九幽之项链[2;37;0m。$br#
