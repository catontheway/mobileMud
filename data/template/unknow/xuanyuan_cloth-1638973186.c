...
void create()
{
	set_name("[1;35m轩辕之服装[2;37;0m", ({ "xuanyuan cloth" }));
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;35m昔日黄帝持此物立于指南车上，驱迷雾，扫阴霾，率应龙旱魃，御百兽而战蚩尤！$br#[2;37;0m这是一件由极其坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重二斤零两四钱的[1;35m轩辕之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_fenjin", 21);
    set("armor_prop/max_busy_confuse", 0);
    set("armor_prop/max_busy_body", 0);
    set("armor_prop/AllPoisonsImmune", 15);
