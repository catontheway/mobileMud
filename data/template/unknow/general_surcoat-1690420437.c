// general_surcoat.c
// Create by TEMPLATE_D. Fri Oct 08 16:28:28 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m玫瑰之肚带[2;37;0m", ({ "general surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
玫瑰之肚带[2;37;0m这是一条由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两八钱的[36m玫瑰之肚带[2;37;0m。$br#
