// good_boots.c
// Create by TEMPLATE_D. Thu Nov 10 20:19:41 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[34m神鹰之靴[2;37;0m", ({ "good boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
神鹰之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤一两五钱的[34m神鹰之靴[2;37;0m。$br#
