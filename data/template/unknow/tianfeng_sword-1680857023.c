// tianfeng_sword.c
// Create by TEMPLATE_D. Sat Oct 09 17:07:35 2021.
// gangjian.c
...
void create()
{
	set_name("[32m天凤之剑[2;37;0m", ({ "tianfeng sword" }));
	set_weight(9296);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[32m天凤之剑[2;37;0m这是一把由极其坚硬的[1;32m绿石[2;37;0m制成，重十八斤五两九钱的[32m天凤之剑[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
