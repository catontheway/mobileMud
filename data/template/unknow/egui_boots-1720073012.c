// egui_boots.c
// Create by TEMPLATE_D. Thu Oct 07 07:39:18 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[34m恶鬼之靴[2;37;0m", ({ "egui boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[34m恶鬼之靴[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两三钱的[34m恶鬼之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#
