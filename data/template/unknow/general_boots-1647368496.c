// general_boots.c
// Create by TEMPLATE_D. Sat Oct 09 14:24:06 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m聚泉之靴[2;37;0m", ({ "general boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
聚泉之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两四钱的[1;33m聚泉之靴[2;37;0m。$br#
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 16);
