// fengyun_boots.c
// Create by TEMPLATE_D. Sat Oct 09 12:18:34 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m风云之靴[2;37;0m", ({ "fengyun boots" }));
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;35m所谓风云际会，天地变色！仗此行千里，老魔小丑，岂堪一击！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤三两七钱的[1;35m风云之靴[2;37;0m。$br#
