...
void create()
{
	set_name("[1;35m轩辕之腰带[2;37;0m", ({ "xuanyuan waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;35m昔日黄帝持此物立于指南车上，驱迷雾，扫阴霾，率应龙旱魃，御百兽而战蚩尤！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤九两一钱的[1;35m轩辕之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m创世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/kf_wound", 18);
    set("armor_prop/cant_all_busy", 0);
    set("armor_prop/cant_busy_dianxue", 17);
