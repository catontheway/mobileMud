// fenghuang_sword.c
// Create by TEMPLATE_D. Fri Oct 08 10:39:43 2021.
// gangjian.c
...
void create()
{
	set_name("[35m凤凰之剑[2;37;0m", ({ "fenghuang sword" }));
	set_weight(15259);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[35m凤凰之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重三十斤五两一钱的[35m凤凰之剑[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
