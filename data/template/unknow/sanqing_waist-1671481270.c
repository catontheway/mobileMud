// sanqing_waist.c
// Create by TEMPLATE_D. Sat Oct 09 18:35:23 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m三清之腰带[2;37;0m", ({ "sanqing waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;36m大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤九两七钱的[1;36m三清之腰带[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/max_busy_fenjin", 25);
