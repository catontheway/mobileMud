// good_wrists.c
// Create by TEMPLATE_D. Mon Oct 11 01:25:11 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;34m卷云之护腕[2;37;0m", ({ "good wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
卷云之护腕[2;37;0m这是一双由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两一钱的[1;34m卷云之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;35m绝世[2;37;0m [1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [37m天[2;37;0m:[1;31m无双[2;37;0m 
