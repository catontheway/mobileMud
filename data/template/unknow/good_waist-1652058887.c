// good_waist.c
// Create by TEMPLATE_D. Thu Oct 07 22:39:39 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m飞燕之腰带[2;37;0m", ({ "good waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
飞燕之腰带[2;37;0m这是一条由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两二钱的[1;33m飞燕之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
