// qinghong_head.c
// Create by TEMPLATE_D. Thu Oct 07 11:34:09 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m青虹之头盔[2;37;0m", ({ "qinghong head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[36m青虹之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两三钱的[36m青虹之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/hammer", 17);
    set("armor_prop/spear", 12);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     set("armor_prop/attack_factor", 21);
