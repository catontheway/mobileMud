// haoqi_dagger.c
// Create by TEMPLATE_D. Thu Oct 07 13:41:02 2021.
// gangjian.c
...
void create()
{
	set_name("[1;32m浩气之匕首[2;37;0m", ({ "haoqi dagger" }));
	set_weight(14837);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[1;32m天地浩气之神兵，扫魔除妖，为国为民，侠之大者！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重二十九斤六两七钱的[1;32m浩气之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_confuse", 10);
