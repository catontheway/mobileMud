// luyu_head.c
// Create by TEMPLATE_D. Wed Oct 06 18:17:57 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m绿玉之头盔[2;37;0m", ({ "luyu head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[37m绿玉之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两一钱的[37m绿玉之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
