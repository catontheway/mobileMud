// huanglong_armor.c
// Create by TEMPLATE_D. Sat Oct 09 12:19:51 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m黄龙之披风[2;37;0m", ({ "huanglong armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[33m黄龙之披风[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两一钱的[33m黄龙之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;33m灭世[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/qi_recover", 14);
    set("armor_prop/jing_recover", 0);
    set("armor_prop/jingli_recover", 13);
