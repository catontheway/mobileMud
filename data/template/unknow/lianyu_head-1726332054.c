// lianyu_head.c
// Create by TEMPLATE_D. Mon Oct 18 12:27:07 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m炼狱之头盔[2;37;0m", ({ "lianyu head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;31m三十三天下有地，地下有城，城名鬼城，大小妖魔，人神畜生都在此轮回往返，谓之“炼狱”！$br#[2;37;0m这是一顶由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤零两零钱的[1;31m炼狱之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m无双[2;37;0m 
