// taifeng_shield.c
// Create by TEMPLATE_D. Sat Oct 09 11:07:24 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m太风之盾[2;37;0m", ({ "taifeng shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[37m太风之盾[2;37;0m这是一面由相当坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤八两七钱的[37m太风之盾[2;37;0m。$br#
