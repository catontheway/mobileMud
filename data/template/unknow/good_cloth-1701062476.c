// good_cloth.c
// Create by TEMPLATE_D. Thu Oct 07 22:34:10 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m五步之服装[2;37;0m", ({ "good cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
五步之服装[2;37;0m这是一件由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤八两七钱的[1;31m五步之服装[2;37;0m。$br#
