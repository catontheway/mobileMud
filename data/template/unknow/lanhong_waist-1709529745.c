// lanhong_waist.c
// Create by TEMPLATE_D. Fri Oct 08 07:34:50 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m蓝虹之腰带[2;37;0m", ({ "lanhong waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[36m蓝虹之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两九钱的[36m蓝虹之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;34m举世[2;37;0m [1;37m雷[2;37;0m:[1;35m绝世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/cuff", 34);
    set("armor_prop/dodge", 0);
    set("armor_prop/finger", 0);
    set("armor_prop/hand", 35);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 23);
