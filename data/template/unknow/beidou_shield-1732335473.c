// beidou_shield.c
// Create by TEMPLATE_D. Sun Oct 10 00:28:25 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m北斗之盾[2;37;0m", ({ "beidou shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[35m北斗之盾[2;37;0m这是一面由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重三斤一两五钱的[35m北斗之盾[2;37;0m。$br#
