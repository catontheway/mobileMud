// qilin_shield.c
// Create by TEMPLATE_D. Wed Oct 06 20:59:23 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m麒麟之盾[2;37;0m", ({ "qilin shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[1;31m麒麟之盾[2;37;0m这是一面由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤九两四钱的[1;31m麒麟之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;31m无双[2;37;0m [1;31m魔[2;37;0m:[1;31m开元[2;37;0m 
...
LONG
 ...
 //先天类    
		...
		set("armor_prop/personality",14);
    set("armor_prop/spirituality", 14);
		set("armor_prop/dexerity",0);
		set("armor_prop/constitution",0);
    //技能类
    set("armor_prop/claw", 0);
    set("armor_prop/cuff", 16);
    set("armor_prop/dodge", 0);
    set("armor_prop/finger", 0);
    set("armor_prop/hand", 19);
    set("armor_prop/parry", 0);
    set("armor_prop/strike", 19);
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 8);
