// good_armor.c
// Create by TEMPLATE_D. Wed Oct 06 16:16:21 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m夏荷之披风[2;37;0m", ({ "good armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
夏荷之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两三钱的[1;33m夏荷之披风[2;37;0m。$br#
