// good_hands.c
// Create by TEMPLATE_D. Sat Oct 09 16:26:15 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m啸天之手套[2;37;0m", ({ "good hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
啸天之手套[2;37;0m这是一副由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两三钱的[37m啸天之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m无双[2;37;0m 
	...
	set("no_drop", 1);
	  ...
	  set("systemmake",1);
		set("value", 9000);
                  //  基础类
  set("forge/max", 166);
  set("forge/times_max", 166);
  set("level", 166);

     set("armor_prop/damage", 166);
