// good_neck.c
// Create by TEMPLATE_D. Sun Nov 13 15:03:37 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m芙蓉之项链[2;37;0m", ({ "good neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
芙蓉之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两一钱的[35m芙蓉之项链[2;37;0m。$br#
