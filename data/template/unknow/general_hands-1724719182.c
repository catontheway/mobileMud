// general_hands.c
// Create by TEMPLATE_D. Thu Oct 07 08:44:51 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m聚鹤之手套[2;37;0m", ({ "general hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
聚鹤之手套[2;37;0m这是一副由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤九两零钱的[36m聚鹤之手套[2;37;0m。$br#
