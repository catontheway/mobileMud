// baihong_head.c
// Create by TEMPLATE_D. Sun Oct 10 00:22:12 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m白虹之头盔[2;37;0m", ({ "baihong head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[36m白虹之头盔[2;37;0m这是一顶由绝对坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两四钱的[36m白虹之头盔[2;37;0m。$br#
