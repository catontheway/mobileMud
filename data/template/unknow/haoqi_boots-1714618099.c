// haoqi_boots.c
// Create by TEMPLATE_D. Thu Oct 07 18:40:52 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m浩气之靴[2;37;0m", ({ "haoqi boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;32m天地浩气之神兵，扫魔除妖，为国为民，侠之大者！$br#[2;37;0m这是一双由极为坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤七两一钱的[1;32m浩气之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 13);
    ...
    set("armor_prop/max_all_busy", 18);
