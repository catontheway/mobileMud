// general_wrists.c
// Create by TEMPLATE_D. Wed Oct 06 20:48:36 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m双星之护腕[2;37;0m", ({ "general wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
双星之护腕[2;37;0m这是一双由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两六钱的[31m双星之护腕[2;37;0m。$br#
