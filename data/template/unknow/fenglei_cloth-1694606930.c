// fenglei_cloth.c
// Create by TEMPLATE_D. Sat Oct 09 18:31:46 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m风雷之服装[2;37;0m", ({ "fenglei cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[37m风雷之服装[2;37;0m这是一件由相当坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两四钱的[37m风雷之服装[2;37;0m。$br#
