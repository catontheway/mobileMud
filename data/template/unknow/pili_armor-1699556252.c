// pili_armor.c
// Create by TEMPLATE_D. Wed Oct 06 21:22:28 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m霹雳之披风[2;37;0m", ({ "pili armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[37m霹雳之披风[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤七两零钱的[37m霹雳之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_body", 13);
