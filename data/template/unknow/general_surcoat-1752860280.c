// general_surcoat.c
// Create by TEMPLATE_D. Sun Nov 13 15:00:12 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m望霞之肚带[2;37;0m", ({ "general surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
望霞之肚带[2;37;0m这是一条由相当坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤零两九钱的[1;35m望霞之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
