// good_boots.c
// Create by TEMPLATE_D. Sat Oct 09 01:44:41 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m神水之靴[2;37;0m", ({ "good boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
神水之靴[2;37;0m这是一双由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤一两二钱的[1;33m神水之靴[2;37;0m。$br#
