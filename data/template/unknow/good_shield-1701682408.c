// good_shield.c
// Create by TEMPLATE_D. Wed Oct 27 20:08:29 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m朝云之盾[2;37;0m", ({ "good shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
朝云之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤八两八钱的[35m朝云之盾[2;37;0m。$br#
