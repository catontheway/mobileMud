// dilong_dagger.c
// Create by TEMPLATE_D. Wed Oct 06 15:51:53 2021.
// gangjian.c
...
void create()
{
	set_name("[32m地龙之匕首[2;37;0m", ({ "dilong dagger" }));
	set_weight(9294);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[32m地龙之匕首[2;37;0m这是一把由极为坚硬的[1;32m绿石[2;37;0m制成，重十八斤五两八钱的[32m地龙之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;32m魔王[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//伤害防御类
    ...
    set("weapon_prop/attack_speed", 0);
     ...
     set("weapon_prop/parry_factor", 3);
