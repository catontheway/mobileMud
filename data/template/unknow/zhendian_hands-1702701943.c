// zhendian_hands.c
// Create by TEMPLATE_D. Mon Oct 18 08:17:42 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m震电之手套[2;37;0m", ({ "zhendian hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[37m震电之手套[2;37;0m这是一副由十分坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤三两五钱的[37m震电之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m [37m天[2;37;0m:[1;31m无双[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 4);
    set("armor_prop/max_busy_jiemai", 0);
    set("armor_prop/max_busy_fenjin", 12);
