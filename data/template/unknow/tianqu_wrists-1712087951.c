// tianqu_wrists.c
// Create by TEMPLATE_D. Tue Nov 15 19:00:35 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m天枢之护腕[2;37;0m", ({ "tianqu wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[35m天枢之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两六钱的[35m天枢之护腕[2;37;0m。$br#
