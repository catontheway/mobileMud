// shengsi_neck.c
// Create by TEMPLATE_D. Fri Nov 11 07:36:54 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m生死之项链[2;37;0m", ({ "shengsi neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[37m生死之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两六钱的[37m生死之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[31m精致[2;37;0m [1;36m人[2;37;0m:[1;31m开元[2;37;0m 
