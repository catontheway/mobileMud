// lanyu_hands.c
// Create by TEMPLATE_D. Thu Oct 07 18:12:18 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m蓝玉之手套[2;37;0m", ({ "lanyu hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[37m蓝玉之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两三钱的[37m蓝玉之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m开元[2;37;0m 
	...
	set("no_drop", 1);
	  ...
	  set("systemmake",1);
		set("value", 16000);
                  //  基础类
  set("forge/max", 194);
  set("forge/times_max", 194);
  set("level", 194);

     set("armor_prop/damage", 194);
