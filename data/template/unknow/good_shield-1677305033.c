// good_shield.c
// Create by TEMPLATE_D. Fri Nov 11 14:51:27 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;37m神豹之盾[2;37;0m", ({ "good shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
神豹之盾[2;37;0m这是一面由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤二两二钱的[1;37m神豹之盾[2;37;0m。$br#
