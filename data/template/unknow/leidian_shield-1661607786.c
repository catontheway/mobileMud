// leidian_shield.c
// Create by TEMPLATE_D. Fri Oct 08 21:22:19 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m雷电之盾[2;37;0m", ({ "leidian shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[37m雷电之盾[2;37;0m这是一面由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤八两七钱的[37m雷电之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m无双[2;37;0m 
