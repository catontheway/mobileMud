// taie_neck.c
// Create by TEMPLATE_D. Thu Nov 10 20:08:06 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m太阿之项链[2;37;0m", ({ "taie neck" }));
        ...
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一串由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤八两七钱的[31m太阿之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;31m开元[2;37;0m 
