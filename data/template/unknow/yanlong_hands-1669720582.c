// yanlong_hands.c
// Create by TEMPLATE_D. Fri Oct 08 11:42:56 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m炎龙之手套[2;37;0m", ({ "yanlong hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[1;31m炎龙之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两五钱的[1;31m炎龙之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;32m魔王[2;37;0m [33m土[2;37;0m:[1;35m绝世[2;37;0m 
	...
	set("no_drop", 1);
	  ...
	  set("systemmake",1);
		set("value", 16000);
                  //  基础类
  set("forge/max", 206);
  set("forge/times_max", 206);
  set("level", 206);

     set("armor_prop/damage", 206);
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 5);
    set("armor_prop/cant_busy_fenjin", 0);
    set("armor_prop/cant_busy_confuse", 0);
    set("armor_prop/cant_busy_body", 6);
    set("armor_prop/max_all_busy", 0);
    set("armor_prop/max_busy_dianxue", 12);
    ...
    set("armor_prop/AllPoisonsImmune", 9);
    set("armor_prop/PoisonAttack", 12);
    set("armor_prop/kf_hit_rate", 0);
    set("armor_prop/kf_anti_hr", 0);
//伤害防御类
    set("armor_prop/deep_injure", 5);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 18);
