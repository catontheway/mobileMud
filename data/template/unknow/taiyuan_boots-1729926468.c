// taiyuan_boots.c
// Create by TEMPLATE_D. Thu Oct 07 19:50:27 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m太渊之靴[2;37;0m", ({ "taiyuan boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[37m太渊之靴[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两七钱的[37m太渊之靴[2;37;0m。$br#
