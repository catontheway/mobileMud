// zihong_neck.c
// Create by TEMPLATE_D. Sun Oct 10 00:23:32 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m紫虹之项链[2;37;0m", ({ "zihong neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[36m紫虹之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两二钱的[36m紫虹之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m创世[2;37;0m 
