// xuanyuan_neck.c
// Create by TEMPLATE_D. Tue Oct 12 08:34:30 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m轩辕之项链[2;37;0m", ({ "xuanyuan neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[1;35m昔日黄帝持此物立于指南车上，驱迷雾，扫阴霾，率应龙旱魃，御百兽而战蚩尤！$br#[2;37;0m这是一串由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤二两四钱的[1;35m轩辕之项链[2;37;0m。$br#
