// tianfeng_wrists.c
// Create by TEMPLATE_D. Sun Oct 24 18:09:59 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[32m天凤之护腕[2;37;0m", ({ "tianfeng wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[32m天凤之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两四钱的[32m天凤之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;31m创世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/finger", 24);
    set("armor_prop/hand", 0);
    set("armor_prop/parry", 0);
    set("armor_prop/strike", 12);
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 18);
    set("armor_prop/cant_busy_dianxue", 18);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 22);
