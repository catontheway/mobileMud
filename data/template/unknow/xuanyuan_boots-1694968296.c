// xuanyuan_boots.c
// Create by TEMPLATE_D. Thu Nov 10 15:02:43 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m轩辕之靴[2;37;0m", ({ "xuanyuan boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;35m昔日黄帝持此物立于指南车上，驱迷雾，扫阴霾，率应龙旱魃，御百兽而战蚩尤！$br#[2;37;0m这是一双由相当坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤四两二钱的[1;35m轩辕之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m毁天[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 22);
