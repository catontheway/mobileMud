// tianxuan_hands.c
// Create by TEMPLATE_D. Sat Oct 09 08:23:17 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m天璇之手套[2;37;0m", ({ "tianxuan hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[35m天璇之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤零两五钱的[35m天璇之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;33m灭世[2;37;0m 
