// pojia_hands.c
// Create by TEMPLATE_D. Thu Oct 07 14:17:50 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m破甲之手套[2;37;0m", ({ "pojia hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[1;32m破甲之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤零两零钱的[1;32m破甲之手套[2;37;0m。$br#
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 30);
