// lianyu_boots.c
// Create by TEMPLATE_D. Wed Oct 13 17:57:06 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m炼狱之靴[2;37;0m", ({ "lianyu boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;31m三十三天下有地，地下有城，城名鬼城，大小妖魔，人神畜生都在此轮回往返，谓之“炼狱”！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤四两八钱的[1;31m炼狱之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;31m毁天[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/armor_effect_armor_vs_force", 18);
