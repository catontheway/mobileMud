// feilong_armor.c
// Create by TEMPLATE_D. Thu Oct 07 22:38:40 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m飞龙之披风[2;37;0m", ({ "feilong armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;32m飞龙之披风[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两四钱的[1;32m飞龙之披风[2;37;0m。$br#
