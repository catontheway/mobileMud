// sanqing_head.c
// Create by TEMPLATE_D. Thu Oct 07 12:13:01 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m三清之头盔[2;37;0m", ({ "sanqing head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;36m大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”$br#[2;37;0m这是一顶由极为坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤五两三钱的[1;36m三清之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     set("armor_prop/attack_factor", 16);
     set("armor_prop/parry_factor", 23);
     set("armor_prop/dodge_factor", 0);
//气血恢复治疗类
    set("armor_prop/max_qi", 19);
