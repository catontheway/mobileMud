// hongjun_neck.c
// Create by TEMPLATE_D. Thu Oct 14 20:15:10 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m鸿钧之项链[2;37;0m", ({ "hongjun neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[33m鸿钧之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两二钱的[33m鸿钧之项链[2;37;0m。$br#
