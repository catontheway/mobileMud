// wuyi_armor.c
// Create by TEMPLATE_D. Wed Oct 06 21:13:37 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m武翼之披风[2;37;0m", ({ "wuyi armor" }));
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;32m武翼之披风[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两四钱的[1;32m武翼之披风[2;37;0m。$br#
...
//伤害防御类
    ...
    set("armor_prop/abs_week_injure", 15);
