// general_neck.c
// Create by TEMPLATE_D. Thu Nov 10 17:52:50 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;34m太陽之项链[2;37;0m", ({ "general neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
太陽之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤零两八钱的[1;34m太陽之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;36m完美[2;37;0m 
