// luyu_armor.c
// Create by TEMPLATE_D. Thu Oct 07 11:34:41 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m绿玉之披风[2;37;0m", ({ "luyu armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[37m绿玉之披风[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两七钱的[37m绿玉之披风[2;37;0m。$br#
