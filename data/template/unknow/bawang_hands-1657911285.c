// bawang_hands.c
// Create by TEMPLATE_D. Sun Oct 10 19:35:17 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m霸王之手套[2;37;0m", ({ "bawang hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[36m霸王之手套[2;37;0m这是一副由绝对坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两二钱的[36m霸王之手套[2;37;0m。$br#
...
LONG
	...
	set("no_drop", 1);
	  ...
	  set("systemmake",1);
		set("value", 16000);
                  //  基础类
  set("forge/max", 192);
  set("forge/times_max", 192);
  set("level", 192);

     set("armor_prop/damage", 192);
     set("armor_prop/attack", 0);
     set("armor_prop/defense", 0);
     set("armor_prop/armor", 34);
     set("armor_prop/magic", 13);
 ...
 //先天类    
    ...
    set("armor_prop/finger", 19);
    set("armor_prop/hand", 0);
    set("armor_prop/parry", 0);
    set("armor_prop/strike", 0);
    set("armor_prop/unarmed", 19);
