// tianlong_cloth.c
// Create by TEMPLATE_D. Sun Oct 10 07:01:49 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m天龙之服装[2;37;0m", ({ "tianlong cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[35m天龙之服装[2;37;0m这是一件由极为坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重三斤一两三钱的[35m天龙之服装[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 15);
    ...
    set("armor_prop/max_busy_fenjin", 15);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     ...
     set("armor_prop/parry_factor", 17);
