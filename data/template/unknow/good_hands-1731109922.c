// good_hands.c
// Create by TEMPLATE_D. Thu Oct 07 22:51:48 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m怒涛之手套[2;37;0m", ({ "good hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
怒涛之手套[2;37;0m这是一副由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两四钱的[33m怒涛之手套[2;37;0m。$br#
