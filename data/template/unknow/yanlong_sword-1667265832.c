// yanlong_sword.c
// Create by TEMPLATE_D. Wed Oct 06 16:01:49 2021.
// gangjian.c
...
void create()
{
	set_name("[1;31m炎龙之剑[2;37;0m", ({ "yanlong sword" }));
	set_weight(10328);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[1;31m炎龙之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二十斤六两五钱的[1;31m炎龙之剑[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
