// kunlun_hands.c
// Create by TEMPLATE_D. Sun Oct 10 06:27:15 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m昆仑之手套[2;37;0m", ({ "kunlun hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[1;36m	笑江湖浪迹十年游，空负少年头。$br#对铜陀巷泊，吟情渺渺，心事悠悠！ $br#酒令诗残梦断，南国正清愁。 $br#把剑凄然望，无处招归舟。 $br#明月天涯路远，问谁留楚佩，弄影中洲？$br#数英雄儿女，俯仰古今愁。$br#难消受灯昏罗帐，伥昙花一现恨难休！$br#飘零惯，金戈铁马，拼葬荒丘！ $br#[2;37;0m这是一副由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤八两七钱的[1;36m昆仑之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m 
	...
	set("no_drop", 1);
	  ...
	  set("systemmake",1);
		set("value", 25000);
                  //  基础类
  set("forge/max", 210);
  set("forge/times_max", 210);
  set("level", 210);

     set("armor_prop/damage", 210);
...
//伤害防御类
    ...
    set("armor_prop/defense_attack", 19);
    set("armor_prop/armor_vs_force", 22);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 37);
