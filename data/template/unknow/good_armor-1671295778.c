// good_armor.c
// Create by TEMPLATE_D. Fri Oct 15 14:12:17 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m冬雨之披风[2;37;0m", ({ "good armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
冬雨之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两五钱的[1;33m冬雨之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [32m水[2;37;0m:[1;31m开元[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 20);
