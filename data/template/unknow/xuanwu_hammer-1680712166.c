// xuanwu_hammer.c
// Create by TEMPLATE_D. Thu Oct 07 16:52:48 2021.
// gangjian.c
...
void create()
{
	set_name("[1;34m玄武之锤[2;37;0m", ({ "xuanwu hammer" }));
	set_weight(12878);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","[1;34m玄武之锤[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重二十五斤七两五钱的[1;34m玄武之锤[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
