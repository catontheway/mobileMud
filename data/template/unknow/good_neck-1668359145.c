// good_neck.c
// Create by TEMPLATE_D. Tue Oct 12 20:34:27 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;34m兽皮之项链[2;37;0m", ({ "good neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
兽皮之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两二钱的[1;34m兽皮之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;31m无双[2;37;0m 
