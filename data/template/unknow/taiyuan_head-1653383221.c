// taiyuan_head.c
// Create by TEMPLATE_D. Mon Oct 11 15:31:34 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m太渊之头盔[2;37;0m", ({ "taiyuan head" }));
        ...
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[37m太渊之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤六两一钱的[37m太渊之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m无双[2;37;0m 
