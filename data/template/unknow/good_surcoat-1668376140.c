// good_surcoat.c
// Create by TEMPLATE_D. Sat Oct 09 00:59:42 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m曙光之肚带[2;37;0m", ({ "good surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
曙光之肚带[2;37;0m这是一条由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两八钱的[1;32m曙光之肚带[2;37;0m。$br#
