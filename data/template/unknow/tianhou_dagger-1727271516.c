// tianhou_dagger.c
// Create by TEMPLATE_D. Thu Oct 07 12:04:40 2021.
// gangjian.c
...
void create()
{
	set_name("[36m天后之匕首[2;37;0m", ({ "tianhou dagger" }));
	set_weight(8457);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[36m天后之匕首[2;37;0m这是一把由相当坚硬的[1;32m绿石[2;37;0m制成，重十六斤九两一钱的[36m天后之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;34m举世[2;37;0m [40m地[2;37;0m:[1;32m魔王[2;37;0m [1;31m魔[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
