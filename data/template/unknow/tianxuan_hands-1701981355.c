// tianxuan_hands.c
// Create by TEMPLATE_D. Tue Nov 15 18:59:01 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m天璇之手套[2;37;0m", ({ "tianxuan hands" }));
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[35m天璇之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤六两九钱的[35m天璇之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;31m开元[2;37;0m 
