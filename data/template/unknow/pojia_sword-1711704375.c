// pojia_sword.c
// Create by TEMPLATE_D. Sat Oct 23 10:41:20 2021.
// gangjian.c
...
void create()
{
	set_name("[1;32m破甲之剑[2;37;0m", ({ "pojia sword" }));
	set_weight(1110);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[1;32m破甲之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二斤二两二钱的[1;32m破甲之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;35m绝世[2;37;0m [1;37m雷[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
