// taifeng_sword.c
// Create by TEMPLATE_D. Wed Oct 13 09:56:36 2021.
// gangjian.c
...
void create()
{
	set_name("[37m太风之剑[2;37;0m", ({ "taifeng sword" }));
	set_weight(2267);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[37m太风之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重四斤五两三钱的[37m太风之剑[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
