// wuji_cloth.c
// Create by TEMPLATE_D. Sun Nov 13 14:55:42 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m无极之服装[2;37;0m", ({ "wuji cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;32m此物已达出神入化，登峰造极，神乎其神之境界！俗说万物归宗，便是这“无极”！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重二斤二两三钱的[1;32m无极之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 24);
