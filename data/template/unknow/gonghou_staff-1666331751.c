// gonghou_staff.c
// Create by TEMPLATE_D. Sat Oct 09 23:41:11 2021.
// gangjian.c
...
void create()
{
	set_name("[34m公侯之杖[2;37;0m", ({ "gonghou staff" }));
	set_weight(10157);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","[34m公侯之杖[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重二十斤三两一钱的[34m公侯之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
