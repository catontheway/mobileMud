// yuchang_boots.c
// Create by TEMPLATE_D. Thu Oct 07 22:40:27 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m鱼肠之靴[2;37;0m", ({ "yuchang boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m鱼肠轻巧无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤六两九钱的[31m鱼肠之靴[2;37;0m。$br#
