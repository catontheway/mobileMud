// good_head.c
// Create by TEMPLATE_D. Mon Oct 11 03:31:11 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m朝云之头盔[2;37;0m", ({ "good head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
朝云之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两九钱的[1;31m朝云之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m天圣[2;37;0m 
