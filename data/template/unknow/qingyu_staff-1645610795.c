// qingyu_staff.c
// Create by TEMPLATE_D. Wed Oct 13 10:41:26 2021.
// gangjian.c
...
void create()
{
	set_name("[37m青玉之杖[2;37;0m", ({ "qingyu staff" }));
	set_weight(10472);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","[37m青玉之杖[2;37;0m这是一根由相当坚硬的[1;32m绿石[2;37;0m制成，重二十斤九两四钱的[37m青玉之杖[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
