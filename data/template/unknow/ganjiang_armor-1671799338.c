// ganjiang_armor.c
// Create by TEMPLATE_D. Mon Oct 18 12:28:41 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m干将之披风[2;37;0m", ({ "ganjiang armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m干将威力无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一件由绝对坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤八两七钱的[31m干将之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;33m灭世[2;37;0m 
