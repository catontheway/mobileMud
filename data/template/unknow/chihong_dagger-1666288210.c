// chihong_dagger.c
// Create by TEMPLATE_D. Wed Oct 06 18:24:03 2021.
// gangjian.c
...
void create()
{
	set_name("[36m赤虹之匕首[2;37;0m", ({ "chihong dagger" }));
	set_weight(11502);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[36m赤虹之匕首[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二十三斤零两零钱的[36m赤虹之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m [1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [40m地[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
