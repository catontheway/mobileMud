// yaoguang_cloth.c
// Create by TEMPLATE_D. Sun Oct 10 20:47:49 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m摇光之服装[2;37;0m", ({ "yaoguang cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[35m摇光之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤九两四钱的[35m摇光之服装[2;37;0m。$br#
