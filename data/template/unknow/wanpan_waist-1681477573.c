// wanpan_waist.c
// Create by TEMPLATE_D. Sun Oct 10 09:39:21 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m婉盘之腰带[2;37;0m", ({ "wanpan waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;32m婉盘之腰带[2;37;0m这是一条由绝对坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤六两七钱的[1;32m婉盘之腰带[2;37;0m。$br#
