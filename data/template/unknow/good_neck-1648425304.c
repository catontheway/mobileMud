// good_neck.c
// Create by TEMPLATE_D. Sat Oct 09 01:45:18 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m神竹之项链[2;37;0m", ({ "good neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
神竹之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两一钱的[37m神竹之项链[2;37;0m。$br#
