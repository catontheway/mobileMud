// general_hands.c
// Create by TEMPLATE_D. Thu Oct 07 23:15:03 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m飞凤之手套[2;37;0m", ({ "general hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
飞凤之手套[2;37;0m这是一副由非常坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两四钱的[1;32m飞凤之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [1;34m电[2;37;0m:[31m精致[2;37;0m 
	...
	set("no_drop", 1);
	  ...
	  set("systemmake",1);
		set("value", 2000);
                  //  基础类
  set("forge/max", 152);
  set("forge/times_max", 152);
  set("level", 152);

     set("armor_prop/damage", 152);
