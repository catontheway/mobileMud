// good_armor.c
// Create by TEMPLATE_D. Thu Oct 07 19:26:55 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m毒蛇之披风[2;37;0m", ({ "good armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
毒蛇之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两一钱的[35m毒蛇之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m开元[2;37;0m 
