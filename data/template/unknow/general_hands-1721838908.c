// general_hands.c
// Create by TEMPLATE_D. Thu Nov 10 15:02:36 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m烟雨之手套[2;37;0m", ({ "general hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
烟雨之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两七钱的[1;32m烟雨之手套[2;37;0m。$br#
