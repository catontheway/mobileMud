// jiutian_armor.c
// Create by TEMPLATE_D. Sat Oct 09 15:24:33 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m九天之披风[2;37;0m", ({ "jiutian armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;32m九天之披风[2;37;0m这是一件由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤三两二钱的[1;32m九天之披风[2;37;0m。$br#
