// diwang_boots.c
// Create by TEMPLATE_D. Thu Oct 07 17:17:12 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m帝王之靴[2;37;0m", ({ "diwang boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[36m帝王之靴[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤七两七钱的[36m帝王之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[35m标准[2;37;0m [40m地[2;37;0m:[33m很高[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 5);
