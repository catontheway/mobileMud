// shengxie_armor.c
// Create by TEMPLATE_D. Wed Oct 06 16:38:42 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m胜邪之披风[2;37;0m", ({ "shengxie armor" }));
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一件由极其坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤三两七钱的[31m胜邪之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/finger", 25);
    set("armor_prop/hand", 0);
    set("armor_prop/parry", 0);
    set("armor_prop/strike", 0);
    set("armor_prop/unarmed", 39);
...
//特效数值
    ...
    set("armor_prop/cant_busy_body", 26);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 21);
