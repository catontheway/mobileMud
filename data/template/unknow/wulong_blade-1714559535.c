// wulong_blade.c
// Create by TEMPLATE_D. Wed Oct 06 15:59:49 2021.
// gangjian.c
...
void create()
{
	set_name("[35m五龙之刀[2;37;0m", ({ "wulong blade" }));
	set_weight(8373);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","[35m五龙之刀[2;37;0m这是一柄由极其坚硬的[1;32m绿石[2;37;0m制成，重十六斤七两四钱的[35m五龙之刀[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m无双[2;37;0m [36m木[2;37;0m:[1;35m绝世[2;37;0m [33m土[2;37;0m:[1;31m创世[2;37;0m [37m天[2;37;0m:[1;31m开元[2;37;0m [1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/max_busy_jiemai", 9);
...
//伤害防御类
    set("weapon_prop/deep_injure", 14);
    set("weapon_prop/week_injure", 0);
    set("weapon_prop/abs_week_injure", 0);
    set("weapon_prop/defense_attack", 9);
