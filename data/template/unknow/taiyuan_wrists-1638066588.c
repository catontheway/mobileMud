// taiyuan_wrists.c
// Create by TEMPLATE_D. Mon Oct 11 00:04:31 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m太渊之护腕[2;37;0m", ({ "taiyuan wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[37m太渊之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤三两四钱的[37m太渊之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m无双[2;37;0m 
