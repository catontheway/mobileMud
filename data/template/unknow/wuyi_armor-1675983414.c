// wuyi_armor.c
// Create by TEMPLATE_D. Wed Oct 06 20:42:48 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m武翼之披风[2;37;0m", ({ "wuyi armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;32m武翼之披风[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤零两二钱的[1;32m武翼之披风[2;37;0m。$br#
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/staff", 18);
    set("armor_prop/force", 12);
    set("armor_prop/dagge", 35);
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 8);
    set("armor_prop/cant_busy_fenjin", 0);
    set("armor_prop/cant_busy_confuse", 11);
