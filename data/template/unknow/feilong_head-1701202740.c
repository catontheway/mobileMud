// feilong_head.c
// Create by TEMPLATE_D. Thu Oct 14 22:37:51 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m飞龙之头盔[2;37;0m", ({ "feilong head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;32m飞龙之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤七两二钱的[1;32m飞龙之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[35m标准[2;37;0m 
