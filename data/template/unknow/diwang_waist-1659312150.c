...
void create()
{
	set_name("[36m帝王之腰带[2;37;0m", ({ "diwang waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[36m帝王之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤零两九钱的[36m帝王之腰带[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 12);
