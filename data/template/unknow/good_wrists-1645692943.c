// good_wrists.c
// Create by TEMPLATE_D. Thu Oct 14 10:51:13 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m柳叶之护腕[2;37;0m", ({ "good wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
柳叶之护腕[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两一钱的[37m柳叶之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;35m绝世[2;37;0m 
