// bad_head.c
// Create by TEMPLATE_D. Sun Oct 10 00:27:59 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m铜之头盔[2;37;0m", ({ "bad head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
铜之头盔[2;37;0m这是一顶由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤三两零钱的[1;33m铜之头盔[2;37;0m。$br#
