// good_head.c
// Create by TEMPLATE_D. Wed Oct 06 17:29:41 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m地水之头盔[2;37;0m", ({ "good head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
地水之头盔[2;37;0m这是一顶由极其坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两一钱的[36m地水之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m天圣[2;37;0m 
