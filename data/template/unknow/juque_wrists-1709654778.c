// juque_wrists.c
// Create by TEMPLATE_D. Tue Oct 12 08:35:15 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m巨阙之护腕[2;37;0m", ({ "juque wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m巨阙坚硬无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤零两零钱的[31m巨阙之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 20);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 50);
