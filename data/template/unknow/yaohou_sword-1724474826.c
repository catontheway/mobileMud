// yaohou_sword.c
// Create by TEMPLATE_D. Wed Oct 06 16:37:28 2021.
// gangjian.c
...
void create()
{
	set_name("[36m妖后之剑[2;37;0m", ({ "yaohou sword" }));
	set_weight(4538);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[36m妖后之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重九斤零两七钱的[36m妖后之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
