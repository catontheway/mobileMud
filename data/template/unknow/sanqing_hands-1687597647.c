// sanqing_hands.c
// Create by TEMPLATE_D. Mon Oct 11 13:56:43 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m三清之手套[2;37;0m", ({ "sanqing hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[1;36m大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤八两七钱的[1;36m三清之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_fenjin", 20);
