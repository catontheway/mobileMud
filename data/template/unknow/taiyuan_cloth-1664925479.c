// taiyuan_cloth.c
// Create by TEMPLATE_D. Fri Oct 08 21:21:39 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m太渊之服装[2;37;0m", ({ "taiyuan cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[37m太渊之服装[2;37;0m这是一件由相当坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两零钱的[37m太渊之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m毁天[2;37;0m $br#[1;37m雷[2;37;0m:[1;31m开元[2;37;0m [1;34m电[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[1;31m毁天[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/force", 18);
    set("armor_prop/dagge", 17);
