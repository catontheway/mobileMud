// general_head.c
// Create by TEMPLATE_D. Mon Oct 11 03:33:12 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m净坛之头盔[2;37;0m", ({ "general head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
净坛之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤六两七钱的[1;31m净坛之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
