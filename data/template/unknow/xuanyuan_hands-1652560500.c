// xuanyuan_hands.c
// Create by TEMPLATE_D. Wed Oct 13 18:14:23 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m轩辕之手套[2;37;0m", ({ "xuanyuan hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[1;35m昔日黄帝持此物立于指南车上，驱迷雾，扫阴霾，率应龙旱魃，御百兽而战蚩尤！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤三两一钱的[1;35m轩辕之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_body", 11);
