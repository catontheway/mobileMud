// wuji_surcoat.c
// Create by TEMPLATE_D. Sat Oct 16 03:02:34 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m无极之肚带[2;37;0m", ({ "wuji surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;32m此物已达出神入化，登峰造极，神乎其神之境界！俗说万物归宗，便是这“无极”！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤五两八钱的[1;32m无极之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m灭世[2;37;0m 
