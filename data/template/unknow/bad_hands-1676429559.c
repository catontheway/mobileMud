// bad_hands.c
// Create by TEMPLATE_D. Thu Oct 07 21:09:51 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m竹之手套[2;37;0m", ({ "bad hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
竹之手套[2;37;0m这是一副由十分坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤二两五钱的[33m竹之手套[2;37;0m。$br#
