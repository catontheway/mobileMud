// qinghong_axe.c
// Create by TEMPLATE_D. Thu Nov 10 20:30:50 2022.
// gangjian.c
...
void create()
{
	set_name("[36m青虹之斧[2;37;0m", ({ "qinghong axe" }));
	set_weight(2162);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","[36m青虹之斧[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重四斤三两二钱的[36m青虹之斧[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m毁天[2;37;0m [1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#[40m地[2;37;0m:[1;31m开元[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/neili_recover", 17);
    set("weapon_prop/qi_recover", 0);
    set("weapon_prop/jing_recover", 0);
    set("weapon_prop/jingli_recover", 29);
