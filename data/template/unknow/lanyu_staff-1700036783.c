// lanyu_staff.c
// Create by TEMPLATE_D. Wed Oct 06 16:24:43 2021.
// gangjian.c
...
void create()
{
	set_name("[37m蓝玉之杖[2;37;0m", ({ "lanyu staff" }));
	set_weight(14054);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","[37m蓝玉之杖[2;37;0m这是一根由无比坚硬的[1;32m绿石[2;37;0m制成，重二十八斤一两零钱的[37m蓝玉之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m [37m天[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
