// good_surcoat.c
// Create by TEMPLATE_D. Thu Nov 10 18:13:11 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m复体之肚带[2;37;0m", ({ "good surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
复体之肚带[2;37;0m这是一条由极为坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤零两四钱的[31m复体之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m 
