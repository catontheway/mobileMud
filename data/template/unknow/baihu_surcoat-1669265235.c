// baihu_surcoat.c
// Create by TEMPLATE_D. Sat Oct 23 22:39:25 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;37m白虎之肚带[2;37;0m", ({ "baihu surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;37m白虎之肚带[2;37;0m这是一条由十分坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两三钱的[1;37m白虎之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;31m开元[2;37;0m 
