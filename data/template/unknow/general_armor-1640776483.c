// general_armor.c
// Create by TEMPLATE_D. Sat Oct 09 18:06:50 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m翻天之披风[2;37;0m", ({ "general armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
翻天之披风[2;37;0m这是一件由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两三钱的[1;36m翻天之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m天圣[2;37;0m 
