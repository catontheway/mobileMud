// qinglong_cloth.c
// Create by TEMPLATE_D. Wed Oct 27 22:13:38 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m青龙之服装[2;37;0m", ({ "qinglong cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;36m青龙之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤六两四钱的[1;36m青龙之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m毁天[2;37;0m [1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 33);
