// zidian_boots.c
// Create by TEMPLATE_D. Sat Oct 09 18:14:10 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m紫电之靴[2;37;0m", ({ "zidian boots" }));
        ...
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[35m紫电之靴[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤六两六钱的[35m紫电之靴[2;37;0m。$br#
