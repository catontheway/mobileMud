// dilong_cloth.c
// Create by TEMPLATE_D. Wed Oct 13 17:56:08 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[32m地龙之服装[2;37;0m", ({ "dilong cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[32m地龙之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤三两三钱的[32m地龙之服装[2;37;0m。$br#
