// taie_boots.c
// Create by TEMPLATE_D. Sun Oct 10 23:59:07 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m太阿之靴[2;37;0m", ({ "taie boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤零两二钱的[31m太阿之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m 
