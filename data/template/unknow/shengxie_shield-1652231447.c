// shengxie_shield.c
// Create by TEMPLATE_D. Mon Oct 11 15:02:15 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m胜邪之盾[2;37;0m", ({ "shengxie shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[31m胜邪威力巨大而无任何要求！$br#[2;37;0m这是一面由极其坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重二斤五两七钱的[31m胜邪之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 24);
