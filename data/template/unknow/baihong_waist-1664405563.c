// baihong_waist.c
// Create by TEMPLATE_D. Thu Oct 07 22:36:19 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m白虹之腰带[2;37;0m", ({ "baihong waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[36m白虹之腰带[2;37;0m这是一条由极为坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两九钱的[36m白虹之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m 
