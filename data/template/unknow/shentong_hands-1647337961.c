// shentong_hands.c
// Create by TEMPLATE_D. Thu Oct 07 14:52:25 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m神通之手套[2;37;0m", ({ "shentong hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[1;31m天兵神通，走势要平善，气要随行，两眼顾尖，气沉两足稳，身法需自然，身行如飞燕，身落如停风，收如花絮，刺如钢钉！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤八两五钱的[1;31m神通之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;33m灭世[2;37;0m 
	...
	set("no_drop", 1);
	  ...
	  set("systemmake",1);
		set("value", 25000);
                  //  基础类
  set("forge/max", 222);
  set("forge/times_max", 222);
  set("level", 222);

     set("armor_prop/damage", 222);
...
//特效数值
    ...
    set("armor_prop/cant_busy_confuse", 19);
    ...
    set("armor_prop/max_busy_fenjin", 17);
    set("armor_prop/max_busy_confuse", 0);
    set("armor_prop/max_busy_body", 0);
    set("armor_prop/AllPoisonsImmune", 14);
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 17);
