// tiandi_neck.c
// Create by TEMPLATE_D. Thu Oct 07 16:59:39 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m天地之项链[2;37;0m", ({ "tiandi neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[1;36m天地之初，女娲补天所留下的天地间至尊之物之一经千秋万载所制，功能开天劈地！$br#[2;37;0m这是一串由绝对坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤一两四钱的[1;36m天地之项链[2;37;0m。$br#
