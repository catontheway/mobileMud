// jiulong_cloth.c
// Create by TEMPLATE_D. Fri Oct 08 22:08:58 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m九龙之服装[2;37;0m", ({ "jiulong cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[35m九龙之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤三两四钱的[35m九龙之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;31m开元[2;37;0m [1;35m风[2;37;0m:[1;33m天圣[2;37;0m $br#
