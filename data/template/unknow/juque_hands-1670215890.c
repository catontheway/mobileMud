// juque_hands.c
// Create by TEMPLATE_D. Sat Oct 23 10:41:35 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m巨阙之手套[2;37;0m", ({ "juque hands" }));
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m巨阙坚硬无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一副由极为坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤八两六钱的[31m巨阙之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;33m灭世[2;37;0m 
	...
	set("no_drop", 1);
	  ...
	  set("systemmake",1);
		set("value", 36000);
                  //  基础类
  set("forge/max", 232);
  set("forge/times_max", 232);
  set("level", 232);

     set("armor_prop/damage", 232);
