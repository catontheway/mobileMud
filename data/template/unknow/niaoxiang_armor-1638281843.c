// niaoxiang_armor.c
// Create by TEMPLATE_D. Thu Oct 07 22:18:27 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m鸟翔之披风[2;37;0m", ({ "niaoxiang armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;32m鸟翔之披风[2;37;0m这是一件由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤六两五钱的[1;32m鸟翔之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[31m精致[2;37;0m 
