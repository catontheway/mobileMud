// good_shield.c
// Create by TEMPLATE_D. Thu Oct 07 20:54:09 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m慈云之盾[2;37;0m", ({ "good shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
慈云之盾[2;37;0m这是一面由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤八两八钱的[33m慈云之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m创世[2;37;0m 
