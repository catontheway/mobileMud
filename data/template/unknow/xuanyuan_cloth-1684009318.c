// xuanyuan_cloth.c
// Create by TEMPLATE_D. Fri Oct 08 12:53:14 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m轩辕之服装[2;37;0m", ({ "xuanyuan cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;35m昔日黄帝持此物立于指南车上，驱迷雾，扫阴霾，率应龙旱魃，御百兽而战蚩尤！$br#[2;37;0m这是一件由相当坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重二斤八两四钱的[1;35m轩辕之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m创世[2;37;0m [1;35m风[2;37;0m:[1;36m完美[2;37;0m $br#[1;36m人[2;37;0m:[31m精致[2;37;0m [1;31m魔[2;37;0m:[1;34m举世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_jiemai", 10);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 16);
