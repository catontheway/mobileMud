// longxiang_neck.c
// Create by TEMPLATE_D. Sat Oct 09 01:13:19 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[32m龙翔之项链[2;37;0m", ({ "longxiang neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[32m龙翔之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤零两八钱的[32m龙翔之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m [1;35m风[2;37;0m:[31m精致[2;37;0m $br#
