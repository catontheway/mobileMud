// moye_cloth.c
// Create by TEMPLATE_D. Thu Oct 07 16:57:20 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m莫邪之服装[2;37;0m", ({ "moye cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤三两九钱的[31m莫邪之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m [1;34m电[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;33m灭世[2;37;0m 
