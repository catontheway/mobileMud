// sanqing_boots.c
// Create by TEMPLATE_D. Fri Oct 15 10:08:49 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m三清之靴[2;37;0m", ({ "sanqing boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;36m大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤三两七钱的[1;36m三清之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m 
