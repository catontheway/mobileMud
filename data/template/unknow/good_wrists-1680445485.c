// good_wrists.c
// Create by TEMPLATE_D. Sat Oct 09 09:15:57 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m纵横之护腕[2;37;0m", ({ "good wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
纵横之护腕[2;37;0m这是一双由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤五两六钱的[35m纵横之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m 
