// jinguang_boots.c
// Create by TEMPLATE_D. Thu Nov 10 14:10:20 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m金光之靴[2;37;0m", ({ "jinguang boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[33m金光之靴[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两三钱的[33m金光之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;35m绝世[2;37;0m [37m天[2;37;0m:[1;33m天圣[2;37;0m [1;36m人[2;37;0m:[33m很高[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spirituality", 11);
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 5);
    set("armor_prop/cant_busy_dianxue", 6);
    set("armor_prop/cant_busy_jiemai", 0);
    set("armor_prop/cant_busy_fenjin", 0);
    set("armor_prop/cant_busy_confuse", 4);
    ...
    set("armor_prop/AllPoisonsImmune", 4);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     ...
     set("armor_prop/dodge_factor", 5);
//气血恢复治疗类
    set("armor_prop/max_qi", 0);
    set("armor_prop/max_jing", 33);
