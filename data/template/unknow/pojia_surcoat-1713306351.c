// pojia_surcoat.c
// Create by TEMPLATE_D. Thu Oct 07 21:50:02 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m破甲之肚带[2;37;0m", ({ "pojia surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;32m破甲之肚带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两七钱的[1;32m破甲之肚带[2;37;0m。$br#
