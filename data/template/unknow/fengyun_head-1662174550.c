// fengyun_head.c
// Create by TEMPLATE_D. Sat Oct 09 12:13:34 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m风云之头盔[2;37;0m", ({ "fengyun head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;35m所谓风云际会，天地变色！仗此行千里，老魔小丑，岂堪一击！$br#[2;37;0m这是一顶由绝对坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤四两六钱的[1;35m风云之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;36m完美[2;37;0m [40m地[2;37;0m:[1;31m创世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spirituality", 25);
