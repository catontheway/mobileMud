// wuyi_surcoat.c
// Create by TEMPLATE_D. Wed Oct 13 10:38:16 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m武翼之肚带[2;37;0m", ({ "wuyi surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;32m武翼之肚带[2;37;0m这是一条由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤七两六钱的[1;32m武翼之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
