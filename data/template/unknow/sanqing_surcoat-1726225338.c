// sanqing_surcoat.c
// Create by TEMPLATE_D. Wed Oct 06 18:22:36 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m三清之肚带[2;37;0m", ({ "sanqing surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;36m大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤九两五钱的[1;36m三清之肚带[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/max_busy_fenjin", 9);
    set("armor_prop/max_busy_confuse", 0);
    set("armor_prop/max_busy_body", 0);
    set("armor_prop/AllPoisonsImmune", 13);
...
//伤害防御类
    ...
    set("armor_prop/defense_attack", 5);
...
//气血恢复治疗类
    ...
    set("armor_prop/jing_recover", 26);
