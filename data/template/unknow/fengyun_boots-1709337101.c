// fengyun_boots.c
// Create by TEMPLATE_D. Thu Oct 07 22:46:06 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m风云之靴[2;37;0m", ({ "fengyun boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;35m所谓风云际会，天地变色！仗此行千里，老魔小丑，岂堪一击！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤七两一钱的[1;35m风云之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m毁天[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/unarmed", 18);
    set("armor_prop/blade", 0);
    set("armor_prop/whip", 31);
