// xuanwu_waist.c
// Create by TEMPLATE_D. Sat Oct 09 22:55:33 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;34m玄武之腰带[2;37;0m", ({ "xuanwu waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;34m玄武之腰带[2;37;0m这是一条由极为坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两一钱的[1;34m玄武之腰带[2;37;0m。$br#
