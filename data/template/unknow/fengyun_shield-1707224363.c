// fengyun_shield.c
// Create by TEMPLATE_D. Sat Oct 09 18:30:22 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m风云之盾[2;37;0m", ({ "fengyun shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[1;35m所谓风云际会，天地变色！仗此行千里，老魔小丑，岂堪一击！$br#[2;37;0m这是一面由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重二斤五两六钱的[1;35m风云之盾[2;37;0m。$br#
