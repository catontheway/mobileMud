// xuling_shield.c
// Create by TEMPLATE_D. Sun Oct 17 12:36:55 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m虚灵之盾[2;37;0m", ({ "xuling shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[37m虚灵之盾[2;37;0m这是一面由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤四两一钱的[37m虚灵之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;32m魔王[2;37;0m 
