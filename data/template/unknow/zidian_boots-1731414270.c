// zidian_boots.c
// Create by TEMPLATE_D. Sat Nov 12 00:35:20 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m紫电之靴[2;37;0m", ({ "zidian boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[35m紫电之靴[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两六钱的[35m紫电之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;31m无双[2;37;0m 
