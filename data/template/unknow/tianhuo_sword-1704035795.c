// tianhuo_sword.c
// Create by TEMPLATE_D. Wed Oct 06 16:35:31 2021.
// gangjian.c
...
void create()
{
	set_name("[1;31m天火之剑[2;37;0m", ({ "tianhuo sword" }));
	set_weight(14939);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[1;31m天火之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重二十九斤八两七钱的[1;31m天火之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;35m绝世[2;37;0m [1;36m人[2;37;0m:[1;31m创世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jing_recover", 26);
