// tiandi_surcoat.c
// Create by TEMPLATE_D. Sat Oct 09 12:15:14 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m天地之肚带[2;37;0m", ({ "tiandi surcoat" }));
        ...
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;36m天地之初，女娲补天所留下的天地间至尊之物之一经千秋万载所制，功能开天劈地！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤三两五钱的[1;36m天地之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#
