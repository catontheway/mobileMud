// good_neck.c
// Create by TEMPLATE_D. Thu Oct 07 19:50:44 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m地门之项链[2;37;0m", ({ "good neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
地门之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两四钱的[1;32m地门之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;31m毁天[2;37;0m $br#[40m地[2;37;0m:[1;31m创世[2;37;0m 
