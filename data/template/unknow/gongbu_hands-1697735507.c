// gongbu_hands.c
// Create by TEMPLATE_D. Thu Oct 07 22:37:21 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m工布之手套[2;37;0m", ({ "gongbu hands" }));
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤五两五钱的[31m工布之手套[2;37;0m。$br#
...
LONG
	...
	set("no_drop", 1);
	  ...
	  set("systemmake",1);
		set("value", 36000);
                  //  基础类
  set("forge/max", 242);
  set("forge/times_max", 242);
  set("level", 242);

     set("armor_prop/damage", 242);
 ...
 //先天类    
    ...
    set("armor_prop/strike", 27);
    set("armor_prop/unarmed", 0);
    set("armor_prop/blade", 16);
    set("armor_prop/whip", 0);
    set("armor_prop/staff", 0);
    set("armor_prop/force", 17);
