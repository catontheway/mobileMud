// good_hands.c
// Create by TEMPLATE_D. Sat Oct 09 19:34:23 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[34m幻风之手套[2;37;0m", ({ "good hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
幻风之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两零钱的[34m幻风之手套[2;37;0m。$br#
