// hongjun_sword.c
// Create by TEMPLATE_D. Tue Oct 12 18:34:01 2021.
// gangjian.c
...
void create()
{
	set_name("[33m鸿钧之剑[2;37;0m", ({ "hongjun sword" }));
	set_weight(6070);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[33m鸿钧之剑[2;37;0m这是一把由无比坚硬的[1;32m绿石[2;37;0m制成，重十二斤一两四钱的[33m鸿钧之剑[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
