// taie_wrists.c
// Create by TEMPLATE_D. Thu Oct 07 11:30:47 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m太阿之护腕[2;37;0m", ({ "taie wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一双由绝对坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤八两五钱的[31m太阿之护腕[2;37;0m。$br#
