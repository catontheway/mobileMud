// guangcheng_boots.c
// Create by TEMPLATE_D. Wed Oct 06 21:20:44 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m广成之靴[2;37;0m", ({ "guangcheng boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[33m广成之靴[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两七钱的[33m广成之靴[2;37;0m。$br#
