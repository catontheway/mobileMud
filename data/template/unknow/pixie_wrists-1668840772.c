// pixie_wrists.c
// Create by TEMPLATE_D. Thu Oct 14 08:21:32 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m辟邪之护腕[2;37;0m", ({ "pixie wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;31m辟邪之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两三钱的[1;31m辟邪之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m开元[2;37;0m 
