// moye_staff.c
// Create by TEMPLATE_D. Thu Oct 07 22:06:20 2021.
// gangjian.c
...
void create()
{
	set_name("[31m莫邪之杖[2;37;0m", ({ "moye staff" }));
	set_weight(7460);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","[31m莫邪锋利无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一根由无比坚硬的[1;37m软银[2;37;0m制成，重十四斤九两二钱的[31m莫邪之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
if(query("weapon_prop/damage"))
 ...
 //先天类    
		...
		set("weapon_prop/personality",41);
  ...
  //  set("weapon_prop/claw", 0);
   // set("weapon_prop/cuff", 34);
    ...
    //set("weapon_prop/staff", 45);
    set("weapon_prop/force", 47);
    set("weapon_prop/dagge", 0);
    //set("weapon_prop/hammer", 0);
    //set("weapon_prop/spear", 40);
...
//特效数值
    ...
    set("weapon_prop/cant_busy_confuse", 21);
    set("weapon_prop/cant_busy_body", 0);
    set("weapon_prop/max_all_busy", 15);
    ...
    set("weapon_prop/max_busy_body", 22);
...
//伤害防御类
    ...
    set("weapon_prop/armor_effect_armor_vs_force", 19);
    set("weapon_prop/attack_speed", 0);
     set("weapon_prop/attack_factor", 0);
     set("weapon_prop/parry_factor", 17);
