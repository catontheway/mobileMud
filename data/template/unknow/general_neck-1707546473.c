// general_neck.c
// Create by TEMPLATE_D. Sat Oct 09 23:55:30 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m黑魅之项链[2;37;0m", ({ "general neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
黑魅之项链[2;37;0m这是一串由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤五两三钱的[1;35m黑魅之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 7);
    ...
    set("armor_prop/AllPoisonsImmune", 7);
