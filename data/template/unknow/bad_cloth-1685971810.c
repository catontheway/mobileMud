// bad_cloth.c
// Create by TEMPLATE_D. Fri Oct 08 21:44:16 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m叠之服装[2;37;0m", ({ "bad cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
叠之服装[2;37;0m这是一件由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重三斤一两七钱的[35m叠之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[34m细碎[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_confuse", 6);
    set("armor_prop/cant_busy_body", 0);
    set("armor_prop/max_all_busy", 6);
    ...
    set("armor_prop/kf_hit_rate", 3);
    set("armor_prop/kf_anti_hr", 0);
//伤害防御类
    set("armor_prop/deep_injure", 4);
