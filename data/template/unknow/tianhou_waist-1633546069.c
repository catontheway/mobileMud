// tianhou_waist.c
// Create by TEMPLATE_D. Wed Oct 06 18:20:43 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m天后之腰带[2;37;0m", ({ "tianhou waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[36m天后之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤三两六钱的[36m天后之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m天圣[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/armor_vs_force", 14);
