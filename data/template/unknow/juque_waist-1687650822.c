// juque_waist.c
// Create by TEMPLATE_D. Thu Oct 07 11:50:28 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m巨阙之腰带[2;37;0m", ({ "juque waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[31m巨阙坚硬无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤一两六钱的[31m巨阙之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m天圣[2;37;0m [37m天[2;37;0m:[1;31m创世[2;37;0m 
