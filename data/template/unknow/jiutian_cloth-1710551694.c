// jiutian_cloth.c
// Create by TEMPLATE_D. Mon Oct 11 17:35:28 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m九天之服装[2;37;0m", ({ "jiutian cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;32m九天之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤九两一钱的[1;32m九天之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m创世[2;37;0m [1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
...
//伤害防御类
    ...
    set("armor_prop/armor_vs_force", 19);
