// general_hands.c
// Create by TEMPLATE_D. Mon Oct 11 01:18:03 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[34m璨星之手套[2;37;0m", ({ "general hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
璨星之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两七钱的[34m璨星之手套[2;37;0m。$br#
