// jiulong_hands.c
// Create by TEMPLATE_D. Tue Nov 15 01:42:58 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m九龙之手套[2;37;0m", ({ "jiulong hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[35m九龙之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤九两八钱的[35m九龙之手套[2;37;0m。$br#
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/dagge", 22);
    set("armor_prop/hammer", 0);
    set("armor_prop/spear", 0);
    set("armor_prop/throwing", 29);
...
//特效数值
    ...
    set("armor_prop/cant_busy_body", 13);
