// good_wrists.c
// Create by TEMPLATE_D. Thu Oct 07 13:51:36 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m天水之护腕[2;37;0m", ({ "good wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
天水之护腕[2;37;0m这是一双由非常坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两七钱的[33m天水之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m无双[2;37;0m [33m土[2;37;0m:[1;31m毁天[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/dagge", 14);
    set("armor_prop/hammer", 0);
    set("armor_prop/spear", 0);
    set("armor_prop/throwing", 24);
