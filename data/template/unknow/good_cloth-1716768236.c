// good_cloth.c
// Create by TEMPLATE_D. Sat Oct 09 23:56:06 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[34m延永之服装[2;37;0m", ({ "good cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
延永之服装[2;37;0m这是一件由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重二斤二两八钱的[34m延永之服装[2;37;0m。$br#
