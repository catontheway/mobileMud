// lanhong_armor.c
// Create by TEMPLATE_D. Thu Nov 10 21:18:25 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m蓝虹之披风[2;37;0m", ({ "lanhong armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[36m蓝虹之披风[2;37;0m这是一件由绝对坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两零钱的[36m蓝虹之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;32m魔王[2;37;0m 
