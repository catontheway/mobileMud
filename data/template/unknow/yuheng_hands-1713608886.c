// yuheng_hands.c
// Create by TEMPLATE_D. Fri Oct 08 03:10:38 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m玉衡之手套[2;37;0m", ({ "yuheng hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[35m玉衡之手套[2;37;0m这是一副由极其坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两八钱的[35m玉衡之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;35m绝世[2;37;0m [37m天[2;37;0m:[1;31m毁天[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spirituality", 12);
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 18);
    ...
    set("armor_prop/kf_anti_hr", 19);
//伤害防御类
    set("armor_prop/deep_injure", 0);
    set("armor_prop/week_injure", 18);
    set("armor_prop/abs_week_injure", 12);
