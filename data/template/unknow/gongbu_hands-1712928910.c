// gongbu_hands.c
// Create by TEMPLATE_D. Thu Oct 07 17:01:05 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m工布之手套[2;37;0m", ({ "gongbu hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[31m工布天生怪异，功能参商！$br#[2;37;0m这是一副由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤五两八钱的[31m工布之手套[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/max_busy_jiemai", 21);
    set("armor_prop/max_busy_fenjin", 24);
    set("armor_prop/max_busy_confuse", 22);
...
//伤害防御类
    ...
    set("armor_prop/armor_vs_force", 17);
