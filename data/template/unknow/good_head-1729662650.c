// good_head.c
// Create by TEMPLATE_D. Fri Oct 08 22:22:24 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m神豹之头盔[2;37;0m", ({ "good head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
神豹之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤六两九钱的[1;31m神豹之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m 
