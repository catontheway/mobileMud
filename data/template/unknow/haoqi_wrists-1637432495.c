// haoqi_wrists.c
// Create by TEMPLATE_D. Wed Oct 06 16:39:36 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m浩气之护腕[2;37;0m", ({ "haoqi wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;32m天地浩气之神兵，扫魔除妖，为国为民，侠之大者！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤零两七钱的[1;32m浩气之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_dianxue", 24);
