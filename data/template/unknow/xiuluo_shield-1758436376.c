// xiuluo_shield.c
// Create by TEMPLATE_D. Sun Nov 13 15:02:59 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m修罗之盾[2;37;0m", ({ "xiuluo shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[33m修罗之盾[2;37;0m这是一面由绝对坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤六两八钱的[33m修罗之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;36m完美[2;37;0m 
