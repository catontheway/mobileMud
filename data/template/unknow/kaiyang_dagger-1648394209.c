// kaiyang_dagger.c
// Create by TEMPLATE_D. Wed Oct 06 15:51:29 2021.
// gangjian.c
...
void create()
{
	set_name("[35m开阳之匕首[2;37;0m", ({ "kaiyang dagger" }));
	set_weight(10274);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[35m开阳之匕首[2;37;0m这是一把由极其坚硬的[1;32m绿石[2;37;0m制成，重二十斤五两四钱的[35m开阳之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[40m地[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
