// bawang_neck.c
// Create by TEMPLATE_D. Mon Oct 11 03:19:19 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m霸王之项链[2;37;0m", ({ "bawang neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[36m霸王之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两三钱的[36m霸王之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;33m天圣[2;37;0m 
