// longquan_boots.c
// Create by TEMPLATE_D. Fri Oct 15 20:14:20 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m龙泉之靴[2;37;0m", ({ "longquan boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一双由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重一斤一两零钱的[31m龙泉之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [31m火[2;37;0m:[1;33m灭世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/spirituality", 22);
...
//特效数值
    set("armor_prop/kf_def_wound", 28);
...
//伤害防御类
    ...
    set("armor_prop/armor_effect_armor_vs_force", 28);
...
//气血恢复治疗类
    ...
    set("armor_prop/neili_recover", 25);
    set("armor_prop/qi_recover", 0);
    set("armor_prop/jing_recover", 44);
