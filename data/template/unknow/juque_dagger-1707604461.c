// juque_dagger.c
// Create by TEMPLATE_D. Wed Oct 06 16:19:18 2021.
// gangjian.c
...
void create()
{
	set_name("[31m巨阙之匕首[2;37;0m", ({ "juque dagger" }));
	set_weight(4566);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[31m巨阙坚硬无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重九斤一两三钱的[31m巨阙之匕首[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m [1;36m人[2;37;0m:[1;33m灭世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/jingli_recover", 30);
