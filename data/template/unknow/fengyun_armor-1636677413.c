// fengyun_armor.c
// Create by TEMPLATE_D. Sun Oct 10 00:25:09 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m风云之披风[2;37;0m", ({ "fengyun armor" }));
        ...
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;35m所谓风云际会，天地变色！仗此行千里，老魔小丑，岂堪一击！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重零斤八两二钱的[1;35m风云之披风[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[35m标准[2;37;0m 
