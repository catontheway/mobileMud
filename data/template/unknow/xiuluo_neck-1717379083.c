// xiuluo_neck.c
// Create by TEMPLATE_D. Thu Oct 21 11:41:30 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m修罗之项链[2;37;0m", ({ "xiuluo neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[33m修罗之项链[2;37;0m这是一串由相当坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两九钱的[33m修罗之项链[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[31m精致[2;37;0m [36m木[2;37;0m:[35m标准[2;37;0m [1;34m电[2;37;0m:[1;33m天圣[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_body", 10);
