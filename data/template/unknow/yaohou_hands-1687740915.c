// yaohou_hands.c
// Create by TEMPLATE_D. Thu Nov 10 22:40:45 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m妖后之手套[2;37;0m", ({ "yaohou hands" }));
        ...
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
[36m妖后之手套[2;37;0m这是一副由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两一钱的[36m妖后之手套[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m无双[2;37;0m 
