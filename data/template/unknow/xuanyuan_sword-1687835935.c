// xuanyuan_sword.c
// Create by TEMPLATE_D. Thu Oct 07 16:27:44 2021.
// gangjian.c
...
void create()
{
	...
	if (clonep())
		...
		set("unit", "把");
		set("long","[1;35m昔日黄帝持此物立于指南车上，驱迷雾，扫阴霾，率应龙旱魃，御百兽而战蚩尤！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重十斤三两六钱的[1;35m轩辕之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[1;35m绝世[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//气血恢复治疗类
    ...
    set("weapon_prop/qi_recover", 27);
    set("weapon_prop/jing_recover", 0);
    set("weapon_prop/jingli_recover", 46);
