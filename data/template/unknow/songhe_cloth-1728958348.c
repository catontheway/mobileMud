// songhe_cloth.c
// Create by TEMPLATE_D. Thu Oct 07 11:31:23 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[32m松鹤之服装[2;37;0m", ({ "songhe cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[32m松鹤之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤一两六钱的[32m松鹤之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;33m金[2;37;0m:[1;33m灭世[2;37;0m [33m土[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/kf_hit_rate", 17);
    set("armor_prop/kf_anti_hr", 0);
//伤害防御类
    set("armor_prop/deep_injure", 13);
...
//气血恢复治疗类
    ...
    set("armor_prop/qi_cure", 28);
    set("armor_prop/jing_cure", 26);
