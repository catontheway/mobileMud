// good_wrists.c
// Create by TEMPLATE_D. Sun Nov 13 15:05:02 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m地竹之护腕[2;37;0m", ({ "good wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
地竹之护腕[2;37;0m这是一双由相当坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤八两九钱的[1;35m地竹之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;34m举世[2;37;0m 
