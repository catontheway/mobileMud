// haoqi_head.c
// Create by TEMPLATE_D. Fri Oct 08 17:13:17 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m浩气之头盔[2;37;0m", ({ "haoqi head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;32m天地浩气之神兵，扫魔除妖，为国为民，侠之大者！$br#[2;37;0m这是一顶由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤二两五钱的[1;32m浩气之头盔[2;37;0m。$br#
