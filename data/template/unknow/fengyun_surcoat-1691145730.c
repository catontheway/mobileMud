// fengyun_surcoat.c
// Create by TEMPLATE_D. Thu Oct 07 22:58:36 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;35m风云之肚带[2;37;0m", ({ "fengyun surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;35m所谓风云际会，天地变色！仗此行千里，老魔小丑，岂堪一击！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤零两九钱的[1;35m风云之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;33m灭世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_confuse", 23);
