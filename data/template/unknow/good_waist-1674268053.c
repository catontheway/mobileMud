// good_waist.c
// Create by TEMPLATE_D. Mon Oct 11 17:55:17 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m盘古之腰带[2;37;0m", ({ "good waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
盘古之腰带[2;37;0m这是一条由十分坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤七两二钱的[1;33m盘古之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;35m绝世[2;37;0m $br#
...
//气血恢复治疗类
    ...
    set("armor_prop/jingli_recover", 11);
