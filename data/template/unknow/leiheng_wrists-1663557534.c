// leiheng_wrists.c
// Create by TEMPLATE_D. Sat Oct 16 23:20:54 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[33m泪痕之护腕[2;37;0m", ({ "leiheng wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[33m泪痕之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两二钱的[33m泪痕之护腕[2;37;0m。$br#
