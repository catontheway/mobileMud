// haoqi_shield.c
// Create by TEMPLATE_D. Sat Oct 16 04:45:13 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m浩气之盾[2;37;0m", ({ "haoqi shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[1;32m天地浩气之神兵，扫魔除妖，为国为民，侠之大者！$br#[2;37;0m这是一面由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重三斤零两零钱的[1;32m浩气之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m毁天[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
