// longquan_sword.c
// Create by TEMPLATE_D. Fri Oct 08 10:10:56 2021.
// gangjian.c
...
void create()
{
	set_name("[31m龙泉之剑[2;37;0m", ({ "longquan sword" }));
	set_weight(12550);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[31m龙泉人间极品，武林至宝！$br#[2;37;0m这是一把由无比坚硬的[1;37m软银[2;37;0m制成，重二十五斤一两零钱的[31m龙泉之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;31m无双[2;37;0m [1;34m电[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
...
//特效数值
    ...
    set("weapon_prop/cant_all_busy", 4);
