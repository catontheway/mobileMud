// yaohou_cloth.c
// Create by TEMPLATE_D. Fri Nov 11 07:34:05 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m妖后之服装[2;37;0m", ({ "yaohou cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[36m妖后之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重三斤一两三钱的[36m妖后之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;33m灭世[2;37;0m 
