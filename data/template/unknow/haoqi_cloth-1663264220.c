// haoqi_cloth.c
// Create by TEMPLATE_D. Thu Oct 07 16:59:15 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m浩气之服装[2;37;0m", ({ "haoqi cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;32m天地浩气之神兵，扫魔除妖，为国为民，侠之大者！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤五两六钱的[1;32m浩气之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m毁天[2;37;0m [31m火[2;37;0m:[1;34m举世[2;37;0m [33m土[2;37;0m:[1;31m毁天[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/cuff", 15);
    set("armor_prop/dodge", 0);
    set("armor_prop/finger", 27);
...
//特效数值
    ...
    set("armor_prop/max_busy_body", 12);
