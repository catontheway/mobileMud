// chungou_armor.c
// Create by TEMPLATE_D. Sun Oct 17 01:12:53 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m纯钩之披风[2;37;0m", ({ "chungou armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重零斤八两七钱的[31m纯钩之披风[2;37;0m。$br#
...
//特效数值
    ...
    set("armor_prop/cant_busy_confuse", 16);
...
//伤害防御类
    ...
    set("armor_prop/attack_speed", 0);
     ...
     set("armor_prop/parry_factor", 14);
