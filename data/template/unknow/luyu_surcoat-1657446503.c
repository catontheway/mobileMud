// luyu_surcoat.c
// Create by TEMPLATE_D. Mon Oct 11 03:28:33 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m绿玉之肚带[2;37;0m", ({ "luyu surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[37m绿玉之肚带[2;37;0m这是一条由相当坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤七两三钱的[37m绿玉之肚带[2;37;0m。$br#
