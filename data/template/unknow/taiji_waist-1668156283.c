// taiji_waist.c
// Create by TEMPLATE_D. Mon Oct 18 18:22:48 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;33m太极之腰带[2;37;0m", ({ "taiji waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;33m太极者，无极而生，阴阳之母也。动之则分，静之则合。无过不及，随曲就伸。人刚我柔谓之走，我顺人背谓之粘。动急则急应，动缓则缓随。虽变化万端，而理为一贯！$br#[2;37;0m这是一条由无比坚硬的精钢加上[1;37m蚕丝[2;37;0m制成，重一斤五两一钱的[1;33m太极之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;34m电[2;37;0m:[1;33m灭世[2;37;0m 
