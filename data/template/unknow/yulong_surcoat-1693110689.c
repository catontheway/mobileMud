// yulong_surcoat.c
// Create by TEMPLATE_D. Mon Oct 11 16:22:30 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[32m玉龙之肚带[2;37;0m", ({ "yulong surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[32m玉龙之肚带[2;37;0m这是一条由绝对坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两六钱的[32m玉龙之肚带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m 
