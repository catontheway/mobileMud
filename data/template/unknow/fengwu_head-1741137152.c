// fengwu_head.c
// Create by TEMPLATE_D. Sat Nov 12 00:03:08 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[32m凤舞之头盔[2;37;0m", ({ "fengwu head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[32m凤舞之头盔[2;37;0m这是一顶由十分坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两九钱的[32m凤舞之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;33m灭世[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
