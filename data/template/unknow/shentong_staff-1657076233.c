// shentong_staff.c
// Create by TEMPLATE_D. Sat Oct 09 09:25:05 2021.
// gangjian.c
...
void create()
{
	set_name("[1;31m神通之杖[2;37;0m", ({ "shentong staff" }));
	set_weight(5024);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "根");
		set("long","[1;31m天兵神通，走势要平善，气要随行，两眼顾尖，气沉两足稳，身法需自然，身行如飞燕，身落如停风，收如花絮，刺如钢钉！$br#[2;37;0m这是一根由无比坚硬的[31m流花石[2;37;0m制成，重十斤零两四钱的[1;31m神通之杖[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;36m完美[2;37;0m [1;35m风[2;37;0m:[1;31m开元[2;37;0m $br#[37m天[2;37;0m:[1;36m完美[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
