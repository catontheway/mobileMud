// good_cloth.c
// Create by TEMPLATE_D. Sat Oct 09 11:11:50 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m吉祥之服装[2;37;0m", ({ "good cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
吉祥之服装[2;37;0m这是一件由绝对坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两一钱的[1;31m吉祥之服装[2;37;0m。$br#
