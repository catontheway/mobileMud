// pixie_blade.c
// Create by TEMPLATE_D. Wed Oct 06 21:21:29 2021.
// gangjian.c
...
void create()
{
	set_name("[1;31m辟邪之刀[2;37;0m", ({ "pixie blade" }));
	set_weight(13806);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "柄");
		set("long","[1;31m辟邪之刀[2;37;0m这是一柄由无比坚硬的[1;32m绿石[2;37;0m制成，重二十七斤六两一钱的[1;31m辟邪之刀[2;37;0m。$br#
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
