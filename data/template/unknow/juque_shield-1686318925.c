// juque_shield.c
// Create by TEMPLATE_D. Thu Oct 07 13:25:29 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m巨阙之盾[2;37;0m", ({ "juque shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[31m巨阙坚硬无比，能开天辟地，荡妖除魔！$br#[2;37;0m这是一面由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重二斤八两三钱的[31m巨阙之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;31m毁天[2;37;0m 
