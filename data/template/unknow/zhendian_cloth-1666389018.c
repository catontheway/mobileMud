// zhendian_cloth.c
// Create by TEMPLATE_D. Sat Oct 09 21:11:44 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m震电之服装[2;37;0m", ({ "zhendian cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[37m震电之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤八两八钱的[37m震电之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;31m毁天[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/max_busy_confuse", 15);
