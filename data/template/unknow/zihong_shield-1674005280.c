// zihong_shield.c
// Create by TEMPLATE_D. Thu Oct 07 07:20:03 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[36m紫虹之盾[2;37;0m", ({ "zihong shield" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "面");
		set("long", @LONG
[36m紫虹之盾[2;37;0m这是一面由十分坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重二斤七两二钱的[36m紫虹之盾[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;31m无双[2;37;0m [1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [37m天[2;37;0m:[1;31m开元[2;37;0m 
