// general_waist.c
// Create by TEMPLATE_D. Mon Oct 18 10:50:18 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m含翠之腰带[2;37;0m", ({ "general waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
含翠之腰带[2;37;0m这是一条由十分坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两五钱的[1;36m含翠之腰带[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;31m开元[2;37;0m 
