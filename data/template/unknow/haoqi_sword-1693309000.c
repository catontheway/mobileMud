// haoqi_sword.c
// Create by TEMPLATE_D. Wed Oct 06 16:32:07 2021.
// gangjian.c
...
void create()
{
	set_name("[1;32m浩气之剑[2;37;0m", ({ "haoqi sword" }));
	set_weight(5820);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "把");
		set("long","[1;32m天地浩气之神兵，扫魔除妖，为国为民，侠之大者！$br#[2;37;0m这是一把由无比坚硬的[31m流花石[2;37;0m制成，重十一斤六两四钱的[1;32m浩气之剑[2;37;0m。$br#$br#上面刻了几个古符号：$br#[37m天[2;37;0m:[1;31m无双[2;37;0m 
");
    set("no_get",1);
	set("no_put", 1);
	  set("no_pawn",1);
