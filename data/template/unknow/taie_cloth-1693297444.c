// taie_cloth.c
// Create by TEMPLATE_D. Sun Oct 10 21:24:33 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m太阿之服装[2;37;0m", ({ "taie cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m太阿帝王之兵，持之能号令天下，莫有不从！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重二斤零两一钱的[31m太阿之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[31m火[2;37;0m:[1;33m灭世[2;37;0m [1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[1;37m雷[2;37;0m:[1;33m灭世[2;37;0m [1;34m电[2;37;0m:[1;31m开元[2;37;0m [40m地[2;37;0m:[1;33m灭世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/finger", 9);
    set("armor_prop/hand", 0);
    set("armor_prop/parry", 0);
    set("armor_prop/strike", 0);
    set("armor_prop/unarmed", 41);
    set("armor_prop/blade", 0);
    set("armor_prop/whip", 13);
...
//特效数值
    ...
    set("armor_prop/cant_busy_confuse", 23);
    set("armor_prop/cant_busy_body", 0);
    set("armor_prop/max_all_busy", 21);
