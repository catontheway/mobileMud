// huangyu_surcoat.c
// Create by TEMPLATE_D. Sun Oct 24 18:06:02 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[37m黄玉之肚带[2;37;0m", ({ "huangyu surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[37m黄玉之肚带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤七两六钱的[37m黄玉之肚带[2;37;0m。$br#
