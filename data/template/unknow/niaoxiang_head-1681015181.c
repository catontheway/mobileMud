// niaoxiang_head.c
// Create by TEMPLATE_D. Wed Oct 13 11:55:33 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m鸟翔之头盔[2;37;0m", ({ "niaoxiang head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;32m鸟翔之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两九钱的[1;32m鸟翔之头盔[2;37;0m。$br#$br#上面刻了几个古符号：$br#[32m水[2;37;0m:[1;31m开元[2;37;0m [1;34m电[2;37;0m:[1;31m毁天[2;37;0m 
