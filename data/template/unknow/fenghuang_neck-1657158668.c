// fenghuang_neck.c
// Create by TEMPLATE_D. Fri Oct 08 12:06:28 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[35m凤凰之项链[2;37;0m", ({ "fenghuang neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[35m凤凰之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤六两八钱的[35m凤凰之项链[2;37;0m。$br#
