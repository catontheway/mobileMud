// bad_surcoat.c
// Create by TEMPLATE_D. Sun Oct 10 00:22:53 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m铜之肚带[2;37;0m", ({ "bad surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
铜之肚带[2;37;0m这是一条由还算坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤一两二钱的[1;32m铜之肚带[2;37;0m。$br#
