// pojia_boots.c
// Create by TEMPLATE_D. Sun Oct 10 21:30:50 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m破甲之靴[2;37;0m", ({ "pojia boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;32m破甲之靴[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤七两零钱的[1;32m破甲之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;35m风[2;37;0m:[1;33m灭世[2;37;0m $br#[1;36m人[2;37;0m:[1;31m无双[2;37;0m 
