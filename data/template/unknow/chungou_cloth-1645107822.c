// chungou_cloth.c
// Create by TEMPLATE_D. Fri Oct 15 09:23:42 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[31m纯钩之服装[2;37;0m", ({ "chungou cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[31m纯钩将帅之兵，持之能挥军百万，克敌制胜！$br#[2;37;0m这是一件由无比坚硬的精钢加上[1;33m木棉花[2;37;0m制成，重二斤九两八钱的[31m纯钩之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;36m人[2;37;0m:[1;35m绝世[2;37;0m [1;31m魔[2;37;0m:[1;33m灭世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    //技能类
    set("armor_prop/claw", 22);
    set("armor_prop/cuff", 0);
    set("armor_prop/dodge", 0);
    set("armor_prop/finger", 42);
...
//特效数值
    ...
    set("armor_prop/cant_all_busy", 13);
