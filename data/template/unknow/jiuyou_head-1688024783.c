// jiuyou_head.c
// Create by TEMPLATE_D. Sun Nov 13 14:55:00 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;32m九幽之头盔[2;37;0m", ({ "jiuyou head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
[1;32m九幽之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两八钱的[1;32m九幽之头盔[2;37;0m。$br#
