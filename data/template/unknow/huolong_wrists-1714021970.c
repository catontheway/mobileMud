// huolong_wrists.c
// Create by TEMPLATE_D. Fri Nov 11 15:20:53 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;31m火龙之护腕[2;37;0m", ({ "huolong wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
[1;31m火龙之护腕[2;37;0m这是一双由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两零钱的[1;31m火龙之护腕[2;37;0m。$br#$br#上面刻了几个古符号：$br#[1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
...
LONG
 ...
 //先天类    
    ...
    set("armor_prop/staff", 16);
    set("armor_prop/force", 0);
    set("armor_prop/dagge", 0);
    set("armor_prop/hammer", 31);
