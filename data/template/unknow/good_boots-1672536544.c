// good_boots.c
// Create by TEMPLATE_D. Fri Oct 08 20:14:40 2021.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m弯月之靴[2;37;0m", ({ "good boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
弯月之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤三两八钱的[1;36m弯月之靴[2;37;0m。$br#$br#上面刻了几个古符号：$br#[33m土[2;37;0m:[1;33m灭世[2;37;0m 
