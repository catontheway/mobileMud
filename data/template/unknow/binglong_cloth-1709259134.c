// binglong_cloth.c
// Create by TEMPLATE_D. Thu Nov 10 17:54:00 2022.
#include <ansi.h> 
#include <armor.h>
...
void create()
{
	set_name("[1;36m冰龙之服装[2;37;0m", ({ "binglong cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[1;36m冰龙之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤六两二钱的[1;36m冰龙之服装[2;37;0m。$br#$br#上面刻了几个古符号：$br#[36m木[2;37;0m:[1;32m魔王[2;37;0m [32m水[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;35m绝世[2;37;0m 
...
//特效数值
    ...
    set("armor_prop/cant_busy_dianxue", 16);
    set("armor_prop/cant_busy_jiemai", 0);
    set("armor_prop/cant_busy_fenjin", 16);
    set("armor_prop/cant_busy_confuse", 0);
    set("armor_prop/cant_busy_body", 16);
