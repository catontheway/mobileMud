...
trust_list = []
manager_list = ("jason","becool","whuan","picewolf","vast","pal","icer","safeguard","zgbl")
advert_string = ["我是$ME$，有什么问题就问我吧。比如helpme ask 保卫襄阳。","我是$ME$，人称通天彻地美智囊，用helpme ask 问题，我给你解惑！","江湖中除了我，就属wiki有学问，尤其是 http://pkuxkx.net/wiki/guide，是每个新手都应该读的。"]
host="localhost 8301"    
username = "grobot"
password = "pkuxkx!@#"
...
if __name__ == "__main__":
    db = sqlite3.connect("./question_test.db")
    c = db.cursor()
